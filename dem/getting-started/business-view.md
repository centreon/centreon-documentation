...
- a **Business**, **Full**, or **Enterprise** CXM license.
- synchronization of your CXM account with your Google Analytics account.
...
- a ranked list of pages that need performance improvements and that have the greatest potential impact if optimized. To calculate this, CXM analyzes the traffic each page generates together with each page's response times. The result is a summary table expressing potential gains in additional annual revenue.
