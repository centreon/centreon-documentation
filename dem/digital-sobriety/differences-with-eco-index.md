...
The distinction between DEM's Digital Sobriety Score and the Eco Index developed by the GreenIT collective rests on several fundamental points, reflecting different approaches to evaluating the environmental footprint of websites.
...
Advantages: By valuing a wider spectrum of indicators and analyzing a representative panel of pages rather than a single URL, DEM's Digital Sobriety Score provides a more comprehensive assessment of a site's environmental footprint. These indicators account for:
...
Purpose: DEM's initiative aims to offer all stakeholders a free, global view of a website's environmental footprint, with a score comparable between two sites that may not have the same traffic level. The initiative encourages extensive optimization efforts and supports reductions in digital ecological impact across servers, networks, and by promoting longer device lifetimes.

### Which indicator should you follow?

That depends on your goals. Both approaches are complementary: the Eco Index emphasizes simple evaluation based on three technical criteria for a given URL — very useful during development — while DEM's Digital Sobriety Score adopts a broader, audit-style approach more suited to sites already in production.
