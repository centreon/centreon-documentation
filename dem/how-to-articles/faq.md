...
To ensure the agent works, outgoing HTTPS connections [to our IPs](../installation/dem-ip-addresses.md) must be allowed.
...
- Sends collected data to DEM via secure HTTPS (proxy possible).
