...
A gray area on the chart indicates that DEM could not collect data during that period, or that the data was null or non-existent.
...
Finally, in rare situations, DEM's STM probes may be non-functional for a few minutes. To avoid skewing analysis by making it appear the site was unreachable, DEM displays a gray area (red indicates a detected incident on the monitored site).
