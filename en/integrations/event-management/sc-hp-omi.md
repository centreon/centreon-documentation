...
| Number | `max_buffer_size`   | Maximum number of events to be buffered while waiting to be transmitted in one transmission       | 5                                                       |
| Number | `max_buffer_age`    | Maximum time to wait before sending events to the buffer if `max_buffer_size` is not yet reached  | 60                                                      |
...
curl -X POST https://192.168.56.15:300005/bsmc/rest/events/opscx-sdk/v1/
   ...
   -d "<event_data>       <related_ci>test_splunk</related_ci>    <source_ci>Centreon</source_ci> <title>Ping</title>     <source_event_id>271</source_event_id>  <severity>0</severity>  <description>OK - localhost rta 0.024ms lost 0%</description>   <node>test_splunk</node>        <time_created>1643303907</time_created> </event_data>"
```
