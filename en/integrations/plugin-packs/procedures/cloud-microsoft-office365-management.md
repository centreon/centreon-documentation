...
2. Sélectionnez 'Office 365 Management APIs' de manière à ce qu’elles apparaissent dans la colonne 'Sélectionné', puis cochez la case en bas à droite pour enregistrer votre sélection et revenir à la page de configuration principale de votre application.
...
Les droits minimum à attribuer sont :
* Reports.Read.All sur Microsoft Graph
...
```bash
yum install centreon-pack-cloud-microsoft-office365-management-3.1.1-1.el7.centos.noarch 
```
...
| Obligatoire | Nom               | Description                                                                                 |
| :---------- | :--------------   | :------------------------------------------------------------------------------------------ |
|             | FILTERSERVICENAME | Filtre pour cibler un service en particulier (Office 365 Portal, Exchang Online, etc..)     |
|             | FILTERFEATURENAME | Filtre pour cibler une feature en particulier (Word, Excel, Visio, etc..)                   |
|             | WARNINGSTATUS     | Seuil d'alerte warning                                                                      |
|             | CRITICALSTATUS    | Seuil d'alerte critical (par défaut : %{status} !~ /Normal/i)                               |



## FAQ

#### Comment tester en ligne de commande et comprendre les options principales ?
...
Remarque : Par defaut ce plugin utilise la librairie web "Lwb" pour requêter l'api de Microsoft Office 365. Si nécessaire, veuillez utiliser la librairie Curl
