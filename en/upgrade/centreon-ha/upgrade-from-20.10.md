...
> **WARNING** the following commands must be executed firstly on the master database node. Once the master database node is in 10.5, you can upgrade the slave database node.
