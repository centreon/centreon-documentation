...
In Log Management, you can filter your data by using these attributes in [queries](../query-syntax.md), in [**Log explorer**](../log-explorer.md#using-the-log-explorer-page) or [dashboards](../dashboards.md).
