...
See also [Alert event](#alert-eventalert-status).
...
In CLM, you will only ever see logs with a <span style={{color:'#1ebeb3'}}>**DEBUG**</span>, <span style={{color:'#1588d1'}}>**INFO**</span>, <span style={{color:'#ffca34'}}>**WARNING**</span>, <span style={{color:'#fd9b27'}}>**ERROR**</span>, or <span style={{color:'#ff4a4a'}}>**FATAL**</span> severity. This is because all queries are based on the **SeverityNumber** attribute. However, the labels shown always follow the OpenTelemetry standard (except WARN that becomes WARNING). If your device uses different labels in its **SeverityText** attribute, those labels will be ignored. This prevents duplicates or inconsistent entries in the severity list.
