...
You can expand each alert event to view more information about it, including the alert rule evaluation history. Hover over the graph to display the start and end dates for each segment.
