---
id: plugins-advanced
title: Plugins / Connectors advanced documentation
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Plugins / Connectors advanced documentation
...
This function adds a string to the output (it is printed when the `display()` method is called). If the status is 
different from 'ok', the output associated with 'ok' status is not printed.
...
All the explanations are [here](https://github.com/centreon/centreon-plugins/blob/develop/doc/en/developer/sequence_diagram.md) and the full diagram is [here](https://github.com/centreon/centreon-plugins/blob/develop/doc/en/developer/sequence_diagram.mmd).