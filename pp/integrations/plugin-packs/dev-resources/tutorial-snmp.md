...
## Create the plugin file : plugin.pm
...
## Create the mode file : cpu.pm

### Common declarations and new constructor
...
### Get raw data from SNMP and understand the data structure
