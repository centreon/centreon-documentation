---
id: plugins-global
title: Plugins / Connectors global documentation
---
...
An more detailed description of this libraries is available [here](../dev-resources/plugins-advanced.md)
...
* centreon::plugins::script_simple : Previously the general use case if no custom is needed, more explainations [here](../dev-resources/tutorial-api.md) in this section.
* centreon::plugins::script_custom : Need custom directory - More explainations [here](../dev-resources/tutorial-api.md) in this section.
...
You can look at how we handle help at mode level with the centreon-plugins framework [here](../dev-resources/plugins-advanced.md).