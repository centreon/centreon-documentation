...
The following monitoring connectors will be installed when you install the **Netbackup SSH** connector through the
...
The Monitoring Connector **Netbackup SSH** brings a host template:
...
|:---------------|:----------------------------------------|:---------------------------------|:----------:|
| Dedup-Status   | App-Netbackup-SSH-Dedup-Status-custom   | Check deduplication status       |            |
| Drive-Cleaning | App-Netbackup-SSH-Drive-Cleaning-custom | Check drive cleaning             |            |
| Drive-Status   | App-Netbackup-SSH-Drive-Status-custom   | Check drive status               |            |
| Job-Status     | App-Netbackup-SSH-Job-Status-custom     | Check job status                 | X          |
| Tape-Usage     | App-Netbackup-SSH-Tape-Usage-custom     | Check tapes available in library |            |

> The services listed above are created automatically when the **App-Netbackup-SSH-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Netbackup SSH** connector through
...
3. Apply the **App-Netbackup-SSH-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
