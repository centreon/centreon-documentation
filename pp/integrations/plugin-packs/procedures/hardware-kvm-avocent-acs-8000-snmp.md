...
| --free                   | Apply thresholds on free space instead of on used space. (deprecated. Please use newcounters directly)                                                                                                                                                                                                                      |
...
| --statefile-key          | Define the key to encrypt/decrypt the cache.                                                                                                                                                                                                  |
| --statefile-cipher       | Define the cipher algorithm to encrypt the cache (default: 'AES').                                                                                                                                                                            |
| --filter-name            | Filter by serial device name (can be a regexp).                                                                                                                                                                                               |
