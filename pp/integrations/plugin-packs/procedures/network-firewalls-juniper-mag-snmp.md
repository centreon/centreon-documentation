...
/usr/lib/centreon/plugins/centreon_juniper_mag.pl \
	--plugin=network::juniper::mag::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
```bash
OK: All interfaces are ok | 'interface_name1#interface.traffic.in.bitspersecond'=38864b/s;;;; 'interface_name2#interface.traffic.in.bitspersecond'=67300b/s;;;; 'interface_name1#interface.traffic.out.bitspersecond'=37966b/s;;;; 'interface_name2#interface.traffic.out.bitspersecond'=7307b/s;;;; 
```
...
|:--------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| blade-temperature [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/mag/snmp/mode/bladetemperature.pm)] | Net-Juniper-MAG-Blade-Temperature-SNMP-custom                                                                                                        |
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/ive/snmp/mode/cpu.pm)]                     | Net-Juniper-MAG-Cpu-SNMP-custom                                                                                                                      |
| disk [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/ive/snmp/mode/disk.pm)]                   | Net-Juniper-MAG-Disk-SNMP-custom                                                                                                                     |
...
| logfile [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/ive/snmp/mode/logfile.pm)]             | Net-Juniper-MAG-Logfile-SNMP-custom                                                                                                                  |
...
| users [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/ive/snmp/mode/users.pm)]                 | Net-Juniper-MAG-Users-SNMP-custom                                                                                                                    |
...
| Option                              | Description                                                                                     |
|:------------------------------------|:------------------------------------------------------------------------------------------------|
| --filter-counters                   | Only display some counters (regexp can be used). Example: C\<--filter-counters='web\|meeting'\> |
| --warning-node-users-usage          | Warning threshold for node users usage (count).                                                 |
| --critical-node-users-usage         | Critical threshold for node users usage (count).                                                |
| --warning-node-users-free           | Warning threshold for node users free (count).                                                  |
| --critical-node-users-free          | Critical threshold for node users free (count).                                                 |
| --warning-node-users-usage-prct     | Warning threshold for node users usage (percentage).                                            |
| --critical-node-users-usage-prct    | Critical threshold for node users usage (percentage).                                           |
| --warning-cluster-users-usage       | Warning threshold for cluster users usage (count).                                              |
| --critical-cluster-users-usage      | Critical threshold for cluster users usage (count).                                             |
| --warning-cluster-users-free        | Warning threshold for cluster users free (count).                                               |
| --critical-cluster-users-free       | Critical threshold for cluster users free (count).                                              |
| --warning-cluster-users-usage-prct  | Warning threshold for cluster users usage (percentage).                                         |
| --critical-cluster-users-usage-prct | Critical threshold for cluster users usage (percentage).                                        |
| --warning-web-users-signedin-usage  | Warning threshold for web users signed-in usage (count).                                        |
| --critical-web-users-signedin-usage | Critical threshold for web users signed-in usage (count).                                       |
| --warning-meeting-users-usage       | Warning threshold for meeting users usage (count).                                              |
| --critical-meeting-users-usage      | Critical threshold for meeting users usage (count).                                             |
