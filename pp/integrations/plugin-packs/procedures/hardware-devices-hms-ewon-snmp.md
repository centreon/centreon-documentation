...
2. On the Centreon Web interface in **Configuration > Monitoring Connector Manager**, install the *HMS Ewon SNMP* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Monitoring Connector Manager**, install the *HMS Ewon SNMP* Monitoring Connector
