...
| CRITICALSTATUS         | Define the conditions to match for the status to be CRITICAL (default: '%\{role\} ne %\{roleLast\} or %\{sync_status\} =~ /unsynchronized/'). You can use the following variables: %\{serial\}, %\{hostname\}, %\{sync_status\}, %\{role\}, %\{roleLast\} | %\{role\} ne %\{roleLast\} or %\{sync_status\} =~ /unsynchronized/ |             |
| WARNINGSTATUS          | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{serial\}, %\{hostname\}, %\{sync_status\}, %\{role\}, %\{roleLast\}                                                                             |                                                               |             |
...
| WARNINGSTATUS            | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{op_mode\}, %\{ha_state\}  |                   |             |
| CRITICALSTATUS           | Define the conditions to match for the status to be CRITICAL (default: ''). You can use the following variables: %\{op_mode\}, %\{ha_state\} |                   |             |
| WARNINGTRAFFICIN         | Thresholds                                                                                                                                 |                   |             |
| CRITICALTRAFFICIN        | Thresholds                                                                                                                                 |                   |             |
| WARNINGTRAFFICOUT        | Thresholds                                                                                                                                 |                   |             |
| CRITICALTRAFFICOUT       | Thresholds                                                                                                                                 |                   |             |
...
| --warning-status         | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{serial\}, %\{hostname\}, %\{sync_status\}, %\{role\}, %\{roleLast\}                                                                               |
| --critical-status        | Define the conditions to match for the status to be CRITICAL (default: '%\{role\} ne %\{roleLast\} or %\{sync_status\} =~ /unsynchronized/'). You can use the following variables: %\{serial\}, %\{hostname\}, %\{sync_status\}, %\{role\}, %\{roleLast\}   |
...
| --warning-status         | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{op_mode\}, %\{ha_state\}                                                                                                     |
| --critical-status        | Define the conditions to match for the status to be CRITICAL (default: ''). You can use the following variables: %\{op_mode\}, %\{ha_state\}                                                                                                    |
