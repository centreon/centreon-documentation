...
|:--------------|:--------------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| Cpu           | Net-Fortinet-Fortigate-Cpu-SNMP-custom      | Check the rate of utilization of CPU for the machine. This check can give the average utilization rate of CPU |
...
| Traffic-Id       | Net-Fortinet-Fortigate-Traffic-Id-SNMP-custom       | Check traffic of an network interface                        |            |
| Traffic-Name     | Net-Fortinet-Fortigate-Traffic-Name-SNMP-custom     | Check traffic of an network interface                        |            |
| VPN-Global       | Net-Fortinet-Fortigate-VPN-Global-SNMP-custom       | Check VPN links state                                        |            |
