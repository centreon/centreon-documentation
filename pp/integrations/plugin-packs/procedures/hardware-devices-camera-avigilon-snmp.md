...
slug: /hardware-devices-camera-avigilon-snmp
...
The Monitoring Connector **Camera Avigilon SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="HW-Device-Camera-Avigilon-SNMP-custom" label="HW-Device-Camera-Avigilon-SNMP-custom">
...
```bash
apt install centreon-pack-hardware-devices-camera-avigilon-snmp
```
...
```bash
yum install centreon-pack-hardware-devices-camera-avigilon-snmp
```

</TabItem>
</Tabs>

2. Whatever the license type (*online* or *offline*), install the **Camera Avigilon SNMP** connector through
...
```bash
apt install centreon-plugin-hardware-devices-camera-avigilon-snmp
```
...
```bash
yum install centreon-plugin-Hardware-Devices-Camera-Avigilon-Snmp
```
...
3. Apply the **HW-Device-Camera-Avigilon-SNMP-custom** template to the host. 
...
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/uptime.pm)]                                   | HW-Device-Camera-Avigilon-Uptime-SNMP-custom      |
...
| Option                | Description                                           |
|:----------------------|:------------------------------------------------------|
| --warning-available*  | Warning threshold for total memory available (B).     |
| --critical-available* | Critical threshold for total memory available (B).    |
...
| Option                  | Description                                                                                                                                                      |
|:------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --warning-status        | Define the conditions to match to return a warning status. The condition can be written using the following macros: %\{status\}.                                   |
| --critical-status       | Define the conditions to match to return a critical status (default: '%\{status\} ne "ok"'). The condition can be written using the following macros: %\{status\}.   |
| --warning-temperature*  | Warning threshold for temperature (Celsius).                                                                                                                     |
| --critical-temperature* | Critical threshold for temperature (Celsius).                                                                                                                    |
