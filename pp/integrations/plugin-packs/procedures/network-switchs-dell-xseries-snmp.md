...
The following monitoring connectors will be installed when you install the **Dell Xseries SNMP** connector through the
...
The Monitoring Connector **Dell Xseries SNMP** brings a host template:
...
|:--------------|:----------------------------------------|:---------------------------|:---------:|
| Cpu           | Net-Dell-Xseries-Cpu-SNMP-custom        | Check CPU on 5s, 1m and 5m |           |
| Hardware      | Net-Dell-Xseries-Hardware-SNMP-custom   | Check Hardware component   |           |
| Interfaces    | Net-Dell-Xseries-Interfaces-SNMP-custom | Check interfaces           |     X     |
| Uptime        | Net-Dell-Xseries-Uptime-SNMP-custom     | Check Uptime of equipment  |           |

> The services listed above are created automatically when the **Net-Dell-Xseries-SNMP-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Dell Xseries SNMP** connector through
...
3. Apply the **Net-Dell-Xseries-SNMP-custom** template to the host.
...
| WARNINGAVERAGE1S  | Threshold                                                                                                                                        |               |           |
| CRITICALAVERAGE1S | Threshold                                                                                                                                        |               |           |
...
```bash
OK: All interfaces are ok | 'interface_name1#interface.traffic.in.bitspersecond'=69297b/s;;;; 'interface_name2#interface.traffic.in.bitspersecond'=34119b/s;;;; 'interface_name1#interface.traffic.out.bitspersecond'=12676b/s;;;; 'interface_name2#interface.traffic.out.bitspersecond'=86102b/s;;;; 'interface_name1#interface.packets.in.discard.percentage'=1%;;;;100 'interface_name2#interface.packets.in.discard.percentage'=23%;;;;100 'interface_name1#interface.packets.in.error.percentage'=57%;;;;100 'interface_name2#interface.packets.in.error.percentage'=61%;;;;100 'interface_name1#interface.packets.out.discard.percentage'=66%;;;;100 'interface_name2#interface.packets.out.discard.percentage'=34%;;;;100 'interface_name1#interface.packets.out.error.percentage'=57%;;;;100 'interface_name2#interface.packets.out.error.percentage'=74%;;;;100 
```
