...
The Monitoring Connector **Azure SQL Server** brings a host template:
...
to the list of monitored hosts. This provider is named **Microsoft Azure SQL Server**.
...
2. Whatever the license type (*online* or *offline*), install the **Azure SQL Server** connector through
...
3. Apply the **Cloud-Azure-Database-SqlServer-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
