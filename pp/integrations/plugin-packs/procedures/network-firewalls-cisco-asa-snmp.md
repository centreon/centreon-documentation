...
| Packet-Errors-Generic-Id   | Net-FW-Cisco-Asa-Packet-Errors-Generic-Id-SNMP-custom   | Check packets on errors/discards of a network interface.         |            |
| Packet-Errors-Generic-Name | Net-FW-Cisco-Asa-Packet-Errors-Generic-Name-SNMP-custom | Check packets on errors/discards of a network interface.         |            |
| Packet-Errors-Global       | Net-FW-Cisco-Asa-Packet-Errors-Global-SNMP-custom       | Check packets on errors/discards of multiple network interfaces. | X          |
