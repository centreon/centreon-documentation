...
The Monitoring Connector **Phoenixtec UPS SNMP** brings a host template:

* **HW-Ups-Phoenixtec-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<TabItem value="HW-Ups-Phoenixtec-SNMP-custom" label="HW-Ups-Phoenixtec-SNMP-custom">

| Service Alias  | Service Template                             | Service Description |
|:---------------|:---------------------------------------------|:--------------------|
| Battery-Status | HW-Ups-Phoenixtec-Battery-Status-SNMP-custom | Check battery status and remaining battery charge.                    |
| Input-Lines    | HW-Ups-Phoenixtec-Input-Lines-SNMP-custom    | Check input lines metrics.                    |
| Output-Lines   | HW-Ups-Phoenixtec-Output-Lines-SNMP-custom   | Check output lines metrics.                    |

> The services listed above are created automatically when the **HW-Ups-Phoenixtec-SNMP-custom** host template is used.
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Ups-Phoenixtec-SNMP-custom** host template |
...
```bash
dnf install centreon-pack-hardware-ups-phoenixtec-snmp
```
...
```bash
apt install centreon-pack-hardware-ups-phoenixtec-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **Phoenixtec UPS SNMP** connector through
...
```bash
dnf install centreon-plugin-Hardware-Ups-Phoenixtec-Snmp
```
...
```bash
apt install centreon-plugin-hardware-ups-phoenixtec-snmp
```
...
3. Apply the **HW-Ups-Phoenixtec-SNMP-custom** template to the host.
...
| WARNINGSTATUS                  | Define the conditions to match for the status to be WARNING (default: '%{status} =~ /low/i'). You can use the following variables: %{status} |                   |             |
...
```bash
OK: frequence: 25 Hz voltage: 66 V | 'lines.input.frequence.hertz'=25Hz;;;;'lines.input.voltage.volt'=66V;;;;
```
...
|:---------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------|
| battery-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/xppc/snmp/mode/batterystatus.pm)] | HW-Ups-Phoenixtec-Battery-Status-SNMP-custom |
| input-lines [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/xppc/snmp/mode/inputlines.pm)]       | HW-Ups-Phoenixtec-Input-Lines-SNMP-custom    |
| output-lines [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/xppc/snmp/mode/outputlines.pm)]     | HW-Ups-Phoenixtec-Output-Lines-SNMP-custom   |
...
| --warning-* --critical-* | Thresholds. Can be: Can be: 'charge-remaining' (%), 'charge-remaining-minutes', 'temperature' (C), 'voltage' (V).                                   |
...
| Option                   | Description                                    |
|:-------------------------|:-----------------------------------------------|
| --warning-* --critical-* | Thresholds. Can be: 'frequence', 'voltage'.    |
