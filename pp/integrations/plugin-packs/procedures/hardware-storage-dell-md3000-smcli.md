...
The Monitoring Connector **Dell MD3000** brings a host template:
...
3. Apply the **HW-Storage-Dell-MD3000-Cli-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
