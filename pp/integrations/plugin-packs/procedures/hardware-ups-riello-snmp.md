...
The Monitoring Connector **Riello UPS SNMP** brings a host template:
...
|:--------------|:---------------------------------------|:---------------------------|
| Alarms        | HW-UPS-Riello-Alarms-SNMP-custom       | Check current alarms       |
| Battery       | HW-UPS-Riello-Battery-SNMP-custom      | Check battery status       |
| Input-Lines   | HW-UPS-Riello-Input-Lines-SNMP-custom  | Check input lines metrics  |
| Output-Lines  | HW-UPS-Riello-Output-Lines-SNMP-custom | Check output lines metrics |

> The services listed above are created automatically when the **HW-UPS-Riello-SNMP-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Riello UPS SNMP** connector through
...
3. Apply the **HW-UPS-Riello-SNMP-custom** template to the host. 
