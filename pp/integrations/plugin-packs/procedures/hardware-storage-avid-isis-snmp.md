...
The following monitoring connectors will be installed when you install the **Avid Isis SNMP** connector through the
...
The Monitoring Connector **Avid Isis SNMP** brings a host template:
...
|:--------------|:---------------------------------------------------|:----------------------------------------------------------------|
| Hardware      | Hardware-Storage-Avid-Isis-Hardware-SNMP-custom    | Check hardware (LSI-MegaRAID-SAS-MIB)                           |
...
2. Whatever the license type (*online* or *offline*), install the **Avid Isis SNMP** connector through
