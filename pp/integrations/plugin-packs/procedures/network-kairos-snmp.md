...
The following monitoring connectors will be installed when you install the **Kairos SNMP** connector through the
...
The Monitoring Connector **Kairos SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="Net-Kairos-SNMP-custom" label="Net-Kairos-SNMP-custom">

| Service Alias | Service Template                | Service Description                                                                                                                                  |
|:--------------|:--------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Cpu           | Net-Kairos-Cpu-SNMP-custom      | Check the rate of utilization of CPU for the equipment. This check can give the average CPU utilization rate and the rate per CPU for multi-core CPU |
| Hardware      | Net-Kairos-Hardware-SNMP-custom | Check the state of hardware components                                                                                                               |
| Load          | Net-Kairos-Load-SNMP-custom     | Check system load                                                                                                                                    |
| Memory        | Net-Kairos-Memory-SNMP-custom   | Check machine memory usage                                                                                                                           |
| Uptime        | Net-Kairos-Uptime-SNMP-custom   | Time since the system has been working and available                                                                                                 |

> The services listed above are created automatically when the **Net-Kairos-SNMP-custom** host template is used.
...
|:--------------|:------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|
| Alarms        | Net-Kairos-Alarms-SNMP-custom       | Check if alarms are present                                                                                                                                 | X         |
| Cpu-Detailed  | Net-Kairos-Cpu-Detailed-SNMP-custom | Check the detailed rate of utilization of CPU for the machine. This check can give the average CPU utilization rate and the rate per CPU for multi-core CPU |           |
| Interfaces    | Net-Kairos-Interfaces-SNMP-custom   | Check interfaces                                                                                                                                            | X         |
...
|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Kairos-SNMP-custom** host template. |
...
The SNMP agent must be enabled and configured on the [Kairos resource](https://www.radioactivity-tlc.it/pdf/Brochure_Kairos_EN.pdf). Please refer to the official documentation from the manufacturer/publisher. 
...
2. Whatever the license type (*online* or *offline*), install the **Kairos SNMP** connector through
...
| list-alarms [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/kairos/snmp/mode/listalarms.pm)]   | Used for service discovery            |
