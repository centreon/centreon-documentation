...
> There is no service template linked with this host template.
...
| Cloudwatch-Get-Metrics | Cloud-Aws-Cloudwatch-Get-Metrics-Api-custom | Check Cloudwatch metrics  |
