...
The Monitoring Connector **Libraesva SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="Net-Libraesva-SNMP-custom" label="Net-Libraesva-SNMP-custom">

| Service Alias | Service Template                 | Service Description                           |
|:--------------|:---------------------------------|:----------------------------------------------|
| Load          | Net-Libraesva-Load-SNMP-custom   | Check the server load average                 |
| Memory        | Net-Libraesva-Memory-SNMP-custom | Check the rate of the utilization of memories |
| Swap          | Net-Libraesva-Swap-SNMP-custom   | Check swap                                    |
| System        | Net-Libraesva-System-SNMP-custom | Check system                                  |

> The services listed above are created automatically when the **Net-Libraesva-SNMP-custom** host template is used.
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Libraesva-SNMP-custom** host template |
...
| Rule name                         | Description                                                   |
|:----------------------------------|:--------------------------------------------------------------|
| Net-Libraesva-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
| Net-Libraesva-SNMP-Storage-Name   | Discover the disk partitions and monitor space occupation     |
...
| Metric name                  | Unit  |
|:-----------------------------|:------|
| system.mails.sent.count      | count |
| system.mails.received.count  | count |
| system.mails.rejected.count  | count |
| system.mails.bounced.count   | count |
| system.messages.spam.count   | count |
| system.messages.virus.count  | count |
| system.mails.queue.in.count  | count |
| system.mails.queue.out.count | count |
| cluster-status               | N/A   |
...
```bash
dnf install centreon-pack-network-libraesva-snmp
```
...
```bash
apt install centreon-pack-network-libraesva-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **Libraesva SNMP** connector through
...
```bash
dnf install centreon-plugin-Network-Libraesva-Snmp
```
...
```bash
apt install centreon-plugin-network-libraesva-snmp
```
...
3. Apply the **Net-Libraesva-SNMP-custom** template to the host.
...
| Macro                 | Description                                                                                                                                                       | Default value     | Mandatory   |
|:----------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| WARNINGCLUSTERSTATUS  | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %{cluster\_status}                                |                   |             |
| CRITICALCLUSTERSTATUS | Define the conditions to match for the status to be CRITICAL (default: '%{cluster\_status} =~ /error/i'). You can use the following variables: %{cluster\_status} |                   |             |
| WARNINGMAILSBOUNCED   | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMAILSBOUNCED  | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMAILSQUEUEIN   | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMAILSQUEUEIN  | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMAILSQUEUEOUT  | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMAILSQUEUEOUT | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMAILSRECEIVED  | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMAILSRECEIVED | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMAILSREJECTED  | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMAILSREJECTED | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMAILSSENT      | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMAILSSENT     | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMESSAGESSPAM   | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMESSAGESSPAM  | Thresholds                                                                                                                                                        |                   |             |
| WARNINGMESSAGESVIRUS  | Thresholds                                                                                                                                                        |                   |             |
| CRITICALMESSAGESVIRUS | Thresholds                                                                                                                                                        |                   |             |
| EXTRAOPTIONS          | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                                                                |                   |             |
...
```bash
OK: Partitions count: 65 All storages are ok | 'storage.partitions.count'=65;;;0;'*disk_name*#storage.space.usage.bytes'=12B;;;;'*disk_name*#storage.access.count'=5;;;1;2
```
...
|:-----------------------------------------------------------------------------------------------------------------------------|:-------------------------------------|
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/libraesva/snmp/mode/interfaces.pm)] | Net-Libraesva-Interfaces-SNMP-custom |
...
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/libraesva/snmp/mode/load.pm)]             | Net-Libraesva-Load-SNMP-custom       |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/libraesva/snmp/mode/memory.pm)]         | Net-Libraesva-Memory-SNMP-custom     |
| storage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/libraesva/snmp/mode/storage.pm)]       | Net-Libraesva-Storage-SNMP-custom    |
| swap [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/libraesva/snmp/mode/swap.pm)]             | Net-Libraesva-Swap-SNMP-custom       |
| system [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/libraesva/snmp/mode/system.pm)]         | Net-Libraesva-System-SNMP-custom     |
...
| --statefile-key           | Define the key to encrypt/decrypt the cache.                                                                                                                                                                                                  |
| --statefile-cipher        | Define the cipher algorithm to encrypt the cache (default: 'AES').                                                                                                                                                                            |
| --filter-counters         | Only display some counters (regexp can be used). Example: --filter-counters='^mail-sent$'                                                                                                                                                     |
| --unknown-cluster-status  | Define the conditions to match for the status to be UNKNOWN (default: ''). You can use the following variables: %{cluster\_status}                                                                                                            |
| --warning-cluster-status  | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %{cluster\_status}                                                                                                            |
| --critical-cluster-status | Define the conditions to match for the status to be CRITICAL (default: '%{cluster\_status} =~ /error/i'). You can use the following variables: %{cluster\_status}                                                                             |
| --warning-* --critical-*  | Thresholds. Can be: 'mails-sent', 'mails-received', 'mails-rejected', 'mails-bounced', 'mails-queue-in', 'mails-queue-out', 'messages-spam', 'messages-virus',                                                                                |
