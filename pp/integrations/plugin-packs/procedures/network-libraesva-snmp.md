...
| Macro                 | Description                                                                                                                                                       | Default value     | Mandatory   |
|:----------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| WARNINGCLUSTERSTATUS  | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{cluster_status\}                                |                   |             |
| CRITICALCLUSTERSTATUS | Define the conditions to match for the status to be CRITICAL (default: '%\{cluster_status\} =~ /error/i'). You can use the following variables: %\{cluster_status\} |                   |             |
...
| --unknown-cluster-status  | Define the conditions to match for the status to be UNKNOWN (default: ''). You can use the following variables: %\{cluster_status\}                                                                                                            |
| --warning-cluster-status  | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{cluster_status\}                                                                                                            |
| --critical-cluster-status | Define the conditions to match for the status to be CRITICAL (default: '%\{cluster_status\} =~ /error/i'). You can use the following variables: %\{cluster_status\}                                                                             |
