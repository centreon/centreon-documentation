...
The following monitoring connectors will be installed when you install the **Dell CMC** connector through the
...
The Monitoring Connector **Dell CMC** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="HW-Server-Dell-CMC-SNMP-custom" label="HW-Server-Dell-CMC-SNMP-custom">
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Server-Dell-CMC-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Dell CMC** connector through
...
3. Apply the **HW-Server-Dell-CMC-SNMP-custom** template to the host.
