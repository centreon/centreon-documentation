...
2. On the Centreon Web interface, install the *Azure CDN* Centreon Monitoring Connector on the **Configuration > Connectors > Monitoring Connectors** page
...
3. On the Centreon Web interface, install the *Azure CDN* Centreon Monitoring Connector on the **Configuration > Connectors > Monitoring Connectors** page
