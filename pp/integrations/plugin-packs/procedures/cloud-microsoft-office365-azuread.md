...
2. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Office 365 Azure AD** Centreon Monitoring Connector.
...
3. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Office 365 Azure AD** Centreon Monitoring Connector.
