...
|:----------------------------------------|:-----|
| status                                  | N/A  |
| *sp*#storagepool.space.usage.bytes      | B    |
| *sp*#storagepool.space.free.bytes       | B    |
| *sp*#storagepool.space.usage.percentage | %    |
...
|:-------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| COMMSERVEAPIUSERNAME     | Set API username                                                                                                                         |               |           |
...
| WARNINGLONG       | Set warning threshold for long jobs. You can use the following variables: %\{display\}, %\{status\}, %\{elapsed\}, %\{type\}, %\{client\_name\}            |                                  |           |
| CRITICALLONG      | Set critical threshold for long jobs. You can use the following variables: %\{display\}, %\{status\}, %\{elapsed\}, %\{type\}, %\{client\_name\}           |                                  |           |
| WARNINGSTATUS     | Define the conditions to match for the status to be WARNING You can use the following variables: %\{display\}, %\{status\}, %\{type\}, %\{client\_name\}   | %\{status\} =~ /abnormal/i       |           |
| CRITICALSTATUS    | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{display\}, %\{status\}, %\{type\}, %\{client\_name\} | %\{status\} =~ /errors\|failed/i |           |
| EXTRAOPTIONS      | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                     | --verbose                        |           |
...
| WARNINGMEDIAAGENTSOFFLINE  | Thresholds                                                                                                                                                            |                                                           |           |
| CRITICALMEDIAAGENTSOFFLINE | Thresholds                                                                                                                                                            |                                                           |           |
| WARNINGMEDIAAGENTSONLINE   | Thresholds                                                                                                                                                            |                                                           |           |
| CRITICALMEDIAAGENTSONLINE  | Thresholds                                                                                                                                                            |                                                           |           |
| WARNINGMEDIAAGENTSTOTAL    | Thresholds                                                                                                                                                            |                                                           |           |
| CRITICALMEDIAAGENTSTOTAL   | Thresholds                                                                                                                                                            |                                                           |           |
...
| --instance                                 | Set instance name to differentiate cache files when --api-token and 'token' authentication are used (default: 'default').                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| --timeframe           | Set timeframe in seconds (E.g '3600' to check last 60 minutes).                                                                                                                                          |
| --warning-status      | Define the conditions to match for the status to be WARNING (default: '%\{status\} =~ /abnormal/i') You can use the following variables: %\{display\}, %\{status\}, %\{type\}, %\{client\_name\}         |
| --critical-status     | Define the conditions to match for the status to be CRITICAL (default: '%\{status\} =~ /errors\|failed/i'). You can use the following variables: %\{display\}, %\{status\}, %\{type\}, %\{client\_name\} |
| --warning-long        | Set warning threshold for long jobs. You can use the following variables: %\{display\}, %\{status\}, %\{elapsed\}, %\{type\}, %\{client\_name\}                                                          |
| --critical-long       | Set critical threshold for long jobs. You can use the following variables: %\{display\}, %\{status\}, %\{elapsed\}, %\{type\}, %\{client\_name\}                                                         |
| --warning-jobs-total  | Thresholds.                                                                                                                                                                                              |
| --critical-jobs-total | Thresholds.                                                                                                                                                                                              |
...
| --warning-media-agents-total    | Thresholds.                                                                                                                                                                                                                                  |
| --critical-media-agents-total   | Thresholds.                                                                                                                                                                                                                                  |
| --warning-media-agents-online   | Thresholds.                                                                                                                                                                                                                                  |
| --critical-media-agents-online  | Thresholds.                                                                                                                                                                                                                                  |
| --warning-media-agents-offline  | Thresholds.                                                                                                                                                                                                                                  |
| --critical-media-agents-offline | Thresholds.                                                                                                                                                                                                                                  |
