...
The following monitoring connectors will be installed when you install the **Cisco ISE** connector through the
...
The Monitoring Connector **Cisco ISE** brings a host template:
...
|:--------------|:-------------------------------------|:------------------------------------------------------------------------------|
| Session       | App-Cisco-Ise-Session-Restapi-custom | Check active sessions, postured endpoints and profiler service sessions count |

> The services listed above are created automatically when the **App-Cisco-Ise-Restapi-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Cisco ISE** connector through
...
3. Apply the **App-Cisco-Ise-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
