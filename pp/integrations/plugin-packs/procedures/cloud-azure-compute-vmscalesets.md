...
The following monitoring connectors will be installed when you install the **Azure Virtual Machine Scale Sets** connector through the
...
The Monitoring Connector **Azure Virtual Machine Scale Sets** brings a host template:
...
|:--------------|:-----------------------------------------------------|:-----------------------------------------------------|
| Cpu-Usage     | Cloud-Azure-Compute-Vmscalesets-Cpu-Usage-Api-custom | Check CPU of Virtual Machine Scale Sets              |
| Diskio        | Cloud-Azure-Compute-Vmscalesets-Diskio-Api-custom    | Check disks I/O utilization                          |
| Health        | Cloud-Azure-Compute-Vmscalesets-Health-Api-custom    | Check Virtual Machine Scale Sets state               |
| Memory        | Cloud-Azure-Compute-Vmscalesets-Memory-Api-custom    | Check memory available on Virtual Machine Scale Sets |
| Traffic       | Cloud-Azure-Compute-Vmscalesets-Traffic-Api-custom   | Check Virtual Machine Scale Sets network usage       |

> The services listed above are created automatically when the **Cloud-Azure-Compute-Vmscalesets-custom** host template is used.
...
to the list of monitored hosts. This provider is named **Microsoft Azure Virtual Machine Scale Sets**.
...
2. Whatever the license type (*online* or *offline*), install the **Azure Virtual Machine Scale Sets** connector through
...
3. Apply the **Cloud-Azure-Compute-Vmscalesets-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
