...
2. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Nutanix** Centreon Monitoring Connector.
...
3. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Nutanix** Centreon Monitoring Connector.
