...
slug: /network-fortinet-fortiweb-snmp
...
The Monitoring Connector **Fortinet FortiWeb SNMP** brings a host template:
...
|:--------------|:-----------------------------------------|:--------------------|
| Proxy         | Net-Fortinet-Fortiweb-Proxy-SNMP-custom  | Check proxy usage   |
| System        | Net-Fortinet-Fortiweb-System-SNMP-custom | Check system usage  |

> The services listed above are created automatically when the **Net-Fortinet-Fortiweb-SNMP-custom** host template is used.
...
|:--------------|:---------------------------------------------|:--------------------|:----------:|
| Interfaces    | Net-Fortinet-Fortiweb-Interfaces-SNMP-custom | Check interfaces    | X          |
...
2. Whatever the license type (*online* or *offline*), install the **Fortinet FortiWeb SNMP** connector through
...
3. Apply the **Net-Fortinet-Fortiweb-SNMP-custom** template to the host. 
