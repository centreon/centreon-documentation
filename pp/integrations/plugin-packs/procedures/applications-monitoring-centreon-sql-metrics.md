...
| Storage-Partitioning | App-Monitoring-Centreon-SQL-Storage-Partitioning-custom | Check partitions for MySQL                                                     |
...
Custom metrics. It depends of the service configuration.
