...
The Monitoring Connector **HP MSA2000** brings a host template:

* **HW-Storage-Hp-Msa2000-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<TabItem value="HW-Storage-Hp-Msa2000-SNMP-custom" label="HW-Storage-Hp-Msa2000-SNMP-custom">

| Service Alias | Service Template                      | Service Description  |
|:--------------|:--------------------------------------|:---------------------|
| Hardware      | HW-Storage-Hp-Msa2000-Hardware-custom | Check hardware state |

> The services listed above are created automatically when the **HW-Storage-Hp-Msa2000-SNMP-custom** host template is used.
...
| Rule name                          | Description                                                   |
|:-----------------------------------|:--------------------------------------------------------------|
| HW-Storage-Hp-Msa2000-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
```bash
dnf install centreon-pack-hardware-storage-hp-msa2000-snmp
```
...
```bash
yum install centreon-pack-hardware-storage-hp-msa2000-snmp
```

</TabItem>
</Tabs>

2. Whatever the license type (*online* or *offline*), install the **HP MSA2000** connector through
...
```bash
dnf install centreon-plugin-Hardware-Storage-Hp-Msa2000-Snmp
```
...
3. Apply the **HW-Storage-Hp-Msa2000-SNMP-custom** template to the host. 
...
```bash
/usr/lib/centreon/plugins/centreon_hp_msa2000.pl \
...
|:-----------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------|
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/hardwarefibrealliance.pm)] | HW-Storage-Hp-Msa2000-Hardware-custom                                                                                                                   |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | HW-Storage-Hp-Msa2000-Traffic-Generic-Id-custom<br />HW-Storage-Hp-Msa2000-Traffic-Generic-Name-custom<br />HW-Storage-Hp-Msa2000-Traffic-Global-custom |
