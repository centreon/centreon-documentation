...
The following monitoring connectors will be installed when you install the **Protocol SSH** connector through the
...
The Monitoring Connector **Protocol SSH** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="App-Protocol-Ssh-custom" label="App-Protocol-Ssh-custom">

| Service Alias | Service Template              | Service Description                     |
|:--------------|:------------------------------|:----------------------------------------|
| Ssh-Login     | App-Protocol-Ssh-Login-custom | Check connection on a remote SSH server |

> The services listed above are created automatically when the **App-Protocol-Ssh-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Protocol SSH** connector through
...
3. Apply the **App-Protocol-Ssh-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| PROTOCOLSSHEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
