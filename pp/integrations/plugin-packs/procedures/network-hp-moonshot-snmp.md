...
The Monitoring Connector **HP Moonshot SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="Net-Hp-Moonshot-SNMP-custom" label="Net-Hp-Moonshot-SNMP-custom">
...
|:--------------|:---------------------------------------|:--------------------|:----------:|
| Interfaces    | Net-Hp-Moonshot-Interfaces-SNMP-custom | Check interfaces    | X          |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Hp-Moonshot-SNMP-custom** host template |
...
| Rule name                           | Description                                                   |
|:------------------------------------|:--------------------------------------------------------------|
| Net-Hp-Moonshot-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
...
```bash
dnf install centreon-pack-network-hp-moonshot-snmp
```
...
```bash
apt install centreon-pack-network-hp-moonshot-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **HP Moonshot SNMP** connector through
...
```bash
dnf install centreon-plugin-Network-Hp-Moonshot-Snmp
```
...
```bash
apt install centreon-plugin-network-hp-moonshot-snmp
```
...
3. Apply the **Net-Hp-Moonshot-SNMP-custom** template to the host.
...
|:-------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/hp/moonshot/snmp/mode/cpu.pm)]               | Net-Hp-Moonshot-Cpu-SNMP-custom        |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/hp/moonshot/snmp/mode/interfaces.pm)] | Net-Hp-Moonshot-Interfaces-SNMP-custom |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)]   | Used for service discovery             |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/hp/moonshot/snmp/mode/memory.pm)]         | Net-Hp-Moonshot-Memory-SNMP-custom     |
...
| Option                   | Description                                                                               |
|:-------------------------|:------------------------------------------------------------------------------------------|
| --warning-* --critical-* | Thresholds. Can be: 'cpu-utilization-5s', 'cpu-utilization-1m', 'cpu-utilization-15m'.    |
