...
The following monitoring connectors will be installed when you install the **Netgear Readynas SNMP** connector through the
...
The Monitoring Connector **Netgear Readynas SNMP** brings a host template:
...
|:----------------|:--------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------|
| Cpu             | HW-Storage-Netgear-Readynas-Cpu-SNMP-custom             | Check the rate of utilization of CPU for the machine. This check can give the average CPU utilization rate and the rate per CPU for multi-core CPU |
| Hardware-Global | HW-Storage-Netgear-Readynas-Hardware-Global-SNMP-custom | Check hardware                                                                                                                                     |
| Load            | HW-Storage-Netgear-Readynas-Load-SNMP-custom            | Check the server load average                                                                                                                      |
| Memory          | HW-Storage-Netgear-Readynas-Memory-SNMP-custom          | Check the rate of the utilization of memory (RAM)                                                                                                  |
| Storage         | HW-Storage-Netgear-Readynas-Storage-SNMP-custom         | Check storage usage                                                                                                                                |

> The services listed above are created automatically when the **HW-Storage-Netgear-Readynas-SNMP-custom** host template is used.
...
| Service Alias | Service Template                                   | Service Description |
|:--------------|:---------------------------------------------------|:--------------------|
| Interfaces    | HW-Storage-Netgear-Readynas-Interfaces-SNMP-custom | Check interfaces    |
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Storage-Netgear-Readynas-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Netgear Readynas SNMP** connector through
...
3. Apply the **HW-Storage-Netgear-Readynas-SNMP-custom** template to the host. 
