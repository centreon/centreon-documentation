...
2. On the Centreon Web interface, install the *ActiveMQ JMX* Centreon Monitoring Connector from the **Configuration > Connectors > Monitoring Connectors** page
...
3. On the Centreon Web interface, install the *ActiveMQ JMX* Centreon Monitoring Connector from the **Configuration > Connectors > Monitoring Connectors** page
