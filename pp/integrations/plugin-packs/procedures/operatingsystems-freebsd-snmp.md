...
| Disk-Generic-Name    | OS-FreeBSD-Disk-Generic-Name-SNMP-custom    | Check the rate of free space on the disk. For each check the disk mount point will appear |           |
| Disk-Global          | OS-FreeBSD-Disk-Global-SNMP-custom          | Check the rate of free space on the disk. For each check the disk mount point will appear | X         |
