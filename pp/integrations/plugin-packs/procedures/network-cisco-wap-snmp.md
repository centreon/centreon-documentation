...
The following monitoring connectors will be installed when you install the **Cisco Wap SNMP** connector through the
...
The Monitoring Connector **Cisco Wap SNMP** brings a host template:

* **Net-Cisco-Wap-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<TabItem value="Net-Cisco-Wap-SNMP-custom" label="Net-Cisco-Wap-SNMP-custom">

| Service Alias         | Service Template                               | Service Description                                     |
|:----------------------|:-----------------------------------------------|:--------------------------------------------------------|
| Clients               | Net-Cisco-Wap-Clients-SNMP-custom              | Check total clients connected                           |
| Cpu                   | Net-Cisco-Wap-Cpu-SNMP-custom                  | Check CPU usage                                         |
| Memory                | Net-Cisco-Wap-Memory-SNMP-custom               | Check the rate of the utilization of memory (RAM)       |
| Uptime                | Net-Cisco-Wap-Uptime-SNMP-custom               | Time since the equipment has been working and available |
| Virtual Access Points | Net-Cisco-Wap-Virtual-Access-Point-SNMP-custom | Check virtual access points                             |

> The services listed above are created automatically when the **Net-Cisco-Wap-SNMP-custom** host template is used.
...
|:--------------|:-------------------------------------|:--------------------|:---------:|
| Interfaces    | Net-Cisco-Wap-Interfaces-SNMP-custom | Check interfaces    | X         |
...
|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Cisco-Wap-SNMP-custom** host template. |
...
| Rule name                         | Description                                                   |
|:----------------------------------|:--------------------------------------------------------------|
| Net-Cisco-Wap-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
...
```bash
dnf install centreon-pack-network-cisco-wap-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **Cisco Wap SNMP** connector through
...
```bash
dnf install centreon-plugin-Network-Cisco-Wap-Snmp
```
...
3. Apply the **Net-Cisco-Wap-SNMP-custom** template to the host.
...
| Macro                         | Description                                                                                                                                      | Default value | Mandatory |
|:------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| FILTERRADIONAME               | Filter radio interfaces by name (can be a regexp)                                                                                                |               |           |
| WARNINGCLIENTSCONNECTED       | Threshold                                                                                                                                        |               |           |
| CRITICALCLIENTSCONNECTED      | Threshold                                                                                                                                        |               |           |
| WARNINGRADIOCLIENTSCONNECTED  | Threshold                                                                                                                                        |               |           |
| CRITICALRADIOCLIENTSCONNECTED | Threshold                                                                                                                                        |               |           |
...
| Macro               | Description                                                                                                                                                       | Default value                                                     | Mandatory |
|:--------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------|:---------:|
| FILTERAPDESCRIPTION | Filter virtual access points by description (can be a regexp)                                                                                                     | .*                                                                |           |
| UNKNOWNSTATUS       | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: %\{description\}, %\{admin\_status\}, %\{operational\_status\}  |                                                                   |           |
| CRITICALSTATUS      | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{description\}, %\{admin\_status\}, %\{operational\_status\} | %\{admin\_status\} eq "up" and %\{operational\_status\} eq "down" |           |
| WARNINGSTATUS       | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{description\}, %\{admin\_status\}, %\{operational\_status\}  |                                                                   |           |
...
/usr/lib/centreon/plugins/centreon_cisco_wap_snmp.pl \
	...
	--unknown-status='' \
	--warning-status='' \
	--critical-status='%\{admin\_status\} eq "up" and %\{operational\_status\} eq "down"' \
	--warning-total='' \
	--critical-total='' \
	--verbose
```
...
```bash
OK: total: 84198 All virtual access points are ok | 'virtual_access_points.total.count'=84198;;;0; 
```
...
|:-------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------|
| clients [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/cisco/wap/snmp/mode/clients.pm)]                           | Net-Cisco-Wap-Clients-SNMP-custom              |
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/cisco/wap/snmp/mode/cpu.pm)]                                   | Net-Cisco-Wap-Cpu-SNMP-custom                  |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                              | Net-Cisco-Wap-Interfaces-SNMP-custom           |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)]                     | Used for service discovery                     |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/cisco/wap/snmp/mode/memory.pm)]                             | Net-Cisco-Wap-Memory-SNMP-custom               |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/uptime.pm)]                                      | Net-Cisco-Wap-Uptime-SNMP-custom               |
| virtual-access-points [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/cisco/wap/snmp/mode/virtualaccesspoints.pm)] | Net-Cisco-Wap-Virtual-Access-Point-SNMP-custom |
...
| --filter-radio-name      | Filter radio interfaces by name (can be a regexp).                                     |
| --warning-* --critical-* | Thresholds. Can be: 'clients-connected', 'radio-clients-connected'.                    |
...
| --filter-description     | Filter virtual access points by description (can be a regexp).                                                                                                                                                                                   |
| --unknown-status         | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: %\{description\}, %\{admin\_status\}, %\{operational\_status\}                                                                                 |
| --warning-status         | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{description\}, %\{admin\_status\}, %\{operational\_status\}                                                                                 |
| --critical-status        | Define the conditions to match for the status to be CRITICAL (default: '%\{admin\_status\} eq "up" and %\{operational\_status\} eq "down"'). You can use the following variables: %\{description\}, %\{admin\_status\}, %\{operational\_status\} |
