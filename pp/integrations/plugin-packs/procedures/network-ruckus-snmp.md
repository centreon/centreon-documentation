...
The following monitoring connectors will be installed when you install the **Ruckus SNMP** connector through the
...
<Tabs groupId="sync">
<TabItem value="Net-Ruckus-Ap-SNMP-custom" label="Net-Ruckus-Ap-SNMP-custom">
...
|:---------------|:-----------------------------------------|:---------------------------------------------|:---------:|
| Traffic-Global | Net-Ruckus-Ap-Traffic-Global-SNMP-custom | Check traffic of multiple network interfaces | X         |
...
|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Ruckus-Ap-SNMP-custom** host template. |
...
| Rule name                       | Description                                                   |
|:--------------------------------|:--------------------------------------------------------------|
| Net-Ruckus-Ap-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
```bash
dnf install centreon-pack-network-ruckus-snmp
```
...
```bash
yum install centreon-pack-network-ruckus-snmp
```
...
```bash
dnf install centreon-plugin-Network-Ruckus-Snmp
```
...
```bash
yum install centreon-plugin-Network-Ruckus-Snmp
```
...
3. Apply the **Net-Ruckus-Ap-SNMP-custom** template to the host.
...
```bash
/usr/lib/centreon/plugins/centreon_ruckus_snmp.pl \
...
|:-----------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/ruckus/ap/snmp/mode/cpu.pm)]               | Net-Ruckus-Ap-Cpu-SNMP-custom            |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | Net-Ruckus-Ap-Traffic-Global-SNMP-custom |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)] | Used for service discovery               |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/ruckus/ap/snmp/mode/memory.pm)]         | Net-Ruckus-Ap-Memory-SNMP-custom         |
| users [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/ruckus/ap/snmp/mode/users.pm)]           | Net-Ruckus-Ap-Users-SNMP-custom          |
