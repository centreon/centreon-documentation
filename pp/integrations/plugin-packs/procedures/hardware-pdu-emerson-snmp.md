...
The following monitoring connectors will be installed when you install the **Emerson PDU SNMP** connector through the
...
The Monitoring Connector **Emerson PDU SNMP** brings a host template:
...
|:-------------------|:----------------------------------------------|:-------------------------|
| Global-Status      | HW-Pdu-Emerson-Global-Status-SNMP-custom      | Check global status      |
| Power-Source-Usage | HW-Pdu-Emerson-Power-Source-Usage-SNMP-custom | Check power source usage |
| Receptacles        | HW-Pdu-Emerson-Receptacles-SNMP-custom        | Check receptacles        |

> The services listed above are created automatically when the **HW-Pdu-Emerson-SNMP-custom** host template is used.
...
The SNMP service must be configured and activated on the host. Please refer to the [official documentation](https://www.emerson.com/en-us/support/manuals-and-guides). 
...
2. Whatever the license type (*online* or *offline*), install the **Emerson PDU SNMP** connector through
...
3. Apply the **HW-Pdu-Emerson-SNMP-custom** template to the host. 
