...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Mulesoft Anypoint* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Mulesoft Anypoint* Monitoring Connector
