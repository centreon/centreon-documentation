...
The following monitoring connectors will be installed when you install the **H3C Network SNMP** connector through the
...
The Monitoring Connector **H3C Network SNMP** brings a host template:
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-H3C-SNMP-custom** host template. |
...
| Rule name                 | Description                                                   |
|:--------------------------|:--------------------------------------------------------------|
| Net-H3C-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
2. Whatever the license type (*online* or *offline*), install the **H3C Network SNMP** connector through
...
3. Apply the **Net-H3C-SNMP-custom** template to the host. 
