...
|:----------------|:-------------------------------------------------|
| cluster-status  | Net-PaloAlto-Standard-Cluster-Status-SNMP-custom |
| cpu             | Net-PaloAlto-Standard-Cpu-SNMP-custom            |
| gp-usage        | Net-PaloAlto-Standard-Global-Protect-SNMP-custom |
| hardware        | Net-PaloAlto-Standard-Hardware-SNMP-custom       |
| interfaces      | Net-PaloAlto-Standard-Interfaces-SNMP-custom     |
| list-interfaces | Used for service discovery                       |
| memory          | Net-PaloAlto-Standard-Memory-SNMP-custom         |
| panorama        | Net-PaloAlto-Standard-Panorama-SNMP-custom       |
| sessions        | Net-PaloAlto-Standard-Sessions-SNMP-custom       |
| signatures      | Net-PaloAlto-Standard-Signatures-SNMP-custom     |
