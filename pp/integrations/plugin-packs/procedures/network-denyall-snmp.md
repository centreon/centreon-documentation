...
2. On the Centreon Web interface in **Configuration > Monitoring Connector Manager**, install the *DenyAll SNMP* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Monitoring Connector Manager**, install the *DenyAll SNMP* Monitoring Connector
