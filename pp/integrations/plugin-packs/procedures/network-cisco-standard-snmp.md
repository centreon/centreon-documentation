...
| --warning-stack-status   | Set warning threshold for stack status (default: ''). You can use the following variables: %\{stack_status\}                                                                                                                                                                                                                                                                                            |
| --critical-stack-status  | Set critical threshold for stack status (default: '%\{stack_status\} =~ /notredundant/'). You can use the following variables: %\{stack_status\}                                                                                                                                                                                                                                                         |
