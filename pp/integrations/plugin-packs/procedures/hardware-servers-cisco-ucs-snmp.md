...
slug: /hardware-servers-cisco-ucs-snmp
...
The following monitoring connectors will be installed when you install the **Cisco UCS SNMP** connector through the
...
The Monitoring Connector **Cisco UCS SNMP** brings a host template:
