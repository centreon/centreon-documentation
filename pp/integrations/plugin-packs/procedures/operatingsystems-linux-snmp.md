...
The following monitoring connectors will be installed when you install the **Linux SNMP** connector through the
...
| Memory        | OS-Linux-Memory-SNMP-custom | Monitor the memory (RAM) usage                                                                                                                     |
| Swap          | OS-Linux-Swap-SNMP-custom   | Check virtual memory usage (SWAP)                                                                                                                  |
...
| Disk-Generic-Id            | OS-Linux-Disk-Generic-Id-SNMP-custom            | Check the rate of free space on the disk. For each checks the name of the disk will appear (« label ») rather than the letter assigned. Thresholds can be in percentage or in free space remaining |           |
| Disk-Generic-Name          | OS-Linux-Disk-Generic-Name-SNMP-custom          | Check the rate of free space on the disk. For each checks the mount pont of the disk will appear (« label »). Thresholds can be in percentage or in free space remaining                           |           |
| Disk-Global                | OS-Linux-Disk-Global-SNMP-custom                | Check the rate of free space on disks. For each checks the mount point of disks will appear (« label »). Thresholds can be in percentage or in free space remaining                                | X         |
| Disk-IO                    | OS-Linux-Disk-IO-SNMP-custom                    | Check access disk of the disk. For each check the name of the disk will appear "label" rather than the letter assigned                                                                             | X         |
...
| Packet-Errors-Generic-Id   | Os-Linux-Packet-Errors-Generic-Id-SNMP-custom   | Check packets in error and discarded packets for multiple network interfaces                                                                                                                       |           |
| Packet-Errors-Generic-Name | Os-Linux-Packet-Errors-Generic-Name-SNMP-custom | Check packets in error and discarded packets for a network interface                                                                                                                               |           |
| Packet-Errors-Global       | Os-Linux-Packet-Errors-Global-SNMP-custom       | Check packets in error and discarded packets for multiple network interfaces                                                                                                                       | X         |
| Process-Generic            | OS-Linux-Process-Generic-SNMP-custom            | Check Linux process/service is working                                                                                                                                                             | X         |
| Tcpcon-Generic             | OS-Linux-Tcpcon-Generic-SNMP-custom             | Check current TCP connections                                                                                                                                                                      |           |
| Traffic-Generic-Id         | OS-Linux-Traffic-Generic-Id-SNMP-custom         | Check the bandwidth of the interface. For each checks the name of the interface will appear (« label » shortcut describing the interface)                                                          |           |
| Traffic-Generic-Name       | OS-Linux-Traffic-Generic-Name-SNMP-custom       | Check the bandwidth of the interface. For each checks the name of the interface will appear (« label » shortcut describing the interface)                                                          |           |
| Traffic-Global             | OS-Linux-Traffic-Global-SNMP-custom             | Check the bandwidth of interfaces. For each checks the name of the interface will appear (« label » shortcut describing the interface)                                                             | X         |
...
| Rule name                        | Description                                                           |
|:---------------------------------|:----------------------------------------------------------------------|
| OS-Linux-SNMP-Disk-IO            | Discover the disk partitions and monitor inodes usage                 |
| OS-Linux-SNMP-Disk-Name          | Discover the disk partitions and monitor space occupation             |
| OS-Linux-SNMP-Disk-Path          | Discover network interfaces and monitor errored and discarded packets |
