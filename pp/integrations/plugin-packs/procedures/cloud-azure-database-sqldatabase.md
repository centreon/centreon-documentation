...
The Centreon Monitoring Connector **Azure SQL Database** brings a host template:
...
1. Install the package on every Centreon poller expected to monitor **Azure SQL Database** resources:

```bash
yum install centreon-plugin-Cloud-Azure-Database-SqlDatabase-Api
```

2. On the Centreon web interface, on page **Configuration > Monitoring Connectors Manager**, install the **Azure SQL Database** Centreon Monitoring Connector.
...
2. Install the **Azure SQL Database** Centreon Monitoring Connector RPM on the Centreon central server:

```bash
yum install centreon-pack-cloud-azure-database-sqldatabase
```

3. On the Centreon web interface, on page **Configuration > Monitoring Connectors Manager**, install the **Azure SQL Database** Centreon Monitoring Connector.
