...
| Macro                         | Description                                                                                                                            | Default value | Mandatory |
|:------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| WARNINGPAGEFAULTSDATABASE     | Threshold                                                                                                                              |               |           |
| CRITICALPAGEFAULTSDATABASE    | Threshold                                                                                                                              |               |           |
| WARNINGPAGEFAULTSNONDATABASE  | Threshold                                                                                                                              |               |           |
| CRITICALPAGEFAULTSNONDATABASE | Threshold                                                                                                                              |               |           |
| EXTRAOPTIONS                  | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options). |               |           |
...
| WARNINGPROCESSUNITUSAGE  | Threshold                                                                                                                              |               |           |
| CRITICALPROCESSUNITUSAGE | Threshold                                                                                                                              |               |           |
| WARNINGSTORAGEPOOLSPACE  | Threshold                                                                                                                              |               |           |
| CRITICALSTORAGEPOOLSPACE | Threshold                                                                                                                              |               |           |
| EXTRAOPTIONS             | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options). | --verbose     |           |
...
```bash
OK: processing units used: 22828 % storage pool space used: 45150 % total: 6632 active: 30604 running: 20748 waiting for message: 20305 | 'system~system.processing.units.usage.percentage'=22828%;;;0; 'system~system.storage.pool.space.usage.percentage'=45150%;;;0;100 'system~system.jobs.total.count'=6632;;;0; 'system~system.jobs.active.count'=30604;;;0; 'system~system.batch_jobs.running.count'=20748;;;0; 'system~system.batch_jobs.waiting_message.count'=20305;;;0; 
```
