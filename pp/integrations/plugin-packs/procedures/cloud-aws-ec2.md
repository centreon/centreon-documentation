...
<Tabs groupId="sync">
<TabItem value="Cloud-Aws-Ec2-Asg-&-Cloud-Aws-Ec2-Instance" label="Cloud-Aws-Ec2-Asg-&-Cloud-Aws-Ec2-Instance">
...
<TabItem value="Cloud-Aws-Ec2-Spot-Fleet-Request" label="Cloud-Aws-Ec2-Spot-Fleet-Request">
