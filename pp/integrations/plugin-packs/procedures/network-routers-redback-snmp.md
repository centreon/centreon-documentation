...
|:---------------------------|:---------------------------------------------------|:-----------------------------------------------------------------------------|:---------:|
| Packet-Errors-Generic-Id   | Net-Redback-Packet-Errors-Generic-Id-SNMP-custom   | Check packets in error and discarded packets for multiple network interfaces |           |
| Packet-Errors-Generic-Name | Net-Redback-Packet-Errors-Generic-Name-SNMP-custom | Check packets in error and discarded packets for a network interface         |           |
| Packet-Errors-Global       | Net-Redback-Packet-Errors-Global-SNMP-custom       | Check packets in error and discarded packets for multiple network interfaces | X         |
