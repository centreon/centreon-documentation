...
| Swap              | App-Trendmicro-Iwsva-Swap-SNMP-custom              | Check virtual memory usage                  |            |
...
In order to monitor your IWSVA TrendMicro equipment, it is necessary to [install and configure it properly](https://success.trendmicro.com/dcx/s/solution/1096980-best-practices-for-installation-and-deployment-of-interscan-web-security-virtual-appliance-iwsva?language=en_US&sfdcIFrameOrigin=null).
