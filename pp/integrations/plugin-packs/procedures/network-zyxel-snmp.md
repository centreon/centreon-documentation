...
The following monitoring connectors will be installed when you install the **Zyxel SNMP** connector through the
...
|:--------------|:-------------------------------|:-----------------------------------------------------|
| Cpu           | Net-Zyxel-Cpu-SNMP-custom      | Check the rate of utilization of CPU for the machine |
| Memory        | Net-Zyxel-Memory-SNMP-custom   | Check the rate of the utilization of memories        |
| Sessions      | Net-Zyxel-Sessions-SNMP-custom | Check sessions                                       |

> The services listed above are created automatically when the **Net-Zyxel-SNMP-custom** host template is used.
...
|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Zyxel-SNMP-custom** host template. |
...
| Rule name                   | Description                                                   |
|:----------------------------|:--------------------------------------------------------------|
| Net-Zyxel-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
3. Apply the **Net-Zyxel-SNMP-custom** template to the host.
...
| list-vpn [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/zyxel/snmp/mode/listvpn.pm)]          | Not used in this Monitoring Connector                                                |
