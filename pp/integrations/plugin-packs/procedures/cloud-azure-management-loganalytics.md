...
2. On the Centreon Web interface, install the *Azure Log Analytics* Centreon Monitoring Connector on the **Configuration > Connectors > Monitoring Connectors** page
...
3. On the Centreon Web interface, install the *Azure Log Analytics* Centreon Monitoring Connector on the **Configuration > Connectors > Monitoring Connectors** page
