...
The following monitoring connectors will be installed when you install the **EMC Symmetrix CMA** connector through the
...
2. Whatever the license type (*online* or *offline*), install the **EMC Symmetrix CMA** connector through
...
3. Apply the **HW-Storage-EMC-Symmetrix-Dmx34-CMA-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **HW-Storage-EMC-Symmetrix-Vmax-CMA-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
4. Fill in the macros you want. Some macros are mandatory.
