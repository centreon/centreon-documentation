...
2. On the centreon Web interface, install the  *Netapp Santricity Restapi* Centreon Monitoring Connector on the **Configuration > Connectors > Monitoring Connectors** page
...
3. On the centreon Web interface, install the  *Netapp Santricity Restapi* Centreon Monitoring Connector on the **Configuration > Connectors > Monitoring Connectors** page
