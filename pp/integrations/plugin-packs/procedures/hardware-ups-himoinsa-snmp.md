...
The Monitoring Connector **Himoinsa UPS** brings a host template:
...
> The services listed above are created automatically when the **HW-UPS-Himoinsa-SNMP-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Himoinsa UPS** connector through
...
3. Apply the **HW-UPS-Himoinsa-SNMP-custom** template to the host.
