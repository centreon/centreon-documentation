...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Hikvision camera SNMP* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Hikvision camera SNMP* Monitoring Connector
