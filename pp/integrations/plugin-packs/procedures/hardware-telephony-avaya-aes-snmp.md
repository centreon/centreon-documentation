...
description: Monitor Avaya AES servers via SNMP: CPU, memory, load, storage, interfaces, and service status.
---
...
<Tabs groupId="sync">
<TabItem value="HW-Telephony-Avaya-Aes-SNMP-custom" label="HW-Telephony-Avaya-Aes-SNMP-custom">
