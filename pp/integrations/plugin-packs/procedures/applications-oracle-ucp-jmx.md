...
The following monitoring connectors will be installed when you install the **Oracle UCP JMX** connector through the
...
The Monitoring Connector **Oracle UCP JMX** brings a host template:
...
|:-----------------|:-------------------------------------------|:-----------------------|:----------:|
| Connection-Pools | App-Oracle-Ucp-Connection-Pools-JMX-custom | Check connection pools | X          |
...
2. Whatever the license type (*online* or *offline*), install the **Oracle UCP JMX** connector through
