...
The Monitoring Connector **Microsoft Dynamics365 NSClient NRPE** brings a host template:
...
|:--------------|:----------------------------------------|:----------------------------------|
| New-Orders    | App-Dynamics-365-New-Orders-NRPE-custom | Check new orders presence and age |

> The services listed above are created automatically when the **App-Dynamics-365-NRPE-custom** host template is used.
