...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Oracle ZS Rest API* Pack
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Oracle ZS Rest API* Pack
