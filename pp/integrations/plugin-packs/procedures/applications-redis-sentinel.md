...
|:------------------|:--------------------------------------------|:-------------------------------------|:----------:|
| Redis-Clusters    | App-Redis-Sentinel-Redis-Clusters-custom    | Check Redis cluster information      | X          |
| Sentinel-Clusters | App-Redis-Sentinel-Sentinel-Clusters-custom | Check Sentinel cluster information   | X          |
...
| CRITICALSTATUS                | Define the conditions to match for the status to be CRITICAL (default: '%\{status\} =~ /o\_down\|s\_down\|master\_down\|disconnected/i'). You can use the following variables: %\{status\}, %\{role\}, %\{address\}, %\{port\}, %\{cluster\_name\} | %\{status\} =~ /o\_down\|s\_down\|master\_down\|disconnected/i |             |
...
|:------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------|:-----------:|
| FILTERCLUSTERNAME             | Filter clusters by name (can be a regexp)                                                                                                                                                                                               |                                                                |             |
| CRITICALQUORUMSTATUS          | Set critical threshold for quorum status (default: '%\{status\} =~ /noQuorum/'). You can use the following variables: %\{status\}, %\{cluster\_name\}                                                                                   | %\{status\} =~ /noQuorum/                                      |             |
...
| CRITICALSTATUS                | Define the conditions to match for the status to be CRITICAL (default: '%\{status\} =~ /o\_down\|s\_down\|master\_down\|disconnected/i'). You can use the following variables: %\{status\}, %\{address\}, %\{port\}, %\{cluster\_name\} | %\{status\} =~ /o\_down\|s\_down\|master\_down\|disconnected/i |             |
