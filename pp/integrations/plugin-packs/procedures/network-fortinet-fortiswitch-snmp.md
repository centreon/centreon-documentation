...
slug: /network-fortinet-fortiswitch-snmp
...
The Monitoring Connector **Fortinet FortiSwitch SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="Net-Fortinet-Fortiswitch-SNMP-custom" label="Net-Fortinet-Fortiswitch-SNMP-custom">

| Service Alias | Service Template                            | Service Description                                  |
|:--------------|:--------------------------------------------|:-----------------------------------------------------|
| Cpu           | Net-Fortinet-Fortiswitch-Cpu-SNMP-custom    | Check the rate of utilization of CPU for the machine |
| Disk          | Net-Fortinet-Fortiswitch-Disk-SNMP-custom   | Check system disk usage                              |
| Memory        | Net-Fortinet-Fortiswitch-Memory-SNMP-custom | Check the rate of the utilization of memory          |
| Uptime        | Net-Fortinet-Fortiswitch-Uptime-SNMP-custom | Time since the server has been working and available |

> The services listed above are created automatically when the **Net-Fortinet-Fortiswitch-SNMP-custom** host template is used.
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Fortinet-Fortiswitch-SNMP-custom** host template |
...
| Rule name                                    | Description                                                   |
|:---------------------------------------------|:--------------------------------------------------------------|
| Net-Fortinet-Fortiswitch-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
...
```bash
dnf install centreon-pack-network-fortinet-fortiswitch-snmp
```
...
```bash
apt install centreon-pack-network-fortinet-fortiswitch-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **Fortinet FortiSwitch SNMP** connector through
...
```bash
dnf install centreon-plugin-Network-Fortinet-Fortiswitch-Snmp
```
...
```bash
apt install centreon-plugin-network-fortinet-fortiswitch-snmp
```
...
3. Apply the **Net-Fortinet-Fortiswitch-SNMP-custom** template to the host. 
...
```bash
/usr/lib/centreon/plugins/centreon_fortinet_fortiswitch_snmp.pl \
...
|:----------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------|
| arp [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/arp.pm)]                                   | Net-Fortinet-Fortiswitch-Arp-SNMP-custom        |
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiswitch/snmp/mode/cpu.pm)]               | Net-Fortinet-Fortiswitch-Cpu-SNMP-custom        |
| disk [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiswitch/snmp/mode/disk.pm)]             | Net-Fortinet-Fortiswitch-Disk-SNMP-custom       |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiswitch/snmp/mode/interfaces.pm)] | Net-Fortinet-Fortiswitch-Interfaces-SNMP-custom |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)]            | Used for service discovery                      |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiswitch/snmp/mode/memory.pm)]         | Net-Fortinet-Fortiswitch-Memory-SNMP-custom     |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiswitch/snmp/mode/uptime.pm)]         | Net-Fortinet-Fortiswitch-Uptime-SNMP-custom     |
