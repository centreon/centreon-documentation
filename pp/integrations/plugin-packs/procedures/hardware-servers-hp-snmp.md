...
The Monitoring Connector **HP Proliant** brings a host template:
...
|:----------------|:-----------------------------------------|:--------------------|
| Hardware-Global | HW-Hp-Server-Hardware-Global-SNMP-custom | Check all hardware  |
...
2. Whatever the license type (*online* or *offline*), install the **HP Proliant** connector through
