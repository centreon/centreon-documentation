...
2. On the Centreon Web interface, install the *EMC Symmetrix API* Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page
...
3. On the Centreon Web interface, install the *EMC Symmetrix API* Pack on the **Configuration > Connectors > Monitoring Connectors** page
