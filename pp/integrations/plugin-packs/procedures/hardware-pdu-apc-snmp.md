...
The Monitoring Connector **APC PDU** brings a host template:
...
| Load          | HW-Pdu-Apc-SNMP-Load-custom     | Check load          |
...
| *bank*#bank-status           | N/A   |
| *bank*#bank.current.ampere   | A     |
| *phase*#phase-status         | N/A   |
...
2. Whatever the license type (*online* or *offline*), install the **APC PDU** connector through
...
| time [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/apc/snmp/mode/ntp.pm)]          | Not used in this Monitoring Connector |
