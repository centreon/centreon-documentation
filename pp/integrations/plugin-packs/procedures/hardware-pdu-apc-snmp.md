...
The following monitoring connectors will be installed when you install the **APC PDU SNMP** connector through the
...
The Monitoring Connector **APC PDU SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="HW-Pdu-Apc-SNMP-custom" label="HW-Pdu-Apc-SNMP-custom">
...
| Service Alias | Service Template              | Service Description                                  |
|:--------------|:------------------------------|:-----------------------------------------------------|
| Ntp           | HW-Pdu-Apc-NTP-SNMP-custom    | Check the synchronization with an NTP server         |
| Uptime        | HW-Pdu-Apc-Uptime-SNMP-custom | Time since the server has been working and available |
...
|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Pdu-Apc-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **APC PDU SNMP** connector through
...
3. Apply the **HW-Pdu-Apc-SNMP-custom** template to the host.
...
```bash
OK: All outlets are ok | 'outlet1#outlet.current.ampere'=8A;;;0; 'outlet2#outlet.current.ampere'=9A;;;0; 
```
