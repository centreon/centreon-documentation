...
The following monitoring connectors will be installed when you install the **APC ATS SNMP** connector through the
...
<Tabs groupId="sync">
<TabItem value="HW-ATS-Apc-SNMP-custom" label="HW-ATS-Apc-SNMP-custom">

| Service Alias | Service Template                     | Service Description  |
|:--------------|:-------------------------------------|:---------------------|
| Device-Status | HW-ATS-Apc-Device-Status-SNMP-custom | Check device status  |
| Input-Lines   | HW-ATS-Apc-Input-Lines-SNMP-custom   | Check input metrics  |
| Output-Lines  | HW-ATS-Apc-Output-Lines-SNMP-custom  | Check output metrics |

> The services listed above are created automatically when the **HW-ATS-Apc-SNMP-custom** host template is used.
...
3. Apply the **HW-ATS-Apc-SNMP-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| time [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/ats/apc/snmp/mode/ntp.pm)]                   | Not used in this Monitoring Connector |
