...
|:-------------------------------------|:------------|
| App-DB-Mongodb-Collection-Statistics |             |
| App-DB-Mongodb-Database-Statistics   |             |
...
| WARNINGCOLLECTIONDOCUMENTS    |                                                                                                                                                  |               |           |
| CRITICALCOLLECTIONDOCUMENTS   |                                                                                                                                                  |               |           |
| WARNINGCOLLECTIONINDEXES      |                                                                                                                                                  |               |           |
| CRITICALCOLLECTIONINDEXES     |                                                                                                                                                  |               |           |
| WARNINGCOLLECTIONSIZEINDEX    |                                                                                                                                                  |               |           |
| CRITICALCOLLECTIONSIZEINDEX   |                                                                                                                                                  |               |           |
| WARNINGCOLLECTIONSIZESTORAGE  |                                                                                                                                                  |               |           |
...
| Macro                  | Description                                                                                                                                      | Default value | Mandatory |
|:-----------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| WARNINGCONNECTIONTIME  |                                                                                                                                                  |               |           |
| CRITICALCONNECTIONTIME |                                                                                                                                                  |               |           |
| EXTRAOPTIONS           | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).           |               |           |
...
| WARNINGACTIVE                |                                                                                                                                                  |               |           |
| CRITICALACTIVE               |                                                                                                                                                  |               |           |
| WARNINGCONNECTIONSPERSECOND  |                                                                                                                                                  |               |           |
| CRITICALCONNECTIONSPERSECOND |                                                                                                                                                  |               |           |
| WARNINGCURRENT               |                                                                                                                                                  |               |           |
| CRITICALCURRENT              |                                                                                                                                                  |               |           |
| WARNINGUSAGE                 |                                                                                                                                                  |               |           |
| CRITICALUSAGE                |                                                                                                                                                  |               |           |
...
| FILTERDATABASE              | Filter databases by name (can use regexp)                                                                                                        |               |           |
| FILTERCOUNTERS              | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                        |               |           |
| WARNINGDATABASECOLLECTIONS  |                                                                                                                                                  |               |           |
| CRITICALDATABASECOLLECTIONS |                                                                                                                                                  |               |           |
| WARNINGDATABASEDOCUMENTS    |                                                                                                                                                  |               |           |
| CRITICALDATABASEDOCUMENTS   |                                                                                                                                                  |               |           |
| WARNINGDATABASEINDEXES      |                                                                                                                                                  |               |           |
| CRITICALDATABASEINDEXES     |                                                                                                                                                  |               |           |
| WARNINGDATABASESIZEDATA     |                                                                                                                                                  |               |           |
| CRITICALDATABASESIZEDATA    |                                                                                                                                                  |               |           |
| WARNINGDATABASESIZEINDEX    |                                                                                                                                                  |               |           |
| CRITICALDATABASESIZEINDEX   |                                                                                                                                                  |               |           |
| WARNINGDATABASESIZESTORAGE  |                                                                                                                                                  |               |           |
| CRITICALDATABASESIZESTORAGE |                                                                                                                                                  |               |           |
| WARNINGDATABASEVIEWS        |                                                                                                                                                  |               |           |
| CRITICALDATABASEVIEWS       |                                                                                                                                                  |               |           |
| EXTRAOPTIONS                | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).           |               |           |
...
/usr/lib/centreon/plugins/centreon_mongodb.pl \
	...
	--port='27017' \
	--protocol='mongodb'  \
	--warning-queries-total-persecond='' \
	--critical-queries-total-persecond='' \
	--warning-queries-insert-persecond='' \
	--critical-queries-insert-persecond='' \
	--warning-queries-query-persecond='' \
	--critical-queries-query-persecond='' \
	--warning-queries-update-persecond='' \
	--critical-queries-update-persecond='' \
	--warning-queries-delete-persecond='' \
	--critical-queries-delete-persecond='' \
	--warning-queries-getmore-persecond='' \
	--critical-queries-getmore-persecond='' \
	--warning-queries-command-persecond='' \
	--critical-queries-command-persecond='' 
```

The expected command output is shown below:

```bash
OK: total: 98244 insert : 98934 query : 88651 update : 77281 delete : 9340 getmore : 5308 command : 40811 | 'queries.total.persecond'=98244/s;;;0; 'queries.insert.persecond'=98934/s;;;0; 'queries.query.persecond'=88651/s;;;0; 'queries.update.persecond'=77281/s;;;0; 'queries.delete.persecond'=9340/s;;;0; 'queries.getmore.persecond'=5308/s;;;0; 'queries.command.persecond'=40811/s;;;0; 
```
