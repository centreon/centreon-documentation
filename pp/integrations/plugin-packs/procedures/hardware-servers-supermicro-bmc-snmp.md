...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Supermicro BMC SNMP* Pack
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Supermicro BMC SNMP* Pack
