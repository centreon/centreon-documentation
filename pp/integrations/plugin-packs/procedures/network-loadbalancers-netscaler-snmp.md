...
| --alternative-status-mapping | on psu mode by default, .1.3.6.1.4.1.5951.4.1.1.41.7.1.2 mean the following :  0 =\> not supported, 1 =\> not present, 2 =\> failed, 3 =\> normal.  If this option is set to '1', meaning of the oid will change to the following :  0 =\> normal, 1 =\> not present, 2 =\> failed, 3 =\> not supported. |
