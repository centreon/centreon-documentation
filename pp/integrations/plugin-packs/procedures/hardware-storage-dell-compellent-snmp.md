...
The Monitoring Connector **Dell Compellent SNMP** brings a host template:
...
|:----------------|:-------------------------------------------------------|:--------------------|
| Hardware-Global | HW-Storage-Dell-Compellent-Hardware-Global-SNMP-custom | Check hardware      |

> The services listed above are created automatically when the **HW-Storage-Dell-Compellent-SNMP-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Dell Compellent SNMP** connector through
...
3. Apply the **HW-Storage-Dell-Compellent-SNMP-custom** template to the host. 
