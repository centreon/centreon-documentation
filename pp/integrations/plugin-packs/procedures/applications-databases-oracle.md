...
The following monitoring connectors will be installed when you install the **Oracle Database** connector through the
...
|:---------------------------------------|:-----------------------------------------------------------------------------------|
| App-DB-Oracle-ASM-Diskgroup-Usage-Name | Discover the ASM groupdisk of the Oracle server and monitor their usage and status |
| App-DB-Oracle-Tablespaces-Usage-Name   | Discover the tablespace of the Oracle server and monitor their usage               |
...
| EXTRAOPTIONS  | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).           | --verbose --notemp    |           |
