...
The following monitoring connectors will be installed when you install the **JVM Actuator** connector through the
...
The Monitoring Connector **JVM Actuator** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="App-Jvm-Actuator-custom" label="App-Jvm-Actuator-custom">

| Service Alias   | Service Template                        | Service Description                         |
|:----------------|:----------------------------------------|:--------------------------------------------|
| Class-Count     | App-Jvm-Class-Count-Actuator-custom     | Check Java Class usage                      |
| Cpu-Load        | App-Jvm-Cpu-Load-Actuator-custom        | Check JVM SystemCpuLoad and ProcessCpuLoad  |
| Fd-Usage        | App-Jvm-Fd-Usage-Actuator-custom        | Check number/percentage of file descriptors |
| Load-Average    | App-Jvm-Load-Average-Actuator-custom    | Check system load average                   |
| Memory          | App-Jvm-Memory-Actuator-custom          | Check Java Heap and NonHeap Memory usage    |
| Memory-Detailed | App-Jvm-Memory-Detailed-Actuator-custom | Check Java Memory Pools                     |
| Threads         | App-Jvm-Threads-Actuator-custom         | Check threads                               |

> The services listed above are created automatically when the **App-Jvm-Actuator-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **JVM Actuator** connector through
...
3. Apply the **App-Jvm-Actuator-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
