...
The Monitoring Connector **AudioCodes** brings a host template:
...
|:--------------|:------------------------------------|:-----------------------------------------------------|
| Cpu           | Net-Audiocodes-Cpu-SNMP-custom      | Check the rate of utilization of CPU for the machine |
| Hardware      | Net-Audiocodes-Hardware-SNMP-custom | Check hardware environment                           |
| Memory        | Net-Audiocodes-Memory-SNMP-custom   | Check machine memory usage                           |

> The services listed above are created automatically when the **Net-Audiocodes-SNMP-custom** host template is used.
...
|:--------------|:----------------------------------------|:--------------------|:----------:|
| Interfaces    | Net-Audiocodes-Interfaces-SNMP-custom   | Check interfaces    | X          |
| Sbc-Calls     | Net-Audiocodes-Sbc-Calls-SNMP-custom    | Check SBC calls     |            |
| Trunk-Status  | Net-Audiocodes-Trunk-Status-SNMP-custom | Check trunk status  | X          |
...
|:-----------------------------------|:--------------------------------------------------------------|
| Net-Audiocodes-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
| Net-Audiocodes-SNMP-Trunk-Name     | Discover trunks and monitor status                            |
...
| sbc.calls.active.inbound.count                 |       |
| sbc.calls.active.outbound.count                |       |
| sbc.calls.established.inbound.count            |       |
| sbc.calls.established.outbound.count           |       |
| sbc.calls.notestablished.inbound.failed.count  |       |
| sbc.calls.notestablished.outbound.failed.count |       |
| sbc.sessions.active.count                      |       |
...
2. Whatever the license type (*online* or *offline*), install the **AudioCodes** connector through
...
3. Apply the **Net-Audiocodes-SNMP-custom** template to the host. 
