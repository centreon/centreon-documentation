...
The following monitoring connectors will be installed when you install the **Thales Mistral VS9 Rest API** connector through the
...
The Monitoring Connector **Thales Mistral VS9 Rest API** brings 2 host templates:
...
|:------------------|:--------------------------------------------------------------------|:------------------------|
| Certificates      | App-Thales-Mistral-Vs9-Host-Device-Certificates-Restapi-custom      | Check certificates      |
| Certificates      | App-Thales-Mistral-Vs9-Mmc-Certificates-Restapi-custom              | Check CA certificates   |
| Connection-Status | App-Thales-Mistral-Vs9-Host-Device-Connection-Status-Restapi-custom | Check MMC connection    |
| Interfaces        | App-Thales-Mistral-Vs9-Host-Device-Interfaces-Restapi-custom        | Check interfaces        |
| Mistral           | App-Thales-Mistral-Vs9-Host-Device-Mistral-Restapi-custom           | Check Mistral equipment |
| System            | App-Thales-Mistral-Vs9-Host-Device-System-Restapi-custom            | Check system            |
| Tunnels           | App-Thales-Mistral-Vs9-Host-Device-Tunnels-Restapi-custom           | Check VPN tunnels       |

> The services listed above are created automatically when the **App-Thales-Mistral-Vs9-Host-Restapi-custom** host template is used.
...
| Certificates  | App-Thales-Mistral-Vs9-Host-Device-Certificates-Restapi-custom | Check certificates       |
| Certificates  | App-Thales-Mistral-Vs9-Mmc-Certificates-Restapi-custom         | Check CA certificates    |
| Cluster       | App-Thales-Mistral-Vs9-Mmc-Cluster-Restapi-custom              | Check MMC cluster status |

> The services listed above are created automatically when the **App-Thales-Mistral-Vs9-Mmc-Restapi-custom** host template is used.
...
| Service Alias | Service Template                               | Service Description |
|:--------------|:-----------------------------------------------|:--------------------|
| Clusters      | App-Thales-Mistral-Vs9-Clusters-Restapi-custom | Check clusters      |
...
2. Whatever the license type (*online* or *offline*), install the **Thales Mistral VS9 Rest API** connector through
...
3. Apply the **App-Thales-Mistral-Vs9-Host-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| MMCAPIEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **App-Thales-Mistral-Vs9-Mmc-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
4. Fill in the macros you want. Some macros are mandatory.
