...
The Monitoring Connector **Socomec Net Vision UPS SNMP** brings a host template:
...
|:--------------|:--------------------------------------------------|:----------------------------|
| Alarms        | HW-UPS-Socomec-Netvision-Alarms-SNMP-custom       | Check if alarms are present |
| Battery       | HW-UPS-Socomec-Netvision-Battery-SNMP-custom      | Check battery status        |
| Input-Lines   | HW-UPS-Socomec-Netvision-Input-Lines-SNMP-custom  | Check input lines metrics   |
| Output-Lines  | HW-UPS-Socomec-Netvision-Output-Lines-SNMP-custom | Check output lines metrics  |

> The services listed above are created automatically when the **HW-UPS-Socomec-Netvision-SNMP-custom** host template is used.
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-UPS-Socomec-Netvision-SNMP-custom** host template |
...
| CRITICALSTATUS                 | Define the conditions to match for the status to be CRITICAL (default: '%{status} =~ /depleted\|failure/i'). You can use the following variables: %{status} | %{status} =~ /depleted\|failure/i |             |
...
| Macro                | Description                                                                                                                                      | Default value           | Mandatory   |
|:---------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------|:-----------:|
| UNKNOWNSOURCESTATUS  | Define the conditions to match for the status to be UNKNOWN (default: '%{status} =~ /unknown/i'). You can use the following variables: %{status} | %{status} =~ /unknown/i |             |
| WARNINGCURRENT       | Thresholds                                                                                                                                       |                         |             |
| CRITICALCURRENT      | Thresholds                                                                                                                                       |                         |             |
