...
title: AWS Billing
description: Monitor AWS estimated billing charges via CloudWatch, using the AWS CLI or the Perl Paws SDK.
---
...
The following monitoring connectors will be installed when you install the **AWS Billing** connector through the
...
The Monitoring Connector **AWS Billing** brings a host template:
...
|:--------------------------|:-----------------------------------------------|:--------------------------------|
| Billing-Estimated-Charges | Cloud-Aws-Billing-Estimated-Charges-Api-custom | Check service estimated charges |

> The services listed above are created automatically when the **Cloud-Aws-Billing-custom** host template is used.
...
|:----------------|:-----------------------------|
| Amazon Billing  | Discover AWS Billed Services |
...
2. Whatever the license type (*online* or *offline*), install the **AWS Billing** connector through
...
3. Apply the **Cloud-Aws-Billing-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
