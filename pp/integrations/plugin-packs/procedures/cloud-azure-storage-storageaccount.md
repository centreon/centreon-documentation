...
2. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Azure Storage Account** Centreon Monitoring Connector.
...
2. Install the **Azure Storage Account** Centreon Monitoring Connector RPM on the Centreon central server:

```bash
yum install centreon-pack-cloud-azure-storage-storageaccount
```

3. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Azure Storage Account** Centreon Monitoring Connector.
