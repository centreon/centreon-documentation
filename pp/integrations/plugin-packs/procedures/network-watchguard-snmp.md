...
| Net-Watchguard-SNMP-Traffic-Name  | Discover network interfaces and monitor bandwidth utilization |
...
3. Apply the **Net-Watchguard-SNMP-custom** template to the host. 
...
| --warning-member-status   | Define the conditions to match for the status to be WARNING. You can use the following variables: %{role}, %{serial}    |
