...
description: "Monitor Cisco Umbrella virtual appliances via SNMP: appliance status, connectivity, CPU, memory, load, DNS queries, and storage usage."
---
...
The following monitoring connectors will be installed when you install the **Cisco Umbrella SNMP** connector through the
...
Please refer to the [official documentation](https://docs.umbrella.com/deployment-umbrella/docs/appendix-c-enable-snmp-monitoring) from the manufacturer/publisher. 
