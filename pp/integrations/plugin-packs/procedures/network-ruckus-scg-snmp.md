...
<Tabs groupId="sync">
<TabItem value="Net-Ruckus-Scg-SNMP-custom" label="Net-Ruckus-Scg-SNMP-custom">
...
<TabItem value="Ssid-Usage" label="Ssid-Usage">
...
<TabItem value="System-Stats" label="System-Stats">
...
| WARNINGSTATUS  | Define the conditions to match for the status to be WARNING (default: '%{configuration\_status} !~ /^Up-to-date$/i'). You can use the following variables: %{connection\_status}, %{registration\_status}, %{configuration\_status}, %{display} | %{configuration\_status} !~ /^Up-to-date$/i |             |
| CRITICALSTATUS | Define the conditions to match for the status to be CRITICAL (default: '%{connection\_status} =~ /^Disconnect$/i'). You can use the following variables: %{connection\_status}, %{registration\_status}, %{configuration\_status}, %{display}   | %{connection\_status} =~ /^Disconnect$/i    |             |
...
| --warning-status  | Define the conditions to match for the status to be WARNING (default: '%{configuration\_status} !~ /^Up-to-date$/i'). You can use the following variables: %{connection\_status}, %{registration\_status}, %{configuration\_status}, %{display}   |
| --critical-status | Define the conditions to match for the status to be CRITICAL (default: '%{connection\_status} =~ /^Disconnect$/i'). You can use the following variables: %{connection\_status}, %{registration\_status}, %{configuration\_status}, %{display}     |
