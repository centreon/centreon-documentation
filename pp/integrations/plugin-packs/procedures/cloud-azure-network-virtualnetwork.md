...
2. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Azure Virtual Network** Centreon Monitoring Connector.
...
3. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Azure Virtual Network** Centreon Monitoring Connector.
