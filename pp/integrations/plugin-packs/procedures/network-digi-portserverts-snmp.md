...
The Monitoring Connector **Digi PortServers TS** brings a host template:

* **Net-Digi-Portserverts-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<TabItem value="Net-Digi-Portserverts-SNMP-custom" label="Net-Digi-Portserverts-SNMP-custom">

| Service Alias  | Service Template                                 | Service Description                          | Discovery  |
|:---------------|:-------------------------------------------------|:---------------------------------------------|:----------:|
| Cpu            | Net-Digi-Portserverts-Cpu-SNMP-custom            | Check the rate of utilization of CPU         |            |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Digi-Portserverts-SNMP-custom** host template |
...
| Rule name                               | Description                                                   |
|:----------------------------------------|:--------------------------------------------------------------|
| Net-Digi-Portserverts-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
```bash
dnf install centreon-pack-network-digi-portserverts-snmp
```
...
```bash
apt install centreon-pack-network-digi-portserverts-snmp
```
...
```bash
yum install centreon-pack-network-digi-portserverts-snmp
```

</TabItem>
</Tabs>

2. Whatever the license type (*online* or *offline*), install the **Digi PortServers TS** connector through
...
```bash
dnf install centreon-plugin-Network-Digi-Portserverts-Snmp
```
...
```bash
apt install centreon-plugin-network-digi-portserverts-snmp
```
...
3. Apply the **Net-Digi-Portserverts-SNMP-custom** template to the host.
...
```bash
/usr/lib/centreon/plugins/centreon_digi_portservers.pl \
	--plugin=network::digi::portserverts::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:-----------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/digi/portserverts/snmp/mode/cpu.pm)]       | Net-Digi-Portserverts-Cpu-SNMP-custom            |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | Net-Digi-Portserverts-Traffic-Global-SNMP-custom |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)] | Used for service discovery                       |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/digi/portserverts/snmp/mode/memory.pm)] | Net-Digi-Portserverts-Memory-SNMP-custom         |
