...
The following monitoring connectors will be installed when you install the **Microsoft SQL Server** connector through the
...
| *by_instance*#mssql.deadlocks.perminute |      |
...
| *by_instance*#mssql.lockswaits.perminute |      |
...
```bash
OK: total transactions: 21977/s All databases are ok | 'databases.transactions.persecond'=21977/s;;;0; 'database1#database.transactions.persecond'=9141/s;;;0; 'database2#database.transactions.persecond'=93031/s;;;0; 
```
...
| --unit                   | Select the time unit for thresholds. May be 's' for seconds, 'm' for minutes, 'h' for hours, 'd' for days, 'w' for weeks. Default is days.                                                                |
