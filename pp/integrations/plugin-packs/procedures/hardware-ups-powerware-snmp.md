...
The following monitoring connectors will be installed when you install the **Powerware UPS SNMP** connector through the
...
| Output-Source  | HW-UPS-Powerware-Output-Source-SNMP-custom  | Check output source status                        |

> The services listed above are created automatically when the **HW-UPS-Powerware-SNMP-custom** host template is used.
...
| Name                        | Unit |
|:----------------------------|:-----|
| lines.input.frequency.hertz | Hz   |
...
3. Apply the **HW-UPS-Powerware-SNMP-custom** template to the host.
...
| Macro                       | Description                                                                                                                                      | Default value | Mandatory |
|:----------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| WARNINGINTERNALHUMIDITY     | Threshold                                                                                                                                        |               |           |
| CRITICALINTERNALHUMIDITY    | Threshold                                                                                                                                        |               |           |
| WARNINGINTERNALTEMPERATURE  | Threshold                                                                                                                                        |               |           |
| CRITICALINTERNALTEMPERATURE | Threshold                                                                                                                                        |               |           |
| WARNINGREMOTEHUMIDITY       | Threshold                                                                                                                                        |               |           |
| CRITICALREMOTEHUMIDITY      | Threshold                                                                                                                                        |               |           |
| WARNINGREMOTETEMPERATURE    | Threshold                                                                                                                                        |               |           |
| CRITICALREMOTETEMPERATURE   | Threshold                                                                                                                                        |               |           |
| EXTRAOPTIONS                | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).           |               |           |
...
| WARNINGPOWER      | Threshold in Watts                                                                                                                                                                                                                                                                                                                 |               |           |
| CRITICALPOWER     | Threshold in Watts                                                                                                                                                                                                                                                                                                                 |               |           |
| WARNINGVOLTAGE    | Threshold in Volts                                                                                                                                                                                                                                                                                                                 |               |           |
| CRITICALVOLTAGE   | Threshold in Volts. If --warning-voltage and --critical-voltage are not specified the connector uses the SNMP values `upsConfigLowVoltageTransferPoint` ( OID .1.3.6.1.2.1.33.1.9.9 ) and `upsConfigHighVoltageTransferPoint` ( OID .1.3.6.1.2.1.33.1.9.10 ) to set the CRITICAL threshold if these values are different from zero |               |           |
| EXTRAOPTIONS      | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                                                                                                                                                                                             |               |           |
...
| --filter-type          | Filter on type. (can be a regexp) Default: ^(?!(UtilityPowerRestored\|NoticeCondition\|ReturnFromLowBattery\|AlarmEntryAdded\|AlarmEntryRemoved))                                                                                           |
...
| --warning-power      | Threshold in Watts.                                                                                                                                                                                                                                                                                                                 |
| --critical-power     | Threshold in Watts.                                                                                                                                                                                                                                                                                                                 |
| --warning-voltage    | Threshold in Volts.                                                                                                                                                                                                                                                                                                                 |
| --critical-voltage   | Threshold in Volts. If --warning-voltage and --critical-voltage are not specified the connector uses the SNMP values `upsConfigLowVoltageTransferPoint` ( OID .1.3.6.1.2.1.33.1.9.9 ) and `upsConfigHighVoltageTransferPoint` ( OID .1.3.6.1.2.1.33.1.9.10 ) to set the CRITICAL threshold if these values are different from zero. |
