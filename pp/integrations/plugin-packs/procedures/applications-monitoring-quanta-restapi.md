...
<Tabs groupId="sync">
<TabItem value="App-Monitoring-Quanta-Restapi-custom" label="App-Monitoring-Quanta-Restapi-custom">

| Service Alias              | Service Template                                  | Service Description                                 |
|:---------------------------|:--------------------------------------------------|:----------------------------------------------------|
| RUM Overview               | App-Monitoring-Quanta-RUM-Restapi-custom          | Check RUM metrics for a given site                  |
| Site Performances Overview | App-Monitoring-Quanta-Siteoverview-Restapi-custom | Check overview performance metrics for a given site |

> The services listed above are created automatically when the **App-Monitoring-Quanta-Restapi-custom** host template is used.
...
|:------------------------|:------------------------------------------------------------|:-----------------------------------------|:----------:|
| User Journey Incidents  | App-Monitoring-Quanta-Userjourney-Incidents-Restapi-custom  | Check incidents for a given user journey | X          |
| User Journey Statistics | App-Monitoring-Quanta-Userjourney-Statistics-Restapi-custom | Check statistics for a user journey      | X          |
...
| Name                         | Unit  |
|:-----------------------------|:------|
| quanta.incidents.total.count | count |
| incident-status              | N/A   |
| incident-type                | N/A   |
...
| journey-performance-score                       | N/A   |
| *metrics1*#journey.herotime.milliseconds        | ms    |
| *metrics2*#journey.herotime.milliseconds        | ms    |
| *metrics1*#journey.speedindex.time.milliseconds | ms    |
| *metrics2*#journey.speedindex.time.milliseconds | ms    |
| *metrics1*#journey.ttfb.milliseconds            | ms    |
| *metrics2*#journey.ttfb.milliseconds            | ms    |
| interaction-performance-score                   | N/A   |
| interaction-performance-score                   | N/A   |
| *metrics1*#herotime.milliseconds                | ms    |
| *metrics2*#herotime.milliseconds                | ms    |
| *metrics1*#speedindex.time.milliseconds         | ms    |
| *metrics2*#speedindex.time.milliseconds         | ms    |
| *metrics1*#ttfb.milliseconds                    | ms    |
| *metrics2*#ttfb.milliseconds                    | ms    |
...
```bash
dnf install centreon-pack-applications-monitoring-quanta-restapi
```
...
```bash
apt install centreon-pack-applications-monitoring-quanta-restapi
```
...
```bash
yum install centreon-pack-applications-monitoring-quanta-restapi
```
...
```bash
dnf install centreon-plugin-Applications-Monitoring-Quanta-Restapi
```
...
```bash
apt install centreon-plugin-applications-monitoring-quanta-restapi
```
...
```bash
yum install centreon-plugin-Applications-Monitoring-Quanta-Restapi
```
...
3. Apply the **App-Monitoring-Quanta-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
4. Fill in the macros you want. Some macros are mandatory.

| Macro                 | Description                                                                                          | Default value     | Mandatory   |
|:----------------------|:-----------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| QUANTAAPITOKEN        | API token                                                                                            |                   | X           |
| QUANTASITEID          | Set ID of the site                                                                                   |                   | X           |
| QUANTATIMEOUT         | Set HTTP timeout                                                                                     | 10                |             |
| QUANTAAPIEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
...
| WARNINGONLOAD                | Warning threshold for C\<onload\> time (in ms)                                                                                       |                   |             |
| CRITICALONLOAD               | Critical threshold for C\<onload\> time (in ms)                                                                                      |                   |             |
...
| WARNINGECODESIGNSCORE        | Warning threshold for C\<eco design\> score                                                        |                   |             |
| CRITICALECODESIGNSCORE       | Critical threshold for C\<eco design\> score                                                       |                   |             |
...
| WARNINGINCIDENTSTATUS    | Define the conditions to match for the status to be B\<WARNING\>.  You can use the following variables: C\<%\{status\}\>.  Example: C\<--warning-incident-status='%\{status\} =~ /open/i'\>     |                   |             |
| CRITICALINCIDENTSTATUS   | Define the conditions to match for the status to be B\<CRITICAL\>.  You can use the following variables: C\<%\{status\}\>.  Default: C\<--critical-incident-status='%\{status\} =~ /open/i'\>   |                   |             |
| WARNINGINCIDENTSTOTAL    | Warning threshold for incidents total                                                                                                                                                           |                   |             |
| CRITICALINCIDENTSTOTAL   | Critical threshold for incidents total                                                                                                                                                          |                   |             |
| WARNINGINCIDENTTYPE      | Define the conditions to match for the incident type to be B\<WARNING\>.  You can use the following variables: C\<%\{type\}\>.  Example: C\<--warning-incident-type='%\{type\} =~ /error/i'\>   |                   |             |
| CRITICALINCIDENTTYPE     | Define the conditions to match for the incident type to be B\<CRITICAL\>.  You can use the following variables: C\<%\{type\}\>.  Example: C\<--critical-incident-type='%\{type\} =~ /error/i'\> |                   |             |
| EXTRAOPTIONS             | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                                                                                              |                   |             |
...
| CRITICALJOURNEYTTFB                 | Critical threshold for journey time to first byte (in ms).                                                                                                                              |                   |             |
| EXTRAOPTIONS                        | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                                                                                      |                   |             |
...
```bash
/usr/lib/centreon/plugins/centreon_monitoring_quanta_restapi.pl \
...
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------|
| list-user-journeys [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/monitoring/quanta/restapi/mode/listuserjourneys.pm)]           | Used for service discovery                                  |
| rum [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/monitoring/quanta/restapi/mode/rum.pm)]                                       | App-Monitoring-Quanta-RUM-Restapi-custom                    |
| site-overview [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/monitoring/quanta/restapi/mode/siteoverview.pm)]                    | App-Monitoring-Quanta-Siteoverview-Restapi-custom           |
| user-journey-incidents [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/monitoring/quanta/restapi/mode/userjourneyincidents.pm)]   | App-Monitoring-Quanta-Userjourney-Incidents-Restapi-custom  |
| user-journey-statistics [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/monitoring/quanta/restapi/mode/userjourneystatistics.pm)] | App-Monitoring-Quanta-Userjourney-Statistics-Restapi-custom |
...
| --hostname                                 |   Quanta API hostname (default: 'api.quanta.io')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| --warning-onload                  |   Warning threshold for C\<onload\> time (in ms).                                                                                         |
| --critical-onload                 |   Critical threshold for C\<onload\> time (in ms).                                                                                        |
...
| --warning-eco-design-score        |   Warning threshold for C\<eco design\> score.     |
| --critical-eco-design-score       |   Critical threshold for C\<eco design\> score.    |
...
| --warning-incident-status    |   Define the conditions to match for the status to be B\<WARNING\>.  You can use the following variables: C\<%\{status\}\>.  Example: C\<--warning-incident-status='%\{status\} =~ /open/i'\>       |
| --critical-incident-status   |   Define the conditions to match for the status to be B\<CRITICAL\>.  You can use the following variables: C\<%\{status\}\>.  Default: C\<--critical-incident-status='%\{status\} =~ /open/i'\>     |
| --warning-incident-type      |   Define the conditions to match for the incident type to be B\<WARNING\>.  You can use the following variables: C\<%\{type\}\>.  Example: C\<--warning-incident-type='%\{type\} =~ /error/i'\>     |
| --critical-incident-type     |   Define the conditions to match for the incident type to be B\<CRITICAL\>.  You can use the following variables: C\<%\{type\}\>.  Example: C\<--critical-incident-type='%\{type\} =~ /error/i'\>   |
...
| --critical-journey-ttfb                  |   Critical threshold for journey time to first byte (in ms).                                                                                                                                    
