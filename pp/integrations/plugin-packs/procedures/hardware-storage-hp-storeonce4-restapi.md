...
2. On the Centreon web interface, install the **HP StoreOnce 4.x Rest API** Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page.
...
3. On the Centreon web interface, install the **HP StoreOnce 4.x Rest API** Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page.
