...
The following monitoring connectors will be installed when you install the **Veeam NRPE** connector through the
...
The Monitoring Connector **Veeam NRPE** brings a host template:
...
2. Whatever the license type (*online* or *offline*), install the **Veeam NRPE** connector through
...
```bash
/usr/lib64/nagios/plugins//check_centreon_nrpe -H 10.0.0.1 -p 5666 -t 55  -c check_centreon_plugins -a \
...
```bash
OK: detected jobs: 6241 success: 56423 failed: 74619 warning: 6645 All SureBackup jobs are ok | 'sure_backup.jobs.detected.count'=6241;;;0; 'sure_backup.jobs.success.count'=56423;;;0; 'sure_backup.jobs.failed.count'=74619;;;0; 'sure_backup.jobs.warning.count'=6645;;;0; 
```
...
```bash
/usr/lib64/nagios/plugins//check_centreon_nrpe -H 10.0.0.1 -p 5666 -t 55  -c check_centreon_plugins -a 'apps::backup::veeam::local::plugin' \
	'vsb-jobs' \
	'--list-mode'
```
