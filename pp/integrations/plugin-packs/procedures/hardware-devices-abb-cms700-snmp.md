...
The following monitoring connectors will be installed when you install the **ABB CMS-700 SNMP** connector through the
...
3. Apply the **HW-Device-Abb-Cms700-SNMP-custom** template to the host.
