...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Google Storage* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Google Storage* Monitoring Connector
