...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Google Stackdriver* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Google Stackdriver* Monitoring Connector
