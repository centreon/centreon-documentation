...
* **App-Monitoring-Iplabel-Newtest-Restapi-custom**
...
|:--------------|:--------------------------------------------------------|:--------------------|:----------:|
| Scenarios     | App-Monitoring-Iplabel-Newtest-Scenarios-Restapi-custom | Check scenarios     | X          |
...
|:------------------------------------------------------|:--------------------------------------|
| App-Monitoring-Iplabel-Newtest-Restapi-List-Scenarios | Discover scenarios and monitor status |
...
| Metric name                          | Unit  |
|:-------------------------------------|:------|
| scenario.status.green.percentage     | %     |
| scenario.status.red.percentage       | %     |
| scenario.status.orange.percentage    | %     |
| scenario.status.grey.percentage      | %     |
...
```bash
dnf install centreon-pack-applications-monitoring-iplabel-newtest-restapi
```
...
2. Whatever the license type (*online* or *offline*), install the **IP-Label Newtest Rest API** connector through
...
```bash
dnf install centreon-plugin-Applications-Monitoring-Iplabel-Newtest-Restapi
```
...
3. Apply the **App-Monitoring-Iplabel-Newtest-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
4. Fill in the macros you want. Some macros are mandatory.

| Macro                         | Description | Default value     | Mandatory   |
|:------------------------------|:------------------------|:------------------|:-----------:|
| IPLABELNEWTESTAPIHOSTNAME     | Newtest address         |                   | X           |
| IPLABELNEWTESTAPIUSERNAME     | API username            |                   |             |
...
| Macro                 | Description                                                                                         | Default value     | Mandatory   |
|:----------------------|:----------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| TIMEFRAME             | Define timeframe in seconds (by default it's the time between two executions)                       |                   |             |
| FILTERROBOTNAME       | Filter robots (can be a regexp)                                                                     |                   |             |
| FILTERSCENARIONAME    | Filter scenarios (can be a regexp)                                                                  |                   |             |
| WARNINGEXECUTIONTIME  | Thresholds                                                                                          |                   |             |
| CRITICALEXECUTIONTIME | Thresholds                                                                                          |                   |             |
| WARNINGSTATUSGREEN    | Thresholds                                                                                          |                   |             |
| CRITICALSTATUSGREEN   | Thresholds                                                                                          |                   |             |
| WARNINGSTATUSGREY     | Thresholds                                                                                          |                   |             |
| CRITICALSTATUSGREY    | Thresholds                                                                                          |                   |             |
| WARNINGSTATUSORANGE   | Thresholds                                                                                          |                   |             |
| CRITICALSTATUSORANGE  | Thresholds                                                                                          |                   |             |
| WARNINGSTATUSRED      | Thresholds                                                                                          |                   |             |
| CRITICALSTATUSRED     | Thresholds                                                                                          |                   |             |
...
| list-instances | Used for service discovery                              |
| scenarios      | App-Monitoring-Iplabel-Newtest-Scenarios-Restapi-custom |
...
| --source-encoding                          | Define the character encoding of the response sent by the monitored resource Default: 'UTF-8'.      IP-Label newtest Rest API                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --hostname                                 | Newtest hostname.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --port                                     | Port used (Default: 8085)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --proto                                    | Specify https if needed (Default: 'http')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --url-path                                 | API url path (Default: '/rest')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| --filter-robot-name                        | Filter robots (can be a regexp).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --filter-scenario-name                     | Filter scenarios (can be a regexp).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --timeframe                                | Define timeframe in seconds (by default it's the time between two executions).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --warning-* --critical-*                   | Thresholds. Can be: 'status-green', 'status-red', 'status-orange', 'status-grey', 'execution-time'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
