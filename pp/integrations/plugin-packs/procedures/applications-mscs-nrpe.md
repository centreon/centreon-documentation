...
The Monitoring Connector **Microsoft Cluster Server NSClient++ NRPE** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="App-Mscs-NRPE-custom" label="App-Mscs-NRPE-custom">

| Service Alias               | Service Template                          | Service Description                 |
|:----------------------------|:------------------------------------------|:------------------------------------|
| Cluster-Network-Status      | App-Mscs-Network-Status-NRPE-custom       | Check cluster network status        |
| Cluster-Node-Status         | App-Mscs-Node-Status-NRPE-custom          | Check cluster node status           |
| Cluster-Resouce-Status      | App-Mscs-Resource-Status-NRPE-custom      | Check cluster resource status       |
| Cluster-Resoucegroup-Status | App-Mscs-Resourcegroup-Status-NRPE-custom | Check cluster resource group status |

> The services listed above are created automatically when the **App-Mscs-NRPE-custom** host template is used.
...
```bash
/usr/lib64/nagios/plugins//check\_centreon\_nrpe -H 10.0.0.1 -p 5666 -t 55  -c check_centreon_plugins -a 'apps::microsoft::mscs::local::plugin' 'resourcegroup-status'  ' \
	--filter-name="" \
