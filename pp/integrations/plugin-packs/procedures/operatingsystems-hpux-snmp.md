...
The following monitoring connectors will be installed when you install the **HP-UX SNMP** connector through the
...
The Monitoring Connector **HP-UX SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="OS-Hpux-SNMP-custom" label="OS-Hpux-SNMP-custom">

| Service Alias  | Service Template                   | Service Description                                                                               |
|:---------------|:-----------------------------------|:--------------------------------------------------------------------------------------------------|
| Cpu            | OS-Hpux-Cpu-SNMP-custom            | Check system CPUs                                                                                 |
| Load           | OS-Hpux-Load-SNMP-custom           | Check the server load average                                                                     |
| Memory         | OS-Hpux-Memory-SNMP-custom         | Check the rate of the utilization of memory (RAM) and swap                                        |
| Storage-Global | OS-Hpux-Storage-Global-SNMP-custom | Check the rate of free space on disks. Thresholds can be in percentage or in free space remaining |

> The services listed above are created automatically when the **OS-Hpux-SNMP-custom** host template is used.
...
| Service Alias   | Service Template                    | Service Description                                  |
|:----------------|:------------------------------------|:-----------------------------------------------------|
| Process-Generic | OS-Hpux-Process-Generic-SNMP-custom | Check process                                        |
| Uptime          | OS-Hpux-Uptime-SNMP-custom          | Time since the server has been working and available |
...
|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **OS-Hpux-SNMP-custom** host template. |
...
<TabItem value="Storage-Global" label="Storage-Global">
...
```bash
dnf install centreon-pack-operatingsystems-hpux-snmp
```
...
```bash
apt install centreon-pack-operatingsystems-hpux-snmp
```
...
```bash
yum install centreon-pack-operatingsystems-hpux-snmp
```

</TabItem>
</Tabs>

2. Whatever the license type (*online* or *offline*), install the **HP-UX SNMP** connector through
...
```bash
dnf install centreon-plugin-Operatingsystems-Hpux-Snmp
```
...
```bash
apt install centreon-plugin-operatingsystems-hpux-snmp
```
...
3. Apply the **OS-Hpux-SNMP-custom** template to the host.
...
| Macro        | Description                                                                                                                                      | Default value | Mandatory |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| WARNINGIDLE  | Threshold                                                                                                                                        | 10:           |           |
| CRITICALIDLE | Threshold                                                                                                                                        | 20:           |           |
...
| Macro        | Description                                                                                                                                      | Default value | Mandatory |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| PROCESSCMD   | Define the command of the processes to check                                                                                                     |               |           |
| WARNING      | Warning threshold (process count)                                                                                                                |               |           |
| CRITICAL     | Critical threshold (process count)                                                                                                               |               |           |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).           |               |           |
...
| Macro         | Description                                                                                                                                      | Default value | Mandatory |
|:--------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| FILTERNAME    | Filter path name (can be a regexp)                                                                                                               | .*            |           |
...
```bash
/usr/lib/centreon/plugins/centreon_hpux_snmp.pl \
...
```bash
OK: All storages are ok | 'disk_name1#usage'=67612B;80;90;; 'disk_name2#usage'=36416B;80;90;; 
```
...
|:-------------------------------------------------------------------------------------------------------------|:--------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/os/hpux/snmp/mode/cpu.pm)]         | OS-Hpux-Cpu-SNMP-custom               |
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/os/hpux/snmp/mode/load.pm)]       | OS-Hpux-Load-SNMP-custom              |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/os/hpux/snmp/mode/memory.pm)]   | OS-Hpux-Memory-SNMP-custom            |
| process [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/os/hpux/snmp/mode/process.pm)] | OS-Hpux-Process-Generic-SNMP-custom   |
| storage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/os/hpux/snmp/mode/storage.pm)] | OS-Hpux-Storage-Global-SNMP-custom    |
...
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/uptime.pm)]  | OS-Hpux-Uptime-SNMP-custom            |
...
| --warning-*       | Warning threshold. Can be: 'user', 'sys', 'idle', 'nice'.                             |
| --critical-*      | Critical threshold. Can be: 'user', 'sys', 'idle', 'nice'.                            |
...
| --warning        | Warning threshold (process count).                                                 |
| --critical       | Critical threshold (process count).                                                |
| --process-cmd    | Define the command of the processes to check.                                      |
| --regexp-cmd     | Allows to use regexp to filter process command (with option --process-cmd).        |
| --process-status | Define the status(es) of the processes to check (default: 'run'). Can be a regexp. |
...
| --warning-xxx     | Warning threshold.                                                                                                        |
| --critical-xxx    | Critical threshold.                                                                                                       |
| --filter-name     | Filter path name (can be a regexp).                                                                                       |
