...
The following monitoring connectors will be installed when you install the **Azure ServiceBus** connector through the
...
The Monitoring Connector **Azure ServiceBus** brings a host template:
...
|:--------------|:----------------------------------------------------------|:------------------------------------------------------|
| Connections   | Cloud-Azure-Integration-ServiceBus-Connections-Api-custom | Check Azure ServiceBus namespaces connections         |
| Messages      | Cloud-Azure-Integration-ServiceBus-Messages-Api-custom    | Check Azure ServiceBus namespaces messages            |
| Namespaces    | Cloud-Azure-Integration-ServiceBus-Namespaces-Api-custom  | Check Azure ServiceBus namespaces allocated resources |
| Requests      | Cloud-Azure-Integration-ServiceBus-Requests-Api-custom    | Check Azure ServiceBus namespaces requests            |

> The services listed above are created automatically when the **Cloud-Azure-Integration-ServiceBus-custom** host template is used.
...
The Centreon Monitoring Connector **Azure ServiceBus** includes a Host Discovery provider to
automatically discover the Azure instances of a given subscription and add them
to the list of monitored hosts. This provider is named **Microsoft Azure ServiceBus**.
...
2. Whatever the license type (*online* or *offline*), install the **Azure ServiceBus** connector through
...
3. Apply the **Cloud-Azure-Integration-ServiceBus-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| discovery [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/integration/servicebus/mode/discovery.pm)]     | Used for host discovery                                   |
| health [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/integration/servicebus/mode/health.pm)]           | Not used in this Monitoring Connector                     |
...
| --warning-*       |   Warning threshold where '*' can be: 'closed-connection', 'active-connections', 'opened-connections'.                        |
| --critical-*      |   Critical threshold where '*' can be: 'closed-connection', 'active-connections', 'opened-connections'.                       |
...
| --resource       |   Set resource name or ID (required).                                                        |
| --resource-group |   Set resource group (required if resource's name is used).                                  |
| --warning-*      |   Warning threshold where '*' can be: 'cpu-usage-percentage', 'memory-usage-percentage'.     |
| --critical-*     |   Critical threshold where '*' can be: 'cpu-usage-percentage', 'memory-usage-percentage'.    |
