...
The following monitoring connectors will be installed when you install the **Juniper ISG SNMP** connector through the
...
|:----------------|:--------------------------------------------|:-----------------------------------------------------|
| Cpu             | Net-Juniper-Isg-Cpu-SNMP-custom             | Check the rate of utilization of CPU for the machine |
| Hardware-Global | Net-Juniper-Isg-Hardware-Global-SNMP-custom | Check hardware                                       |
| Memory          | Net-Juniper-Isg-Memory-SNMP-custom          | Check the rate of the utilization of memory          |
| Sessions        | Net-Juniper-Isg-Sessions-SNMP-custom        | Check sessions usage and failed sessions             |

> The services listed above are created automatically when the **Net-Juniper-Isg-SNMP-custom** host template is used.
...
|:---------------|:-------------------------------------------|:---------------------------------------------|:---------:|
| Traffic-Global | Net-Juniper-Isg-Traffic-Global-SNMP-custom | Check traffic of multiple network interfaces | X         |
...
|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Juniper-Isg-SNMP-custom** host template. |
...
3. Apply the **Net-Juniper-Isg-SNMP-custom** template to the host.
...
```bash
OK: All interfaces are ok | 'interface_name1#interface.traffic.in.bitspersecond'=54545b/s;80;90;; 'interface_name2#interface.traffic.in.bitspersecond'=10541b/s;80;90;; 'interface_name1#interface.traffic.out.bitspersecond'=48483b/s;80;90;; 'interface_name2#interface.traffic.out.bitspersecond'=26731b/s;80;90;; 
```
