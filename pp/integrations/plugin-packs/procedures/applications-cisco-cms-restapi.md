...
The following monitoring connectors will be installed when you install the **Cisco CMS** connector through the
...
The Monitoring Connector **Cisco CMS** brings a host template:
...
|:----------------|:---------------------------------------------|:--------------------------------------------------|
| Alarms          | App-Cisco-Cms-Alarms-Restapi-custom          | Check alarms count                                |
| Calls           | App-Cisco-Cms-Calls-Restapi-custom           | Check calls, local and remote participants count  |
| Database-Status | App-Cisco-Cms-Database-Status-Restapi-custom | Check databases hosts                             |
| Licences        | App-Cisco-Cms-Licences-Restapi-custom        | Check licenses state                              |
| System-Status   | App-Cisco-Cms-System-Status-Restapi-custom   | Check system status and audio/video traffic       |

> The services listed above are created automatically when the **App-Cisco-Cms-Restapi-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **Cisco CMS** connector through
...
3. Apply the **App-Cisco-Cms-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
