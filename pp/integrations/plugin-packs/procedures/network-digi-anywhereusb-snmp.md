...
|:---------------|:------------------------------------------------|:---------------------------------------------|:----------:|
| Cpu            | Net-Digi-AnywhereUSB-Cpu-SNMP-custom            | Check the rate of utilization of CPU         |            |
| Memory         | Net-Digi-AnywhereUSB-Memory-SNMP-custom         | Check the rate of the utilization of memory  |            |
| Traffic-Global | Net-Digi-AnywhereUSB-Traffic-Global-SNMP-custom | Check traffic of multiple network interfaces | X          |

> The services listed above are created automatically when the **Net-Digi-AnywhereUSB-SNMP-custom** host template is used.
...
| Rule name                              | Description                                                   |
|:---------------------------------------|:--------------------------------------------------------------|
| Net-Digi-AnywhereUSB-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
3. Apply the **Net-Digi-AnywhereUSB-SNMP-custom** template to the host. 
