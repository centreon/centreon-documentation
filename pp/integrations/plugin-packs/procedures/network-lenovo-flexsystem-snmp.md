...
description: Monitor Lenovo Flex System switches via SNMP: CPU, memory, environment, network traffic, packet errors, storage, and uptime.
---
...
The following monitoring connectors will be installed when you install the **Lenovo Flexsystem Switch SNMP** connector through the
...
The Monitoring Connector **Lenovo Flexsystem Switch SNMP** brings a host template:
...
|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Lenovo-Flexsystem-SNMP-custom** host template. |
...
```bash
dnf install centreon-pack-network-lenovo-flexsystem-snmp
```
...
```bash
apt install centreon-pack-network-lenovo-flexsystem-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **Lenovo Flexsystem Switch SNMP** connector through
...
```bash
dnf install centreon-plugin-Network-Lenovo-Flexsystem-Snmp
```
...
```bash
apt install centreon-plugin-network-lenovo-flexsystem-snmp
```
...
3. Apply the **Net-Lenovo-Flexsystem-SNMP-custom** template to the host.
...
| WARNINGAVERAGE5M  | Threshold                                                                                                                                        | 80            |           |
| CRITICALAVERAGE5M | Threshold                                                                                                                                        | 90            |           |
...
|:-------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| INTERFACEID        | Check only the interfaces with the specified IDs (OID indexes, e.g.: 1,2,...). If empty, all interfaces will be monitored. To filter on interface names, see --name |               |           |
| WARNINGINTRAFFIC   | Threshold                                                                                                                                                           | 80            |           |
| CRITICALINTRAFFIC  | Threshold                                                                                                                                                           | 90            |           |
| WARNINGOUTTRAFFIC  | Threshold                                                                                                                                                           | 80            |           |
| CRITICALOUTTRAFFIC | Threshold                                                                                                                                                           | 90            |           |
| EXTRAOPTIONS       | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                              |               |           |
...
```bash
OK: All interfaces are ok | 'interface_name1#interface.traffic.in.bitspersecond'=24b/s;80;90;; 'interface_name2#interface.traffic.in.bitspersecond'=61b/s;80;90;; 'interface_name1#interface.traffic.out.bitspersecond'=50b/s;80;90;; 'interface_name2#interface.traffic.out.bitspersecond'=48b/s;80;90;; 
```
...
|:---------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/lenovo/flexsystem/snmp/mode/cpu.pm)]                 | Net-Lenovo-Flexsystem-Cpu-custom                                                                                                                                                                                                                                                                                                                                     |
| disk [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/ibm/nos/snmp/mode/disk.pm)]                 | Net-Lenovo-Flexsystem-Disk-Usage-custom                                                                                                                                                                                                                                                                                                                              |
| environment [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/lenovo/flexsystem/snmp/mode/environment.pm)] | Net-Lenovo-Flexsystem-Environment-custom                                                                                                                                                                                                                                                                                                                             |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                    | Net-Lenovo-Flexsystem-Packet-Errors-Generic-Id-SNMP-custom<br />Net-Lenovo-Flexsystem-Packet-Errors-Generic-Name-SNMP-custom<br />Net-Lenovo-Flexsystem-Packet-Errors-Global-SNMP-custom<br />Net-Lenovo-Flexsystem-Traffic-Generic-Id-SNMP-custom<br />Net-Lenovo-Flexsystem-Traffic-Generic-Name-SNMP-custom<br />Net-Lenovo-Flexsystem-Traffic-Global-SNMP-custom |
...
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/lenovo/flexsystem/snmp/mode/memory.pm)]           | Net-Lenovo-Flexsystem-Memory-Usage-custom                                                                                                                                                                                                                                                                                                                            |
| time [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/ntp.pm)]                                 | Net-Lenovo-Flexsystem-Time-custom                                                                                                                                                                                                                                                                                                                                    |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/uptime.pm)]                            | Net-Lenovo-Flexsystem-Uptime-custom                                                                                                                                                                                                                                                                                                                                  |
...
| --warning-* --critical-* | Thresholds. Can be: 'average-1m' (%), 'average-5m' (%).                                                                   |
...
| --filter             | Exclude some components. This option can be called several times (example: --filter=component1 --filter=component2). You can also exclude components from a specific instance (example: --filter=component\_name,instance\_value). |
...
| --threshold-overload | Use this option to override the status returned by the plugin when the status label matches a regular expression (syntax: section,status,regexp). Example: --threshold-overload='faulted,WARNING,on'                               |
| --warning            | Set warning threshold for temperatures (syntax: type,regexp,threshold) Example: --warning='temperature,.*,30'                                                                                                                      |
| --critical           | Set critical threshold for temperatures (syntax: type,regexp,threshold) Example: --critical='temperature,.*,40'                                                                                                                    |
...
| --filter-storage-type                           | Filter storage types with a regexp (default: '^(?!(hrStorageRam)$)').                                                                                                                                                                       |
