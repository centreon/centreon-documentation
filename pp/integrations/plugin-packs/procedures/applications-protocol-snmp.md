...
The following monitoring connectors will be installed when you install the **Generic SNMP** connector through the
...
| Response-Time | App-Protocol-SNMP-Response-Time-custom | Check SNMP agent response time                         |
...
|:-------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------|
| cache [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/protocols/snmp/mode/cache.pm)]                | Not used in this Monitoring Connector  |
| collection [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/protocols/snmp/mode/collection.pm)]      | Not used in this Monitoring Connector  |
| discovery [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/discovery.pm)]              | Used for host discovery                |
| dynamic-command [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/dynamiccommand.pm)]   | Not used in this Monitoring Connector  |
