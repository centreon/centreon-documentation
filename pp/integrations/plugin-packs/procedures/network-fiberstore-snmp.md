...
The Monitoring Connector **Fiberstore SNMP** brings a host template:

* **Net-Fiberstore-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<TabItem value="Net-Fiberstore-SNMP-custom" label="Net-Fiberstore-SNMP-custom">
...
| Memory        | Net-Fiberstore-Memory-SNMP-custom   | Check the rate of the utilization of memory |

> The services listed above are created automatically when the **Net-Fiberstore-SNMP-custom** host template is used.
...
|:--------------|:--------------------------------------|:--------------------|:----------:|
| Interfaces    | Net-Fiberstore-Interfaces-SNMP-custom | Check interfaces    | X          |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Fiberstore-SNMP-custom** host template |
...
| Rule name                          | Description                                                   |
|:-----------------------------------|:--------------------------------------------------------------|
| Net-Fiberstore-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
...
| slot status                                    | N/A      |
| fan status                                     | N/A      |
| *fandescription*#hardware.fan.speed.percentage | %     |
| power status                                   | N/A      |
...
```bash
dnf install centreon-pack-network-fiberstore-snmp
```
...
```bash
apt install centreon-pack-network-fiberstore-snmp
```
...
2. Whatever the license type (*online* or *offline*), install the **Fiberstore SNMP** connector through
...
```bash
dnf install centreon-plugin-Network-Fiberstore-Snmp
```
...
```bash
apt install centreon-plugin-network-fiberstore-snmp
```
...
3. Apply the **Net-Fiberstore-SNMP-custom** template to the host.
...
| Macro        | Description                                                                                        | Default value     | Mandatory   |
|:-------------|:---------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check (default: '.*'). Can be: 'fan', 'power', 'slot'                           |                   |             |
...
|:-----------------------------------------------------------------------------------------------------------------------------|:--------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fiberstore/snmp/mode/cpu.pm)]              | Net-Fiberstore-Cpu-SNMP-custom        |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fiberstore/snmp/mode/hardware.pm)]    | Net-Fiberstore-Hardware-SNMP-custom   |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | Net-Fiberstore-Interfaces-SNMP-custom |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)] | Used for service discovery            |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fiberstore/snmp/mode/memory.pm)]        | Net-Fiberstore-Memory-SNMP-custom     |
...
|:---------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --component          | Which component to check (default: '.*'). Can be: 'fan', 'power', 'slot'.                                                                                                                                   |
| --filter             | Exclude the items given as a comma-separated list (example: --filter=power). You can also exclude items from specific instances: --filter=power,1                                                           |
| --no-component       | Define the expected status if no components are found (default: critical).                                                                                                                                  |
| --threshold-overload | Use this option to override the status returned by the plugin when the status label matches a regular expression (syntax: section,status,regexp). Example: --threshold-overload='fan,CRITICAL,notInstall'   |
| --warning            | Set warning threshold for 'fan.speed' (syntax: type,regexp,threshold) Example: --warning='fan.speed,.*,90'                                                                                                  |
| --critical           | Set critical threshold for 'fan.speed' (syntax: type,regexp,threshold) Example: --critical='fan.speed,.*,95'                                                                                                |
