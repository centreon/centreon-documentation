...
2. On the Centreon Web interface, install the Centreon Monitoring Connector *Smartermail Server* from the **Configuration > Connectors > Monitoring Connectors** page
...
3. On the Centreon Web interface, install the Centreon Monitoring Connector *Smartermail Server* from the **Configuration > Connectors > Monitoring Connectors** page
