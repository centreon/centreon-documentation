...
The Monitoring Connector **Huawei** brings a host template:
...
|:--------------|:------------------------------|:--------------------------------------------|
| Cpu           | Net-Huawei-Cpu-SNMP-custom    | Check the utilization rate of the CPU.    |
| Memory        | Net-Huawei-Memory-SNMP-custom | Check the utilization rate of the memory. |
...
2. Whatever the license type (*online* or *offline*), install the **Huawei** connector through
