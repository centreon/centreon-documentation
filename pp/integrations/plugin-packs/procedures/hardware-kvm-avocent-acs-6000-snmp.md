...
The following monitoring connectors will be installed when you install the **Avocent ACS 6000** connector through the
...
The Monitoring Connector **Avocent ACS 6000** brings a host template:
...
|:----------------|:----------------------------------------------------|:--------------------|
| Hardware-Global | HW-Kvm-Avocent-Acs-6000-Hardware-Global-SNMP-custom | Check  hardware     |

> The services listed above are created automatically when the **HW-Kvm-Avocent-Acs-6000-SNMP-custom** host template is used.
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Kvm-Avocent-Acs-6000-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Avocent ACS 6000** connector through
...
3. Apply the **HW-Kvm-Avocent-Acs-6000-SNMP-custom** template to the host.
