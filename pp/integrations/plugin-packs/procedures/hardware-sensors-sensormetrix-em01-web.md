...
The Monitoring Connector **Sensormetrix** brings a host template:
...
|:--------------|:------------------------------------------------|:--------------------------|
| Humidity      | HW-Sensor-Sensormetrix-Em01-Humidity-custom     | Check humidity sensor     |
| Illumination  | HW-Sensor-Sensormetrix-Em01-Illumination-custom | Check illumination sensor |
| Temperature   | HW-Sensor-Sensormetrix-Em01-Temperature-custom  | Check temperature sensor  |

> The services listed above are created automatically when the **HW-Sensor-Sensormetrix-Em01-Web-custom** host template is used.
...
| Service Alias          | Service Template                              | Service Description                 |
|:-----------------------|:----------------------------------------------|:------------------------------------|
| Contact                | HW-Sensor-Sensormetrix-Em01-Contact-custom    | Check contact sensor                |
| Flood                  | HW-Sensor-Sensormetrix-Em01-Flood-custom      | Check flood sensor                  |
| Thermistor-Temperature | HW-Sensor-Sensormetrix-Em01-Thermistor-custom | Check thermistor temperature sensor |
| Voltage                | HW-Sensor-Sensormetrix-Em01-Voltage-custom    | Check voltage sensor                |
...
2. Whatever the license type (*online* or *offline*), install the **Sensormetrix** connector through
...
3. Apply the **HW-Sensor-Sensormetrix-Em01-Web-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| SENSORMETRIXEXTRAOPTIONS      | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
