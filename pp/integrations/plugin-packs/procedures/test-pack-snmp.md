...
The following monitoring connectors will be installed when you install the **Test Monitoring Connector** connector through the
...
The Monitoring Connector **Test Monitoring Connector** brings a host template:
...
> The services listed above are created automatically when the **Test-Monitoring-Connector-custom** host template is used.
...
|:------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Test-Monitoring-Connector-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Test Monitoring Connector** connector through
...
3. Apply the **Test-Monitoring-Connector-custom** template to the host. 
