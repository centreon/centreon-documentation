...
The following monitoring connectors will be installed when you install the **Juniper SSG** connector through the
...
```bash
OK: All VPN are ok | 'vpn1#traffic-in'=28478b/s;;;0; 'vpn2#traffic-in'=19833b/s;;;0; 'vpn1#traffic-out'=64794b/s;;;0; 'vpn2#traffic-out'=24953b/s;;;0; 
```
