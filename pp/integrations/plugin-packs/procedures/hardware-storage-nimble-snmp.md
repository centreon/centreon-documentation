...
The Monitoring Connector **Nimble Storage** brings a host template:
...
2. Whatever the license type (*online* or *offline*), install the **Nimble Storage** connector through
