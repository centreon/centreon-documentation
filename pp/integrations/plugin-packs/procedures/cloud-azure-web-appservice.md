...
The Monitoring Connector **Azure App Service** brings a host template:
...
|:--------------|:----------------------------------------------------|:-----------------------------------------------------|
| App-Usage     | Cloud-Azure-Web-AppService-App-Usage-Api-custom     | Check Azure App Service app usage                    |
| Cpu-Time      | Cloud-Azure-Web-AppService-Cpu-Time-Api-custom      | Check Azure App Service Cpu time consumed by the app |
| Data          | Cloud-Azure-Web-AppService-Data-Api-custom          | Check Azure App Service app bandwith usage           |
| File-System   | Cloud-Azure-Web-AppService-FIle-System-Api-custom   | Check Azure App Service file system                  |
| Gc-Usage      | Cloud-Azure-Web-AppService-Gc-Usage-Api-custom      | Check Azure App Service garbage collector usage      |
| Health        | Cloud-Azure-Web-AppService-Health-Api-custom        | Check Azure App Service                              |
| Http-Requests | Cloud-Azure-Web-AppService-Http-Requests-Api-custom | Check Azure App Service HTTP requests                |
| IO-Operations | Cloud-Azure-Web-AppService-IO-Operations-Api-custom | Check Azure App Service I/O opérations               |
| Memory        | Cloud-Azure-Web-AppService-Memory-Api-custom        | Check Azure App Service app memory usage             |
| Response-Time | Cloud-Azure-Web-AppService-Response-Time-Api-custom | Check Azure App Service app response time            |
| Status        | Cloud-Azure-Web-AppService-Status-Api-custom        | Check Azure App Service app status                   |

> The services listed above are created automatically when the **Cloud-Azure-Web-AppService-custom** host template is used.
...
The Centreon Monitoring Connector **Azure App Service** includes a Host Discovery provider to
automatically discover the Azure instances of a given subscription and add them
to the list of monitored hosts. This provider is named **Microsoft Azure App Service**.
...
3. Apply the **Cloud-Azure-Web-AppService-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
