...
The following monitoring connectors will be installed when you install the **Test Monitoring Connector Multiple Host Templates** connector through the
...
The Monitoring Connector **Test Monitoring Connector Multiple Host Templates** brings 3 host templates:
...
| Memory        | OS-Linux-Memory-SNMP-custom | Check the rate of the utilization of memory (RAM)                                                                                                  |

> The services listed above are created automatically when the **Test-Monitoring-Tpl1-Connector-custom** host template is used.
...
> The services listed above are created automatically when the **Test-Monitoring-Tpl2-Connector-custom** host template is used.
...
| Service Alias  | Service Template                    | Service Description                                                                                                                  |
|:---------------|:------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------|
| Traffic-Global | OS-Linux-Traffic-Global-SNMP-custom | Check the bandwidth of interfaces. For each checks the name of the interface will appear ('label' shortcut describing the interface) |
...
2. Whatever the license type (*online* or *offline*), install the **Test Monitoring Connector Multiple Host Templates** connector through
...
3. Apply the **Test-Monitoring-Tpl1-Connector-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **Test-Monitoring-Tpl2-Connector-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **Test-Monitoring-Tpl3-Connector-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
