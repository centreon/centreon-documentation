...
```bash
OK: 86 VM(s) poweredon 97 VM(s) poweredoff 68 VM(s) suspended All ESX Hosts are ok | 'host.vm.poweredon.current.count'=86;;;0;total'host.vm.poweredoff.current.count'=97;;;0;total'host.vm.suspended.current.count'=68;;;0;total'*host*#host.vm.poweredon.current.count'=;;;0;total'*host*#host.vm.poweredoff.current.count'=;;;0;total'*host*#host.vm.suspended.current.count'=;;;0;total
```
