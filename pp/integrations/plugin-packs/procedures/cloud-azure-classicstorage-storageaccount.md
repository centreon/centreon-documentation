...
The Centreon Monitoring Connector **Azure Classic Storage** brings 5 different host templates:
...
2. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Azure Classic Storage** Centreon Monitoring Connector.
...
3. On the Centreon web interface, on page **Configuration > Connectors > Monitoring Connectors**, install the **Azure Classic Storage** Centreon Monitoring Connector.
