...
The Monitoring Connector **Alpha UPS SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="HW-UPS-Alpha-SNMP-custom" label="HW-UPS-Alpha-SNMP-custom">

| Service Alias  | Service Template                        | Service Description  |
|:---------------|:----------------------------------------|:---------------------|
| Alarms         | HW-UPS-Alpha-Alarms-SNMP-custom         | Check alarms         |
| Battery-Status | HW-UPS-Alpha-Battery-Status-SNMP-custom | Check battery status |

> The services listed above are created automatically when the **HW-UPS-Alpha-SNMP-custom** host template is used.
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-UPS-Alpha-SNMP-custom** host template |
...
2. Whatever the license type (*online* or *offline*), install the **Alpha UPS SNMP** connector through
...
3. Apply the **HW-UPS-Alpha-SNMP-custom** template to the host.
