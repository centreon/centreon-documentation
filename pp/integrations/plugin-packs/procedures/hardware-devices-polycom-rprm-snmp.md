...
The following monitoring connectors will be installed when you install the **Polycom RPRM SNMP** connector through the
...
The Monitoring Connector **Polycom RPRM SNMP** brings a host template:
...
|:---------------|:--------------------------------------------------|:-----------------------------------------|
| Cluster-Status | HW-Device-Polycom-Rprm-Cluster-Status-SNMP-custom | Check Polycom RPRM SuperCluster status   |
| License        | HW-Device-Polycom-Rprm-License-SNMP-custom        | Check the Polycom RPRM license           |
| Provisioning   | HW-Device-Polycom-Rprm-Provisioning-SNMP-custom   | Check the Polycom RPRM provisioning jobs |
| SiteLinks      | HW-Device-Polycom-Rprm-SiteLinks-SNMP-custom      | Check the Polycom RPRM SiteLinks         |
| Sites          | HW-Device-Polycom-Rprm-Sites-SNMP-custom          | Check the Polycom RPRM Sites             |
| Updates        | HW-Device-Polycom-Rprm-Updates-SNMP-custom        | Check the Polycom RPRM Updates status    |

> The services listed above are created automatically when the **HW-Device-Polycom-Rprm-SNMP-custom** host template is used.
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Device-Polycom-Rprm-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Polycom RPRM SNMP** connector through
...
3. Apply the **HW-Device-Polycom-Rprm-SNMP-custom** template to the host. 
...
| WARNINGCLUSTERSTATUS       | Custom Warning threshold of the cluster state Syntax: --warning-cluster-status='%\{cluster\_status\} =~ /busyOut/i'                                    |                                   |           |
