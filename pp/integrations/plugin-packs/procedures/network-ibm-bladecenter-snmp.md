...
The Monitoring Connector **IBM BladeCenter Switch** brings a host template:
...
|:---------------|:-----------------------------------------------|:--------------------|
| Cpu            | Net-IBM-Bladecenter-Cpu-custom                 | Check CPU utilization                    |
| Environment    | Net-IBM-Bladecenter-Environment-custom         | Check hardware environment                    |
| Memory Usage   | Net-IBM-Bladecenter-Memory-Usage-custom        | Check memory usage                    |
| Traffic-Global | Net-IBM-Bladecenter-Traffic-Global-SNMP-custom | Check traffic of multiple network interfaces                    |

> The services listed above are created automatically when the **Net-IBM-Bladecenter-SNMP-custom** host template is used.
...
| Service Alias              | Service Template                                           | Service Description |
|:---------------------------|:-----------------------------------------------------------|:--------------------|
| Packet-Errors-Generic-Id   | Net-IBM-Bladecenter-Packet-Errors-Generic-Id-SNMP-custom   | Check packets in error and discarded packets for multiple network interfaces                    |
| Packet-Errors-Generic-Name | Net-IBM-Bladecenter-Packet-Errors-Generic-Name-SNMP-custom | Check packets in error and discarded packets for a network interface                    |
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-IBM-Bladecenter-SNMP-custom** host template |
...
2. Whatever the license type (*online* or *offline*), install the **IBM BladeCenter Switch** connector through
...
3. Apply the **Net-IBM-Bladecenter-SNMP-custom** template to the host.
