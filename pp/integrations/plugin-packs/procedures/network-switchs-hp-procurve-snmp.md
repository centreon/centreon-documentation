...
| CRITICALLINKSTATUS      | Define the conditions to match for the status to be CRITICAL (default: '%\{link_status\} eq "down"'). You can use the following variables: %\{link_status\}, %\{display\}                                                    | %\{link_status\} eq "down"                                                         |             |
