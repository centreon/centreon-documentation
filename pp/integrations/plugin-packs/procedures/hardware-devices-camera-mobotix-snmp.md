...
2. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Mobotix Camera* Monitoring Connector
...
3. On the Centreon Web interface in **Configuration > Connectors > Monitoring Connectors**, install the *Mobotix Camera* Monitoring Connector
