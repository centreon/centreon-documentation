...
The following monitoring connectors will be installed when you install the **Azure Application Insights** connector through the
...
The Monitoring Connector **Azure Application Insights** brings a host template:
...
|:----------------|:----------------------------------------------------------------------|:-------------------------------------------------------------------------------------|
| Availability    | Cloud-Azure-Management-ApplicationInsights-Availability-Api-custom    | Check Azure Application Insights monitored application availability                  |
| Browser-Timings | Cloud-Azure-Management-ApplicationInsights-Browser-Timings-Api-custom | Check Azure Application Insights monitored application browser timings               |
| Cpu             | Cloud-Azure-Management-ApplicationInsights-Cpu-Api-custom             | Check Azure Application Insights monitored application CPU                           |
| Exceptions      | Cloud-Azure-Management-ApplicationInsights-Exceptions-Api-custom      | Check Azure Application Insights monitored application uncaught exceptions           |
| External-Calls  | Cloud-Azure-Management-ApplicationInsights-External-Calls-Api-custom  | Check Azure Application Insights calls made by the application to external resources |
| IO-Operations   | Cloud-Azure-Management-ApplicationInsights-Io-Operations-Api-custom   | Check Azure Application Insights monitored application read and write operations     |
| Memory          | Cloud-Azure-Management-ApplicationInsights-Memory-Api-custom          | Check Azure Application Insights monitored application memory usage                  |
| Page-Views      | Cloud-Azure-Management-ApplicationInsights-Page-Views-Api-custom      | Check Azure Application Insights monitored application page views                    |
| Requests        | Cloud-Azure-Management-ApplicationInsights-Requests-Api-custom        | Check Azure Application Insights monitored application requests                      |

> The services listed above are created automatically when the **Cloud-Azure-Management-ApplicationInsights-custom** host template is used.
...
The Centreon Monitoring Connector **Azure Application Insights** includes a Host Discovery provider to
automatically discover the Azure instances of a given subscription and add them
to the list of monitored hosts. This provider is named **Microsoft Azure Application Insights**.
...
2. Whatever the license type (*online* or *offline*), install the **Azure Application Insights** connector through
...
3. Apply the **Cloud-Azure-Management-ApplicationInsights-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
