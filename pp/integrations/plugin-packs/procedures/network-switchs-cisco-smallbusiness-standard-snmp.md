...
| Environment   | Net-Cisco-Sb-Standard-Environment-SNMP-custom | Check hardware environment                                                                                    |
...
|:---------------------------|:-------------------------------------------------------------|:----------------------------------------------------------------|:----------:|
| Packet-Errors-Generic-Id   | Net-Cisco-Sb-Standard-Packet-Errors-Generic-Id-SNMP-custom   | Check packets on errors/discards of a network interface         |            |
| Packet-Errors-Generic-Name | Net-Cisco-Sb-Standard-Packet-Errors-Generic-Name-SNMP-custom | Check packets on errors/discards of a network interface         |            |
| Packet-Errors-Global       | Net-Cisco-Sb-Standard-Packet-Errors-Global-SNMP-custom       | Check packets on errors/discards of multiple network interfaces | X          |
| Spanning-Tree              | Net-Cisco-Sb-Standard-SpanningTree-SNMP-custom               | Check Spanning Tree state on interfaces                         |            |
