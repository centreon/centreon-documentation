...
description: "Monitor Cisco Small Business switches via SNMP: CPU, environment, packet errors, spanning tree, stack, and traffic."
---
...
The following monitoring connectors will be installed when you install the **Cisco Small Business SNMP** connector through the
...
|:--------------|:----------------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| Cpu           | Net-Cisco-Sb-Standard-Cpu-SNMP-custom         | Check the rate of utilization of CPU for the machine. This check can give the average utilization rate of CPU |
| Environment   | Net-Cisco-Sb-Standard-Environment-SNMP-custom | Check hardware environment (Fans, Power Supplies)                                                             |

> The services listed above are created automatically when the **Net-Cisco-Sb-Standard-SNMP-custom** host template is used.
...
|:---------------------------|:-------------------------------------------------------------|:-----------------------------------------------------------------------------|:---------:|
| Packet-Errors-Generic-Id   | Net-Cisco-Sb-Standard-Packet-Errors-Generic-Id-SNMP-custom   | Check packets in error and discarded packets for multiple network interfaces |           |
| Packet-Errors-Generic-Name | Net-Cisco-Sb-Standard-Packet-Errors-Generic-Name-SNMP-custom | Check packets in error and discarded packets for a network interface         |           |
| Packet-Errors-Global       | Net-Cisco-Sb-Standard-Packet-Errors-Global-SNMP-custom       | Check packets in error and discarded packets for multiple network interfaces |     X     |
| Spanning-Tree              | Net-Cisco-Sb-Standard-SpanningTree-SNMP-custom               | Monitor the status of the Spanning Tree Protocol on network interfaces       |           |
| Stack                      | Net-Cisco-Sb-Standard-Stack-SNMP-custom                      | Check stack members                                                          |           |
| Traffic-Generic-Id         | Net-Cisco-Sb-Standard-Traffic-Generic-Id-SNMP-custom         | Check traffic of an network interface                                        |           |
| Traffic-Generic-Name       | Net-Cisco-Sb-Standard-Traffic-Generic-Name-SNMP-custom       | Check traffic of an network interface                                        |           |
| Traffic-Global             | Net-Cisco-Sb-Standard-Traffic-Global-SNMP-custom             | Check traffic of multiple network interfaces                                 |     X     |
...
| Name                                           | Unit  |
|:-----------------------------------------------|:------|
| stack.members.detected.count                   | count |
| *members*~stack.member.connected.members.count | count |
| member-connection-status                       | N/A   |
...
3. Apply the **Net-Cisco-Sb-Standard-SNMP-custom** template to the host.
...
| Macro                          | Description                                                                                                                                                    | Default value | Mandatory |
|:-------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------|:---------:|
| WARNINGMEMBERCONNECTEDMEMBERS  | Thresholds                                                                                                                                                     |               |           |
| CRITICALMEMBERCONNECTEDMEMBERS | Thresholds                                                                                                                                                     |               |           |
| WARNINGMEMBERCONNECTIONSTATUS  | Set warning threshold for member connection status. You can use the following variables: %\{connectionStatus\}, %\{connectionSide\}, %\{connectedMemberUnit\}  |               |           |
| CRITICALMEMBERCONNECTIONSTATUS | Set critical threshold for member connection status. You can use the following variables: %\{connectionStatus\}, %\{connectionSide\}, %\{connectedMemberUnit\} |               |           |
...
```bash
OK: All interfaces are ok | 'interface_name1#interface.traffic.in.bitspersecond'=33b/s;80;90;; 'interface_name2#interface.traffic.in.bitspersecond'=21b/s;80;90;; 'interface_name1#interface.traffic.out.bitspersecond'=36b/s;80;90;; 'interface_name2#interface.traffic.out.bitspersecond'=51b/s;80;90;; 
```
...
| stack [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/cisco/smallbusiness/snmp/mode/stack.pm)]             | Net-Cisco-Sb-Standard-Stack-SNMP-custom                                                                                                                                                                                                                                                                                                                              |
...
|:------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --filter-counters                   | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                                      |
| --warning-member-connection-status  | Set warning threshold for member connection status. You can use the following variables: %\{connectionStatus\}, %\{connectionSide\}, %\{connectedMemberUnit\}  |
| --critical-member-connection-status | Set critical threshold for member connection status. You can use the following variables: %\{connectionStatus\}, %\{connectionSide\}, %\{connectedMemberUnit\} |
| --warning-members-detected          | Thresholds.                                                                                                                                                    |
| --critical-members-detected         | Thresholds.                                                                                                                                                    |
| --warning-member-connected-members  | Thresholds.                                                                                                                                                    |
| --critical-member-connected-members | Thresholds.                                                                                                                                                    |
