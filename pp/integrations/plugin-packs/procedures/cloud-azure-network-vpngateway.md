...
The following monitoring connectors will be installed when you install the **Azure VPN Gateway** connector through the
...
The Monitoring Connector **Azure VPN Gateway** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="Cloud-Azure-Network-VpnGateway-custom" label="Cloud-Azure-Network-VpnGateway-custom">
...
to the list of monitored hosts. This provider is named **Microsoft Azure VPN Gateway**.
...
| azvpngateway.p2s.connections.count                 | count |
...
| azvpngateway.tunnel.packets.in.count          | count |
| azvpngateway.tunnel.packets.out.count         | count |
| azvpngateway.tunnel.dropped.packets.in.count  | count |
| azvpngateway.tunnel.dropped.packets.out.count | count |
...
```bash
apt install centreon-pack-cloud-azure-network-vpngateway
```
...
2. Whatever the license type (*online* or *offline*), install the **Azure VPN Gateway** connector through
...
```bash
apt install centreon-plugin-cloud-azure-network-vpngateway-api
```
...
3. Apply the **Cloud-Azure-Network-VpnGateway-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| STATUSCRITICAL     | Define the conditions to match for the status to be CRITICAL (default: '%\{provisioning\_state\} ne "Succeeded"'). You can use the following variables: %\{provisioning\_state\}, %\{gateway\_type\}, %\{vpn\_type\}, %\{display\} | %\{status\} =~ /^Unavailable$/ |             |
...
| FILTERMETRIC             | Filter metrics (can be: 'AverageBandwidth', 'P2SBandwidth', 'P2SConnectionCount') (can be a regexp) |                   |             |
| WARNINGBANDWIDTHAVERAGE  | Threshold                                                                                           |                   |             |
| CRITICALBANDWIDTHAVERAGE | Threshold                                                                                           |                   |             |
| WARNINGP2SBANDWIDTH      | Threshold                                                                                           |                   |             |
| CRITICALP2SBANDWIDTH     | Threshold                                                                                           |                   |             |
| WARNINGP2SCONNECTIONS    | Threshold                                                                                           |                   |             |
| CRITICALP2SCONNECTIONS   | Threshold                                                                                           |                   |             |
...
| TIMEFRAME                 | Set timeframe in seconds (i.e. 3600 to check last hour)                                                                                                                                                      | 900               |             |
| INTERVAL                  | Set interval of the metric query (can be : PT1M, PT5M, PT15M, PT30M, PT1H, PT6H, PT12H, PT24H)                                                                                                               | PT5M              |             |
| FILTERMETRIC              | Filter metrics (can be: 'TunnelIngressBytes', 'TunnelEgressBytes', 'TunnelIngressPackets', 'TunnelEgressPackets', 'TunnelIngressPacketDropTSMismatch', 'TunnelEgressPacketDropTSMismatch') (can be a regexp) |                   |             |
| WARNINGDROPPEDPACKETSIN   | Threshold                                                                                                                                                                                                    |                   |             |
| CRITICALDROPPEDPACKETSIN  | Threshold                                                                                                                                                                                                    |                   |             |
| WARNINGDROPPEDPACKETSOUT  | Threshold                                                                                                                                                                                                    |                   |             |
| CRITICALDROPPEDPACKETSOUT | Threshold                                                                                                                                                                                                    |                   |             |
...
| CRITICALSTATUS | Define the conditions to match for the status to be CRITICAL (default: '%\{provisioning\_state\} ne "Succeeded"'). You can use the following variables: %\{provisioning\_state\}, %\{gateway\_type\}, %\{vpn\_type\}, %\{display\} | %\{provisioning\_state\} ne "Succeeded" |             |
| WARNINGSTATUS  | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{provisioning\_state\}, %\{gateway\_type\}, %\{vpn\_type\}, %\{display\}                                         |                                         |             |
| EXTRAOPTIONS   | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options).                                                                                                                                 |                                         |             |
...
|:---------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------|
| discovery [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/network/vpngateway/mode/discovery.pm)]                 | Used for host discovery                                      |
| health [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/network/vpngateway/mode/health.pm)]                       | Cloud-Azure-Network-VpnGateway-Health-Api-custom             |
| site-traffic [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/network/vpngateway/mode/sitetraffic.pm)]            | Cloud-Azure-Network-VpnGateway-Site-Traffic-Api-custom       |
| tunnel-traffic [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/network/vpngateway/mode/tunneltraffic.pm)]        | Cloud-Azure-Network-VpnGateway-Tunnel-Traffic-Api-custom     |
| vpn-gateway-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/azure/network/vpngateway/mode/vpngatewaystatus.pm)] | Cloud-Azure-Network-VpnGateway-Vpn-Gateway-Status-Api-custom |
...
| --resource         | Set resource name or ID (required).                                                                                                  |
| --resource-group   | Set resource group (required if resource's name is used).                                                                            |
| --filter-metric    | Filter metrics (can be: 'AverageBandwidth', 'P2SBandwidth', 'P2SConnectionCount') (can be a regexp).                                 |
| --warning-$label$  | Warning thresholds  ($label$ can be: 'bandwidth-average', 'p2s-bandwidth', p2s-connections)                                          |
| --critical-$label$ | Critical thresholds ($label$ can be: 'bandwidth-average', 'p2s-bandwidth', p2s-connections)                                          |
...
| --resource         | Set resource name or ID (required).                                                                                                                                                                           |
| --resource-group   | Set resource group (required if resource's name is used).                                                                                                                                                     |
| --filter-metric    | Filter metrics (can be: 'TunnelIngressBytes', 'TunnelEgressBytes', 'TunnelIngressPackets', 'TunnelEgressPackets', 'TunnelIngressPacketDropTSMismatch', 'TunnelEgressPacketDropTSMismatch') (can be a regexp). |
| --warning-$label$  | Warning thresholds. ($label$ can be traffic-in, traffic-out,  packets-in, packets-out, dropped-packets-in, dropped-packets-out)                                                                               |
| --critical-$label$ | Critical thresholds ($label$ can be traffic-in, traffic-out,  packets-in, packets-out, dropped-packets-in, dropped-packets-out)                                                                               |
...
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --filter-counters | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                                                                                                          |
| --resource-group  | Set resource group (required).                                                                                                                                                                                                     |
| --filter-name     | Filter vpn name (can be a regexp).                                                                                                                                                                                                 |
| --warning-status  | Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{provisioning\_state\}, %\{gateway\_type\}, %\{vpn\_type\}, %\{display\}                                         |
| --critical-status | Define the conditions to match for the status to be CRITICAL (default: '%\{provisioning\_state\} ne "Succeeded"'). You can use the following variables: %\{provisioning\_state\}, %\{gateway\_type\}, %\{vpn\_type\}, %\{display\} |
