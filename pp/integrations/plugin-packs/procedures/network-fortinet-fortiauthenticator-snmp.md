...
The Monitoring Connector **Fortinet Fortiauthenticator SNMP** brings a host template:
...
<Tabs groupId="sync">
<TabItem value="Net-Fortinet-Fortiauthenticator-SNMP-custom" label="Net-Fortinet-Fortiauthenticator-SNMP-custom">
...
|:--------------|:-------------------------------------------------------|:--------------------|:----------:|
| Interfaces    | Net-Fortinet-Fortiauthenticator-Interfaces-SNMP-custom | Check interfaces    | X          |
...
| Rule name                                           | Description                                                   |
|:----------------------------------------------------|:--------------------------------------------------------------|
| Net-Fortinet-Fortiauthenticator-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
...
2. Whatever the license type (*online* or *offline*), install the **Fortinet Fortiauthenticator SNMP** connector through
...
3. Apply the **Net-Fortinet-Fortiauthenticator-SNMP-custom** template to the host. 
...
|:-----------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------|
| authenticator [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiauthenticator/snmp/mode/authenticator.pm)] | Net-Fortinet-Fortiauthenticator-Authenticator-SNMP-custom |
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiauthenticator/snmp/mode/cpu.pm)]                     | Net-Fortinet-Fortiauthenticator-Cpu-SNMP-custom           |
| disk-log [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiauthenticator/snmp/mode/disklog.pm)]            | Net-Fortinet-Fortiauthenticator-Disk-Log-SNMP-custom      |
| ha [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiauthenticator/snmp/mode/ha.pm)]                       | Net-Fortinet-Fortiauthenticator-Ha-SNMP-custom            |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                                  | Net-Fortinet-Fortiauthenticator-Interfaces-SNMP-custom    |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)]                         | Used for service discovery                                |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/fortinet/fortiauthenticator/snmp/mode/memory.pm)]               | Net-Fortinet-Fortiauthenticator-Memory-SNMP-custom        |
