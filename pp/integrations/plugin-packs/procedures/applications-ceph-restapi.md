...
2. On the Centreon web interface, install the **Ceph RestAPI** Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page.
...
3. On the Centreon web interface, install the **Ceph RestAPI** Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page.
