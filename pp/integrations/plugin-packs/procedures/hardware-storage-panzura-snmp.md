...
The following monitoring connectors will be installed when you install the **Panzura SNMP** connector through the
...
The Monitoring Connector **Panzura SNMP** brings a host template:

* **HW-Storage-Panzura-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<TabItem value="HW-Storage-Panzura-SNMP-custom" label="HW-Storage-Panzura-SNMP-custom">
...
> The services listed above are created automatically when the **HW-Storage-Panzura-SNMP-custom** host template is used.
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Storage-Panzura-SNMP-custom** host template. |
...
| Rule name                                  | Description                                                           |
|:-------------------------------------------|:----------------------------------------------------------------------|
| HW-Storage-Panzura-SNMP-Packet-Errors-Name | Discover network interfaces and monitor errored and discarded packets |
| HW-Storage-Panzura-SNMP-Traffic-Name       | Discover network interfaces and monitor errored and discarded packets |
...
<Tabs groupId="sync">
<TabItem value="Cpu-Cloud" label="Cpu-Cloud">
...
<TabItem value="Disk-Usage-Cloud-*" label="Disk-Usage-Cloud-*">
...
> Applies to the following service templates: Disk-Usage-Cloud-Generic-Name, Disk-Usage-Cloud-Global

> To obtain this new metric format, include **--use-new-perfdata** in the **EXTRAOPTIONS** service macro.

</TabItem>
<TabItem value="Disk-Usage-Local" label="Disk-Usage-Local">
...
<TabItem value="Ratios" label="Ratios">

| Name                             | Unit  |
|:---------------------------------|:------|
| system.deduplication.ratio.count | count |
| system.compression.ratio.count   | count |
| system.save.ratio.count          | count |
...
```bash
dnf install centreon-pack-hardware-storage-panzura-snmp
```
...
```bash
apt install centreon-pack-hardware-storage-panzura-snmp
```
...
```bash
yum install centreon-pack-hardware-storage-panzura-snmp
```

</TabItem>
</Tabs>

2. Whatever the license type (*online* or *offline*), install the **Panzura SNMP** connector through
...
```bash
dnf install centreon-plugin-Hardware-Storage-Panzura-Snmp
```
...
```bash
apt install centreon-plugin-hardware-storage-panzura-snmp
```
...
3. Apply the **HW-Storage-Panzura-SNMP-custom** template to the host. 
...
| Macro         | Description                                                                                                                            | Default value     | Mandatory   |
|:--------------|:---------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| DISKNAME      | Specify the device to be checked (number expected) example: 1, 2,... (empty means 'check all devices')                                 |                   |             |
...
| Macro         | Description                                                                                                                            | Default value     | Mandatory   |
|:--------------|:---------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| FILTER        | Specify the device to be checked (number expected) example: 1, 2,... (empty means 'check all devices')                                 | .*                |             |
| CRITICALREAD  | Threshold                                                                                                                              |                   |             |
| WARNINGREAD   | Threshold                                                                                                                              |                   |             |
| CRITICALWRITE | Threshold                                                                                                                              |                   |             |
| WARNINGWRITE  | Threshold                                                                                                                              |                   |             |
...
<TabItem value="Disk-Usage-Cloud-Generic-Name" label="Disk-Usage-Cloud-Generic-Name">

| Macro        | Description                                                                                                                            | Default value     | Mandatory   |
|:-------------|:---------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| DISKPATH     | Specify the path of the disk you want to check (number expected) example: 1, 2,... (empty means 'check all disks path').               |                   |             |
| CRITICAL     | Threshold                                                                                                                              |                   |             |
| WARNING      | Threshold                                                                                                                              |                   |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |

</TabItem>
<TabItem value="Disk-Usage-Cloud-Global" label="Disk-Usage-Cloud-Global">

| Macro        | Description                                                                                                                            | Default value     | Mandatory   |
|:-------------|:---------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| FILTER       | Specify the path of the disk you want to check (number expected) example: 1, 2,... (empty means 'check all disks path').               | .*                |             |
| CRITICAL     | Threshold                                                                                                                              |                   |             |
| WARNING      | Threshold                                                                                                                              |                   |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options). | --verbose         |             |
...
| Macro         | Description                                                                                                                            | Default value     | Mandatory   |
|:--------------|:---------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| CRITICALCOMP  | Threshold                                                                                                                              |                   |             |
| WARNINGCOMP   | Threshold                                                                                                                              |                   |             |
| CRITICALDEDUP | Threshold                                                                                                                              |                   |             |
| WARNINGDEDUP  | Threshold                                                                                                                              |                   |             |
| WARNINGDESAVE | Threshold                                                                                                                              |                   |             |
| CRITICALSAVE  | Threshold                                                                                                                              |                   |             |
| EXTRAOPTIONS  | Any extra option you may want to add to the command (a --verbose flag for example). All options are listed [here](#available-options). | --verbose         |             |
...
```bash
/usr/lib/centreon/plugins/centreon_panzura.pl \
	--plugin=storage::panzura::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:-------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cpu-cloud [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/panzura/snmp/mode/cpucloud.pm)]              | HW-Storage-Panzura-Cpu-Cloud-SNMP-custom                                                                                                                                                                                                                                                                                                           |
| cpu-detailed [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/cpudetailed.pm)]               | HW-Storage-Panzura-Cpu-Detailed-SNMP-custom                                                                                                                                                                                                                                                                                                        |
| disk-usage-cloud [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/diskusage.pm)]             | HW-Storage-Panzura-Disk-Usage-Cloud-Generic-Name-SNMP-custom<br />HW-Storage-Panzura-Disk-Usage-Cloud-Global-SNMP-custom                                                                                                                                                                                                                           |
| disk-usage-local [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/panzura/snmp/mode/diskusagelocal.pm)] | HW-Storage-Panzura-Disk-Usage-Local-SNMP-custom                                                                                                                                                                                                                                                                                                    |
| diskio [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/diskio.pm)]                          | HW-Storage-Panzura-Disk-Io-Generic-Name-SNMP-custom<br />HW-Storage-Panzura-Disk-Io-Global-SNMP-custom                                                                                                                                                                                                                                             |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                  | HW-Storage-Panzura-Packet-Errors-Generic-Id-SNMP-custom<br />HW-Storage-Panzura-Packet-Errors-Generic-Name-SNMP-custom<br />HW-Storage-Panzura-Packet-Errors-Global-SNMP-custom<br />HW-Storage-Panzura-Traffic-Generic-Id-SNMP-custom<br />HW-Storage-Panzura-Traffic-Generic-Name-SNMP-custom<br />HW-Storage-Panzura-Traffic-Global-SNMP-custom |
...
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/loadaverage.pm)]                       | HW-Storage-Panzura-Load-SNMP-custom                                                                                                                                                                                                                                                                                                                |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/panzura/snmp/mode/memory.pm)]                   | HW-Storage-Panzura-Memory-SNMP-custom                                                                                                                                                                                                                                                                                                              |
| ratios [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/panzura/snmp/mode/ratios.pm)]                   | HW-Storage-Panzura-Ratios-SNMP-custom                                                                                                                                                                                                                                                                                                              |
| swap [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/swap.pm)]                              | HW-Storage-Panzura-Swap-SNMP-custom                                                                                                                                                                                                                                                                                                                |
...
|:------------------|:------------------------------------------------------------------------------------------------------------------------------|
| --filter-counters |   Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'   |
| --warning-*       |   Warning threshold. Can be: 'dedup', 'comp', 'save'.                                                                         |
| --critical-*      |   Critical threshold. Can be: 'dedup', 'comp', 'save'.                                                                        |
