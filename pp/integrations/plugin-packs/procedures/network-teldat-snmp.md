...
2. Whatever the license type (*online* or *offline*), install the **Teldat SNMP** connector through
...
| Option                      | Description                                                                                                                                                                                                                                             |
|:----------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --filter-cell-id            | Filter cell modules by id IMEI.                                                                                                                                                                                                                         |
| --custom-perfdata-instances | Define perfdatas instance (default: '%(cellId) %(operator)'). You can use the following variables: %{cellId}, %{simIcc}, %{operator}                                                                                                                    |
...
| --name                   | Allows to use interface name with option --interface instead ofinterface oid index (Can be a regexp)                                                                                                                                                                                       |
