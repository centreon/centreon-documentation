...
To get started, create your plugin: for example, you can use [our developer guide](https://docs.centreon.com/pp/integrations/plugin-packs/dev-resources/introduction.md).
