...
| Customizable check commands | These scripts remain compatible with the Centreon Monitoring Agent. You will need to adapt the commands (or duplicate them to work in double run mode). A [detailed guide](cma-custom.md) isavailable. |
