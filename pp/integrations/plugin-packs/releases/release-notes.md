...
- [**Elasticsearch**](../procedures/applications-databases-elasticsearch.md) - Added new mode **query**.
- [**Extreme (formerly Nortel/Avaya) SNMP**](../procedures/network-nortel-standard-snmp.md) - **Nortel standard SNMP** rebranded to Extreme SNMP category. 
- [**Linux NRPE3**](../procedures/operatingsystems-linux-nrpe3.md) - Convert to deprecated, please use [**Linux NRPE4**](../procedures/operatingsystems-linux-nrpe4.md).
- [**Office 365 Management**](../procedures/cloud-microsoft-office365-management.md) - Added `filter-classification` option in **service-status** mode.
...
- [**VMware8 ESXi REST API**](../procedures/applications-virtualization-vmware8-esx-restapi.md) - Enhance performance by implementing cache and handles pagination for **acq-specs**.
- [**VMware8 vCenter REST API**](../procedures/applications-virtualization-vmware8-vcenter-restapi.md) - Enhance performance by implementing cache and handles pagination for **acq-specs**.
- [**VMware8 VM REST API**](../procedures/applications-virtualization-vmware8-vm-restapi.md) - Added new modes **disk-io**, **network** and **power**; enhance performance by implementing cache and handles pagination for **acq-specs**.

</TabItem>
<TabItem value="Breaking changes" label="Breaking changes">

- [**Elasticsearch**](../procedures/applications-databases-elasticsearch.md) - Host macro `ELASTICSEARCHPROTO` default value is now `https` to follow Elasticsearch recomendations (see [here](https://www.elastic.co/docs/deploy-manage/security/set-up-minimal-security)).
- [**VMware8 ESX REST API**](../procedures/application-virtualization-vmware8-esx-restapi.md) - Changed options for **power** mode.

</TabItem>
<TabItem value="Bug fixes" label="Bug fixes">

- [**Commvault Commserve Rest API**](../procedures/applications-commvault-commserve-restapi.md) - Fixed an error in jobs mode when output was too long.
...
- [**IBM Storwize SSH**](../procedures/hardware-storage-ibm-storwize-ssh.md) - Fixed an issue while parsing response, from community contribution [PR 5697](https://github.com/centreon/centreon-plugins/pull/5697).
- [**InfluxDB**](../procedures/applications-databases-influxdb.md) - Fixed an error in **query** mode command.
- [**Microsoft SQL Server**](../procedures/applications-databases-mssql.md) - Fixed an issue where **deadlocks** mode returns false positive.
- [**Office 365 Management**](../procedures/cloud-microsoft-office365-management.md) - Fixed an issue where each new alert for a service overwrites the previous one, making it impossible to have a global vision in **service-status**.
