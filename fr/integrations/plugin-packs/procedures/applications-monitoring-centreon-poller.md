...
SNMP doit être configuré sur chaque collecteur supervisé. Vous pouvez vous aider de cette [documentation](../operatingsystems-linux-snmp.html#prerequisites) pour mettre en place rapidement une simple configuration SNMP. 
...
Rendez-vous sur la [documentation dédiée](../tutorials/troubleshooting-plugins.html) pour le diagnostic des erreurs communes des Plugins Centreon.