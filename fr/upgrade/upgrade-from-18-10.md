...
Centreon depuis la version 18.10 vers la version 21.10.
...
```
Ensuite, vous devez changer le flux PHP de la version 7.1 à 8.0 en exécutant les commandes suivantes et en répondant **y**
pour confirmer :
```shell
