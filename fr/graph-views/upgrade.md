...
& custom procedures. Please note that [applying a fix](../graph-views/troubleshooter.html#metric-links-are-black-after-updating-map) may be necessary if you upgrade MAP to version 21.10.1 or later.
