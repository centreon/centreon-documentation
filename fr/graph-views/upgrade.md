...
& custom procedures. Please note that [applying a fix](../graph-views/troubleshooter.html#metric-links-are-black-after-updating-map) may be necessary if you upgrade MAP to version 20.10.6 or later.
