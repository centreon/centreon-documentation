...
Les widgets de Centreon MBI s"utilisent dans les [vues personnalisées](../getting-started/create-custom-view.html) de Centreon. Il vous est de ce fait possible de créer des
