...
* [UI] Check session id in popup (PR/#8326)
...
* Fix RCE on mib import from manufacturer input (PR/#8023)
* Don't return js (PR/#8095)
* Avoid SQL injections in multiple monitoring pages (PR/#8063)
* Fix call of host macros list without authentication (PR/#8037)
* Fix call of service macros list without authentication (PR/#8035)
* Bump terser-webpack-plugin to 1.4.2 (PR/#8182)
* Upgrade javascript dependencies (handlebars) (PR/#8224)
* Improve authentication messages in login.log (PR/#7943)
* Remove session id parameter (PR/#8291)
