...
* [Amelioration] Le protocole TLS pour communiquer avec le composant Broker a été implémenter
...
* [Fix] Ajouter ou supprimer un Downtown depuis l'interface web causait parfois une rupture de connexion avec Broker
...
* [Fix] Des événements WhatsUp était levés inutilement lors de sessions web causant parfois des baisses de performance
