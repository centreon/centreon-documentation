...
filtrage de ces objets au sein [d’ACL](../administration/access-control-lists.html). Les catégories sont également utilisées pour définir des types d’objets au sein
du module [Centreon MAP](../graph-views/introduction.html) ou pour classer les objets au sein de sous-groupes dans le module [Centreon BI](../reporting/introduction.html).
