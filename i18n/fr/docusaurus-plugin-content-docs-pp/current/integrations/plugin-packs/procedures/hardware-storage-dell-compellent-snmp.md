...
Le connecteur de supervision **Dell Compellent SNMP** apporte un modèle d'hôte :

* **HW-Storage-Dell-Compellent-SNMP-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<TabItem value="HW-Storage-Dell-Compellent-SNMP-custom" label="HW-Storage-Dell-Compellent-SNMP-custom">

| Alias           | Modèle de service                                      | Description          |
|:----------------|:-------------------------------------------------------|:---------------------|
| Hardware-Global | HW-Storage-Dell-Compellent-Hardware-Global-SNMP-custom | Contrôle le matériel |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-Dell-Compellent-SNMP-custom** est utilisé.
...
```bash
dnf install centreon-pack-hardware-storage-dell-compellent-snmp
```
...
```bash
yum install centreon-pack-hardware-storage-dell-compellent-snmp
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Dell Compellent SNMP**
...
```bash
dnf install centreon-plugin-Hardware-Storage-Dell-Compellent-Snmp
```
...
3. Appliquez le modèle d'hôte **HW-Storage-Dell-Compellent-SNMP-custom**.
...
| Macro        | Description                                                                                                                                                                                                   | Valeur par défaut | Obligatoire |
|:-------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'ctrl', 'disk', 'diskfolder', 'encl', 'ctrlfan', 'ctrlpower', 'ctrlvoltage', 'ctrltemp', 'enclfan', 'enclpower', 'encliomod', 'encltemp', 'volume', 'cache', 'server', 'sc' | .*                |             |
...
```bash
/usr/lib/centreon/plugins/centreon_dell_compellent.pl \
...
|:----------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| global-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/dell/compellent/snmp/mode/globalstatus.pm)] | Not used in this Monitoring Connector                                                                                                                                                 |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/dell/compellent/snmp/mode/hardware.pm)]          | HW-Storage-Dell-Compellent-Hardware-Global-SNMP-custom                                                                                                                                |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                     | HW-Storage-Dell-Compellent-Traffic-Generic-Id-SNMP-custom<br />HW-Storage-Dell-Compellent-Traffic-Generic-Name-SNMP-custom<br />HW-Storage-Dell-Compellent-Traffic-Global-SNMP-custom |
...
| --filter             | Exclude the items given as a comma-separated list (example: --filter=ctrlfan --filter=enclpower). You can also exclude items from specific instances: --filter=ctrlfan,1                                                         |
| --add-name-instance  | Add literal description for instance value (used in filter and threshold options).                                                                                                                                               |
| --no-component       | Define the expected status if no components are found (default: critical).                                                                                                                                                       |
| --threshold-overload | Use this option to override the status returned by the plugin when the status label matches a regular expression (syntax: section,\[instance,\]status,regexp). Example: --threshold-overload='ctrl,CRITICAL,^(?!(up)$)'          |
| --warning            | Set warning threshold for 'ctrltemp', 'ctrlfan', 'ctrlvoltage', 'encltemp' (syntax: type,regexp,threshold) Example: --warning='ctrltemp,1,30'                                                                                    |
| --critical           | Set critical threshold for 'ctrltemp', 'ctrlfan', 'ctrlvoltage', 'encltemp' (syntax: type,regexp,threshold) Example: --critical='ctrltemp,1,50'                                                                                  |
