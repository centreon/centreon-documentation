...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Centreon SQL Metrics** 
...
| CENTREONDATABASEPASSWORD | Password for the defined user                                                                                                                      | PASSWORD          | X           |
| CENTREONDATABASE         | Centreon database name                                                                                                                             | centreon          |             |
| CENTREONSTORAGEDATABASE  | Set the Centreon storage database name, only alphanumeric characters and underscores are allowed                                                   | centreon\_storage |             |
...
| WARNINGHOSTQUEUECACHE   | Threshold                                                                                                                                        |                   |             |
| CRITICALHOSTQUEUECACHE  | Threshold                                                                                                                                        |                   |             |
| WARNINGTOTALQUEUECACHE  | Threshold                                                                                                                                        |                   |             |
| CRITICALTOTALQUEUECACHE | Threshold                                                                                                                                        |                   |             |
| WARNINGTOTALQUEUELOCK   | Threshold                                                                                                                                        |                   |             |
| CRITICALTOTALQUEUELOCK  | Threshold                                                                                                                                        |                   |             |
...
| FILTERPOLLER                 | Filter by poller name (regexp can be used)                                                                                                       |                   |             |
| WARNINGHOSTDOWNCOUNT         | Threshold                                                                                                                                        |                   |             |
| CRITICALHOSTDOWNCOUNT        | Threshold                                                                                                                                        |                   |             |
| WARNINGHOSTUNREACHABLECOUNT  | Threshold                                                                                                                                        |                   |             |
| CRITICALHOSTUNREACHABLECOUNT | Threshold                                                                                                                                        |                   |             |
| WARNINGSVCWARNINGCOUNT       | Threshold                                                                                                                                        |                   |             |
| WARNINGSVCCRITICALCOUNT      | Threshold                                                                                                                                        |                   |             |
| CRITICALSVCWARNINGCOUNT      | Threshold                                                                                                                                        |                   |             |
| CRITICALSVCCRITICALCOUNT     | Threshold                                                                                                                                        |                   |             |
| WARNINGSVCUNKNOWNCOUNT       | Threshold                                                                                                                                        |                   |             |
| CRITICALSVCUNKNOWNCOUNT      | Threshold                                                                                                                                        |                   |             |
| EXTRAOPTIONS                 | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
...
| WARNINGMETRIC  | Threshold                                                                                                                                        |                   |             |
| CRITICALMETRIC | Threshold                                                                                                                                        |                   |             |
| EXTRAOPTIONS   | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
/usr/lib/centreon/plugins/centreon_centreon_sql_metrics.pl \
	...
	--password='PASSWORD' \
	--filter-counters='' \
	--centreon-storage-database='centreon\_storage' \
	--filter-poller='' \
...
|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------|
| backup [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/backup.pm)]                                     | Non utilisé dans ce connecteur de supervision           |
...
| connection-time [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/protocols/sql/mode/connectiontime.pm)]     | Non utilisé dans ce connecteur de supervision           |
...
| databases-size [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/databasessize.pm)]                      | Non utilisé dans ce connecteur de supervision           |
...
| innodb-bufferpool-hitrate [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/innodbbufferpoolhitrate.pm)] | Non utilisé dans ce connecteur de supervision           |
| long-queries [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/longqueries.pm)]                          | Non utilisé dans ce connecteur de supervision           |
| myisam-keycache-hitrate [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/myisamkeycachehitrate.pm)]     | Non utilisé dans ce connecteur de supervision           |
| name [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/db_socket.pm)]                                                        | Non utilisé dans ce connecteur de supervision           |
| open-files [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/openfiles.pm)]                              | Non utilisé dans ce connecteur de supervision           |
| open-tables [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/opentables.pm)]                            | Non utilisé dans ce connecteur de supervision           |
...
| password-expiration [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/passwordexpiration.pm)]            | Non utilisé dans ce connecteur de supervision           |
...
| qcache-hitrate [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/qcachehitrate.pm)]                      | Non utilisé dans ce connecteur de supervision           |
| queries [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/queries.pm)]                                   | Non utilisé dans ce connecteur de supervision           |
| replication [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/replication.pm)]                           | Non utilisé dans ce connecteur de supervision           |
| slow-queries [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/slowqueries.pm)]                          | Non utilisé dans ce connecteur de supervision           |
| sql [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/protocols/sql/mode/sql.pm)]                            | Non utilisé dans ce connecteur de supervision           |
...
| threads-connected [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/threadsconnected.pm)]                | Non utilisé dans ce connecteur de supervision           |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/database/mysql/mode/uptime.pm)]                                     | Non utilisé dans ce connecteur de supervision           |
...
| Option                       | Description                                                                                                                      |
|:-----------------------------|:---------------------------------------------------------------------------------------------------------------------------------|
| --centreon-storage-database  | Set the Centreon storage database name, only alphanumeric characters and underscores are allowed (default: 'centreon\_storage'). |
...
| --warning-host-queue-cache   | Threshold.                                                                                                                       |
| --critical-host-queue-cache  | Threshold.                                                                                                                       |
| --warning-total-queue-cache  | Threshold.                                                                                                                       |
| --critical-total-queue-cache | Threshold.                                                                                                                       |
| --warning-total-queue-lock   | Threshold.                                                                                                                       |
| --critical-total-queue-lock  | Threshold.                                                                                                                       |
...
| --critical-count            | Threshold.                                                                                                                       |
| --warning-list              | Threshold.                                                                                                                       |
| --critical-list             | Threshold.                                                                                                                       |
...
| --warning-hosts-down         | Threshold.                                                                                                                       |
| --critical-hosts-down        | Threshold.                                                                                                                       |
| --warning-hosts-pending      | Threshold.                                                                                                                       |
| --critical-hosts-pending     | Threshold.                                                                                                                       |
| --warning-hosts-unreachable  | Threshold.                                                                                                                       |
| --critical-hosts-unreachable | Threshold.                                                                                                                       |
| --warning-hosts-up           | Threshold.                                                                                                                       |
| --critical-hosts-up          | Threshold.                                                                                                                       |
| --warning-service            | Threshold.                                                                                                                       |
| --critical-service           | Threshold.                                                                                                                       |
| --warning-services-critical  | Threshold.                                                                                                                       |
| --critical-services-critical | Threshold.                                                                                                                       |
| --warning-services-ok        | Threshold.                                                                                                                       |
| --critical-services-ok       | Threshold.                                                                                                                       |
| --warning-services-pending   | Threshold.                                                                                                                       |
| --critical-services-pending  | Threshold.                                                                                                                       |
| --warning-services-unknown   | Threshold.                                                                                                                       |
| --critical-services-unknown  | Threshold.                                                                                                                       |
| --warning-services-warning   | Threshold.                                                                                                                       |
| --critical-services-warning  | Threshold.                                                                                                                       |
...
| Option            | Description                                                                                                                      |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------|
| --database        | Set the Centreon storage database name, only alphanumeric characters and underscores are allowed (default: 'centreon\_storage'). |
| --config-file     | Specify the full path to a json config file.                                                                                     |
| --json-data       | Specify the full path to a json config file.                                                                                     |
| --filter-counters | Filter some counter (can be 'metric' or 'global') Useless, if you use selection/filter but not global/virtual curves.            |
| --warning-global  | Threshold.                                                                                                                       |
| --critical-global | Threshold.                                                                                                                       |
