...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Symantec Netbackup CMA** 
...
Le connecteur de supervision **Symantec Netbackup CMA** apporte un modèle d'hôte :
...
| Alias      | Modèle de service                   | Description                                              |
|:-----------|:------------------------------------|:---------------------------------------------------------|
| Tape-Usage | App-Netbackup-Tape-Usage-CMA-custom | Contrôle permettant de vérifier l'utilisation des bandes |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Symantec Netbackup CMA**
...
3. Appliquez le modèle d'hôte **App-Netbackup-CMA-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
