...
Le connecteur de supervision **Lenovo XCC SNMP** apporte un modèle d'hôte :
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Server-Lenovo-Xcc-SNMP-custom**. |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Lenovo XCC SNMP**
...
3. Appliquez le modèle d'hôte **HW-Server-Lenovo-Xcc-SNMP-custom**.
