...
|:------------------|:------------------------------------------|:--------------------------------------------------|
| Path-Verification | App-Ipfabric-Path-Verification-Api-custom | Contrôle permettant de vérifier l'état des routes |
...
| EXTRAOPTIONS            | Any extra option you may want to add to the command (E.g. a --verbose flag). Toutes les options sont listées [ici](#options-disponibles)                                                                                                                                                                                                                  | --http-backend=curl            |             |
