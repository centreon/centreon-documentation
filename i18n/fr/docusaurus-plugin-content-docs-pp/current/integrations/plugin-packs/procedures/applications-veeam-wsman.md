...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Veeam WSMAN** 
...
| WSMANPATH         | Define the path of the WSMAN URL if it has been customized                                                                                         | /wsman            |             |
| WSMANSCHEME       | Define the transport scheme                                                                                                                        | http              |             |
...
```bash
OK: detected jobs: 67643 success: 58817 failed: 72754 warning: 39751 All SureBackup jobs are ok | 'sure_backup.jobs.detected.count'=67643;;;0; 'sure_backup.jobs.success.count'=58817;;;0; 'sure_backup.jobs.failed.count'=72754;;;0; 'sure_backup.jobs.warning.count'=39751;;;0; 
```
