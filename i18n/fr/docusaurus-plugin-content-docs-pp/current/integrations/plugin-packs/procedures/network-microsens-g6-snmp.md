...
Le connecteur de supervision **Microsens G6 SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="Net-Microsens-G6-SNMP-custom" label="Net-Microsens-G6-SNMP-custom">

| Alias        | Modèle de service                         | Description                                                                                                                                                                        |
|:-------------|:------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cpu-Detailed | Net-Microsens-G6-Cpu-Detailed-SNMP-custom | Contrôle du taux d'utilisation détaillé CPU de la machine. Ce contrôle pourra remonter la moyenne du taux d'utilisation des CPU ainsi que le taux par CPU pour les CPU multi-coeur |
| Hardware     | Net-Microsens-G6-Hardware-SNMP-custom     | Contrôle du matériel                                                                                                                                                               |
| Load         | Net-Microsens-G6-Load-SNMP-custom         | Contrôle de la charge serveur                                                                                                                                                      |
| Memory       | Net-Microsens-G6-Memory-SNMP-custom       | Contrôle du taux d'utilisation de la mémoire vive                                                                                                                                  |
| Uptime       | Net-Microsens-G6-Uptime-SNMP-custom       | Durée depuis laquelle le serveur tourne sans interruption                                                                                                                          |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Microsens-G6-SNMP-custom** est utilisé.
...
|:-----------|:----------------------------------------|:------------------------|:----------:|
| Interfaces | Net-Microsens-G6-Interfaces-SNMP-custom | Contrôle les interfaces | X          |
| Sfp        | Net-Microsens-G6-Sfp-SNMP-custom        | Contrôle les ports SFP  | X          |
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Microsens-G6-SNMP-custom** |
...
| Nom de la règle                      | Description                                                             |
|:-------------------------------------|:------------------------------------------------------------------------|
| Net-Microsens-G6-SNMP-Interface-Name | Découvre les interfaces réseau et en supervise le statut et l'utilisation |
| Net-Microsens-G6-SNMP-Sfp-Port       | Découvre les ports SFP et en supervise le statut et l'utilisation                                                                        |
...
| psu status                          | Status of the power supply         | N/A      |
| sd card status                      | Status/health/state of the SD card | N/A      |
...
|:-------------------------------|:------|
| *sfp*~status                   | N/A   |
| *sfp*~port.input.power.dbm     | dBm   |
| *sfp*~port.output.power.dbm    | dBm   |
| *sfp*~port.temperature.celsius | C     |
...
Veuillez vous référer à la [documentation officielle](https://www.microsens.com/fileadmin/files/downloads/Application_notes/AN-16010_Basic_Config_of_G6_Devices_v1.0.1.pdf) du constructeur/éditeur. 
...
```bash
dnf install centreon-pack-network-microsens-g6-snmp
```
...
```bash
apt install centreon-pack-network-microsens-g6-snmp
```
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Microsens G6 SNMP**
...
```bash
dnf install centreon-plugin-Network-Microsens-G6-Snmp
```
...
```bash
apt install centreon-plugin-network-microsens-g6-snmp
```
...
3. Appliquez le modèle d'hôte **Net-Microsens-G6-SNMP-custom**.
...
| Macro        | Description                                                                                        | Valeur par défaut | Obligatoire |
|:-------------|:---------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check (default: '.*'). Can be: 'fan', 'psu', 'sdcard', 'temperature'            |                   |             |
...
| Macro               | Description                                                                                                                                                                                       | Valeur par défaut                                 | Obligatoire |
|:--------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------|:-----------:|
| FILTERPORT          | Filter ports by index (can be a regexp)                                                                                                                                                           |                                                   |             |
| WARNINGINPUTPOWER   | Thresholds                                                                                                                                                                                        |                                                   |             |
| CRITICALINPUTPOWER  | Thresholds                                                                                                                                                                                        |                                                   |             |
| WARNINGOUTPUTPOWER  | Thresholds                                                                                                                                                                                        |                                                   |             |
| CRITICALOUTPUTPOWER | Thresholds                                                                                                                                                                                        |                                                   |             |
| CRITICALSTATUS      | Define the conditions to match for the status to be CRITICAL (default: '%\{status\} =~ /txFailure\|lossOfSignal\|readError/'). You can use the following variables: %\{status\}, %\{port\}, %\{location\} | %\{status\} =~ /txFailure\|lossOfSignal\|readError/ |             |
| WARNINGSTATUS       | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{status\}, %\{name\}, %\{location\}                                                                 |                                                   |             |
...
/usr/lib/centreon/plugins/centreon_microsens_g6_snmp.pl \
	...
	--filter-port='' \
	--warning-status='' \
	--critical-status='%\{status\} =~ /txFailure|lossOfSignal|readError/' \
	--warning-temperature='' \
...
```bash
OK: input power: 49 dBm output power: 72 dBm temperature: 17 C | '*sfp*~port.input.power.dbm'=49dBm;;;;'*sfp*~port.output.power.dbm'=72dBm;;;;'*sfp*~port.temperature.celsius'=17C;;;;
```
...
|:-----------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------|
| cpu-detailed [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/cpudetailed.pm)] | Net-Microsens-G6-Cpu-Detailed-SNMP-custom |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/hardware.pm)]        | Net-Microsens-G6-Hardware-SNMP-custom     |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/interfaces.pm)]    | Net-Microsens-G6-Interfaces-SNMP-custom   |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)]       | Used for service discovery                |
| list-sfp [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/listsfp.pm)]         | Used for service discovery                |
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/load.pm)]                | Net-Microsens-G6-Load-SNMP-custom         |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/memory.pm)]            | Net-Microsens-G6-Memory-SNMP-custom       |
| sfp [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/sfp.pm)]                  | Net-Microsens-G6-Sfp-SNMP-custom          |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/microsens/g6/snmp/mode/uptime.pm)]            | Net-Microsens-G6-Uptime-SNMP-custom       |
...
|:---------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --component          | Which component to check (default: '.*'). Can be: 'fan', 'psu', 'sdcard', 'temperature'.                                                                                                                              |
| --filter             | Exclude the items given as a comma-separated list (example: --filter=fan). You can also exclude items from specific instances: --filter=psu,2                                                                         |
| --no-component       | Define the expected status if no components are found (default: critical).                                                                                                                                            |
| --threshold-overload | Use this option to override the status returned by the plugin when the status label matches a regular expression (syntax: section,\[instance,\]status,regexp). Example: --threshold-overload='sdcard,WARNING,empty'   |
...
| Option                   | Description                                                                                                                                                                                         |
|:-------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --filter-port            | Filter ports by index (can be a regexp).                                                                                                                                                            |
| --warning-status         | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{status\}, %\{name\}, %\{location\}                                                                   |
| --critical-status        | Define the conditions to match for the status to be CRITICAL (default: '%\{status\} =~ /txFailure\|lossOfSignal\|readError/'). You can use the following variables: %\{status\}, %\{port\}, %\{location\}   |
| --warning-* --critical-* | Thresholds. Can be: 'temperature', 'input-power', 'output-power'.                                                                                                                                   |
