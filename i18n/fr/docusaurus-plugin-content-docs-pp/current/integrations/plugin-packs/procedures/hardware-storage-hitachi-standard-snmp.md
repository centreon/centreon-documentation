...
slug: /hardware-storage-hitachi-standard-snmp
...
<Tabs groupId="sync">
<TabItem value="HW-Storage-Hitachi-Standard-SNMP-custom" label="HW-Storage-Hitachi-Standard-SNMP-custom">

| Alias           | Modèle de service                                       | Description                     |
|:----------------|:--------------------------------------------------------|:--------------------------------|
| Hardware-Global | HW-Storage-Hitachi-Standard-Hardware-Global-SNMP-custom | Contrôle l'ensemble du matériel |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-Hitachi-Standard-SNMP-custom** est utilisé.
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Storage-Hitachi-Standard-SNMP-custom** |
...
```bash
dnf install centreon-pack-hardware-storage-hitachi-standard-snmp
```
...
```bash
yum install centreon-pack-hardware-storage-hitachi-standard-snmp
```
...
```bash
dnf install centreon-plugin-Hardware-Storage-Hitachi-Standard-Snmp
```
...
3. Appliquez le modèle d'hôte **HW-Storage-Hitachi-Standard-SNMP-custom**.
...
```bash
/usr/lib/centreon/plugins/centreon_hitachi_standard_snmp.pl \
	--plugin=storage::hitachi::standard::snmp::plugin \
	--mode=hardware \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:--------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------|
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/hitachi/standard/snmp/mode/hardware.pm)] | HW-Storage-Hitachi-Standard-Hardware-Global-SNMP-custom |
...
| --filter                                   | Exclude the items given as a comma-separated list (example: --filter=dkc). You can also exclude items from specific instances: --filter=dkc,1.fan                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --no-component                             | Define the expected status if no components are found (default: critical).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --threshold-overload                       | Use this option to override the status returned by the plugin when the status label matches a regular expression (syntax: section,\[instance,\]status,regexp). Example: --threshold-overload='component,NAS Server,OK,abnormal'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
