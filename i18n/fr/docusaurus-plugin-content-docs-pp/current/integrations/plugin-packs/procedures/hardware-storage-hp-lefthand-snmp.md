...
Le connecteur de supervision **HP Lefthand SNMP** apporte un modèle d'hôte :
...
| *volume*#read               | B/s   |
| *volume*#write              | B/s   |
| *volume*#read-iops          | iops  |
| *volume*#write-iops         | iops  |
| *volume*#read-latency       | ms    |
| *volume*#write-latency      | ms    |
| *volume*#replication-status | N/A   |
...
```bash
dnf install centreon-pack-hardware-storage-hp-lefthand-snmp
```
...
```bash
yum install centreon-pack-hardware-storage-hp-lefthand-snmp
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **HP Lefthand SNMP**
...
```bash
dnf install centreon-plugin-Hardware-Storage-Hp-Lefthand-Snmp
```
...
3. Appliquez le modèle d'hôte **HW-Storage-Hp-Lefthand-SNMP-custom**.
...
```bash
/usr/lib/centreon/plugins/centreon_hp_lefthand.pl \
...
|:----------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------|
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/hp/lefthand/snmp/mode/hardware.pm)]        | HW-Storage-Hp-Lefthand-Hardware-Global-SNMP-custom     |
| volume-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/hp/lefthand/snmp/mode/volumeusage.pm)] | HW-Storage-Hp-Lefthand-Volume-Usage-Global-SNMP-custom |
...
| --warning            | Set warning threshold for 'temperature', 'voltage', 'fan', 'device.temperature' (syntax: type,regexp,threshold) Example: --warning='temperature,.*,30'                                                             |
| --critical           | Set critical threshold for 'temperature', 'voltage', 'fan', 'device.temperature' (syntax: type,regexp,threshold) Example: --critical='temperature,.*,50'                                                           |
