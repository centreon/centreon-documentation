...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Ruckus Smartzone SNMP** 
...
Le connecteur de supervision **Ruckus Smartzone SNMP** apporte un modèle d'hôte :
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Ruckus-Smartzone-SNMP-custom**. |
...
Référez vous à la [documentation officielle](http://docs.ruckuswireless.com/smartzone/3.6.1/sz100-vsze-administrator-guide/GUID-F08BF334-2116-47A5-900C-B6AA4FC5E62A). 
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Ruckus Smartzone SNMP**
...
3. Appliquez le modèle d'hôte **Net-Ruckus-Smartzone-SNMP-custom**.
...
| WARNINGCONNECTIONCLIENTDEVICESAUTHORIZED  | Threshold                                                                                                                                                                   |                   |             |
| CRITICALCONNECTIONCLIENTDEVICESAUTHORIZED | Threshold                                                                                                                                                                   |                   |             |
...
| Macro                                     | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| WARNINGCONNECTIONACCESSPOINTS             | Threshold                                                                                                                                        |                   |             |
| CRITICALCONNECTIONACCESSPOINTS            | Threshold                                                                                                                                        |                   |             |
| WARNINGCONNECTIONCLIENTDEVICESAUTHORIZED  | Threshold                                                                                                                                        |                   |             |
| CRITICALCONNECTIONCLIENTDEVICESAUTHORIZED | Threshold                                                                                                                                        |                   |             |
| WARNINGTRAFFICIN                          | Threshold                                                                                                                                        |                   |             |
| CRITICALTRAFFICIN                         | Threshold                                                                                                                                        |                   |             |
...
```bash
OK: access points connections: 4160 client devices authorized connections: 29879 traffic in: 9500695006/s traffic out: 6535565355/s | 'system~system.connection.accesspoints.count'=4160;;;0; 'system~system.connection.client.devices.authorized.count'=29879;;;0; 'system~system.traffic.in.bitspersecond'=95006b/s;;;0; 'system~system.traffic.out.bitspersecond'=65355b/s;;;0; 
```
...
| list-access-points [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/ruckus/smartzone/snmp/mode/listaccesspoints.pm)] | Utilisé pour la découverte de services        |
