...
|:-----------------|:-------------------------------------------|:--------------------------------------------------|
| Connections      | Net-Stonesoft-Connections-SNMP-custom      | Contrôle les connexions                           |
| Cpu              | Net-Stonesoft-Cpu-SNMP-custom              | Contrôle du taux d'utilisation du CPU             |
| Dropped-Packets  | Net-Stonesoft-Dropped-Packets-SNMP-custom  | Contrôle le nombre de paquets droppés par seconde |
| Memory           | Net-Stonesoft-Memory-SNMP-custom           | Contrôle du taux d'utilisation de la mémoire      |
| Rejected-Packets | Net-Stonesoft-Rejected-Packets-SNMP-custom | Contrôle le nombre de paquets rejetés par seconde |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Stonesoft-SNMP-custom** est utilisé.
...
3. Appliquez le modèle d'hôte **Net-Stonesoft-SNMP-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
