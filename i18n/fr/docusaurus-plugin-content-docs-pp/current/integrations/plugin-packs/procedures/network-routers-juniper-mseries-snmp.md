...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Juniper M-Series SNMP** 
...
| Disk-Global                | Net-Juniper-Mseries-Disk-Global-custom                     | Contrôle du taux d'espace libre disponible du disque (via le nom. Difficile à utiliser). Les seuils pourront être en pourcentage, en espace libre restant   |     X      |
...
| Traffic-Generic-Id         | Net-Juniper-Mseries-Traffic-Generic-Id-custom              | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Generic-Name       | Net-Juniper-Mseries-Traffic-Generic-Name-custom            | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Global             | Net-Juniper-Mseries-Traffic-Global-custom                  | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface) |     X      |
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Juniper-Mseries-SNMP-custom**. |
...
| fru status               | N/A   |
| hardware.operating.count | count |
...
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------|
| bgp-peer-prefix-statistics [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/bgppeerprefixstatistics.pm)] | Net-Juniper-Mseries-SNMP-Bgp-Peer-Prefix-Statistics-custom                                                                                        |
| bgp-peer-state [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/bgppeerstate.pm)]                        | Net-Juniper-Mseries-SNMP-Bgp-Peer-State-custom                                                                                                    |
| cos [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/cos.pm)]                                            | Non utilisé dans ce connecteur de supervision                                                                                                     |
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/cpu.pm)]                                            | Net-Juniper-Mseries-Cpu-Routing-custom                                                                                                            |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/hardware.pm)]                                  | Net-Juniper-Mseries-Hardware-custom                                                                                                               |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/interfaces.pm)]                              | Net-Juniper-Mseries-Traffic-Generic-Id-custom<br />Net-Juniper-Mseries-Traffic-Generic-Name-custom<br />Net-Juniper-Mseries-Traffic-Global-custom |
| ldp-session-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/ldpsessionstatus.pm)]                | Net-Juniper-Mseries-SNMP-Ldp-Session-Status-custom                                                                                                |
| list-bgp-peers [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/listbgppeers.pm)]                        | Non utilisé dans ce connecteur de supervision                                                                                                     |
...
| lsp-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/lspstatus.pm)]                               | Net-Juniper-Mseries-SNMP-Lsp-Status-custom                                                                                                        |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/memory.pm)]                                      | Net-Juniper-Mseries-Memory-Routing-custom                                                                                                         |
| rsvp-session-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/rsvpsessionstatus.pm)]              | Net-Juniper-Mseries-SNMP-Rsvp-Session-Status-custom                                                                                               |
...
| --warning-prefixes-in           | Threshold warning for prefixes in.                                                                                        |
| --critical-prefixes-in          | Threshold critical for prefixes in.                                                                                       |
| --warning-prefixes-in-accepted  | Threshold warning for prefixes in accepted.                                                                               |
| --critical-prefixes-in-accepted | Threshold critical for prefixes in accepted.                                                                              |
| --warning-prefixes-in-rejected  | Threshold warning for prefixes in rejected.                                                                               |
| --critical-prefixes-in-rejected | Threshold critical for prefixes in rejected.                                                                              |
| --warning-prefixes-in-active    | Threshold warning for prefixes in active.                                                                                 |
| --critical-prefixes-in-active   | Threshold critical for prefixes in active.                                                                                |
| --warning-prefixes-out          | Threshold warning for prefixes out.                                                                                       |
| --critical-prefixes-out         | Threshold critical for prefixes out.                                                                                      |
...
| --critical-load-1m     | Critical threshold for CPU load 1 minute (in percent).                                                                    |
| --warning-load-5m      | Warning threshold for CPU load 5 minutes (in percent).                                                                    |
| --critical-load-5m     | Critical threshold for CPU load 5 minutes (in percent).                                                                   |
| --warning-load-15m     | Warning threshold for CPU load 15 minutes (in percent).                                                                   |
| --critical-load-15m    | Critical threshold for CPU load 15 minutes (in percent).                                                                  |
...
| --warning-in-traffic                            | Set warning threshold for in traffic.                                                                                                                                                                                                                                                    |
...
| --warning-in-mcast                              | Set warning threshold for in multicast traffic.                                                                                                                                                                                                                                          |
| --warning-out-ucast                             | Set warning threshold for out unicast traffic.                                                                                                                                                                                                                                           |
| --warning-out-bcast                             | Set warning threshold for out broadcast traffic.                                                                                                                                                                                                                                         |
| --warning-out-mcast                             | Set warning threshold for out multicast traffic.                                                                                                                                                                                                                                         |
| --warning-speed                                 | Set warning threshold for speed (in b/s).                                                                                                                                                                                                                                                |
| --critical-total-port                           | Threshold.                                                                                                                                                                                                                                                                               |
| --critical-total-admin-up                       | Threshold.                                                                                                                                                                                                                                                                               |
| --critical-total-admin-down                     | Threshold.                                                                                                                                                                                                                                                                               |
| --critical-total-oper-up                        | Threshold.                                                                                                                                                                                                                                                                               |
| --critical-total-oper-down                      | Threshold.                                                                                                                                                                                                                                                                               |
| --critical-in-traffic                           | Set critical threshold for in traffic.                                                                                                                                                                                                                                                   |
| --critical-out-traffic                          | Set critical threshold for out traffic.                                                                                                                                                                                                                                                  |
| --critical-in-error                             | Set critical threshold for in error traffic.                                                                                                                                                                                                                                             |
| --critical-in-discard                           | Set critical threshold for in discard traffic.                                                                                                                                                                                                                                           |
| --critical-out-error                            | Set critical threshold for out error traffic.                                                                                                                                                                                                                                            |
| --critical-out-discard                          | Set critical threshold for out discard traffic.                                                                                                                                                                                                                                          |
| --critical-in-ucast                             | Set critical threshold for in unicast traffic.                                                                                                                                                                                                                                           |
| --critical-in-bcast                             | Set critical threshold for in broadcast traffic.                                                                                                                                                                                                                                         |
| --critical-in-mcast                             | Set critical threshold for in multicast traffic.                                                                                                                                                                                                                                         |
| --critical-out-ucast                            | Set critical threshold for out unicast traffic.                                                                                                                                                                                                                                          |
...
| --warning-fcs-errors                            | Set warning threshold for Frame Check Sum errors (in percent).                                                                                                                                                                                                                           |
| --critical-fcs-errors                           | Set critical threshold for Frame Check Sum errors (in percent).                                                                                                                                                                                                                          |
| --warning-input-power                           | Set warning threshold for input power (dBm).                                                                                                                                                                                                                                             |
| --critical-input-power                          | Set critical threshold for input power (dBm).                                                                                                                                                                                                                                            |
| --warning-bias-current                          | Set warning threshold for bias current (mA).                                                                                                                                                                                                                                             |
| --critical-bias-current                         | Set critical threshold for bias current (mA).                                                                                                                                                                                                                                            |
| --warning-output-power                          | Set warning threshold for output power (dBm).                                                                                                                                                                                                                                            |
| --critical-output-power                         | Set critical threshold for output power (dBm).                                                                                                                                                                                                                                           |
| --warning-module-temperature                    | Set warning threshold for module temperature (C).                                                                                                                                                                                                                                        |
| --critical-module-temperature                   | Set critical threshold for module temperature (C).                                                                                                                                                                                                                                       |
