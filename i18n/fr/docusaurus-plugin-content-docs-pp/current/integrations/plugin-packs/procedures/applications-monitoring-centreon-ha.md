...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Centreon-HA** 
...
| SSHPRIVKEY      | Define the path to the private key file for user authentication.                                                                                                    |                   |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| RESOURCENAME | Set the resource name you want to check                                                                                                          | cbd\_rrd          |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| RESOURCENAME | Set the resource name you want to check                                                                                                          | centreon          |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| RESOURCENAME | Set the resource name you want to check                                                                                                          | ms\_mysql-master  |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| RESOURCENAME | Set the resource name you want to check                                                                                                          | php7              |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
...
| WARNINGCLONERESOURCEACTIONSFAILED    | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALCLONERESOURCEACTIONSFAILED   | Threshold                                                                                                                                                                                                                                |                                                             |             |
| WARNINGCLONERESOURCEMIGRATIONFAILED  | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALCLONERESOURCEMIGRATIONFAILED | Threshold                                                                                                                                                                                                                                |                                                             |             |
...
| WARNINGCLUSTERACTIONSFAILED          | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALCLUSTERACTIONSFAILED         | Threshold                                                                                                                                                                                                                                |                                                             |             |
...
| WARNINGNODESOFFLINE                  | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALNODESOFFLINE                 | Threshold                                                                                                                                                                                                                                |                                                             |             |
| WARNINGNODESONLINE                   | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALNODESONLINE                  | Threshold                                                                                                                                                                                                                                |                                                             |             |
| WARNINGNODESSTANDBY                  | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALNODESSTANDBY                 | Threshold                                                                                                                                                                                                                                |                                                             |             |
...
| WARNINGRESOURCEACTIONSFAILED         | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALRESOURCEACTIONSFAILED        | Threshold                                                                                                                                                                                                                                |                                                             |             |
| WARNINGRESOURCEMIGRATIONFAILED       | Threshold                                                                                                                                                                                                                                |                                                             |             |
| CRITICALRESOURCEMIGRATIONFAILED      | Threshold                                                                                                                                                                                                                                |                                                             |             |
...
| --sshcli-option         | Specify ssh cli options (example: --sshcli-option='-o=StrictHostKeyChecking=no'). The default option is --sshcli-options='-o=LogLevel=ERROR' which hides the SSH banner. If you override this option, make sure to append '-o=LogLevel=ERROR' to your new value to maintain this behavior. This option could be set multiple times. |
