...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Active Directory WSMAN**
...
Le connecteur de supervision **Active Directory WSMAN** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="App-ActiveDirectory-WSMAN-custom" label="App-ActiveDirectory-WSMAN-custom">

| Alias  | Modèle de service                       | Description                                                                                 |
|:-------|:----------------------------------------|:--------------------------------------------------------------------------------------------|
| Dcdiag | App-ActiveDirectory-Dcdiag-WSMAN-custom | Contrôle permettant de diagnostiquer le contrôleur de domaine. Exécute la commande "dcdiag" |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-ActiveDirectory-WSMAN-custom** est utilisé.
...
```bash
dnf install centreon-pack-applications-active-directory-wsman
```
...
```bash
apt install centreon-pack-applications-active-directory-wsman
```
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Active Directory WSMAN**
...
```bash
dnf install centreon-plugin-Applications-ActiveDirectory-Wsman
```
...
3. Appliquez le modèle d'hôte **App-ActiveDirectory-WSMAN-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
|:-----------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------|
| dcdiag [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/microsoft/activedirectory/wsman/mode/dcdiag.pm)] | App-ActiveDirectory-Dcdiag-WSMAN-custom |
