...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Nginx Plus**
...
Le connecteur de supervision **Nginx Plus** apporte un modèle d'hôte :
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Nginx-Plus-Restapi-custom** est utilisé.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Nginx Plus**
...
3. Appliquez le modèle d'hôte **App-Nginx-Plus-Restapi-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
