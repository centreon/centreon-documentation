...
Le connecteur de supervision **Informix DB SNMP** apporte un modèle d'hôte :
...
|:--------------|:------------------------------------------|:------------------------------------------------------------------|
| Archivelevel0 | App-DB-Informix-Archivelevel0-SNMP-custom | Contrôle permettant de vérifier la dernière sauvegarde            |
| Chunk-Status  | App-DB-Informix-Chunk-Status-SNMP-custom  | Contrôle permettant de vérifier le statut des 'chunk'             |
| Dbspace-Usage | App-DB-Informix-Dbspace-Usage-SNMP-custom | Contrôle permettant de vérifier l'utilisation des dbspaces        |
| Global-Cache  | App-DB-Informix-Global-Cache-SNMP-custom  | Contrôle permettant de vérifier l'utilisation du cache            |
| Lock-Stats    | App-DB-Informix-Lock-Stats-SNMP-custom    | Contrôle permettant de vérifier les verrous                       |
| Logfile-Usage | App-DB-Informix-Logfile-Usage-SNMP-custom | Contrôle permettant de vérifier l'utilisation des fichiers de log |
| Sessions      | App-DB-Informix-Sessions-SNMP-custom      | Contrôle permettant de vérifier les sessions courantes            |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-DB-Informix-SNMP-custom** est utilisé.
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **App-DB-Informix-SNMP-custom** |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Informix DB SNMP**
...
3. Appliquez le modèle d'hôte **App-DB-Informix-SNMP-custom**.
