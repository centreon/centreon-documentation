...
| Disk-Global          | OS-FreeBSD-Disk-Global-SNMP-custom          | Contrôle du taux d'espace libre disponible du disque. Pour chaque contrôle apparaîtra le nom du disque | X          |
...
| Traffic-Generic-Name | OS-FreeBSD-Traffic-Generic-Name-SNMP-custom | Contrôle de la bande passante des interfaces. Pour chaque contrôle apparaîtra                          |            |
...
| cpu-detailed [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/cpudetailed.pm)]       | Non utilisé dans ce connecteur de supervision                                                                                         |
...
| list-processes [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listprocesses.pm)]   | Non utilisé dans ce connecteur de supervision                                                                                         |
...
| tcpcon [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/tcpcon.pm)]                  | Non utilisé dans ce connecteur de supervision                                                                                         |
