---
id: test-pack-multiple-htpl
title: Test Monitoring Connector Multiple Host Templates
---
...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Test Monitoring Connector Multiple Host Templates** 
...
Le connecteur de supervision **Test Monitoring Connector Multiple Host Templates** apporte 3 modèles d'hôte :

* **Test-Monitoring-Tpl1-Connector-custom**
* **Test-Monitoring-Tpl2-Connector-custom**
* **Test-Monitoring-Tpl3-Connector-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<TabItem value="Test-Monitoring-Tpl1-Connector-custom" label="Test-Monitoring-Tpl1-Connector-custom">
...
| Memory | OS-Linux-Memory-SNMP-custom | Contrôle du taux d'utilisation de la mémoire vive (RAM)                                                                                                                      |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Test-Monitoring-Tpl1-Connector-custom** est utilisé.

</TabItem>
<TabItem value="Test-Monitoring-Tpl2-Connector-custom" label="Test-Monitoring-Tpl2-Connector-custom">
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Test-Monitoring-Tpl2-Connector-custom** est utilisé.

</TabItem>
<TabItem value="Test-Monitoring-Tpl3-Connector-custom" label="Test-Monitoring-Tpl3-Connector-custom">
...
| Alias          | Modèle de service                   | Description                                                                                                                                   |
|:---------------|:------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------|
| Traffic-Global | OS-Linux-Traffic-Global-SNMP-custom | Contrôle de la bande passante des interfaces. Pour chaque contrôle apparaîtra le nom de l'interface ('label' raccourci décrivant l'interface) |
...
```bash
dnf install centreon-pack-test-pack-multiple-htpl
```
...
```bash
apt install centreon-pack-test-pack-multiple-htpl
```
...
```bash
yum install centreon-pack-test-pack-multiple-htpl
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Test Monitoring Connector Multiple Host Templates**
...
```bash
dnf install centreon-plugin-TestPlugin-Test-Snmp
```
...
```bash
apt install centreon-plugin-testplugin-test-snmp
```
...
```bash
yum install centreon-plugin-TestPlugin-Test-Snmp
```
...
3. Appliquez le modèle d'hôte **Test-Monitoring-Tpl1-Connector-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Complétez les champs **Nom**, **Alias** & **IP Address/DNS** correspondant à votre ressource.
3. Appliquez le modèle d'hôte **Test-Monitoring-Tpl2-Connector-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Complétez les champs **Nom**, **Alias** & **IP Address/DNS** correspondant à votre ressource.
3. Appliquez le modèle d'hôte **Test-Monitoring-Tpl3-Connector-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
/usr/lib/centreon/plugins/centreon_linux_snmp.pl \
        --plugin=test_plugin::snmp::plugin \
        --mode=interfaces \
        --hostname=10.0.0.1 \
        --snmp-version='2c' \
...
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | OS-Linux-Traffic-Global-SNMP-custom            |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)] | Pas uttilisé dans ce connecteur de supervision |
...
| --change-perfdata --extend-perfdata        | Change or extend perfdata. Syntax: --extend-perfdata=searchlabel,newlabel,target\[,\[newuom\],\[min\],\[max\]\]  Common examples:  onvert storage free perfdata into used: --change-perfdata='free,used,invert()'  Convert storage free perfdata into used: --change-perfdata='used,free,invert()'  Scale traffic values automatically: --change-perfdata='traffic,,scale(auto)'  Scale traffic values in Mbps: --change-perfdata='traffic\_in,,scale(Mbps),mbps'  Change traffic values in percent: --change-perfdata='traffic\_in,,percent()'  =back                                                                                                                                                                                                                                                                                                                                                                         |
| --change-perfdata                          | Change or extend perfdata. Syntax: --extend-perfdata=searchlabel,newlabel,target\[,\[newuom\],\[min\],\[max\]\]  Common examples:  onvert storage free perfdata into used: --change-perfdata='free,used,invert()'  Convert storage free perfdata into used: --change-perfdata='used,free,invert()'  Scale traffic values automatically: --change-perfdata='traffic,,scale(auto)'  Scale traffic values in Mbps: --change-perfdata='traffic\_in,,scale(Mbps),mbps'  Change traffic values in percent: --change-perfdata='traffic\_in,,percent()'  =back                                                                                                                                                                                                                                                                                                                                                                         |
| --extend-perfdata                          | Change or extend perfdata. Syntax: --extend-perfdata=searchlabel,newlabel,target\[,\[newuom\],\[min\],\[max\]\]  Common examples:  onvert storage free perfdata into used: --change-perfdata='free,used,invert()'  Convert storage free perfdata into used: --change-perfdata='used,free,invert()'  Scale traffic values automatically: --change-perfdata='traffic,,scale(auto)'  Scale traffic values in Mbps: --change-perfdata='traffic\_in,,scale(Mbps),mbps'  Change traffic values in percent: --change-perfdata='traffic\_in,,percent()'  =back                                                                                                                                                                                                                                                                                                                                                                         |
