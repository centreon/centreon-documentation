...
| bay#bay-count     | count |
| disk#disk-state   | N/A   |
| disk#disk-count   | count |
| fru#fru-state     | N/A   |
| fru#fru-count     | count |
| shelf#shelf-state | N/A   |
| shelf#shelf-count | count |
...
| status                                          | N/A   |
| status                                          | N/A   |
| *volumes1*#volume.space.usage.bytes             | B     |
| *volumes2*#volume.space.usage.bytes             | B     |
| *volumes1*#volume.space.free.bytes              | B     |
| *volumes2*#volume.space.free.bytes              | B     |
| *volumes1*#volume.space.usage.percentage        | %     |
| *volumes2*#volume.space.usage.percentage        | %     |
| *volumes1*#volume.io.read.usage.bytespersecond  | B/s   |
| *volumes2*#volume.io.read.usage.bytespersecond  | B/s   |
| *volumes1*#volume.io.write.usage.bytespersecond | B/s   |
| *volumes2*#volume.io.write.usage.bytespersecond | B/s   |
| *volumes1*#volume.io.other.usage.bytespersecond | B/s   |
| *volumes2*#volume.io.other.usage.bytespersecond | B/s   |
| *volumes1*#volume.io.total.usage.bytespersecond | B/s   |
| *volumes2*#volume.io.total.usage.bytespersecond | B/s   |
| *volumes1*#volume.io.read.usage.iops            | iops  |
| *volumes2*#volume.io.read.usage.iops            | iops  |
| *volumes1*#volume.io.write.usage.iops           | iops  |
| *volumes2*#volume.io.write.usage.iops           | iops  |
| *volumes1*#volume.io.other.usage.iops           | iops  |
| *volumes2*#volume.io.other.usage.iops           | iops  |
| *volumes1*#volume.io.total.usage.iops           | iops  |
| *volumes2*#volume.io.total.usage.iops           | iops  |
| *volumes1*#volume.io.read.latency.milliseconds  | ms    |
| *volumes2*#volume.io.read.latency.milliseconds  | ms    |
| *volumes1*#volume.io.write.latency.milliseconds | ms    |
| *volumes2*#volume.io.write.latency.milliseconds | ms    |
| *volumes1*#volume.io.other.latency.milliseconds | ms    |
| *volumes2*#volume.io.other.latency.milliseconds | ms    |
| *volumes1*#volume.io.total.latency.milliseconds | ms    |
| *volumes2*#volume.io.total.latency.milliseconds | ms    |
