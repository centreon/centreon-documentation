...
slug: /hardware-kvm-avocent-acs-6000-snmp
...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Avocent ACS 6000**
...
Le connecteur de supervision **Avocent ACS 6000** apporte un modèle d'hôte :

* **HW-Kvm-Avocent-Acs-6000-SNMP-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<TabItem value="HW-Kvm-Avocent-Acs-6000-SNMP-custom" label="HW-Kvm-Avocent-Acs-6000-SNMP-custom">

| Alias           | Modèle de service                                   | Description          |
|:----------------|:----------------------------------------------------|:---------------------|
| Hardware-Global | HW-Kvm-Avocent-Acs-6000-Hardware-Global-SNMP-custom | Contrôle le matériel |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Kvm-Avocent-Acs-6000-SNMP-custom** est utilisé.
...
| Alias        | Modèle de service                                | Description                                               |
|:-------------|:-------------------------------------------------|:----------------------------------------------------------|
| Cpu-Detailed | HW-Kvm-Avocent-Acs-6000-Cpu-Detailed-SNMP-custom | Contrôle du taux d'utilisation détaillé CPU de la machine |
| Load         | HW-Kvm-Avocent-Acs-6000-Load-SNMP-custom         | Contrôle de la charge serveur                             |
| Memory       | HW-Kvm-Avocent-Acs-6000-Memory-SNMP-custom       | Contrôle du taux d'utilisation de la mémoire vive (RAM)   |
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Kvm-Avocent-Acs-6000-SNMP-custom**. |
...
```bash
dnf install centreon-pack-hardware-kvm-avocent-acs-6000-snmp
```
...
```bash
apt install centreon-pack-hardware-kvm-avocent-acs-6000-snmp
```
...
```bash
yum install centreon-pack-hardware-kvm-avocent-acs-6000-snmp
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Avocent ACS 6000**
...
```bash
dnf install centreon-plugin-Hardware-Kvm-Avocent-Acs-6000-Snmp
```
...
```bash
apt install centreon-plugin-hardware-kvm-avocent-acs-6000-snmp
```
...
3. Appliquez le modèle d'hôte **HW-Kvm-Avocent-Acs-6000-SNMP-custom**.
...
```bash
/usr/lib/centreon/plugins/centreon_kvm_avocent.pl \
	--plugin=hardware::kvm::avocent::acs::6000::snmp::plugin \
	--mode=cpu-detailed \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:-------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------|
| cpu-detailed [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/cpudetailed.pm)]               | HW-Kvm-Avocent-Acs-6000-Cpu-Detailed-SNMP-custom    |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/kvm/avocent/acs/6000/snmp/mode/hardware.pm)] | HW-Kvm-Avocent-Acs-6000-Hardware-Global-SNMP-custom |
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/loadaverage.pm)]                       | HW-Kvm-Avocent-Acs-6000-Load-SNMP-custom            |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/memory.pm)]                          | HW-Kvm-Avocent-Acs-6000-Memory-SNMP-custom          |
