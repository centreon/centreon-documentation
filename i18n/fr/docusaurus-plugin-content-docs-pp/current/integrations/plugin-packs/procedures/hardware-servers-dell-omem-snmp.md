...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Dell OME–Modular SNMP**
...
Le connecteur de supervision **Dell OME–Modular SNMP** apporte un modèle d'hôte :
...
|:---------|:----------------------------------|:----------------------------------------------------------|
| Hardware | HW-Dell-OMEM-Hardware-SNMP-custom | Contrôle le matériel                                      |
| Uptime   | HW-Dell-OMEM-Uptime-SNMP-custom   | Durée depuis laquelle le serveur tourne sans interruption |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Server-Dell-OMEM-SNMP-custom** est utilisé.
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Server-Dell-OMEM-SNMP-custom**. |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Dell OME–Modular SNMP**
...
3. Appliquez le modèle d'hôte **HW-Server-Dell-OMEM-SNMP-custom**.
