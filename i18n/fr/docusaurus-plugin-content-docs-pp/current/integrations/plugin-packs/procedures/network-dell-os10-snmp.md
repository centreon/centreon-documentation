...
Le connecteur de supervision **Dell OS10 SNMP** apporte un modèle d'hôte :
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Dell-Os10-SNMP-custom** est utilisé.
...
|:-----------|:-------------------------------------|:----------------------------------|:----------:|
| Disk-Usage | Net-Dell-Os10-Disk-Usage-SNMP-custom | Contrôle l'usage du disque        |            |
| Inodes     | Net-Dell-Os10-Inodes-SNMP-custom     | Contrôle les inodes               |            |
| Interfaces | Net-Dell-Os10-Interfaces-SNMP-custom | Contrôle les interfaces           | X          |
| Uptime     | Net-Dell-Os10-Uptime-SNMP-custom     | Contrôle l'uptime de l'équipement |            |
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Dell-Os10-SNMP-custom** |
...
| Nom de la règle                   | Description                                                             |
|:----------------------------------|:------------------------------------------------------------------------|
| Net-Dell-Os10-SNMP-Interface-Name | Découvre les interfaces réseaux et supervise le statut et l'utilisation |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Dell OS10 SNMP**
...
3. Appliquez le modèle d'hôte **Net-Dell-Os10-SNMP-custom**.
