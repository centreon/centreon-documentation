...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Fortinet Fortimanager SNMP** 
...
Le connecteur de supervision **Fortinet Fortimanager SNMP** apporte un modèle d'hôte :
...
|:-------|:---------------------------------------------|:----------------------------------------------------|
| Cpu    | Net-Fortinet-Fortimanager-Cpu-SNMP-custom    | Contrôle du taux d'utilisation du CPU de la machine |
| Disk   | Net-Fortinet-Fortimanager-Disk-SNMP-custom   | Contrôle l'utilisation disque                       |
| Memory | Net-Fortinet-Fortimanager-Memory-SNMP-custom | Contrôle l'utilisation mémoire                      |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Fortinet-Fortimanager-SNMP-custom** est utilisé.
...
| Alias         | Modèle de service                                   | Description                                 |
|:--------------|:----------------------------------------------------|:--------------------------------------------|
| Device-Status | Net-Fortinet-Fortimanager-Device-Status-SNMP-custom | Contrôle le statut des équipements Fortinet |
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Fortinet-Fortimanager-SNMP-custom**. |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Fortinet Fortimanager SNMP**
...
3. Appliquez le modèle d'hôte **Net-Fortinet-Fortimanager-SNMP-custom**.
