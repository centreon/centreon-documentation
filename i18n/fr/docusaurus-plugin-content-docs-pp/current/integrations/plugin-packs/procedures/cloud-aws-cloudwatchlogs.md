...
|:------------------------|:---------------------------------------------|:------------------|
| Cloudwatchlogs-Get-Logs | Cloud-Aws-Cloudwatchlogs-Get-Logs-Api-custom | Contrôle les logs |
...
| list-groups [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/aws/cloudwatchlogs/mode/listgroups.pm)] | Non utilisé dans ce connecteur de supervision |
