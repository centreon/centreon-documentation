...
description: "Supervisez Proxmox Mail Gateway via l'API REST : trafic des mails, spams, virus et version du logiciel."
---
...
Le connecteur de supervision **Proxmox Mail Gateway** apporte un modèle d'hôte :
...
|:--------|:----------------------------------|:--------------------------------|
| Mail    | App-Proxmox-Mg-Mail-Api-custom    | Contrôle les statistiques des mails |
| Version | App-Proxmox-Mg-Version-Api-custom | Contrôle la version             |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Proxmox-Mg-Api-custom** est utilisé.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Proxmox Mail Gateway**
...
3. Appliquez le modèle d'hôte **App-Proxmox-Mg-Api-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
