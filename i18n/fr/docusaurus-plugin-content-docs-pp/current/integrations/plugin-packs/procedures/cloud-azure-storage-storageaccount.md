...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Azure Storage Account**
...
Le connecteur de supervision **Azure Storage Account** apporte 5 modèles d'hôte :
...
|:----------------------------------|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
| Account-Transactions-Availability | Cloud-Azure-Storage-StorageAccount-Account-Transactions-Availability-Api-custom | Contrôle le taux de disponibilité du stockage                                      |
| Account-Transactions-Count        | Cloud-Azure-Storage-StorageAccount-Account-Transactions-Count-Api-custom        | Contrôle le nombre de transactions sur le stockage                                 |
| Account-Transactions-Latency      | Cloud-Azure-Storage-StorageAccount-Account-Transactions-Latency-Api-custom      | Contrôle la latence et le temps de traitement des requêtes réussies sur le stockage |
| Account-Transactions-Throughput   | Cloud-Azure-Storage-StorageAccount-Account-Transactions-Throughput-Api-custom   | Contrôle le volume de données entrantes et sortantes sur le stockage                   |
| Account-Used-Capacity             | Cloud-Azure-Storage-StorageAccount-Account-Used-Capacity-Api-custom             | Contrôle le volume utilisé sur le stockage                                         |
| Health                            | Cloud-Azure-Storage-StorageAccount-Health-Api-custom                            | Contrôle le statut de l'instance de stockage                                       |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Account-custom** est utilisé.
...
| Alias                          | Modèle de service                                                            | Description                                                                        |
|:-------------------------------|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
| Blob-Capacity                  | Cloud-Azure-Storage-StorageAccount-Blob-Capacity-Api-custom                  | Contrôle le volume de type Blob utilisé sur le stockage                            |
| Blob-Container-Count           | Cloud-Azure-Storage-StorageAccount-Blob-Container-Count-Api-custom           | Contrôle le nombre de containers Blob sur le stockage                               |
| Blob-Count                     | Cloud-Azure-Storage-StorageAccount-Blob-Count-Api-custom                     | Contrôle le nombre d'objets sur le stockage                                        |
| Blob-Transactions-Availability | Cloud-Azure-Storage-StorageAccount-Blob-Transactions-Availability-Api-custom | Contrôle le taux de disponibilité du stockage                                      |
| Blob-Transactions-Count        | Cloud-Azure-Storage-StorageAccount-Blob-Transactions-Count-Api-custom        | Contrôle le nombre de transactions sur le stockage                                 |
| Blob-Transactions-Latency      | Cloud-Azure-Storage-StorageAccount-Blob-Transactions-Latency-Api-custom      | Contrôle la latence et le temps de traitement des requêtes réussies sur le stockage |
| Blob-Transactions-Throughput   | Cloud-Azure-Storage-StorageAccount-Blob-Transactions-Throughput-Api-custom   | Contrôle le volume de données entrantes et sortantes sur le stockage                   |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Blob-custom** est utilisé.
...
| File-Transactions-Throughput   | Cloud-Azure-Storage-StorageAccount-File-Transactions-Throughput-Api-custom   | Contrôle le volume de données entrant et sortant sur le stockage                   |            |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-File-custom** est utilisé.
...
| Alias                           | Modèle de service                                                             | Description                                                                        |
|:--------------------------------|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
| Queue-Capacity                  | Cloud-Azure-Storage-StorageAccount-Queue-Capacity-Api-custom                  | Contrôle le volume de type Queue utilisé sur le stockage                           |
| Queue-Count                     | Cloud-Azure-Storage-StorageAccount-Queue-Count-Api-custom                     | Contrôle le nombre de files d'attente sur le stockage                               |
| Queue-Message-Count             | Cloud-Azure-Storage-StorageAccount-Queue-Message-Count-Api-custom             | Contrôle le nombre de messages dans la file d'attente sur le stockage               |
| Queue-Transactions-Availability | Cloud-Azure-Storage-StorageAccount-Queue-Transactions-Availability-Api-custom | Contrôle le taux de disponibilité du stockage                                      |
| Queue-Transactions-Count        | Cloud-Azure-Storage-StorageAccount-Queue-Transactions-Count-Api-custom        | Contrôle le nombre de transactions sur le stockage                                 |
| Queue-Transactions-Latency      | Cloud-Azure-Storage-StorageAccount-Queue-Transactions-Latency-Api-custom      | Contrôle la latence et le temps de traitement des requêtes réussies sur le stockage |
| Queue-Transactions-Throughput   | Cloud-Azure-Storage-StorageAccount-Queue-Transactions-Throughput-Api-custom   | Contrôle le volume de données entrantes et sortantes sur le stockage                   |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Queue-custom** est utilisé.
...
| Table-Transactions-Throughput   | Cloud-Azure-Storage-StorageAccount-Table-Transactions-Throughput-Api-custom   | Contrôle le volume de données entrantes et sortantes sur le stockage                   |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Table-custom** est utilisé.
...
d'hôtes nommé **Microsoft Azure Storage Account**. Celui-ci permet de découvrir l'ensemble des instances
...
|:--------------------------------------------------------|:------------------------------------------------------------------------------------|
| Cloud-Azure-Storage-StorageAccount-File-Share-Quota-Api | Découvre les partitions du disque en utilisant son nom et supervise l'espace occupé |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Azure Storage Account**
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Remplissez le champ **Adresse IP/DNS** avec l'adresse **127.0.0.1**.
3. Appliquez le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Blob-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
4. Renseignez les macros désirées. Attention, certaines macros sont obligatoires. Par exemple, pour ce connecteur, **AZURECUSTOMMODE** (valeurs possibles : **api** ou **azcli**). En effet, il existe plusieurs modes de communication avec l'équipement supervisé : soit l'outil en ligne de commande azcli, soit une interrogation directe de l'api.
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Remplissez le champ **Adresse IP/DNS** avec l'adresse **127.0.0.1**.
3. Appliquez le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-File-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
4. Renseignez les macros désirées. Attention, certaines macros sont obligatoires. Par exemple, pour ce connecteur, **AZURECUSTOMMODE** (valeurs possibles : **api** ou **azcli**). En effet, il existe plusieurs modes de communication avec l'équipement supervisé : soit l'outil en ligne de commande azcli, soit une interrogation directe de l'api.
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Remplissez le champ **Adresse IP/DNS** avec l'adresse **127.0.0.1**.
3. Appliquez le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Queue-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
4. Renseignez les macros désirées. Attention, certaines macros sont obligatoires. Par exemple, pour ce connecteur, **AZURECUSTOMMODE** (valeurs possibles : **api** ou **azcli**). En effet, il existe plusieurs modes de communication avec l'équipement supervisé : soit l'outil en ligne de commande azcli, soit une interrogation directe de l'api.
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Remplissez le champ **Adresse IP/DNS** avec l'adresse **127.0.0.1**.
3. Appliquez le modèle d'hôte **Cloud-Azure-Storage-StorageAccount-Table-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
4. Renseignez les macros désirées. Attention, certaines macros sont obligatoires. Par exemple, pour ce connecteur, **AZURECUSTOMMODE** (valeurs possibles : **api** ou **azcli**). En effet, il existe plusieurs modes de communication avec l'équipement supervisé : soit l'outil en ligne de commande azcli, soit une interrogation directe de l'api.
