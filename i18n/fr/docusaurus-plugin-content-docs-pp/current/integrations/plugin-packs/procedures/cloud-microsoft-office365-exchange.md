...
| WARNINGSTATUS              | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{used\}, %\{issue_warning_quota\}, %\{prohibit_send_quota\}, %\{prohibit_send_receive_quota\}   | %\{used\} \> %\{issue_warning_quota\}|           |
| CRITICALSTATUS             | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{used\}, %\{issue_warning_quota\}, %\{prohibit_send_quota\}, %\{prohibit_send_receive_quota\}  | %\{used\} \> %\{prohibit_send_quota\}|           |
...
| --warning-status  | Define the conditions to match for the status to be WARNING (default: '%\{used\} \> %\{issue_warning_quota\}'). You can use the following variables: %\{used\}, %\{issue_warning_quota\}, %\{prohibit_send_quota\}, %\{prohibit_send_receive_quota\}    |
| --critical-status | Define the conditions to match for the status to be CRITICAL (default: '%\{used\} \> %\{prohibit_send_quota\}'). You can use the following variables: %\{used\}, %\{issue_warning_quota\}, %\{prohibit_send_quota\}, %\{prohibit_send_receive_quota\}   |
| --filter-counters | Only display some counters (regexp can be used). Example to hide per user counters: --filter-counters='active\|total' (default: 'active\|total')                                                                                                     |
| --units           | Unit of thresholds (default: '%') ('%', 'count').                                                                                                                                                                                                    |
