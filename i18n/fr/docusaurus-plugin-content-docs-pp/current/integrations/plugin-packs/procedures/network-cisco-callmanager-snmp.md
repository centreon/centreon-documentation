...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Cisco Call Manager SNMP** 
...
|:------------------|:----------------------------------------------------|:------------------------------------------------------|
| Gateway-Usage     | Net-Cisco-Callmanager-Gateway-Usage-SNMP-custom     | Contrôle l'utilisation des passerelles par statuts     |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Cisco-Callmanager-SNMP-custom**. |
...
| Macro                            | Description                                                                                                                                      | Valeur par défaut   | Obligatoire |
|:---------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------|:-----------:|
| WARNINGGATEWAYSREGISTERED        | Threshold                                                                                                                                        |                     |             |
| CRITICALGATEWAYSREGISTERED       | Threshold                                                                                                                                        |                     |             |
| WARNINGGATEWAYSREJECTED          | Threshold                                                                                                                                        |                     |             |
| CRITICALGATEWAYSREJECTED         | Threshold                                                                                                                                        |                     |             |
| WARNINGGATEWAYSUNREGISTERED      | Threshold                                                                                                                                        |                     |             |
| CRITICALGATEWAYSUNREGISTERED     | Threshold                                                                                                                                        |                     |             |
| WARNINGMEDIADEVICESREGISTERED    | Threshold                                                                                                                                        |                     |             |
| CRITICALMEDIADEVICESREGISTERED   | Threshold                                                                                                                                        |                     |             |
| WARNINGMEDIADEVICESREJECTED      | Threshold                                                                                                                                        |                     |             |
| CRITICALMEDIADEVICESREJECTED     | Threshold                                                                                                                                        |                     |             |
| WARNINGMEDIADEVICESUNREGISTERED  | Threshold                                                                                                                                        |                     |             |
| CRITICALMEDIADEVICESUNREGISTERED | Threshold                                                                                                                                        |                     |             |
| WARNINGPHONESREGISTERED          | Threshold                                                                                                                                        |                     |             |
| CRITICALPHONESREGISTERED         | Threshold                                                                                                                                        |                     |             |
| WARNINGPHONESREJECTED            | Threshold                                                                                                                                        |                     |             |
| CRITICALPHONESREJECTED           | Threshold                                                                                                                                        |                     |             |
| WARNINGPHONESUNREGISTERED        | Threshold                                                                                                                                        |                     |             |
| CRITICALPHONESUNREGISTERED       | Threshold                                                                                                                                        |                     |             |
| CRITICALSTATUS                   | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{status\}, %\{display\}                     | %\{status\} !~ /up/ |             |
...
| Macro                            | Description                                                                                                                                      | Valeur par défaut            | Obligatoire |
|:---------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------|:-----------:|
| CRITICALSTATUS                   | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{status\}, %\{display\}                     | %\{status\} !~ /^registered/ |             |
| WARNINGSTATUS                    | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{status\}, %\{display\}                      |                              |             |
| WARNINGTOTALPARTIALLYREGISTERED  | Threshold                                                                                                                                        |                              |             |
| CRITICALTOTALPARTIALLYREGISTERED | Threshold                                                                                                                                        |                              |             |
| WARNINGTOTALREGISTERED           | Threshold                                                                                                                                        |                              |             |
| CRITICALTOTALREGISTERED          | Threshold                                                                                                                                        |                              |             |
| WARNINGTOTALREJECTED             | Threshold                                                                                                                                        |                              |             |
| CRITICALTOTALREJECTED            | Threshold                                                                                                                                        |                              |             |
| WARNINGTOTALUNKNOWN              | Threshold                                                                                                                                        |                              |             |
| CRITICALTOTALUNKNOWN             | Threshold                                                                                                                                        |                              |             |
| WARNINGTOTALUNREGISTERED         | Threshold                                                                                                                                        |                              |             |
| CRITICALTOTALUNREGISTERED        | Threshold                                                                                                                                        |                              |             |
| EXTRAOPTIONS                     | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                              |             |
...
| Macro                            | Description                                                                                                                                      | Valeur par défaut            | Obligatoire |
|:---------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------|:-----------:|
| CRITICALSTATUS                   | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{status\}, %\{name\}, %\{description\}      | %\{status\} !~ /^registered/ |             |
...
| cti-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/cisco/callmanager/snmp/mode/ctiusage.pm)]                 | Non utilisé dans ce connecteur de supervision       |
...
| voicemail-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/cisco/callmanager/snmp/mode/voicemailusage.pm)]     | Non utilisé dans ce connecteur de supervision       |
