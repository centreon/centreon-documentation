...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Netgear Readynas SNMP** 
...
Le connecteur de supervision **Netgear Readynas SNMP** apporte un modèle d'hôte :

* **HW-Storage-Netgear-Readynas-SNMP-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<TabItem value="HW-Storage-Netgear-Readynas-SNMP-custom" label="HW-Storage-Netgear-Readynas-SNMP-custom">

| Alias           | Modèle de service                                       | Description                                                                                                                                                                  |
|:----------------|:--------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cpu             | HW-Storage-Netgear-Readynas-Cpu-SNMP-custom             | Contrôle du taux d'utilisation du CPU de la machine. Ce contrôle pourra remonter la moyenne du taux d'utilisation des CPU ainsi que le taux par CPU pour les CPU multi-coeur |
| Hardware-Global | HW-Storage-Netgear-Readynas-Hardware-Global-SNMP-custom | Contrôle le matériel                                                                                                                                                         |
| Load            | HW-Storage-Netgear-Readynas-Load-SNMP-custom            | Contrôle de la charge serveur                                                                                                                                                |
| Memory          | HW-Storage-Netgear-Readynas-Memory-SNMP-custom          | Contrôle du taux d'utilisation de la mémoire vive (RAM)                                                                                                                      |
| Storage         | HW-Storage-Netgear-Readynas-Storage-SNMP-custom         | Contrôle l'utilisation des disques                                                                                                                                           |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-Netgear-Readynas-SNMP-custom** est utilisé.
...
| Alias      | Modèle de service                                  | Description             |
|:-----------|:---------------------------------------------------|:------------------------|
| Interfaces | HW-Storage-Netgear-Readynas-Interfaces-SNMP-custom | Contrôle les interfaces |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Storage-Netgear-Readynas-SNMP-custom**. |
...
```bash
dnf install centreon-pack-hardware-storage-netgear-readynas-snmp
```
...
```bash
apt install centreon-pack-hardware-storage-netgear-readynas-snmp
```
...
```bash
yum install centreon-pack-hardware-storage-netgear-readynas-snmp
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Netgear Readynas SNMP**
...
```bash
dnf install centreon-plugin-Hardware-Storage-Netgear-Readynas-Snmp
```
...
```bash
apt install centreon-plugin-hardware-storage-netgear-readynas-snmp
```
...
3. Appliquez le modèle d'hôte **HW-Storage-Netgear-Readynas-SNMP-custom**.
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'psu', 'fan', 'disk', 'volume', 'temperature'                                                                  | .*                |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
```bash
/usr/lib/centreon/plugins/centreon_netgear_readynas_snmp.pl \
	--plugin=storage::netgear::readynas::snmp::plugin \
	--mode=storage \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
```bash
OK: Partitions count: 92863 All storages are ok | 'storage.partitions.count'=92863;;;0; 'disk_name1#storage.space.usage.bytes'=14675B;;;; 'disk_name2#storage.space.usage.bytes'=71577B;;;; 'disk_name1#storage.access.count'=1;;;1;2 'disk_name2#storage.access.count'=1;;;1;2 
```
...
|:--------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/cpu.pm)]                           | HW-Storage-Netgear-Readynas-Cpu-SNMP-custom             |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netgear/readynas/snmp/mode/hardware.pm)] | HW-Storage-Netgear-Readynas-Hardware-Global-SNMP-custom |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]             | HW-Storage-Netgear-Readynas-Interfaces-SNMP-custom      |
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/loadaverage.pm)]                  | HW-Storage-Netgear-Readynas-Load-SNMP-custom            |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/memory.pm)]                     | HW-Storage-Netgear-Readynas-Memory-SNMP-custom          |
| storage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/storage.pm)]                   | HW-Storage-Netgear-Readynas-Storage-SNMP-custom         |
...
| Option               | Description                                                                                                                                                                                                                |
|:---------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --component          |   Which component to check (default: '.*'). Can be: 'psu', 'fan', 'disk', 'volume', 'temperature'.                                                                                                                         |
...
| --warning            |   Set warning threshold for temperatures, fan (syntax: type,instance,threshold) Example: --warning='xxxxx,.*,30'                                                                                                           |
| --critical           |   Set critical threshold for temperatures, fan (syntax: type,instance,threshold) Example: --critical='xxxxx,.*,40'                                                                                                         |
