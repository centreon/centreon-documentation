...
Le connecteur de supervision **Eaton PDU SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="HW-Pdu-Eaton-SNMP-custom" label="HW-Pdu-Eaton-SNMP-custom">

| Alias       | Modèle de service                    | Description            |
|:------------|:-------------------------------------|:-----------------------|
| Environment | HW-Pdu-Eaton-Environment-SNMP-custom | Contrôle les capteurs  |
| Group       | HW-Pdu-Eaton-Group-SNMP-custom       | Contrôle les groupes   |
| Outlet      | HW-Pdu-Eaton-Outlet-SNMP-custom      | Contrôle les sorties   |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Pdu-Eaton-SNMP-custom** est utilisé.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Eaton PDU SNMP**
...
3. Appliquez le modèle d'hôte **HW-Pdu-Eaton-SNMP-custom**.
