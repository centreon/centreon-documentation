...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Qnap SNMP** 
...
Le connecteur de supervision **Qnap SNMP** apporte un modèle d'hôte :
...
| Hardware-Global | HW-Storage-Qnap-Hardware-Global-SNMP-custom | Contrôle le matériel ('ventilateur', 'température', 'disque')                                                                                                                |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Qnap SNMP**
...
| processcount [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/processcount.pm)]      | Non utilisé dans ce connecteur de supervision                                                                                                        |
...
| upgrade [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/qnap/snmp/mode/upgrade.pm)]            | Non utilisé dans ce connecteur de supervision                                                                                                        |
