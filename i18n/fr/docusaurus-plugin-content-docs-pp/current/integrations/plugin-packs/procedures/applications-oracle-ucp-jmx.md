...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Oracle UCP JMX**
...
Le connecteur de supervision **Oracle UCP JMX** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="App-Oracle-Ucp-JMX-custom" label="App-Oracle-Ucp-JMX-custom">
...
|:-----------------|:-------------------------------------------|:---------------------------------------------------------------------|:----------:|
| Connection-Pools | App-Oracle-Ucp-Connection-Pools-JMX-custom | Contrôle permettant de vérifier l'utilisation des pools de connexion | X          |
...
| Nom                                       | Unité |
|:------------------------------------------|:------|
| *pools1*#connection_pool.usage.count      | count |
| *pools2*#connection_pool.usage.count      | count |
| *pools1*#connection_pool.free.count       | count |
| *pools2*#connection_pool.free.count       | count |
| *pools1*#connection_pool.usage.percentage | %     |
| *pools2*#connection_pool.usage.percentage | %     |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Oracle UCP JMX**
...
3. Appliquez le modèle d'hôte **App-Oracle-Ucp-JMX-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
|:------------------|:---------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| FILTERPOOLNAME    | Filter connection pools by name (can be a regexp)                                                  |                   |             |
...
```bash
OK: All connection pools are ok | 'pools1#connection_pool.usage.count'=8931;;;; 'pools2#connection_pool.usage.count'=1526;;;; 'pools1#connection_pool.free.count'=97196;;;; 'pools2#connection_pool.free.count'=60299;;;; 'pools1#connection_pool.usage.percentage'=12%;;;;100 'pools2#connection_pool.usage.percentage'=25%;;;;100
```
...
|:----------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------|
| connection-pools [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/oracle/ucp/jmx/mode/connectionpools.pm)]          | App-Oracle-Ucp-Connection-Pools-JMX-custom |
| list-connection-pools [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/oracle/ucp/jmx/mode/listconnectionpools.pm)] | Used for service discovery                 |
...
| --filter-pool-name                         |   Filter connection pools by name (can be a regexp).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
