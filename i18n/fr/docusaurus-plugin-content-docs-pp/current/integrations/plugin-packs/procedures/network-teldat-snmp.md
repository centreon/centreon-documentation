...
Le connecteur de supervision **Teldat SNMP** apporte un modèle d'hôte :
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Teldat SNMP**
