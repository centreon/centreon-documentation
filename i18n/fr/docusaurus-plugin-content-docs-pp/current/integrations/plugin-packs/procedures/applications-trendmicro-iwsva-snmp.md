...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **TrendMicro Iwsva SNMP** 
...
<Tabs groupId="sync">
<TabItem value="App-Trendmicro-Iwsva-SNMP-custom" label="App-Trendmicro-Iwsva-SNMP-custom">

| Alias             | Modèle de service                                  | Description                                                   | Découverte |
|:------------------|:---------------------------------------------------|:--------------------------------------------------------------|:----------:|
| Cpu               | App-Trendmicro-Iwsva-Cpu-SNMP-custom               | Contrôle l'utilisation CPU                                    |            |
| Disk-Global       | App-Trendmicro-Iwsva-Disk-Global-SNMP-custom       | Contrôle du taux d'espace libre disponible des disques        |     X      |
| Load              | App-Trendmicro-Iwsva-Load-SNMP-custom              | Contrôle de la charge serveur                                 |            |
| Memory            | App-Trendmicro-Iwsva-Memory-SNMP-custom            | Contrôle du taux d'utilisation de la mémoire                  |            |
| Proxy-Connections | App-Trendmicro-Iwsva-Proxy-Connections-SNMP-custom | Contrôle l'utilisation des connexions proxy                   |            |
| Swap              | App-Trendmicro-Iwsva-Swap-SNMP-custom              | Contrôle du taux d'utilisation de la mémoire virtuelle (SWAP) |            |
| Traffic-Global    | App-Trendmicro-Iwsva-Traffic-Global-SNMP-custom    | Contrôle de la bande passante des interfaces                  |     X      |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Trendmicro-Iwsva-SNMP-custom** est utilisé.
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **App-Trendmicro-Iwsva-SNMP-custom**. |
...
| App-Trendmicro-Iwsva-SNMP-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
L'agent SNMP doit être activé et configuré sur l'équipement. Référez-vous à la [documentation officielle](https://success.trendmicro.com/dcx/s/solution/1096980-best-practices-for-installation-and-deployment-of-interscan-web-security-virtual-appliance-iwsva?language=en_US&sfdcIFrameOrigin=null). 
...
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --service='proxy,,,3128' |             |
