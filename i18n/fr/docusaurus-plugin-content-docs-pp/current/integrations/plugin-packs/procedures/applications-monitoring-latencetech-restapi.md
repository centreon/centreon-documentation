...
| Nom                                         | Unité |
|:--------------------------------------------|:------|
| *kpis1*#tcp.response.time.milliseconds      | ms    |
| *kpis2*#tcp.response.time.milliseconds      | ms    |
| *kpis1*#udp.response.time.milliseconds      | ms    |
| *kpis2*#udp.response.time.milliseconds      | ms    |
| *kpis1*#http.response.time.milliseconds     | ms    |
| *kpis2*#http.response.time.milliseconds     | ms    |
| *kpis1*#https.response.time.milliseconds    | ms    |
| *kpis2*#https.response.time.milliseconds    | ms    |
| *kpis1*#icmp.response.time.milliseconds     | ms    |
| *kpis2*#icmp.response.time.milliseconds     | ms    |
| *kpis1*#twamp.response.time.milliseconds    | ms    |
| *kpis2*#twamp.response.time.milliseconds    | ms    |
| *kpis1*#download.bandwidth.bps              | bps   |
| *kpis2*#download.bandwidth.bps              | bps   |
| *kpis1*#upload.bandwidth.bps                | bps   |
| *kpis2*#upload.bandwidth.bps                | bps   |
| *kpis1*#jitter.time.milliseconds            | ms    |
| *kpis2*#jitter.time.milliseconds            | ms    |
| *kpis1*#application.latency.milliseconds    | ms    |
| *kpis2*#application.latency.milliseconds    | ms    |
| *kpis1*#network.latency.milliseconds        | ms    |
| *kpis2*#network.latency.milliseconds        | ms    |
| *kpis1*#expected.latency.milliseconds       | ms    |
| *kpis2*#expected.latency.milliseconds       | ms    |
| *kpis1*#network.stability.percentage        | %     |
| *kpis2*#network.stability.percentage        | %     |
| *kpis1*#expected.stability.percentage       | %     |
| *kpis2*#expected.stability.percentage       | %     |
| *kpis1*#volatility.percentage               | %     |
| *kpis2*#volatility.percentage               | %     |
| qoe-rate                                    | N/A   |
| qoe-rate                                    | N/A   |
| *kpis1*#packetloss.rate.percentage          | %     |
| *kpis2*#packetloss.rate.percentage          | %     |
| *kpis1*#expected.packetloss.rate.percentage | %     |
| *kpis2*#expected.packetloss.rate.percentage | %     |
| connectivity-health                         | N/A   |
| connectivity-health                         | N/A   |
...
| FILTERPROTO            | Filter protocol if needed (can be a regexp) Accepted values are C\<tcp\>, C\<udp\>, C\<http\>, C\<https\>, C\<icmp\>, C\<twamp\> |                   |             |
...
```bash
OK: All KPIs are OK | 'kpis1#tcp.response.time.milliseconds'=20963ms;;;0; 'kpis2#tcp.response.time.milliseconds'=64370ms;;;0; 'kpis1#udp.response.time.milliseconds'=46565ms;;;0; 'kpis2#udp.response.time.milliseconds'=5133ms;;;0; 'kpis1#http.response.time.milliseconds'=64590ms;;;0; 'kpis2#http.response.time.milliseconds'=94482ms;;;0; 'kpis1#https.response.time.milliseconds'=66447ms;;;0; 'kpis2#https.response.time.milliseconds'=44347ms;;;0; 'kpis1#icmp.response.time.milliseconds'=78363ms;;;0; 'kpis2#icmp.response.time.milliseconds'=43656ms;;;0; 'kpis1#twamp.response.time.milliseconds'=58148ms;;;0; 'kpis2#twamp.response.time.milliseconds'=2420ms;;;0; 'kpis1#download.bandwidth.bps'=49073bps;;;0; 'kpis2#download.bandwidth.bps'=95663bps;;;0; 'kpis1#upload.bandwidth.bps'=30141bps;;;0; 'kpis2#upload.bandwidth.bps'=49826bps;;;0; 'kpis1#jitter.time.milliseconds'=27546ms;;;0; 'kpis2#jitter.time.milliseconds'=66368ms;;;0; 'kpis1#application.latency.milliseconds'=68246ms;;;0; 'kpis2#application.latency.milliseconds'=92936ms;;;0; 'kpis1#network.latency.milliseconds'=49966ms;;;0; 'kpis2#network.latency.milliseconds'=42856ms;;;0; 'kpis1#expected.latency.milliseconds'=87322ms;;;0; 'kpis2#expected.latency.milliseconds'=36667ms;;;0; 'kpis1#network.stability.percentage'=6983%;;;0;100 'kpis2#network.stability.percentage'=21656%;;;0;100 'kpis1#expected.stability.percentage'=22877%;;;0;100 'kpis2#expected.stability.percentage'=41645%;;;0;100 'kpis1#volatility.percentage'=4909%;;;0;100 'kpis2#volatility.percentage'=42940%;;;0;100 'kpis1#qoe.rate.value'=86917;;;0;5 'kpis2#qoe.rate.value'=69708;;;0;5 'kpis1#packetloss.rate.percentage'=80208%;;;0;100 'kpis2#packetloss.rate.percentage'=60708%;;;0;100 'kpis1#expected.packetloss.rate.percentage'=34388%;;;0;100 'kpis2#expected.packetloss.rate.percentage'=24974%;;;0;100 
```
...
|:---------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|
| --agent-id                 |   Set the ID of the agent (mandatory option).                                                                                         |
| --filter-protocol          |   Filter protocol if needed (can be a regexp) Accepted values are C\<tcp\>, C\<udp\>, C\<http\>, C\<https\>, C\<icmp\>, C\<twamp\>.   |
