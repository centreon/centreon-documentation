...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Juniper EX Series SNMP** 
...
Le connecteur de supervision **Juniper EX Series SNMP** apporte un modèle d'hôte :
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Juniper-EX-custom** est utilisé.
...
|:---------------------|:-------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------|:----------:|
| Disk-Generic-Id      | Net-Juniper-Ex-Disk-Generic-Id-custom      | Contrôle du taux d'espace libre disponible du disque (via l'ID). Les seuils pourront être en pourcentage, en espace libre restant                         |            |
| Disk-Generic-Name    | Net-Juniper-Ex-Disk-Generic-Name-custom    | Contrôle du taux d'espace libre disponible du disque (via le nom. Difficile à utiliser). Les seuils pourront être en pourcentage, en espace libre restant |            |
| Disk-Global          | Net-Juniper-Ex-Disk-Global-custom          | Contrôle du taux d'espace libre disponible du disque (via le nom. Difficile à utiliser). Les seuils pourront être en pourcentage, en espace libre restant | X          |
| Traffic-Generic-Id   | Net-Juniper-Ex-Traffic-Generic-Id-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface ("label" raccourci décrivant l'interface)             |            |
| Traffic-Generic-Name | Net-Juniper-Ex-Traffic-Generic-Name-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface ("label" raccourci décrivant l'interface)             |            |
| Traffic-Global       | Net-Juniper-Ex-Traffic-Global-custom       | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface ("label" raccourci décrivant l'interface) | X          |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Juniper-EX-custom**. |
...
| Nom de la règle              | Description                                                                                        |
|:-----------------------------|:---------------------------------------------------------------------------------------------------|
| Net-Juniper-Ex-Storages-Name | Découvre les partitions du disque en utilisant son nom et supervise l'espace occupé                |
| Net-Juniper-Ex-Traffic-Name  | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation  |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Juniper EX Series SNMP**
...
/usr/lib/centreon/plugins/centreon_juniper_ex_snmp.pl \
	--plugin=network::juniper::ex::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/cpu.pm)]           | Net-Juniper-Ex-Cpu-Routing-custom                                                                                                  |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/hardware.pm)] | Net-Juniper-Ex-Hardware-custom                                                                                                     |
...
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/memory.pm)]     | Net-Juniper-Ex-Memory-Routing-custom                                                                                               |
| stack [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/juniper/common/junos/snmp/mode/stack.pm)]       | Non utilisé dans ce connecteur de supervision                                                                                      |
