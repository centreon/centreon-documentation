...
|:---------------------|:-------------------------------------------|:-----------------------------------------------------------------------------------------------------------------|:----------:|
| Disk-Generic-Id      | Net-Juniper-Ex-Disk-Generic-Id-custom      | Contrôle du taux d'espace libre disponible du disque                                                             |            |
| Disk-Generic-Name    | Net-Juniper-Ex-Disk-Generic-Name-custom    | Contrôle du taux d'espace libre disponible du disque                                                             |            |
| Disk-Global          | Net-Juniper-Ex-Disk-Global-custom          | Contrôle du taux d'espace libre disponible du disque                                                             | X          |
| Traffic-Generic-Id   | Net-Juniper-Ex-Traffic-Generic-Id-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface              |            |
| Traffic-Generic-Name | Net-Juniper-Ex-Traffic-Generic-Name-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface              |            |
| Traffic-Global       | Net-Juniper-Ex-Traffic-Global-custom       | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface  | X          |
