...
Pour la supervision, un utilisateur avec les droits suivants en lecture est nécessaire : `VM.Monitor`, `VM.Audit`, `Datastore.Audit`, `Sys.Audit`, `Sys.Syslog`.
...
| --api-username                             |   Set Proxmox VE username. The API user needs to have the following privileges: 'VM.Monitor, VM.Audit, Datastore.Audit, Sys.Audit, Sys.Syslog'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
