...
Le connecteur de supervision **Azure API Management** apporte un modèle d'hôte :
...
Le connecteur de supervision Centreon **Azure API Management** inclut un fournisseur de découverte
d'hôtes nommé **Microsoft Azure API Management**. Celui-ci permet de découvrir l'ensemble des instances
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Azure API Management**
...
3. Appliquez le modèle d'hôte **Cloud-Azure-Management-ApiManagement-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
