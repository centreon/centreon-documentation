...
2. Sur l'interface Integration de Centreon, installer le connecteur de supervision *Azure App Service* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**
...
3. Sur l'interface Integration de Centreon, installer le connecteur de supervision *Azure App Service* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**
