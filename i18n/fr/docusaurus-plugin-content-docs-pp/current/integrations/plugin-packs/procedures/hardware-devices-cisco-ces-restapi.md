...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Cisco Collaboration Endpoint Rest API**
...
Le connecteur de supervision **Cisco Collaboration Endpoint Rest API** apporte un modèle d'hôte :
...
|:------------------|:-----------------------------------------------------|:--------------------------------------|
| Calls-Rt          | HW-Device-Cisco-Ces-Calls-Rt-Restapi-custom          | Contrôle les appels en temps réel     |
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Device-Cisco-Ces-Restapi-custom** est utilisé.
...
| Alias                             | Modèle de service                                                    | Description             |
|:----------------------------------|:---------------------------------------------------------------------|:------------------------|
| Components-Audio-Device           | HW-Device-Cisco-Ces-Components-Audio-Device-Restapi-custom           | Contrôle les composants des périphériques audio |
| Components-Audio-Input-Connector  | HW-Device-Cisco-Ces-Components-Audio-Input-Connector-Restapi-custom  | Contrôle les composants des connecteurs audio en entrée |
| Components-Audio-Output-Connector | HW-Device-Cisco-Ces-Components-Audio-Output-Connector-Restapi-custom | Contrôle les composants des connecteurs audio en sortie |
| Components-Camera                 | HW-Device-Cisco-Ces-Components-Camera-Restapi-custom                 | Contrôle les composants des caméras |
| Components-Software               | HW-Device-Cisco-Ces-Components-Software-Restapi-custom               | Contrôle les composants logiciels |
| Components-Speakertrack           | HW-Device-Cisco-Ces-Components-Speakertrack-Restapi-custom           | Contrôle les composants SpeakerTack |
| Components-Temperature            | HW-Device-Cisco-Ces-Components-Temperature-Restapi-custom            | Contrôle les composants température |
| Components-Video-Input-Connector  | HW-Device-Cisco-Ces-Components-Video-Input-Connector-Restapi-custom  | Contrôle les composants des connecteurs vidéo en entrée |
| Components-Video-Input-Source     | HW-Device-Cisco-Ces-Components-Video-Input-Source-Restapi-custom     | Contrôle les composants des sources vidéo en entrée |
| Components-Video-Output-Connector | HW-Device-Cisco-Ces-Components-Video-Output-Connector-Restapi-custom | Contrôle les composants des connecteurs vidéo en sortie |
| Components-Webex                  | HW-Device-Cisco-Ces-Components-Webex-Restapi-custom                  | Contrôle les composants Webex |
...
Pour utiliser le connecteur Cisco Collaboration Endpoint Rest API, assurez-vous que le périphérique est accessible en HTTPS (port 443), que l’API REST est activée et que des identifiants valides (nom d’utilisateur et mot de passe) sont configurés avec les droits nécessaires pour accéder aux statuts et métriques du périphérique.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Cisco Collaboration Endpoint Rest API**
...
3. Appliquez le modèle d'hôte **HW-Device-Cisco-Ces-Restapi-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
| CESAPIEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
