...
| Nom                 | Unité      |
|--------------------------|------------|
| client_conn              | persecond  |
| client_drop              | persecond  |
| client_req               | persecond  |
| client_drop_late         | persecond  |
| client_req_400           | persecond  |
| client_req_411           | persecond  |
| client_req_413           | persecond  |
| client_req_417           | persecond  |
| backend_conn             | persecond  |
| backend_unhealthy        | persecond  |
| backend_busy             | persecond  |
| backend_fail             | persecond  |
| backend_reuse            | persecond  |
| backend_recycle          | persecond  |
| backend_retry            | persecond  |
| backend_req              | persecond  |
| cache_hit                | persecond  |
| cache_hitpass            | persecond  |
| cache_miss               | persecond  |
| n_sess_mem               | count      |
| n_sess                   | count      |
| n_object                 | count      |
...
| n_lru_nuked              | count      |
| n_lru_moved              | count      |
| n_objsendfile            | persecond  |
| n_objwrite               | persecond  |
| n_objoverflow            | persecond  |
| shm_records              | persecond  |
| shm_writes               | persecond  |
| shm_flushes              | persecond  |
| shm_cont                 | persecond  |
| shm_cycles               | persecond  |
| sms_nreq                 | persecond  |
| sms_nobj                 | count      |
| sms_nbytes               | bytes      |
| sms_balloc               | bytes      |
| sms_bfree                | bytes      |
| fetch_head               | persecond  |
| fetch_length             | persecond  |
| fetch_chunked            | persecond  |
| fetch_eof                | persecond  |
| fetch_bad                | persecond  |
| fetch_close              | persecond  |
| fetch_oldhttp            | persecond  |
| fetch_zero               | persecond  |
| fetch_failed             | persecond  |
| fetch_1xx                | persecond  |
| fetch_204                | persecond  |
| fetch_304                | persecond  |
| n_ban                    | count      |
| n_ban_add                | persecond  |
| n_ban_retire             | persecond  |
| n_ban_obj_test           | persecond  |
| n_ban_re_test            | persecond  |
| n_ban_dups               | persecond  |
| dir_dns_lookups          | persecond  |
| dir_dns_failed           | persecond  |
| dir_dns_hit              | persecond  |
| dir_dns_cache_full       | persecond  |
| esi_errors               | persecond  |
| esi_warnings             | persecond  |
| hcb_nolock               | persecond  |
| hcb_lock                 | persecond  |
| hcb_insert               | persecond  |
| n_vcl                    | count      |
| n_vcl_avail              | count      |
| n_vcl_discard            | count      |
| sess_conn                | count      |
