...
| Memory-Dropped-Packets        | Net-FW-Pfsense-Memory-Dropped-Packets-SNMP-custom        | Contrôle le nombre de paquets rejetés du à une trop forte utilisation de la mémoire. |            |
...
| Short-Packets                 | Net-FW-Pfsense-Short-Packets-SNMP-custom                 | Contrôle le nombre de paquets court.                                                 |            |
