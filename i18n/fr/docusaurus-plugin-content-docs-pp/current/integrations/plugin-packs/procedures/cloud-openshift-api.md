...
Ce modèle d'hôte hérite également de l'ensemble des services associés au modèle [Cloud-Kubernetes-Api-custom](../cloud-kubernetes-api/#templates).
...
Ce modèle d'hôte hérite de l'ensemble des services associés au modèle [Cloud-Kubernetes-Node-Api-custom](../cloud-kubernetes-api/#templates).
...
Ce modèle d'hôte hérite également des règles de découverte associées au modèle [Cloud-Kubernetes-Api-custom](../cloud-kubernetes-api/#service-discovery).
