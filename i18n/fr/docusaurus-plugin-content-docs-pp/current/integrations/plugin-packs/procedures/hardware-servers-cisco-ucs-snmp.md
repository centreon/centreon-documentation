...
Le connecteur de supervision **Cisco UCS** apporte un modèle d'hôte :
...
| Service-Profile | HW-Server-Cisco-Ucs-Service-Profile-SNMP-custom | Contrôle le nombre de services profiles |
