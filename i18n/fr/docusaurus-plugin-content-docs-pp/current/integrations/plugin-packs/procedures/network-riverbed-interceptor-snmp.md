...
| Packet-Errors-Global | Net-Riverbed-Interceptor-Packet-Errors-Global-SNMP-custom | Contrôle le pourcentage de paquets en erreur/écarté de plusieurs interfaces réseau                                                                                                 | X          |
