...
2. On the Centreon Web interface, install the *IBM AS400 Connector* Centreon Monitoring Connector on the **Configuration > Monitoring Connectors** page:
...
3. On the Centreon Web interface, install the *IBM AS400 Connector* Centreon Monitoring Connector on the **Configuration > Monitoring Connectors** page.
