...
| --critical-health-status | Define the conditions to match for the status to be CRITICAL (default: '%{health\_status} =~ /fail/'). You can use the following variables: %{health\_status}, %\{display\}                                                                     |
