...
Le connecteur de supervision **HP MSA2000** apporte un modèle d'hôte :
...
|:---------|:--------------------------------------|:----------------------------|
| Hardware | HW-Storage-Hp-Msa2000-Hardware-custom | Controle l'état du matériel |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-Hp-Msa2000-SNMP-custom** est utilisé.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **HP MSA2000**
...
3. Appliquez le modèle d'hôte **HW-Storage-Hp-Msa2000-SNMP-custom**.
