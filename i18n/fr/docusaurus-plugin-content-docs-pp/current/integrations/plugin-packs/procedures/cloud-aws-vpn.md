...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **AWS VPN** 
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **AWS VPN**
...
3. Appliquez le modèle d'hôte **Cloud-Aws-Vpn-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
