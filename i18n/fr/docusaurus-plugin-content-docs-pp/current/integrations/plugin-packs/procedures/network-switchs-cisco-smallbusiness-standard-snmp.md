...
<Tabs groupId="sync">
<TabItem value="Net-Cisco-Sb-Standard-SNMP-custom" label="Net-Cisco-Sb-Standard-SNMP-custom">
...
| Environment | Net-Cisco-Sb-Standard-Environment-SNMP-custom | Contrôle l'état du matériel                                                                                               |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Cisco-Sb-Standard-SNMP-custom** host template |
...
| Nom de la règle                               | Description                                                           |
|:----------------------------------------------|:----------------------------------------------------------------------|
| Net-Cisco-Sb-Standard-SNMP-Packet-Errors-Name | Discover network interfaces and monitor errored and discarded packets |
| Net-Cisco-Sb-Standard-SNMP-Traffic-Name       | Discover network interfaces and monitor bandwidth utilization         |
...
```bash
dnf install centreon-pack-network-switchs-cisco-smallbusiness-standard-snmp
```
...
```bash
yum install centreon-pack-network-switchs-cisco-smallbusiness-standard-snmp
```
...
```bash
dnf install centreon-plugin-Network-Switchs-Cisco-Smallbusiness-Standard-Snmp
```
...
3. Appliquez le modèle d'hôte **Net-Cisco-Sb-Standard-SNMP-custom**.
...
```bash
/usr/lib/centreon/plugins/centreon_cisco_smallbusiness.pl \
...
|:-------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/cisco/smallbusiness/snmp/mode/cpu.pm)]                 | Net-Cisco-Sb-Standard-Cpu-SNMP-custom                                                                                                                                                                                                                                                                                                                                |
| environment [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/cisco/smallbusiness/snmp/mode/environment.pm)] | Net-Cisco-Sb-Standard-Environment-SNMP-custom                                                                                                                                                                                                                                                                                                                        |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                              | Net-Cisco-Sb-Standard-Packet-Errors-Generic-Id-SNMP-custom<br />Net-Cisco-Sb-Standard-Packet-Errors-Generic-Name-SNMP-custom<br />Net-Cisco-Sb-Standard-Packet-Errors-Global-SNMP-custom<br />Net-Cisco-Sb-Standard-Traffic-Generic-Id-SNMP-custom<br />Net-Cisco-Sb-Standard-Traffic-Generic-Name-SNMP-custom<br />Net-Cisco-Sb-Standard-Traffic-Global-SNMP-custom |
...
| spanning-tree [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/spanningtree.pm)]                         | Net-Cisco-Sb-Standard-SpanningTree-SNMP-custom                                                                                                                                                                                                                                                                                                                       |
