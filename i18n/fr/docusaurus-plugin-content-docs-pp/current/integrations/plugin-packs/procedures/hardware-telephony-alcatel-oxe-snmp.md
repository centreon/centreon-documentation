...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Alcatel OXE** 
...
Le connecteur de supervision **Alcatel OXE** apporte un modèle d'hôte :
...
pour le diagnostic des erreurs communes des plugins Centreon.## Installer le connecteur de supervision
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Alcatel OXE**
...
```bash
OK: All trunks are ok | 'trunk1#trunk.channels.usage.count'=77952;;;; 'trunk2#trunk.channels.usage.count'=20577;;;; 'trunk1#trunk.channels.outofservice.count'=47978;;;0; 'trunk2#trunk.channels.outofservice.count'=43052;;;0; 
```
