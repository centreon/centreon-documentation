...
2. Sur l'interface Web de Centreon, installer le connecteur de supervision *D-Link Network* depuis la page **Configuration > Gestionnaire de connecteurs de supervision**
...
3. Sur l'interface Web de Centreon, installer le connecteur de supervision *D-Link Network* depuis la page **Configuration > Gestionnaire de connecteurs de supervision**
...
Ce connecteur de supervision est conçu de manière à avoir dans Centreon un hôte par équipement D-Link.
