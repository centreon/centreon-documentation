...
Le connecteur de supervision **Azure CDN** apporte un modèle d'hôte :
...
|:--------------|:-------------------------------------------------|:-------------------------------------------------------------------|
| Hit-Ratio     | Cloud-Azure-Network-CDN-Hit-Ratio-Api-custom     | Contrôle le ratio d'octets du service Azure CDN profile            |
| Latency       | Cloud-Azure-Network-CDN-Latency-Api-custom       | Contrôle la latence des requêtes HTTP du service Azure CDN profile |
| Requests      | Cloud-Azure-Network-CDN-Requests-Api-custom      | Contrôle le nombre de requêtes HTTP du service Azure CDN profile   |
| Response-Size | Cloud-Azure-Network-CDN-Response-Size-Api-custom | Contrôle la taille des requêtes HTTP du service Azure CDN profile  |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Network-CDN-custom** est utilisé.
...
Le connecteur de supervision Centreon **Azure CDN** inclut un fournisseur de découverte
d'hôtes nommé **Microsoft Azure CDN**. Celui-ci permet de découvrir l'ensemble des instances
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Azure CDN**
...
3. Appliquez le modèle d'hôte **Cloud-Azure-Network-CDN-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
