---
id: test-pack-snmp
title: Test Monitoring Connector
---
...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Test Monitoring Connector** 
...
Le connecteur de supervision **Test Monitoring Connector** apporte un modèle d'hôte :

* **Test-Monitoring-Connector-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<TabItem value="Test-Monitoring-Connector-custom" label="Test-Monitoring-Connector-custom">
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Test-Monitoring-Connector-custom** est utilisé.
...
|:---------------|:------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------|:----------:|
| Traffic-Global | OS-Linux-Traffic-Global-SNMP-custom | Contrôle de la bande passante des interfaces. Pour chaque contrôle apparaîtra le nom de l'interface ('label' raccourci décrivant l'interface) | X          |
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Test-Monitoring-Connector-custom**. |
...
| Nom de la règle            | Description                                                                                       |
|:---------------------------|:--------------------------------------------------------------------------------------------------|
| OS-Linux-SNMP-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
```bash
dnf install centreon-pack-test-pack-snmp
```
...
```bash
apt install centreon-pack-test-pack-snmp
```
...
```bash
yum install centreon-pack-test-pack-snmp
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Test Monitoring Connector**
...
3. Appliquez le modèle d'hôte **Test-Monitoring-Connector-custom**.
