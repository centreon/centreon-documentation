...
<Tabs groupId="sync">
<TabItem value="Net-Digi-AnywhereUSB-SNMP-custom" label="Net-Digi-AnywhereUSB-SNMP-custom">
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Digi-AnywhereUSB-SNMP-custom** host template |
...
| Nom de la règle                        | Description                                                             |
|:---------------------------------------|:------------------------------------------------------------------------|
| Net-Digi-AnywhereUSB-SNMP-Traffic-Name | Découvre les interfaces réseaux et supervise le statut et l'utilisation |
...
```bash
dnf install centreon-pack-network-digi-anywhereusb-snmp
```
...
```bash
yum install centreon-pack-network-digi-anywhereusb-snmp
```
...
```bash
dnf install centreon-plugin-Network-Digi-AnywhereUSB-Snmp
```
...
3. Appliquez le modèle d'hôte **Net-Digi-AnywhereUSB-SNMP-custom**.
...
```bash
/usr/lib/centreon/plugins/centreon_digi_anywhereusb.pl \
	--plugin=network::digi::anywhereusb::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:-----------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/digi/anywhereusb/snmp/mode/cpu.pm)]        | Net-Digi-AnywhereUSB-Cpu-SNMP-custom            |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | Net-Digi-AnywhereUSB-Traffic-Global-SNMP-custom |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)] | Used for service discovery                      |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/digi/anywhereusb/snmp/mode/memory.pm)]  | Net-Digi-AnywhereUSB-Memory-SNMP-custom         |
