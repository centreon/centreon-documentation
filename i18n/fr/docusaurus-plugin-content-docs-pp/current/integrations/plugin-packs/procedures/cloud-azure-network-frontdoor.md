...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Azure Front Door**
...
Le connecteur de supervision **Azure Front Door** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="Cloud-Azure-Network-FrontDoor-custom" label="Cloud-Azure-Network-FrontDoor-custom">

| Alias          | Modèle de service                                       | Description                                                  |
|:---------------|:--------------------------------------------------------|:-------------------------------------------------------------|
| Backend-Health | Cloud-Azure-Network-FrontDoor-Backend-Health-Api-custom | Contrôle la santé du backend des ressources Azure Front Door |
| Health         | Cloud-Azure-Network-FrontDoor-Health-Api-custom         | Contrôle la disponibilité des ressources Azure Front Door    |
| Latency        | Cloud-Azure-Network-FrontDoor-Latency-Api-custom        | Contrôle la latence des ressources Azure Front Door          |
| Requests       | Cloud-Azure-Network-FrontDoor-Requests-Api-custom       | Contrôle les requêtes des ressources Azure Front Door        |
| Size           | Cloud-Azure-Network-FrontDoor-Size-Api-custom           | Contrôle la taille des paquets Azure Front Door              |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Network-FrontDoor-custom** est utilisé.
...
Le connecteur de supervision Centreon **Azure Front Door** inclut un fournisseur de découverte
d'hôtes nommé **Microsoft Azure Front Door**. Celui-ci permet de découvrir l'ensemble des instances
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Azure Front Door**
...
3. Appliquez le modèle d'hôte **Cloud-Azure-Network-FrontDoor-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
