...
2. Sur l'interface Web Centreon, installer le Pack *Azure InsightsMetrics* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**.
...
3. Sur l'interface Web Centreon, installer le Pack *Azure InsightsMetrics* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**.
