...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Juniper SA** 
...
Le connecteur de supervision **Juniper SA** apporte un modèle d'hôte :
...
|:---------------------|:------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------:|
| CPU-Detailed         | Net-Juniper-SA-Cpu-Detailed-SNMP-custom         | Contrôle du taux d'utilisation du CPU de la machine. Ce contrôle pourra remonter la moyenne du taux d'utilisation des CPU                                   |            |
| Disk                 | Net-Juniper-SA-Disk-SNMP-custom                 | Contrôle l'utilisation du disque                                                                                                                            |            |
| Traffic-Generic-ID   | Net-Juniper-SA-Traffic-Generic-ID-SNMP-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Generic-Name | Net-Juniper-SA-Traffic-Generic-Name-SNMP-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Global       | Net-Juniper-SA-Traffic-Global-SNMP-custom       | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface) | X          |
| Users                | Net-Juniper-SA-Users-SNMP-custom                | Contrôle les utilisateurs connectés                                                                                                                         |            |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Juniper-SA-custom**. |
...
| Nom de la règle             | Description                                                                                       |
|:----------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Juniper-SA-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Juniper SA**
...
3. Appliquez le modèle d'hôte **Net-Juniper-SA-custom**.
