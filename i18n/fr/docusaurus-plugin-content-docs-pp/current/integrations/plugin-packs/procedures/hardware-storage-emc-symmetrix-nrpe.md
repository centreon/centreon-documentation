...
|:----------------|:-----------------------------------------------------------|:---------------------------------------------------------------|
| Hardware-Global | HW-Storage-EMC-Symmetrix-Dmx34-Hardware-Global-NRPE-custom | Contrôle permettant de vérifier l'état des composants matériel |
| Hardware-Global | HW-Storage-EMC-Symmetrix-Vmax-Hardware-Global-NRPE-custom  | Contrôle permettant de vérifier l'état des composants matériel |
