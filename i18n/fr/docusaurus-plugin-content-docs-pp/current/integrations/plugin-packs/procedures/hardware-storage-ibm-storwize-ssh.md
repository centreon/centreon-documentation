...
| enclosure battery status                               | N/A   |
| enclosure canister status                              | N/A   |
| enclosure power supply status                          | N/A   |
| host status                                            | N/A   |
| mdisk status                                           | N/A   |
| node status                                            | N/A   |
| FC port status                                         | N/A   |
| SAS port status                                        | N/A   |
| quorum status                                          | N/A   |
| system stats status                                    | N/A   |
| *system_stats_name*#hardware.systemstats.current.count | count |
| vdisk status                                           | N/A   |
...
| Nom                      | Unité |
|:-------------------------|:------|
| eventlogs.problems.count | count |
