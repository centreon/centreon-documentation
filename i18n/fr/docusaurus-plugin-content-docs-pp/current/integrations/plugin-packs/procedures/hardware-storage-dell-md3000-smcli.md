...
Le connecteur de supervision **Dell MD3000** apporte un modèle d'hôte :

* **HW-Storage-Dell-MD3000-Cli-custom**
...
```bash
dnf install centreon-pack-hardware-storage-dell-md3000-smcli
```
...
```bash
apt install centreon-pack-hardware-storage-dell-md3000-smcli
```
...
```bash
yum install centreon-pack-hardware-storage-dell-md3000-smcli
```
...
```bash
dnf install centreon-plugin-Hardware-Storage-Dell-Md3000-Smcli
```
...
```bash
apt install centreon-plugin-hardware-storage-dell-md3000-smcli
```
...
3. Appliquez le modèle d'hôte **HW-Storage-Dell-MD3000-Cli-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
```bash
/usr/lib/centreon/plugins/centreon_dell_md3000.pl \
...
|:---------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------|
| health-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/smcli/mode/healthstatus.pm)] | HW-Storage-Dell-MD3000-Health-Status-Cli-custom |
