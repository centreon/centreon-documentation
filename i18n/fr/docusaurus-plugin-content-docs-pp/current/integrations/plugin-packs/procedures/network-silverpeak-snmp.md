...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Silverpeak SNMP** 
...
Le connecteur de supervision **Silverpeak SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="Net-Silverpeak-SNMP-custom" label="Net-Silverpeak-SNMP-custom">
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Silverpeak-SNMP-custom**. |
...
| Nom de la règle                  | Description                                                                                       |
|:---------------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Silverpeak-SNMP-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
<TabItem value="OperStatus" label="OperStatus">
...
```bash
dnf install centreon-pack-network-silverpeak-snmp
```
...
```bash
yum install centreon-pack-network-silverpeak-snmp
```

</TabItem>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Silverpeak SNMP**
...
```bash
dnf install centreon-plugin-Network-Silverpeak-Snmp
```
...
```bash
yum install centreon-plugin-Network-Silverpeak-Snmp
```
...
| WARNINGSTATUS  | Define the conditions to match for the status to be WARNING You can use the following variables: %\{severity\}, %\{text\}, %\{source\}, %\{since\}   | %\{severity\} =~ /minor\|warning/i  |             |
| CRITICALSTATUS | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{severity\}, %\{text\}, %\{source\}, %\{since\} | %\{severity\} =~ /critical\|major/i |             |
...
| CRITICALSTATUS | Trigger critical on %\{operStatus\} values/') | '%\{operStatus\} !~ /(Normal |             |
...
```bash
/usr/lib/centreon/plugins/centreon_silverpeak_snmp.pl \
	--plugin network::silverpeak::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:-----------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------|
| alarms [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/silverpeak/snmp/mode/alarms.pm)]        | Net-Silverpeak-Alarms-SNMP-custom                                                                                                                 |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | Net-Silverpeak-Traffic-Generic-Id-SNMP-custom<br />Net-Silverpeak-Traffic-Generic-Name-SNMP-custom<br />Net-Silverpeak-Traffic-Global-SNMP-custom |
...
| status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/silverpeak/snmp/mode/status.pm)]        | Net-Silverpeak-OperStatus-SNMP-custom                                                                                                             |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/silverpeak/snmp/mode/uptime.pm)]        | Net-Silverpeak-Uptime-SNMP-custom                                                                                                                 |
