...
description: "Supervisez Azure Functions via l'API Azure Monitor ou Azure CLI : temps processeur, mémoire, requêtes HTTP, exécutions et état de l'application."
---
