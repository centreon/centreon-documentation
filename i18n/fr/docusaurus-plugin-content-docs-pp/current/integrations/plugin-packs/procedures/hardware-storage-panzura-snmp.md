...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Panzura SNMP** 
...
Le connecteur de supervision **Panzura SNMP** apporte un modèle d'hôte :
...
| Load                    | HW-Storage-Panzura-Load-SNMP-custom                    | Contrôle de la charge serveur                                   |            |
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Storage-Panzura-SNMP-custom**. |
...
| Nom de la règle                            | Description                                                                                       |
|:-------------------------------------------|:--------------------------------------------------------------------------------------------------|
| HW-Storage-Panzura-SNMP-Packet-Errors-Name | Découvre les interfaces réseau en utilisant leur nom et supervise les paquets erronés et rejetés  |
| HW-Storage-Panzura-SNMP-Traffic-Name       | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
> Concerne les modèles de service suivants : Disk-Usage-Cloud-Generic-Name, Disk-Usage-Cloud-Global
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Panzura SNMP**
...
3. Appliquez le modèle d'hôte **HW-Storage-Panzura-SNMP-custom**.
