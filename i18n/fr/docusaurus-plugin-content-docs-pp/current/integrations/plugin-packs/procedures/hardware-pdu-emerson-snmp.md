...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Emerson PDU SNMP** 
depuis la page **Configuration > Connectors > Connecteurs de supervision** :
...
Le connecteur de supervision **Emerson PDU SNMP** apporte un modèle d'hôte :
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Pdu-Emerson-SNMP-custom**. |
...
L'agent SNMP doit être activé et configuré sur l'équipement. Référez-vous à la [documentation officielle](https://www.emerson.com/en-us/support/manuals-and-guides). 
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Emerson PDU SNMP**
...
| CRITICALSTATUS | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{status\}, %\{display\}                     | %\{status\} =~ /normalWithAlarm\|abnormalOperation/i |             |
| WARNINGSTATUS  | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{status\}, %\{display\}                      | %\{status\} =~ /normalWithWarning/i                  |             |
...
| WARNINGCURRENTNEUTRAL  | Threshold                                                                                                                                        |                   |             |
| CRITICALCURRENTNEUTRAL | Threshold                                                                                                                                        |                   |             |
| WARNINGENERGY          | Threshold                                                                                                                                        |                   |             |
| CRITICALENERGY         | Threshold                                                                                                                                        |                   |             |
| WARNINGLINECURRENT     | Threshold                                                                                                                                        |                   |             |
| CRITICALLINECURRENT    | Threshold                                                                                                                                        |                   |             |
| WARNINGLINELOAD        | Threshold                                                                                                                                        |                   |             |
| CRITICALLINELOAD       | Threshold                                                                                                                                        |                   |             |
...
| Macro                             | Description                                                                                                                                          | Valeur par défaut                    | Obligatoire |
|:----------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------|:-----------:|
| FILTERNAME                        | Filter receptacle branch name (can be a regexp)                                                                                                      |                                      |             |
| UNKNOWNRCPSTATUS                  | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{oper\_state\}, %\{power\_state\}, %\{display\}  |                                      |             |
| WARNINGCURRENTNEUTRAL             | Threshold                                                                                                                                            |                                      |             |
| CRITICALCURRENTNEUTRAL            | Threshold                                                                                                                                            |                                      |             |
| WARNINGLINE2NEUTRALAPPARENTPOWER  | Threshold                                                                                                                                            |                                      |             |
| CRITICALLINE2NEUTRALAPPARENTPOWER | Threshold                                                                                                                                            |                                      |             |
| WARNINGLINE2NEUTRALREALPOWER      | Threshold                                                                                                                                            |                                      |             |
| CRITICALLINE2NEUTRALREALPOWER     | Threshold                                                                                                                                            |                                      |             |
| WARNINGPOTENTIALNEUTRAL           | Threshold                                                                                                                                            |                                      |             |
| CRITICALPOTENTIALNEUTRAL          | Threshold                                                                                                                                            |                                      |             |
| WARNINGRCPSTATUS                  | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{oper\_state\}, %\{power\_state\}, %\{display\}  | %\{oper\_state\} =~ /warning\|alarm/ |             |
| CRITICALRCPSTATUS                 | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{oper\_state\}, %\{power\_state\}, %\{display\} | %\{oper\_state\} =~ /abnormal/       |             |
| WARNINGTOTALACCUMULATEDENERGY     | Threshold                                                                                                                                            |                                      |             |
| CRITICALTOTALACCUMULATEDENERGY    | Threshold                                                                                                                                            |                                      |             |
| EXTRAOPTIONS                      | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles).     | --verbose                            |             |
...
/usr/lib/centreon/plugins/centreon_pdu_emerson_snmp.pl \
	...
	--filter-rb='' \
	--warning-total-accumulated-energy='' \
	--critical-total-accumulated-energy='' \
	--warning-line2neutral-real-power='' \
	--critical-line2neutral-real-power='' \
	--warning-line2neutral-apparent-power='' \
	--critical-line2neutral-apparent-power='' \
	--warning-current-neutral='' \
	--critical-current-neutral='' \
	--warning-potential-neutral='' \
	--critical-potential-neutral='' \
	--unknown-rcp-status='' \
	--warning-rcp-status='%\{oper\_state\} =~ /warning|alarm/' \
	--critical-rcp-status='%\{oper\_state\} =~ /abnormal/' \
	--verbose
```
...
| --unknown-rcp-status     |   Define the conditions to match for the status to be WARNING (default: ''). You can use the following variables: %\{oper\_state\}, %\{power\_state\}, %\{display\}                                       |
| --warning-rcp-status     |   Define the conditions to match for the status to be WARNING (default: '%\{oper\_state\} =~ /warning\|alarm/'). You can use the following variables: %\{oper\_state\}, %\{power\_state\}, %\{display\}   |
| --critical-rcp-status    |   Define the conditions to match for the status to be CRITICAL (default: '%\{oper\_state\} =~ /abnormal/'). You can use the following variables: %\{oper\_state\}, %\{power\_state\}, %\{display\}        |
