...
Le connecteur de supervision **APC PDU** apporte un modèle d'hôte :
...
| Load     | HW-Pdu-Apc-SNMP-Load-custom     | Contrôle la charge       |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **APC PDU**
