...
Le connecteur de supervision **Dell iDRAC** apporte un modèle d'hôte :
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Dell iDRAC**
