...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Dell iDRAC SNMP** 
...
Le connecteur de supervision **Dell iDRAC SNMP** apporte un modèle d'hôte :
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Server-Dell-iDrac-SNMP-custom**. |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Dell iDRAC SNMP**
...
3. Appliquez le modèle d'hôte **HW-Server-Dell-iDrac-SNMP-custom**.
