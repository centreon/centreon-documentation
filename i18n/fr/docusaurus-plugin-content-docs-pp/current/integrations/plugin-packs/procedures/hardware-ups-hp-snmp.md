...
Le connecteur de supervision **HP UPS SNMP** apporte un modèle d'hôte :
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-UPS-HP-SNMP-custom** est utilisé.
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-UPS-HP-SNMP-custom**. |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **HP UPS SNMP**
...
3. Appliquez le modèle d'hôte **HW-UPS-HP-SNMP-custom**.
