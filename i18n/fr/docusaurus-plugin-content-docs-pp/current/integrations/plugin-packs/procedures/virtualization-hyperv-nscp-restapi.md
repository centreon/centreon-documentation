...
| WARNINGGLOBALSTATUS   | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{vm\}, %{integration\_service\_state}, %{integration\_service\_version}, %\{state\}  | %\{integration_service_state\}=~ /Update required/i |             |
...
| --warning-global-status   | Define the conditions to match for the status to be WARNING (default: '%\{integration_service_state\}=~ /Update required/i'). You can use the following variables: %\{vm\}, %{integration\_service\_state}, %{integration\_service\_version}, %\{state\}   |
