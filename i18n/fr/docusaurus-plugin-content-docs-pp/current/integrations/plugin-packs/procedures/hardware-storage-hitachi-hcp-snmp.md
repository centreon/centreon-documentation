...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Hitachi HCP SNMP**
...
Le connecteur de supervision **Hitachi HCP SNMP** apporte un modèle d'hôte :
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-Hitachi-Hcp-SNMP-custom** est utilisé.
...
|:--------|:-------------------------------------------|:---------------------|:----------:|
| Nodes   | HW-Storage-Hitachi-Hcp-Nodes-SNMP-custom   | Contrôle les nodes   | X          |
| Tenants | HW-Storage-Hitachi-Hcp-Tenants-SNMP-custom | Contrôle les tenants | X          |
| Volumes | HW-Storage-Hitachi-Hcp-Volumes-SNMP-custom | Contrôle les volumes | X          |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Storage-Hitachi-Hcp-SNMP-custom**. |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Hitachi HCP SNMP**
...
3. Appliquez le modèle d'hôte **HW-Storage-Hitachi-Hcp-SNMP-custom**.
