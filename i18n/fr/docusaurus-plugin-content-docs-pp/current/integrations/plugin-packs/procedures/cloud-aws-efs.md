...
Amazon Elastic File System (Amazon EFS) est un système de stockage de fichiers NFS simple, 
évolutif, souple qui s’utilise avec AWS Cloud Services et les ressources sur site. 
Il prend en charge plusieurs pétaoctets de données à la demande sans interrompre les applications, 
ajustant automatiquement sa capacité à la hausse ou à la baisse en fonction de l'ajout ou 
...
Le connecteur de supervision **Amazon EFS** apporte un modèle d'hôte :
...
|:----------------|:-------------------------------------|:----------------------------------------------------------|
| Efs-Connections | Cloud-Aws-Efs-Connections-Api-custom | Contrôle le nombre de connexions aux fichiers système EFS |
| Efs-DataUsage   | Cloud-Aws-Efs-Datausage-Api-custom   | Contrôle les métriques liées aux fichiers système EFS     |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Aws-Efs-custom** est utilisé.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Amazon EFS**
...
3. Appliquez le modèle d'hôte **Cloud-Aws-Efs-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
