...
Le connecteur de supervision **Enterasys SNMP** apporte un modèle d'hôte :
...
|:--------|:----------------------------------|:----------------------------------------------------------|
| Cpu     | Net-Enterasys-Cpu-SNMP-custom     | Contrôle du taux d'utilisation du CPU de la machine       |
| Memory  | Net-Enterasys-Memory-SNMP-custom  | Contrôle du taux d'utilisation mémoire                    |
| Storage | Net-Enterasys-Storage-SNMP-custom | Contrôle l'utilisation du stockage                        |
| Uptime  | Net-Enterasys-Uptime-SNMP-custom  | Durée depuis laquelle le serveur tourne sans interruption |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Enterasys-SNMP-custom** est utilisé.
...
|:-----------|:-------------------------------------|:------------------------|:----------:|
| Interfaces | Net-Enterasys-Interfaces-SNMP-custom | Contrôle les interfaces | X          |
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Enterasys-SNMP-custom** |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Enterasys SNMP**
depuis l'interface web et le menu **Configuration > Gestionnaire de connecteurs de supervision**.
...
3. Appliquez le modèle d'hôte **Net-Enterasys-SNMP-custom**.
