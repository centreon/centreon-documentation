...
| Alias | Modèle de service                             | Description                                                |
|:------|:----------------------------------------------|:-----------------------------------------------------------|
| Chf   | Net-HPE-Athonet-Node-Exporter-Chf-Api-custom  | Contrôle la fonction                                       |
| Dra   | Net-HPE-Athonet-Node-Exporter-Dra-Api-custom  | Contrôle la fonction                                       |
| Eir   | Net-HPE-Athonet-Node-Exporter-Eir-Api-custom  | Contrôle la fonction equipment identity register d'Athonet |
| Mme   | Net-HPE-Athonet-Node-Exporter-Mme-Api-custom  | Contrôle la fonction                                       |
| Nrf   | Net-HPE-Athonet-Node-Exporter-Nrf-Api-custom  | Contrôle la fonction                                       |
| Pcf   | Net-HPE-Athonet-Node-Exporter-Pcf-Api-custom  | Contrôle la fonction                                       |
| Sgwc  | Net-HPE-Athonet-Node-Exporter-Sgwc-Api-custom | Contrôle la fonction                                       |
| Smf   | Net-HPE-Athonet-Node-Exporter-Smf-Api-custom  | Contrôle la fonction                                       |
| Smsf  | Net-HPE-Athonet-Node-Exporter-Smsf-Api-custom | Contrôle la fonction                                       |
| Udm   | Net-HPE-Athonet-Node-Exporter-Udm-Api-custom  | Contrôle la fonction                                       |
| Udr   | Net-HPE-Athonet-Node-Exporter-Udr-Api-custom  | Contrôle la fonction                                       |
| Upf   | Net-HPE-Athonet-Node-Exporter-Upf-Api-custom  | Contrôle la fonction                                       |
...
| UNKNOWNDIAMETERCONNECTIONSTATUS     | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>  |                        |             |
...
| CRITICALDIAMETERCONNECTIONSTATUS    | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\> | %\{status\} =~ /down/i |             |
| WARNINGDIAMETERCONNECTIONSTATUS     | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>  |                        |             |
...
| FILTERCOUNTERSBLOCK              |                                                                                                                                                            |                        |             |
| FILTERCOUNTERS                   | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                                  |                        |             |
| UNKNOWNINTERFACES1ENBSTATUS      | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{enbId\}\>                        |                        |             |
| UNKNOWNDIAMETERCONNECTIONSTATUS  | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>  |                        |             |
| UNKNOWNGTPCCONNECTIONSTATUS      | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>  |                        |             |
| CRITICALDIAMETERCONNECTIONSTATUS | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\> | %\{status\} =~ /down/i |             |
| WARNINGDIAMETERCONNECTIONSTATUS  | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>  |                        |             |
...
| CRITICALGTPCCONNECTIONSTATUS     | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\> | %\{status\} =~ /down/i |             |
| WARNINGGTPCCONNECTIONSTATUS      | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>  |                        |             |
| WARNINGIMSITRACKED               | Thresholds                                                                                                                                                 |                        |             |
| CRITICALIMSITRACKED              | Thresholds                                                                                                                                                 |                        |             |
| CRITICALINTERFACES1ENBSTATUS     | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{enbId\}\>                       | %\{status\} =~ /down/i |             |
| WARNINGINTERFACES1ENBSTATUS      | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{enbId\}\>                        |                        |             |
...
| UNKNOWNNODESTATUS                 | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{repository\}\>, C\<%\{node\}\>  |                              |             |
| UNKNOWNNFREGISTRATIONSTATUS       | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{nfType\}\>                      |                              |             |
| WARNINGCLUSTERNODESDETECTED       | Thresholds                                                                                                                                                |                              |             |
| CRITICALCLUSTERNODESDETECTED      | Thresholds                                                                                                                                                |                              |             |
| WARNINGCLUSTERNODESNOTRUNNING     | Thresholds                                                                                                                                                |                              |             |
| CRITICALCLUSTERNODESNOTRUNNING    | Thresholds                                                                                                                                                |                              |             |
...
| CRITICALNFREGISTRATIONSTATUS      | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{nfType\}\>                     | %\{status\} =~ /suspended/i  |             |
| WARNINGNFREGISTRATIONSTATUS       | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{nfType\}\>                      |                              |             |
| CRITICALNODESTATUS                | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{repository\}\>, C\<%\{node\}\> | %\{status\} =~ /notRunning/i |             |
| WARNINGNODESTATUS                 | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{repository\}\>, C\<%\{node\}\>  |                              |             |
| EXTRAOPTIONS                      | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles).          | --verbose                    |             |
...
| FILTERCOUNTERSBLOCK          |                                                                                                                                                                      |                              |             |
| FILTERCOUNTERS               | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                                            |                              |             |
| UNKNOWNPFCPNODESTATUS        | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>            |                              |             |
| UNKNOWNGTPCCONNECTIONSTATUS  | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>            |                              |             |
| UNKNOWNBLACKLISTNODESTATUS   | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>  |                              |             |
| CRITICALBLACKLISTNODESTATUS  | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\> | %\{isBlacklisted\} =~ /yes/i |             |
| WARNINGBLACKLISTNODESTATUS   | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>  |                              |             |
| WARNINGDFB                   | Thresholds                                                                                                                                                           |                              |             |
| CRITICALDFB                  | Thresholds                                                                                                                                                           |                              |             |
| CRITICALGTPCCONNECTIONSTATUS | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>           | %\{status\} =~ /down/i       |             |
| WARNINGGTPCCONNECTIONSTATUS  | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>            |                              |             |
| CRITICALPFCPNODESTATUS       | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>           | %\{status\} =~ /down/i       |             |
| WARNINGPFCPNODESTATUS        | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>            |                              |             |
...
| FILTERCOUNTERSBLOCK                 |                                                                                                                                                                      |                              |             |
| FILTERCOUNTERS                      | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                                            |                              |             |
| UNKNOWNSBINFREGISTRATIONSTATUS      | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>                                                   |                              |             |
| UNKNOWNPFCPNODESTATUS               | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>            |                              |             |
| UNKNOWNBLACKLISTNODESTATUS          | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>  |                              |             |
| CRITICALBLACKLISTNODESTATUS         | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\> | %\{isBlacklisted\} =~ /yes/i |             |
| WARNINGBLACKLISTNODESTATUS          | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>  |                              |             |
...
| CRITICALSBINFREGISTRATIONSTATUS     | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>                                                  | %\{status\} =~ /suspended/i  |             |
| WARNINGSBINFREGISTRATIONSTATUS      | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>                                                   |                              |             |
...
| FILTERCOUNTERSBLOCK          |                                                                                                                                                            |                        |             |
| FILTERCOUNTERS               | Only display some counters (regexp can be used). Example to check SSL connections only : --filter-counters='^xxxx\|yyyy$'                                  |                        |             |
| UNKNOWNUPFPFCPNODESTATUS     | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>  |                        |             |
...
| CRITICALUPFPFCPNODESTATUS    | Define the conditions to match for the status to be CRITICAL. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\> | %\{status\} =~ /down/i |             |
| WARNINGUPFPFCPNODESTATUS     | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>  |                        |             |
...
```bash
OK: fpcf nodes detected: 1541 sessions: 9064 GTP-U interfaces: 29286 IP interfaces: 58831 DNN: 15145 All PFCP nodes are ok | 'upf.pfcp.nodes.detected.count'=1541;;;0; 'upf.sessions.count'=9064;;;0; 'upf.gtpu.interfaces.count'=29286;;;0; 'upf.ip.interfaces.count'=58831;;;0; 'upf.dnn.count'=15145;;;0; 
```
...
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/cpu.pm)]                  | Non utilisé dans ce connecteur de supervision     |
| cpu-detailed [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/cpudetailed.pm)] | Non utilisé dans ce connecteur de supervision     |
...
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/interfaces.pm)]    | Non utilisé dans ce connecteur de supervision     |
...
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/load.pm)]                | Non utilisé dans ce connecteur de supervision     |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/memory.pm)]            | Non utilisé dans ce connecteur de supervision     |
...
| storage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/storage.pm)]          | Non utilisé dans ce connecteur de supervision     |
...
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/prometheus/exporters/nodeexporter/mode/uptime.pm)]            | Non utilisé dans ce connecteur de supervision     |
...
| --url-path                                 | API url path (default: C\</core/prometheus/api/v1\>)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| --unknown-diameter-connection-status     | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>                                         |
| --warning-diameter-connection-status     | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>                                         |
| --critical-diameter-connection-status    | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\> |
...
| Option                                | Description                                                                                                                                                                                        |
|:--------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --unknown-interface-s1enb-status      | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{enbId\}\>.                                                               |
| --warning-interface-s1enb-status      | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{enbId\}\>.                                                               |
| --critical-interface-s1enb-status     | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{enbId\}\>.                       |
| --unknown-diameter-connection-status  | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>.                                         |
| --warning-diameter-connection-status  | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>.                                         |
| --critical-diameter-connection-status | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{originHost\}\>, C\<%\{stack\}\>. |
| --unknown-gtpc-connection-status      | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                         |
| --warning-gtpc-connection-status      | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                         |
| --critical-gtpc-connection-status     | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>. |
...
| --unknown-node-status                  | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{repository\}\>, C\<%\{node\}\>.                                               |
| --warning-node-status                  | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{repository\}\>, C\<%\{node\}\>.                                               |
| --critical-node-status                 | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /notRunning/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{repository\}\>, C\<%\{node\}\>. |
| --unknown-nf-registration-status       | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{nfType\}\>.                                                                   |
| --warning-nf-registration-status       | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{nfType\}\>.                                                                   |
| --critical-nf-registration-status      | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /suspended/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{nfType\}\>.                      |
| --warning-clusters-detected            | Thresholds.                                                                                                                                                                                             |
| --critical-clusters-detected           | Thresholds.                                                                                                                                                                                             |
| --warning-cluster-nodes-detected       | Thresholds.                                                                                                                                                                                             |
| --critical-cluster-nodes-detected      | Thresholds.                                                                                                                                                                                             |
...
| Option                            | Description                                                                                                                                                                                                        |
|:----------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --unknown-pfcp-node-status        | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                                         |
| --warning-pfcp-node-status        | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                                         |
| --critical-pfcp-node-status       | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                 |
| --unknown-gtpc-connection-status  | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                                         |
| --warning-gtpc-connection-status  | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                                         |
| --critical-gtpc-connection-status | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                 |
| --unknown-blacklist-node-status   | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>.                                               |
| --warning-blacklist-node-status   | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>.                                               |
| --critical-blacklist-node-status  | Define the conditions to match for the status to be CRITICAL (default: C\<%\{isBlacklisted\} =~ /yes/i\>). You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>. |
...
| Option                                    | Description                                                                                                                                                                                                        |
|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --unknown-sbi-nf-registration-status      | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>.                                                                                                |
| --warning-sbi-nf-registration-status      | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>.                                                                                                |
| --critical-sbi-nf-registration-status     | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /suspended/i\>). You can use the following variables: C\<%\{status\}\>.                                                   |
| --unknown-pfcp-node-status                | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                                         |
| --warning-pfcp-node-status                | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                                         |
| --critical-pfcp-node-status               | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                 |
| --unknown-blacklist-node-status           | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{isBlacklisted\}\>, C\<%\{remoteIP\}\>, C\<%\{targetType\}\>.                                               |
...
| Option                             | Description                                                                                                                                                                                        |
|:-----------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --unknown-upf-pfcp-node-status     | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                         |
| --warning-upf-pfcp-node-status     | Define the conditions to match for the status to be WARNING. You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>.                                         |
| --critical-upf-pfcp-node-status    | Define the conditions to match for the status to be CRITICAL (default: C\<%\{status\} =~ /down/i\>). You can use the following variables: C\<%\{status\}\>, C\<%\{localIP\}\>, C\<%\{remoteIP\}\>. |
