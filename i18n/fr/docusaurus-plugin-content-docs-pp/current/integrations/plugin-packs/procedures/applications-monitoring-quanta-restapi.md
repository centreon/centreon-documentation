...
|:---------------------------|:--------------------------------------------------|:------------------------------------------------|
| RUM Overview               | App-Monitoring-Quanta-RUM-Restapi-custom          | Contrôle les métriques RUM d'un site            |
| Site Performances Overview | App-Monitoring-Quanta-Siteoverview-Restapi-custom | Contrôle les métriques de performance d'un site |
...
|:------------------------|:------------------------------------------------------------|:----------------------------------------------------|:----------:|
| User Journey Incidents  | App-Monitoring-Quanta-Userjourney-Incidents-Restapi-custom  | Contrôle les incidents d'une journée utilisateur    | X          |
| User Journey Statistics | App-Monitoring-Quanta-Userjourney-Statistics-Restapi-custom | Contrôle les statistiques d'un parcours utilisateur | X          |
...
3. Appliquez le modèle d'hôte **App-Monitoring-Quanta-Restapi-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
