...
| Nom                          | Unité |
|:-----------------------------|:------|
| hardware.communication.count | count |
...
| voltage status               | N/A   |
| hardware.electronics.count   | count |
| electronics status           | N/A   |
| hardware.raid.count          | count |
| raid status                  | N/A   |

</TabItem>
<TabItem value="Snapmirrorlag" label="Snapmirrorlag">
...
| WARNINGPORTHEALTH            | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{health\}, %\{port\_id\}, %\{node\_name\}                    | %\{health\} eq "degraded"                        |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'psu', 'fan', 'communication', 'voltage', 'temperature', 'electronics', 'raid'                                 | .*                |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
| Macro          | Description                                                                                                                                      | Valeur par défaut                                  | Obligatoire |
|:---------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------|:-----------:|
| FILTERNAME     | Filter the snapmirror name (can be a regexp)                                                                                                     |                                                    |             |
| FILTERSTATUS   | Filter on status (can be a regexp)                                                                                                               |                                                    |             |
| WARNINGLAG     | Warning threshold                                                                                                                                |                                                    |             |
| CRITICALLAG    | Critical threshold                                                                                                                               |                                                    |             |
| WARNINGSTATUS  | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{state\}, %\{display\}                       | %\{state\} =~ /quiesced/i                          |             |
| CRITICALSTATUS | Define the conditions to match for the status to be CRITICAL. You can use the following variables: %\{state\}, %\{display\}                      | %\{state\} =~ /unknown\|brokenOff\|uninitialized/i |             |
| EXTRAOPTIONS   | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose                                          |             |
...
| failover [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/failover.pm)]                   | Non utilisé dans ce connecteur de supervision                                                                      |
...
| list-cluster-nodes [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/listclusternodes.pm)] | Utilisé pour la découverte de services                                                                             |
| list-filesys [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/listfilesys.pm)]            | Utilisé pour la découverte de services                                                                             |
| list-plexes [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/listplexes.pm)]              | Utilisé pour la découverte de services                                                                             |
| list-snapvault [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/listsnapvault.pm)]        | Non utilisé dans ce connecteur de supervision                                                                      |
...
| sis [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/sis.pm)]                             | Non utilisé dans ce connecteur de supervision                                                                      |
| snapmirrorlag [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/snapmirrorlag.pm)]         | HW-Storage-NetApp-Ontap-Snapmirrorlag-SNMP-custom                                                                  |
...
| snapvault-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/netapp/ontap/snmp/mode/snapvaultusage.pm)]      | Non utilisé dans ce connecteur de supervision                                                                      |
...
| --critical           | Set critical threshold for temperature, fan, voltage (syntax: type,regexp,threshold) Example: --critical='temperature,.*,25' --critical='temperature,.*,35'                                                                |
...
| --warning-xxx     | Warning threshold.                                                                                                                                                                          |
| --critical-xxx    | Critical threshold.                                                                                                                                                                         |
| --filter-name     | Filter the snapmirror name (can be a regexp).                                                                                                                                               |
| --filter-status   | Filter on status (can be a regexp).                                                                                                                                                         |
| --unknown-status  | Define the conditions to match for the status to be UNKNOWN (default: ''). You can use the following variables: %\{state\}, %\{display\}                                                    |
| --warning-status  | Define the conditions to match for the status to be WARNING (default: '%\{state\} =~ /quiesced/i'). You can use the following variables: %\{state\}, %\{display\}                           |
| --critical-status | Define the conditions to match for the status to be CRITICAL (default: '%\{state\} =~ /unknown\|brokenOff\|uninitialized/i'). You can use the following variables: %\{state\}, %\{display\} |
| --warning-lag     | Warning threshold.                                                                                                                                                                          |
| --critical-lag    | Critical threshold.                                                                                                                                                                         |
