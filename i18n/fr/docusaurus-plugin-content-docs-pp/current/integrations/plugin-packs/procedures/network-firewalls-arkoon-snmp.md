...
| Swap   | Net-FW-Arkoon-Swap-SNMP-custom   | Contrôle du taux d'utilisation de la mémoire virtuelle  |
...
| Macro          | Description                                                                                                                                                                                                         | Valeur par défaut | Obligatoire |
|:---------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| FILTER         | Define the interface filter on IDs (OID indexes, e.g.: 1,2,...). If empty, all interfaces will be monitored.                                                                                                        | .*                |             |
| WARNINGIN      | Thresholds                                                                                                                                                                                                          | 80                |             |
| CRITICALIN     | Thresholds                                                                                                                                                                                                          | 90                |             |
| WARNINGOUT     | Thresholds                                                                                                                                                                                                          | 80                |             |
| CRITICALOUT    | Thresholds                                                                                                                                                                                                          | 90                |             |
...
```bash
OK: Ram Total: 1.92 GB Used (-buffers/cache): 681.77 MB (34.66%) Free: 1.26 GB (65.34%), Buffer: 36.63 MB, Cached: 501.87 MB, Shared: 28.91 MB | 'used'=714883072B;;;0;2062598144 'free'=1347715072B;;;0;2062598144 'used_prct'=34.66%;;;0;100 'buffer'=38412288B;;;0; 'cached'=526245888B;;;0; 'shared'=30310400B;;;0;
```
