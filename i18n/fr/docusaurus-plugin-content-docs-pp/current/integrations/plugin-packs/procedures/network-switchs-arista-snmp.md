...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Arista Switch SNMP**
...
|:--------|:-------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Bgp     | Net-Arista-Bgp-SNMP-custom     | Contrôle des peers BGP                                                                                                                                                         |
| Cpu     | Net-Arista-Cpu-SNMP-custom     | Contrôle du taux d'utilisation du CPU de l'équipement. Ce contrôle pourra remonter la moyenne du taux d'utilisation des CPU ainsi que le taux par CPU pour les CPU multi-coeur |
| Memory  | Net-Arista-Memory-SNMP-custom  | Contrôle du taux d'utilisation de la mémoire vive                                                                                                                              |
| Sensors | Net-Arista-Sensors-SNMP-custom | Contrôle les sondes                                                                                                                                                            |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Arista-SNMP-custom** est utilisé.
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Arista-SNMP-custom** |
...
3. Appliquez le modèle d'hôte **Net-Arista-SNMP-custom**.
