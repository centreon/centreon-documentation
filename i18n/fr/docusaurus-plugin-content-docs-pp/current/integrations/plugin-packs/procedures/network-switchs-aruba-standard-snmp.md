...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Aruba Standard SNMP** 
...
| Alias             | Modèle de service                                | Description                                                                                                               |
|:------------------|:-------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
| Controller-Status | Net-Aruba-Standard-Controller-Status-SNMP-custom | Contrôle l'état des contrôleurs (fonctionne seulement sur le contrôleur maître)                                           |
...
| Hardware-Global   | Net-Aruba-Standard-Hardware-Global-SNMP-custom   | Contrôle l'ensemble du matériel ('ventilateur', 'modules', 'alimentations') de l'équipement                               |
...
| Nom de la règle                            | Description                                                                                       |
|:-------------------------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Aruba-Standard-SNMP-Packet-Errors-Name | Découvre les interfaces réseau en utilisant leur nom et supervise les paquets erronés et rejetés  |
| Net-Aruba-Standard-SNMP-Traffic-Name       | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
| SNMPPORT                | UDP port to send the SNMP request to                                                                                                                                   | 161               |             |
| APNAME                  | Threshold                                                                                                                                                              |                   |             |
| SNMPTIMEOUT             | Time to wait before sending the request again if no reply has been received, in seconds. See also --snmp-retries                                                       | 1                 |             |
...
| Macro                           | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:--------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| WARNINGBSSIDSTATIONSASSOCIATED  | Threshold                                                                                                                                        |                   |             |
| CRITICALBSSIDSTATIONSASSOCIATED | Threshold                                                                                                                                        |                   |             |
| WARNINGCHANNELNOISE             | Threshold                                                                                                                                        |                   |             |
| CRITICALCHANNELNOISE            | Threshold                                                                                                                                        |                   |             |
| WARNINGESSIDSTATIONSASSOCIATED  | Threshold                                                                                                                                        |                   |             |
| CRITICALESSIDSTATIONSASSOCIATED | Threshold                                                                                                                                        |                   |             |
| WARNINGSIGNALNOISERATIO         | Threshold                                                                                                                                        |                   |             |
| CRITICALSIGNALNOISERATIO        | Threshold                                                                                                                                        |                   |             |
...
| Macro                       | Description                                                                                                                                      | Valeur par défaut    | Obligatoire |
|:----------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------|:-----------:|
| WARNINGCONNECTEDCURRENT     | Threshold                                                                                                                                        |                      |             |
| CRITICALCONNECTEDCURRENT    | Threshold                                                                                                                                        |                      |             |
| WARNINGCONTROLLERBOOTSTRAP  | Threshold                                                                                                                                        |                      |             |
| CRITICALCONTROLLERBOOTSTRAP | Threshold                                                                                                                                        |                      |             |
| WARNINGREBOOT               | Threshold                                                                                                                                        |                      |             |
| CRITICALREBOOT              | Threshold                                                                                                                                        |                      |             |
| CRITICALSTATUS              | Threshold                                                                                                                                        | %\{status\} !~ /up/i |             |
...
| WARNINGCONNECTEDCURRENT  | Threshold                                                                                                                                        |                          |             |
| CRITICALCONNECTEDCURRENT | Threshold                                                                                                                                        |                          |             |
| CRITICALSTATUS           | Threshold                                                                                                                                        | %\{status\} !~ /active/i |             |
| WARNINGSTATUS            | Threshold                                                                                                                                        |                          |             |
| EXTRAOPTIONS             | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose                |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'fan', 'psu', 'module'                                                                                         | fan               |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'fan', 'psu', 'module'                                                                                         | .*                |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'fan', 'psu', 'module'                                                                                         | module            |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'fan', 'psu', 'module'                                                                                         | psu               |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
| Macro          | Description                                                                                                                                      | Valeur par défaut                                                               | Obligatoire |
|:---------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------|:-----------:|
| CRITICALSTATUS | Critical threshold. Can use special variables like: %\{key\}, %\{service\}, %\{flag\}, %\{expires\}')                                            | %\{flag\} !~ /enabled/i \|\| (%\{expires\} ne "Never" && %\{expires\} \< 86400) |             |
| WARNINGSTATUS  | Warning threshold. Can use special variables like:%\{key\}, %\{service\}, %\{flag\}, %\{expires\}                                                |                                                                                 |             |
| EXTRAOPTIONS   | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose                                                                       |             |
...
|:-----------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ap-connections [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/aruba/snmp/mode/apconnections.pm)]        | Non utilisé dans ce connecteur de supervision                                                                                                                                                                                                                                                                                                      |
...
| ap-users [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/aruba/snmp/mode/apusers.pm)]                    | Non utilisé dans ce connecteur de supervision                                                                                                                                                                                                                                                                                                      |
...
| discovery [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/aruba/snmp/mode/discovery.pm)]                 | Utilisé pour la découverte d'hôtes                                                                                                                                                                                                                                                                                                                 |
