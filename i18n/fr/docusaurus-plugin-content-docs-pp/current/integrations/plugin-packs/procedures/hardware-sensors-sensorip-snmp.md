...
<Tabs groupId="sync">
<TabItem value="HW-Sensor-Sensorip-SNMP-custom" label="HW-Sensor-Sensorip-SNMP-custom">

| Alias          | Modèle de service                              | Description                     |
|:---------------|:-----------------------------------------------|:--------------------------------|
| Sensors-Global | HW-Sensors-Sensorip-Sensors-Global-SNMP-custom | Contrôle l'ensemble des sondes  |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Sensor-Sensorip-SNMP-custom** est utilisé.
...
| Alias               | Modèle de service                                   | Description                                           |
|:--------------------|:----------------------------------------------------|:------------------------------------------------------|
| Sensors-Humidity    | HW-Sensors-Sensorip-Sensors-Humidity-SNMP-custom    | Contrôle les sondes d'humidité de l'équipement        |
| Sensors-Sp          | HW-Sensors-Sensorip-Sensors-Sp-SNMP-custom          | Contrôle le statut global des sondes  de l'équipement |
| Sensors-Switch      | HW-Sensors-Sensorip-Sensors-Switch-SNMP-custom      | Contrôle les sondes de contact de l'équipement        |
| Sensors-Temperature | HW-Sensors-Sensorip-Sensors-Temperature-SNMP-custom | Contrôle les sondes de température de l'équipement    |
...
```bash
dnf install centreon-pack-hardware-sensors-sensorip-snmp
```
...
```bash
apt install centreon-pack-hardware-sensors-sensorip-snmp
```
...
```bash
dnf install centreon-plugin-Hardware-Sensors-Sensorip-Snmp
```
...
```bash
apt install centreon-plugin-hardware-sensors-sensorip-snmp
```
...
|:-------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| sensors [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/sensors/sensorip/snmp/mode/sensors.pm)] | HW-Sensors-Sensorip-Sensors-Global-SNMP-custom<br />HW-Sensors-Sensorip-Sensors-Humidity-SNMP-custom<br />HW-Sensors-Sensorip-Sensors-Sp-SNMP-custom<br />HW-Sensors-Sensorip-Sensors-Switch-SNMP-custom<br />HW-Sensors-Sensorip-Sensors-Temperature-SNMP-custom |
...
|:---------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --component          | Which component to check (default: '.*'). Can be: 'sp', 'temperature', 'humidity', 'switch'.                                                                                                                            |
| --filter             | Exclude the items given as a comma-separated list (example: --filter=psu). You can also exclude items from specific instances: --filter=humidty,0                                                                       |
| --absent-problem     | Return an error if an entity is not 'present' (default is skipping) (comma separated list) Can be specific or global: --absent-problem=temperature#2#                                                                   |
| --no-component       | Define the expected status if no components are found (default: critical).                                                                                                                                              |
| --threshold-overload | Use this option to override the status returned by the plugin when the status label matches a regular expression (syntax: section,status,regexp). Example: --threshold-overload='temperature,CRITICAL,^(?!(normal)$)'   |
| --warning            | Set warning threshold for temperatures and humidity (syntax: type,regexp,threshold) Example: --warning='temperature,.*,30' --warning='humidity,.*,90'                                                                   |
| --critical           | Set critical threshold for temperature and humidity (syntax: type,regexp,threshold) Example: --critical='temperature,.*,40'                                                                                             |
