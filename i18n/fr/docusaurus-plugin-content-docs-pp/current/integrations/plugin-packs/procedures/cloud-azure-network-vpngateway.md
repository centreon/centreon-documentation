...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Azure VPN Gateway** 
...
d'hôtes nommé **Microsoft Azure VPN Gateway**. Celui-ci permet de découvrir l'ensemble des instances
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Azure VPN Gateway**
