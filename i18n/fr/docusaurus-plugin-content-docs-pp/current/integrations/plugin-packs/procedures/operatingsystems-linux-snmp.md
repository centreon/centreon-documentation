...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Linux SNMP** 
...
| Memory | OS-Linux-Memory-SNMP-custom | Contrôle l'utilisation de la mémoire vive (RAM)                                                                                                                              |
| Swap   | OS-Linux-Swap-SNMP-custom   | Contrôle du taux d'utilisation de la mémoire virtuelle (SWAP)                                                                                                                |
...
|:---------------------------|:------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------:|
| Cpu-Detailed               | OS-Linux-Cpu-Detailed-SNMP-custom               | Contrôle du taux d'utilisation détaillé des CPU de la machine. Ce contrôle pourra remonter la moyenne du taux d'utilisation des CPU ainsi que le taux par CPU pour les CPU multi-coeur |            |
...
| Inodes-Global              | OS-Linux-Inodes-Global-SNMP-custom              | Contrôle l'utilisation des inodes des partitions                                                                                                                                       | X          |
| Ntp                        | OS-Linux-NTP-SNMP-custom                        | Contrôle la synchronisation avec un serveur NTP                                                                                                                                        |            |
| Packet-Errors-Generic-Id   | Os-Linux-Packet-Errors-Generic-Id-SNMP-custom   | Contrôle le pourcentage de paquets en erreur/écartés de plusieurs interfaces réseau                                                                                                    |            |
| Packet-Errors-Generic-Name | Os-Linux-Packet-Errors-Generic-Name-SNMP-custom | Contrôle le pourcentage de paquets en erreur/écartés d'une interface réseau                                                                                                            |            |
| Packet-Errors-Global       | Os-Linux-Packet-Errors-Global-SNMP-custom       | Contrôle le pourcentage de paquets en erreur/écartés de plusieurs interfaces réseau                                                                                                    | X          |
...
| Tcpcon-Generic             | OS-Linux-Tcpcon-Generic-SNMP-custom             | Contrôle permettant de vérifier les connexions TCP                                                                                                                                     |            |
...
| SNMP v3 Agents enhanced | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **OS-Linux-SNMP-custom**. |
...
| Nom de la règle                  | Description                                                                                               |
|:---------------------------------|:----------------------------------------------------------------------------------------------------------|
| OS-Linux-SNMP-Disk-IO            | Découvre les partitions du disque en utilisant son nom et supervise l'utilisation des inodes              |
| OS-Linux-SNMP-Disk-Name          | Utilise le nom du disque pour découvrir les partitions du disque et supervise l'occupation de l'espace    |
| OS-Linux-SNMP-Disk-Path          | Découvre les interfaces réseau en utilisant leur nom et supervise les paquets erronés et rejetés          |
| OS-Linux-SNMP-Inodes-Name        | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation         |
| OS-Linux-SNMP-Packet-Errors-Name | Utilise le chemin du disque pour découvrir les partitions du disque et supervise l'occupation de l'espace |
| OS-Linux-SNMP-Processes-Name     | Découvre les processus en utilisant leur nom et supervise leur utilisation par le système                 |
| OS-Linux-SNMP-Traffic-Name       | Découvre les partitions du disque en utilisant son IO et supervise l'espace occupé                        |
...
|:-----------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| arp [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/arp.pm)]                        | Non utilisé dans ce connecteur de supervision                                                                                                                                                                                                                                          |
...
| disk-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/diskusage.pm)]           | Non utilisé dans ce connecteur de supervision                                                                                                                                                                                                                                          |
...
| list-diskio [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listdiskio.pm)]         | Utilisé pour la découverte de services                                                                                                                                                                                                                                                 |
| list-diskspath [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listdiskspath.pm)]   | Utilisé pour la découverte de services                                                                                                                                                                                                                                                 |
...
| list-processes [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listprocesses.pm)]   | Utilisé pour la découverte de services                                                                                                                                                                                                                                                 |
...
| udpcon [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/udpcon.pm)]                  | Non utilisé dans ce connecteur de supervision                                                                                                                                                                                                                                          |
...
| --regexp                                        | Allows to use regexp to filter disk path (with option --name).                                                                                                                                    |
| --regexp-insensitive                            | Allows to use regexp non case-sensitive (with --regexp).                                                                                                                                          |
