...
slug: /hardware-ups-standard-rfc1628-snmp
...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **UPS Standard** 
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-UPS-Standard-Rfc1628-SNMP-custom**. |
...
```bash
OK: frequence: 67 Hz All output lines are ok | 'lines.output.frequence.hertz'=67Hz;;;; 'oline1#line.output.load.percentage'=81%;;;0;100 'oline2#line.output.load.percentage'=90%;;;0;100 'oline1#line.output.current.ampere'=25A;;;0; 'oline2#line.output.current.ampere'=8A;;;0; 'oline1#line.output.voltage.volt'=294V;;;; 'oline2#line.output.voltage.volt'=238V;;;; 'oline1#line.output.power.watt'=187W;;;; 'oline2#line.output.power.watt'=563W;;;; 
```
