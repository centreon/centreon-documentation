...
Le connecteur de supervision **HP Moonshot SNMP** apporte un modèle d'hôte :
...
|:-------|:-----------------------------------|:----------------------------------|
| Cpu    | Net-Hp-Moonshot-Cpu-SNMP-custom    | Contrôle l'utilisation processeur |
| Memory | Net-Hp-Moonshot-Memory-SNMP-custom | Contrôle l'utilisation mémoire    |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Hp-Moonshot-SNMP-custom** est utilisé.
...
|:-----------|:---------------------------------------|:------------------------|:----------:|
| Interfaces | Net-Hp-Moonshot-Interfaces-SNMP-custom | Contrôle les interfaces | X          |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Hp-Moonshot-SNMP-custom** |
...
| Nom de la règle                     | Description                                                             |
|:------------------------------------|:------------------------------------------------------------------------|
| Net-Hp-Moonshot-SNMP-Interface-Name | Découvre les interfaces réseau et en supervise le statut et l'utilisation |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **HP Moonshot SNMP**
...
3. Appliquez le modèle d'hôte **Net-Hp-Moonshot-SNMP-custom**.
