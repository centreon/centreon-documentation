...
Le connecteur de supervision Centreon **Azure SQL Database** apporte un modèle d'hôte :
...
2. Sur l'interface web de Centreon, installez le connecteur de supervision **Azure SQL Database** depuis la page **Configuration > Packs de plugins**.
...
2. Sur le serveur central Centreon, installez le RPM du connecteur de supervision **Azure SQL Database** :

```bash
yum install centreon-pack-cloud-azure-database-sqldatabase
```

3. Sur l'interface web de Centreon, installez le connecteur de supervision **Azure SQL Database** depuis la page **Configuration > Packs de plugins**.
