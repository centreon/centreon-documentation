...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Azure-Database-SqlDatabase** est utilisé.
...
```bash
OK: App CPU percent  App Memory percent | 'sqldatabase.serverless.app.cpu.percentage'=95%;;;0; 'sqldatabase.serverless.app.memory.percentage'=62%;;;0; 
```
