...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Netbackup SSH**
...
Le connecteur de supervision **Netbackup SSH** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="App-Netbackup-SSH-custom" label="App-Netbackup-SSH-custom">

| Alias          | Modèle de service                       | Description                                                           | Découverte |
|:---------------|:----------------------------------------|:----------------------------------------------------------------------|:----------:|
| Dedup-Status   | App-Netbackup-SSH-Dedup-Status-custom   | Contrôle permettant de vérifier l'état de la déduplication            |            |
| Drive-Cleaning | App-Netbackup-SSH-Drive-Cleaning-custom | Contrôle permettant de vérifier si les lecteurs doivent être nettoyés |            |
| Drive-Status   | App-Netbackup-SSH-Drive-Status-custom   | Contrôle permettant de vérifier l'état des lecteurs                |            |
| Job-Status     | App-Netbackup-SSH-Job-Status-custom     | Contrôle permettant de vérifier l'état des jobs de sauvegarde      | X          |
| Tape-Usage     | App-Netbackup-SSH-Tape-Usage-custom     | Contrôle permettant de vérifier l'utilisation des bandes              |            |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Netbackup-SSH-custom** est utilisé.
...
```bash
dnf install centreon-pack-applications-netbackup-ssh
```
...
```bash
apt install centreon-pack-applications-netbackup-ssh
```
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Netbackup SSH**
...
```bash
dnf install centreon-plugin-Applications-Netbackup-Ssh
```
...
```bash
apt install centreon-plugin-applications-netbackup-ssh
```
...
3. Appliquez le modèle d'hôte **App-Netbackup-SSH-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
| FILTERSERVERNAME | Filter jobs by server name (can be a regexp)                                                                                                                                                                                                   |                                               |             |
...
|:-----------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------|
| dedup-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/netbackup/local/mode/dedupstatus.pm)]     | App-Netbackup-SSH-Dedup-Status-custom   |
| drive-cleaning [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/netbackup/local/mode/drivecleaning.pm)] | App-Netbackup-SSH-Drive-Cleaning-custom |
| drive-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/netbackup/local/mode/drivestatus.pm)]     | App-Netbackup-SSH-Drive-Status-custom   |
| job-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/netbackup/local/mode/jobstatus.pm)]         | App-Netbackup-SSH-Job-Status-custom     |
| list-policies [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/netbackup/local/mode/listpolicies.pm)]   | Used for service discovery              |
| tape-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/netbackup/local/mode/tapeusage.pm)]         | App-Netbackup-SSH-Tape-Usage-custom     |
