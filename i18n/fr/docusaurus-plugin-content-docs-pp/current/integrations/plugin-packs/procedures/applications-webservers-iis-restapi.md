...
| CRITICALSTATUS   | Define the conditions to match for the status to be CRITICAL (default: '%\{auto_start\} eq "true" and %\{status\} !~ /starting\|started/'). You can use the following variables: %\{status\}, %\{auto_start\}, %\{display\} | %\{auto_start\} eq "true" and %\{status\} !~ /starting\|started/ |             |
| WARNINGSTATUS    | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{status\}, %\{auto_start\}, %\{display\}                                                                             |                                                               |             |
...
| --unknown-status         | Define the conditions to match for the status to be UNKNOWN. You can use the following variables: %\{status\}, %\{auto_start\}, %\{display\}                                                                               |
| --warning-status         | Define the conditions to match for the status to be WARNING. You can use the following variables: %\{status\}, %\{auto_start\}, %\{display\}                                                                               |
| --critical-status        | Define the conditions to match for the status to be CRITICAL (default: '%\{auto_start\} eq "true" and %\{status\} !~ /starting\|started/'). You can use the following variables: %\{status\}, %\{auto_start\}, %\{display\}   |
