...
| WARNINGBIASCURRENT        | Thresholds (will superseed --\[warning-critical\]-errors). : 'input-power' (dBm), 'bias-current' (mA), 'output-power' (dBm), 'module-temperature' (C)                                                               |                                                       |             |
| CRITICALBIASCURRENT       | Thresholds (will superseed --\[warning-critical\]-errors). : 'input-power' (dBm), 'bias-current' (mA), 'output-power' (dBm), 'module-temperature' (C)                                                               |                                                       |             |
