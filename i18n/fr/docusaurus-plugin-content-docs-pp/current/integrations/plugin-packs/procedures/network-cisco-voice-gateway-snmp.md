...
<Tabs groupId="sync">
<TabItem value="Net-Cisco-Voice-Gateway-SNMP-custom" label="Net-Cisco-Voice-Gateway-SNMP-custom">

| Alias             | Modèle de service                                     | Description                              |
|:------------------|:------------------------------------------------------|:-----------------------------------------|
| Isdn-Usage-Global | Net-Cisco-Voice-Gateway-Isdn-Usage-Global-SNMP-custom | Contrôle l'utilisation des channels RNIS |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Cisco-Voice-Gateway-SNMP-custom** est utilisé.
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Cisco-Voice-Gateway-SNMP-custom** host template |
...
| Nom de la règle                           | Description                                                             |
|:------------------------------------------|:------------------------------------------------------------------------|
| Net-Cisco-Voice-Gateway-SNMP-Traffic-Name | Découvre les interfaces réseaux et supervise le statut et l'utilisation |
...
<Tabs groupId="sync">
<TabItem value="Isdn-Usage-Global" label="Isdn-Usage-Global">
...
```bash
dnf install centreon-pack-network-cisco-voice-gateway-snmp
```
...
```bash
yum install centreon-pack-network-cisco-voice-gateway-snmp
```
...
```bash
dnf install centreon-plugin-Network-Cisco-Voice-Gateway-Snmp
```
...
3. Appliquez le modèle d'hôte **Net-Cisco-Voice-Gateway-SNMP-custom**.
...
| WARNINGINCALLS       | Warning threshold                                                                                  |                   |             |
| CRITICALINCALLS      | Critical threshold                                                                                 |                   |             |
| WARNINGOUTCALLS      | Warning threshold                                                                                  |                   |             |
| CRITICALOUTCALLS     | Critical threshold                                                                                 |                   |             |
...
```bash
/usr/lib/centreon/plugins/centreon_cisco_voice_gateway_snmp.pl \
...
```bash
OK: 10 (1m) 12 (5m) 15 (15m) All connection types are ok | 'calls.active.1m.average.count'=10;;;0;'calls.active.5m.average.count'=12;;;0;'calls.active.15m.average.count'=15;;;0;'*ctype*#connection.calls.active.count'=;;;0;
```
...
|:-----------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]                      | Net-Cisco-Voice-Gateway-Traffic-Generic-Id-SNMP-custom<br />Net-Cisco-Voice-Gateway-Traffic-Generic-Name-SNMP-custom<br />Net-Cisco-Voice-Gateway-Traffic-Global-SNMP-custom |
| isdn-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/isdnusage.pm)]                       | Net-Cisco-Voice-Gateway-Isdn-Usage-Global-SNMP-custom                                                                                                                        |
| list-interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listinterfaces.pm)]             | Used for service discovery                                                                                                                                                   |
| voice-call [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/centreon/common/cisco/standard/snmp/mode/voicecall.pm)] | Net-Cisco-Voice-Gateway-Voice-Call-SNMP-custom                                                                                                                               |
...
| --filter-counters      | Only display some counters (regexp can be used). Example: --filter-counters='^current-calls$'                                                                                                                                                 |
| --filter-name          | Filter by name (regexp can be used).                                                                                                                                                                                                          |
| --warning-*            | Warning threshold. Can be: 'in-calls', 'out-calls', 'current-calls'.                                                                                                                                                                          |
| --critical-*           | Critical threshold. Can be: 'in-calls', 'out-calls', 'current-calls'.                                                                                                                                                                         |
