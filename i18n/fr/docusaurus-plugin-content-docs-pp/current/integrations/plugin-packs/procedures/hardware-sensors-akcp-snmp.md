...
Le connecteur de supervision Centreon **AKCP Sensor** apporte un modèle d'hôte :
...
2. Sur l'interface web de Centreon, installez le connecteur de supervision **AKCP Sensor** depuis la page **Configuration > Packs de plugins**.
...
2. Sur le serveur central Centreon, installez le RPM du connecteur de supervision **AKCP Sensor** :

```bash
yum install centreon-pack-hardware-sensors-akcp-snmp
```

3. Sur l'interface web de Centreon, installez le connecteur de supervision **AKCP Sensor** depuis la page **Configuration > Packs de plugins**.
