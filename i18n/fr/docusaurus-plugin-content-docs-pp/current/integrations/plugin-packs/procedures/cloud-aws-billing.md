...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **AWS Billing** 
...
Le connecteur de supervision **AWS Billing** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<TabItem value="Cloud-Aws-Billing-custom" label="Cloud-Aws-Billing-custom">

| Alias                     | Modèle de service                              | Description                                       |
|:--------------------------|:-----------------------------------------------|:--------------------------------------------------|
| Billing-Estimated-Charges | Cloud-Aws-Billing-Estimated-Charges-Api-custom | Contrôle l'estimation des charges pour un service |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Aws-Billing-custom** est utilisé.
...
|:----------------|:---------------------------------------|
| Amazon Billing  | Découvre les hôtes AWS Billed Services |
...
| Nom                                     | Unité |
|:----------------------------------------|:------|
| *services*#billing.estimatedcharges.usd | USD   |
...
```bash
dnf install centreon-pack-cloud-aws-billing
```
...
```bash
apt install centreon-pack-cloud-aws-billing
```
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **AWS Billing**
...
```bash
dnf install centreon-plugin-Cloud-Aws-Billing-Api
```
...
```bash
apt install centreon-plugin-cloud-aws-billing-api
```
...
3. Appliquez le modèle d'hôte **Cloud-Aws-Billing-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
| AWSREGION     | Set the region name                                                                                                                                | us-east-1         |      X      |
| AWSSECRETKEY  | Set AWS secret key                                                                                                                                 |                   |      X      |
| PROXYURL      | Proxy URL if any                                                                                                                                   |                   |             |
| SERVICENAME   | Set the Amazon service (can be defined multiple times)                                                                                             |                   |      X      |
...
| CURRENCY        | Currency                                                                                                                                         | USD               | X           |
| WARNINGBILLING  | Warning thresholds                                                                                                                               |                   |             |
| CRITICALBILLING | Critical thresholds                                                                                                                              |                   |             |
...
|:-------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------|
| discovery [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/aws/billing/mode/discovery.pm)]                | Used for host discovery                        |
| estimated-charges [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/aws/billing/mode/estimatedcharges.pm)] | Cloud-Aws-Billing-Estimated-Charges-Api-custom |
| list-services [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/aws/billing/mode/listservices.pm)]         | Not used in this Monitoring Connector          |
...
| Option                                     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --service                                  |   Set the Amazon service (required) (can be defined multiple times).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --warning-billing                          |   Warning thresholds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --critical-billing                         |   Critical thresholds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
