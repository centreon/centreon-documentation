---
id: hardware-storage-emc-symmetrix-cma
title: EMC Symmetrix CMA
---
...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **EMC Symmetrix CMA**
...
Le connecteur de supervision **EMC Symmetrix CMA** apporte 2 modèles d'hôte :
...
<Tabs groupId="sync">
<TabItem value="HW-Storage-EMC-Symmetrix-Dmx34-CMA-custom" label="HW-Storage-EMC-Symmetrix-Dmx34-CMA-custom">

| Alias           | Modèle de service                                         | Description                                                     |
|:----------------|:----------------------------------------------------------|:----------------------------------------------------------------|
| Hardware-Global | HW-Storage-EMC-Symmetrix-Dmx34-Hardware-Global-CMA-custom | Contrôle permettant de vérifier l'état des composants matériels |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-EMC-Symmetrix-Dmx34-CMA-custom** est utilisé.

</TabItem>
<TabItem value="HW-Storage-EMC-Symmetrix-Vmax-CMA-custom" label="HW-Storage-EMC-Symmetrix-Vmax-CMA-custom">

| Alias           | Modèle de service                                        | Description                                                     |
|:----------------|:---------------------------------------------------------|:----------------------------------------------------------------|
| Hardware-Global | HW-Storage-EMC-Symmetrix-Vmax-Hardware-Global-CMA-custom | Contrôle permettant de vérifier l'état des composants matériels |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Storage-EMC-Symmetrix-Vmax-CMA-custom** est utilisé.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **EMC Symmetrix CMA**
...
3. Appliquez le modèle d'hôte **HW-Storage-EMC-Symmetrix-Dmx34-CMA-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
1. Ajoutez un hôte à Centreon depuis la page **Configuration > Hôtes**.
2. Complétez les champs **Nom**, **Alias** & **IP Address/DNS** correspondant à votre ressource.
3. Appliquez le modèle d'hôte **HW-Storage-EMC-Symmetrix-Vmax-CMA-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
4. Renseignez les macros désirées. Attention, certaines macros sont obligatoires.
...
|:-----------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/storage/emc/symmetrix/vmax/local/mode/hardware.pm)] | HW-Storage-EMC-Symmetrix-Dmx34-Hardware-Global-CMA-custom<br />HW-Storage-EMC-Symmetrix-Vmax-Hardware-Global-CMA-custom |
