...
Le connecteur de supervision **HP Proliant** apporte un modèle d'hôte :
...
|:----------------|:-----------------------------------------|:--------------------------------|
| Hardware-Global | HW-Hp-Server-Hardware-Global-SNMP-custom | Contrôle l'ensemble des sondes  |
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Server-Hp-Server-SNMP-custom** pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **HP Proliant**
...
|:--------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| global-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/server/hp/proliant/snmp/mode/globalstatus.pm)] | Not used in this Monitoring Connector                                                                                                                                                                                                                                                                                                                                |
