...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Cisco Firepower SNMP** 
...
| Nom de la règle                             | Description                                                                                       |
|:--------------------------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Cisco-Firepower-SNMP-Packet-Errors-Name | Découvre les interfaces réseau en utilisant leur nom et supervise les paquets erronés et rejetés  |
| Net-Cisco-Firepower-SNMP-Traffic-Name       | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
| fan status                | N/A   |
| hardware.fanmodule.count  | count |
| fanmodule status          | N/A   |
| hardware.psu.count        | count |
| psu status                | N/A   |
| hardware.cpuunit.count    | count |
| cpuunit status            | N/A   |
| hardware.memoryunit.count | count |
| memoryunit status         | N/A   |
...
Veuillez vous référer à la [documentation officielle)](https://www.cisco.com/c/en/us/support/docs/ip/simple-network-management-protocol-snmp/213971-configure-snmp-on-firepower-ngfw-applian.html?dtid=osscdc000283) du constructeur/éditeur. 
...
| WARNINGAVERAGE15M    | Threshold                                                                                                                                        |                   |             |
| CRITICALAVERAGE15M   | Threshold                                                                                                                                        |                   |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'chassis', 'fan', 'fanmodule', 'psu', 'cpuunit', 'memoryunit'                                                  | .*                |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
```bash
OK: All memory usages are ok | 'memory1#memory.usage.bytes'=21311B;;;0;total 'memory2#memory.usage.bytes'=54960B;;;0;total 'memory1#memory.free.bytes'=95274B;;;0;total 'memory2#memory.free.bytes'=71188B;;;0;total 'memory1#memory.usage.percentage'=42967%;;;0;100 'memory2#memory.usage.percentage'=99850%;;;0;100 
```
