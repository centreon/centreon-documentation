...
| CRITICALCLONERESOURCESTATUS          | Define the conditions to match for the status to be CRITICAL (default: '%\{status\} =~ /failed/i'). You can use the following variables: %\{name\}, %\{status\}, %\{masters_nodes_name\}, %\{slaves_nodes_name\}, %\{is_unmanaged\} | %\{status\} =~ /failed/i             |             |
...
| CRITICALCONNECTIONSTATUS             | Define the conditions to match for the status to be CRITICAL (default: '%\{connection_status\} =~ /failed/i'). You can use the following variables: %\{connection_status\}, %\{connection_error\}                               | %\{connection_status\} =~ /failed/i |             |
...
| CRITICALQUORUMSTATUS                 | Define the conditions to match for the status to be CRITICAL (default: '%\{quorum_status\} =~ /noQuorum/i'). You can use the following variables: %\{quorum_status\}                                                           | %\{quorum_status\} =~ /noQuorum/i   |             |
