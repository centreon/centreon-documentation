...
>
> Utilisez les paramètres `--api-token` et `--refresh-token` pour définir les tokens. Utilisez le paramètre `--instance` lorsque plusieurs plugins sont exécutés sur le même poller afin d’identifier le token à utiliser.
>
> Voir https://documentation.commvault.com/v11/software/access_tokens_for_rest_apis_01.html pour plus d’informations.
...
| --instance                                 |   Set instance name to differentiate cache files when --api-token is used (default: 'default')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --api-token                                |   Set API access token                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --refresh-token                            |   Set API refresh token associated to the access token. Refresh token is mandatory when --api-token is used.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
