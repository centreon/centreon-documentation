...
| Traffic-Generic-ID   | Net-Juniper-MAG-Traffic-Generic-ID-SNMP-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface              |            |
| Traffic-Generic-Name | Net-Juniper-MAG-Traffic-Generic-Name-SNMP-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface              |            |
| Traffic-Global       | Net-Juniper-MAG-Traffic-Global-SNMP-custom       | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface  | X          |
...
| Nom de la règle              | Description                                                                      |
|:-----------------------------|:---------------------------------------------------------------------------------|
| Net-Juniper-MAG-Traffic-Name | Découvre les interfaces réseau et supervise l'utilisation de leur bande passante |
