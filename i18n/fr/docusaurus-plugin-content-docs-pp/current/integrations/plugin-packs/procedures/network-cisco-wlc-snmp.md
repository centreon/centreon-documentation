...
| --critical-status        |     Set critical threshold for status (Default: '%{admstatus} eq "enable" and %{opstatus} !~ /associated\|downloading/'). Can used special variables like: %{admstatus}, %{opstatus}, %{display}   | Mode        |
| --warning-radio-status   |     Set warning threshold for status. Can used special variables like: %{admstatus}, %{opstatus}, %{display}                                                                                       | Mode        |
| --critical-radio-status  |     Set critical threshold for status (Default: '%{admstatus} eq "enable" and %{opstatus} eq "down"'). Can used special variables like: %{admstatus}, %{opstatus}, %{display}                      | Mode        |
