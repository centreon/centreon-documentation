...
Le connecteur de supervision **Libraesva SNMP** apporte un modèle d'hôte :
...
|:-------|:---------------------------------|:--------------------------------------------|
| Load   | Net-Libraesva-Load-SNMP-custom   | Contrôle de la charge serveur               |
| Memory | Net-Libraesva-Memory-SNMP-custom | Contrôle du taux d'utilisation des mémoires |
| Swap   | Net-Libraesva-Swap-SNMP-custom   | Contrôle le swap                            |
| System | Net-Libraesva-System-SNMP-custom | Contrôle le système                         |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Libraesva-SNMP-custom** est utilisé.
...
|:-----------|:-------------------------------------|:-----------------------------------------------|:----------:|
| Interfaces | Net-Libraesva-Interfaces-SNMP-custom | Contrôle les interfaces                        | X          |
| Storage    | Net-Libraesva-Storage-SNMP-custom    | Contrôle l'utilisation des disques du matériel | X          |
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Libraesva-SNMP-custom** |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Libraesva SNMP**
...
3. Appliquez le modèle d'hôte **Net-Libraesva-SNMP-custom**.
