...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Symantec Netbackup**
...
Le connecteur de supervision **Symantec Netbackup** apporte un modèle d'hôte :
...
|:---------------|:-----------------------------------------|:----------------------------------------------------------------------|
| Dedup-Status   | App-Netbackup-Dedup-Status-NRPE-custom   | Contrôle permettant de vérifier l'état de la déduplication            |
| Drive-Cleaning | App-Netbackup-Drive-Cleaning-NRPE-custom | Contrôle permettant de vérifier si les lecteurs doivent être nettoyés |
| Drive-Status   | App-Netbackup-Drive-Status-NRPE-custom   | Contrôle permettant de vérifier l'état des lecteurs                |
| Job-Status     | App-Netbackup-Job-Status-NRPE-custom     | Contrôle permettant de vérifier l'état des jobs de sauvegarde      |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Netbackup-NRPE-custom** est utilisé.
...
| Alias      | Modèle de service                    | Description                                              |
|:-----------|:-------------------------------------|:---------------------------------------------------------|
| Tape-Usage | App-Netbackup-Tape-Usage-NRPE-custom | Contrôle permettant de vérifier l'utilisation des bandes |
...
Pour superviser des ressources *Windows* via NRPE, installez la version Centreon
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Symantec Netbackup**
...
3. Appliquez le modèle d'hôte **App-Netbackup-NRPE-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
