...
<Tabs groupId="sync">
<TabItem value="App-Cisco-Ssms-Restapi-custom" label="App-Cisco-Ssms-Restapi-custom">
...
| Métrique                              | Unité |
|:--------------------------------------|:------|
| *accounts*~account.alerts.minor.count | count |
| *accounts*~account.alerts.major.count | count |
| *accounts*~*alerts*#alert-status      | N/A   |
...
| Métrique                                        | Unité |
|:------------------------------------------------|:------|
| *accounts*~*licenses*#license-status            | N/A   |
| *accounts*~*licenses*#licenses.usage.count      | count |
| *accounts*~*licenses*#licenses.free.count       | count |
| *accounts*~*licenses*#licenses.usage.percentage | %     |
...
Un compte de service est requis pour interroger l'API Cisco SSMS. Celui-ci doit disposer de privilèges de lecture suffisants pour le compte ciblé.
...
```bash
dnf install centreon-pack-applications-cisco-ssms-restapi
```
...
```bash
yum install centreon-pack-applications-cisco-ssms-restapi
```
...
```bash
dnf install centreon-plugin-Applications-Cisco-Ssms-Restapi
```
...
```bash
yum install centreon-plugin-Applications-Cisco-Ssms-Restapi
```
...
3. Appliquez le modèle d'hôte **App-Cisco-Ssms-Restapi-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
4. Renseignez les macros désirées. Attention, certaines macros sont obligatoires.

| Macro        | Description                                                                                          | Valeur par défaut | Obligatoire |
|:-------------|:-----------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| APIPROTO     | Specify https if needed (default: 'https')                                                           |                   |             |
| APIPORT      | Port used (default: 8443)                                                                            |                   |             |
| CLIENTID     | Set client ID                                                                                        |                   | X           |
| CLIENTSECRET | Set client secret                                                                                    |                   | X           |
...
| FILTERCOUNTERS      | Only display some counters (regexp can be used). Example: --filter-counters='minor'                |                   |             |
| FILTERMESSAGETYPE   | Filter alerts by message type (can be a regexp)                                                    |                   |             |
| WARNINGALERTSMAJOR  | Thresholds                                                                                         |                   |             |
| CRITICALALERTSMAJOR | Thresholds                                                                                         |                   |             |
| WARNINGALERTSMINOR  | Thresholds                                                                                         |                   |             |
| CRITICALALERTSMINOR | Thresholds                                                                                         |                   |             |
...
|:--------------------------------------------------------------------------------------------------------------------------|:---------------------------------------|
| alerts [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/cisco/ssms/restapi/mode/alerts.pm)]     | App-Cisco-Ssms-Alerts-Restapi-custom   |
| licenses [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/cisco/ssms/restapi/mode/licenses.pm)] | App-Cisco-Ssms-Licenses-Restapi-custom |
...
| --source-encoding                          | Define the character encoding of the response sent by the monitored resource Default: 'UTF-8'.      Cisco SSMS Rest API                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Option                   | Description                                                                           |
|:-------------------------|:--------------------------------------------------------------------------------------|
| --filter-counters        | Only display some counters (regexp can be used). Example: --filter-counters='minor'   |
| --account                | Check account name (required. Multiple option).                                       |
| --filter-message-type    | Filter alerts by message type (can be a regexp).                                      |
| --warning-* --critical-* | Thresholds. Can be: 'alerts-minor', 'alerts-major'.                                   |
