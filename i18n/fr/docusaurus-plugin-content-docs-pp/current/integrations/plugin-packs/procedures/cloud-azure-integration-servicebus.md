...
2. Sur l'interface Integration de Centreon, installer le connecteur de supervision *Azure ServiceBus* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**
...
3. Sur l'interface Integration de Centreon, installer le connecteur de supervision *Azure ServiceBus* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**
