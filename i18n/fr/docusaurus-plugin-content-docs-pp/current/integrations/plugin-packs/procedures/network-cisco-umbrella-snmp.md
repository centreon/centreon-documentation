...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Cisco Umbrella SNMP** 
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Cisco-Umbrella-SNMP-custom** est utilisé.
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Cisco-Umbrella-SNMP-custom**. |
...
Veuillez vous référer à la [documentation officielle](https://docs.umbrella.com/deployment-umbrella/docs/appendix-c-enable-snmp-monitoring) du constructeur/éditeur. 
...
3. Appliquez le modèle d'hôte **Net-Cisco-Umbrella-SNMP-custom**.
...
| Macro                  | Description                                                                                                                                      | Valeur par défaut       | Obligatoire |
|:-----------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------|:-----------:|
| WARNINGADSTATUS        | Threshold                                                                                                                                        | %\{status\} =~ /yellow/ |             |
| CRITICALADSTATUS       | Threshold                                                                                                                                        | %\{status\} =~ /red/    |             |
| WARNINGCLOUDSTATUS     | Threshold                                                                                                                                        | %\{status\} =~ /yellow/ |             |
| CRITICALCLOUDSTATUS    | Threshold                                                                                                                                        | %\{status\} =~ /red/    |             |
| WARNINGDNSSTATUS       | Threshold                                                                                                                                        | %\{status\} =~ /yellow/ |             |
| CRITICALDNSSTATUS      | Threshold                                                                                                                                        | %\{status\} =~ /red/    |             |
| WARNINGLOCALDNSSTATUS  | Threshold                                                                                                                                        | %\{status\} =~ /yellow/ |             |
| CRITICALLOCALDNSSTATUS | Threshold                                                                                                                                        | %\{status\} =~ /red/    |             |
| EXTRAOPTIONS           | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                         |             |
...
| Macro             | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| WARNINGGUEST      | Threshold                                                                                                                                        |                   |             |
| CRITICALGUEST     | Threshold                                                                                                                                        |                   |             |
| WARNINGGUESTNICE  | Threshold                                                                                                                                        |                   |             |
| CRITICALGUESTNICE | Threshold                                                                                                                                        |                   |             |
| WARNINGIDLE       | Threshold                                                                                                                                        |                   |             |
| CRITICALIDLE      | Threshold                                                                                                                                        |                   |             |
| WARNINGINTERRUPT  | Threshold                                                                                                                                        |                   |             |
| CRITICALINTERRUPT | Threshold                                                                                                                                        |                   |             |
| WARNINGKERNEL     | Threshold                                                                                                                                        |                   |             |
| CRITICALKERNEL    | Threshold                                                                                                                                        |                   |             |
| WARNINGNICE       | Threshold                                                                                                                                        |                   |             |
| CRITICALNICE      | Threshold                                                                                                                                        |                   |             |
| WARNINGSOFTIRQ    | Threshold                                                                                                                                        |                   |             |
| CRITICALSOFTIRQ   | Threshold                                                                                                                                        |                   |             |
| WARNINGSTEAL      | Threshold                                                                                                                                        |                   |             |
| CRITICALSTEAL     | Threshold                                                                                                                                        |                   |             |
| WARNINGSYSTEM     | Threshold                                                                                                                                        |                   |             |
| CRITICALSYSTEM    | Threshold                                                                                                                                        |                   |             |
| WARNINGUSER       | Threshold                                                                                                                                        |                   |             |
| CRITICALUSER      | Threshold                                                                                                                                        |                   |             |
| WARNINGWAIT       | Threshold                                                                                                                                        |                   |             |
| CRITICALWAIT      | Threshold                                                                                                                                        |                   |             |
| EXTRAOPTIONS      | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
...
| Macro                  | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-----------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| WARNINGQUERY15MINUTES  | Threshold                                                                                                                                        |                   |             |
| CRITICALQUERY15MINUTES | Threshold                                                                                                                                        |                   |             |
| WARNINGQUERY5MINUTES   | Threshold                                                                                                                                        |                   |             |
| CRITICALQUERY5MINUTES  | Threshold                                                                                                                                        |                   |             |
| EXTRAOPTIONS           | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
...
```bash
OK: Storage usage: 43 % | 'storage.utilization.percentage'=43%;;;0;100 
```
