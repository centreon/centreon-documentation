...
| Traffic-Generic-Id   | Net-JuniperSRX-Traffic-Generic-Id-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Generic-Name | Net-JuniperSRX-Traffic-Generic-Name-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Global       | Net-JuniperSRX-Traffic-Global-custom       | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface) | X          |
