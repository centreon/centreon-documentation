...
- [**AIX SNMP**](../procedures/operatingsystems-aix-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
...
- [**Arkoon SNMP**](../procedures/network-firewalls-arkoon-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
...
- [**Fortinet Fortigate SNMP**](../procedures/network-firewalls-fortinet-fortigate-snmp.md) - Added option in **sdwan** mode to filter by interface name. Handle more than one VPN phase 2 connection status in **vpn** mode. Added service discovery for **sdwan** (based on a [The Watch idea](https://thewatch.centreon.com/ideas/fortigate-s-sdwan-service-discovery-5071)) and **vpn** (based on a [The Watch idea](https://thewatch.centreon.com/ideas/network-fortinet-fortigate-snmp-plugin-mode-vpn-service-discovery-3910)) modes.
- [**FreeBSD SNMP**](../procedures/operatingsystems-freebsd-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
- [**HTTP Server**](../procedures/applications-protocol-http.md) - Handle nested json path in **collection** mode.
...
- [**Linux SNMP v3**](../procedures/operatingsystems-linux-snmpv3.md) - Added `--force-rfc` option to allow choosing a specific RFC in **tcpcon** mode.
- [**Linux SNMP**](../procedures/operatingsystems-linux-snmp.md) - Added `--force-rfc` option to allow choosing a specific RFC in **tcpcon** mode.
- [**Mac SNMP**](../procedures/operatingsystems-mac-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
- [**PVX**](../procedures/applications-pvx-restapi.md) - Authentication to API now requires a bearer header.
- [**Qnap**](../procedures/hardware-storage-qnap-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
- [**Rubrik Rest API**](../procedures/applications-rubrik-restapi.md) - Improved cache naming and **job** mode filtering.
- [**Solaris SNMP**](../procedures/operatingsystems-solaris-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
- [**Windows SNMP**](../procedures/operatingsystems-windows-snmp.md) - Handle unanticipated hrSWRunStatus in **processcount** mode.
...
- [**Amazon CloudWatch**](../procedures/cloud-aws-cloudwatch.md) - Fixed **get-alarms** mode to handle multiple alarms.
...
- [**IP-Label Ekara Rest API**](../procedures/applications-monitoring-iplabel-ekara-restapi.md) - Fixed host discovery macros.
...
- [**NetApp Ontap Rest API**](../procedures/hardware-storage-netapp-ontap-restapi.md) - Fixed latency values in **cluster** mode.
...
- [**Redis Database**](../procedures/applications-databases-redis.md) - Fixed an issue leading to returned value more than 1000 % in **cpu** mode.
