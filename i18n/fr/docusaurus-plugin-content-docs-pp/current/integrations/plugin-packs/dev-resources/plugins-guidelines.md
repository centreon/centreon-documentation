...
description: "Découvrez les bonnes pratiques pour développer des plugins de supervision compatibles avec Centreon : format de sortie, données de performance, découverte et sécurité."
---
