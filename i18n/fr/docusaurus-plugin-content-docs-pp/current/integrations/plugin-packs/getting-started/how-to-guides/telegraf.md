...
2. [Installez](/docs/monitoring/pluginpacks.md#installer-un-connecteur-de-supervision) le connecteur de supervision **Linux Telegraf Agent**.

</TabItem>
<TabItem value="Windows" label="Windows">

1. Sur votre serveur central, allez à la page **Configuration > Gestionnaire de connecteurs de supervision**.
2. [Installez](/docs/monitoring/pluginpacks.md#installer-un-connecteur-de-supervision) le connecteur de supervision **Windows Telegraf Agent**.
