...
2. Cliquez sur le bouton **Créer un jeton d'accès**.
3. Dans la fenêtre de configuration, saisissez une description qui explique à quoi servira le jeton, ainsi qu'une période de validité. La liste des jetons affichera les 4 premiers caractères du jeton, suivis d'astérisques.
