...
- **[Jeton d'accès](../tokens.md)** : le jeton d'accès est stocké dans le fichier de configuration `/etc/quanta/agent.yml`. Le jeton indique à l’agent à quel site appartiennent les données supervisées.
