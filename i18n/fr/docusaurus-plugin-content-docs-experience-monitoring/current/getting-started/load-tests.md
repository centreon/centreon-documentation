...
> Notez que les tests de charge génèrent réllement du traffic sur le site web, ce qui peut impacter les utilisateurs s'ils sont effectués sur un site en production. Les tests de charge peuvent également être réalisés dans des environnements de test.
