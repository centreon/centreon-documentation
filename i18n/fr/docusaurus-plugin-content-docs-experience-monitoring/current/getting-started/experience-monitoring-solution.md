...
Experience Monitoring mesure également l'empreinte carbone du site web. Cela est réalisé en calculant le poids du site et la puissance de traitement nécessaire pour le stocker, puis en affichant ces informations aux utilisateurs.
Les utilisateurs peuvent ensuite chercher à réduire à la fois leur impact environnemental et les coûts liés à l'hébergement.
...
Une autre fonctionnalité clé est le [Real User Monitoring (RUM)](../getting-started/real-user-monitoring.md). Tandis que les parcours utilisateurs suivent une navigation théorique, le RUM collecte des données à partir de ce que font les véritables utilisateurs sur votre site web.
