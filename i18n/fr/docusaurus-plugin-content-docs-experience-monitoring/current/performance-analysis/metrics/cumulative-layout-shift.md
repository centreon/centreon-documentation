...
Si vous avez déjà lu un article dont tout le contenu se décale d’un coup sans que vous ne fassiez rien, ou pire, que vous essayez de cliquer sur un bouton et qu’il change de place, alors vous avez vécu une page avec un mauvais CLS.
...
Un décalage se produit quand un élément visible change de position dans la page.

Le score dépend de la taille de l’élément et de la distance de décalage.
