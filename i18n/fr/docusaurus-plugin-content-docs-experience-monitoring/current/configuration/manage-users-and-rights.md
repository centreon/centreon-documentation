...
>Si personne de votre organisation n’est Administrateur ou Propriétaire, contactez le support Experience Monitoring ou votre revendeur pour gérer votre organisation.



### **Les permissions**

Experience Monitoring distingue 2 types de permissions pour les utilisateurs que vous invitez :

- **Membre** : les Membres peuvent lire les informations. Ils ne peuvent pas modifier la configuration du site et des scénarios Experience Monitoring. Ils ne peuvent que gérer leurs propres paramètres et leurs inscriptions aux différentes alertes et rapports, et ajouter des commentaires dans les graphes.
...
Pour ajouter l'utilisateur, cliquez sur l’icône à côté du rôle auquel vous voulez l’ajouter et saisissez l'adresse mail de l'utilisateur. S'il n'a pas encore d'accès à Experience Monitoring, il sera automatiquement invité à se créer un compte.
...
>Si vous souhaitez supprimer l'accès d'un utilisateur à plusieurs organisations, il faut le faire pour chacune d'entre elles. Si vous avez accès à beaucoup d'Organisations, n'hésitez pas à contacter le support Experience Monitoring pour que nous vous assistions.
