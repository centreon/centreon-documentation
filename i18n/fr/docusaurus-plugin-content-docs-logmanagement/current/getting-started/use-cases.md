...
* Quel service génère le plus d'erreurs aujourd'hui ? Filtrez la [timeline](../explore-analyze.md#using-the-log-explorer-page) sur la journée courante, puis filtrez par severitynumber>17. Empilez le graphique par nom de service.
