...
1. CLM [collecte](../collector/collector.md) et centralise des logs provenant de diverses sources (serveurs, applications, bases de données, dispositifs réseau, etc).
...
Les logs OpenTelemetry ne sont pas seulement du texte : ce sont des données que vous pouvez analyser. Et CLM vous permet de [définir des alertes dynamiques sur celles-ci](../alerts.md).
