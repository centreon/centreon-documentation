...
4. Cliquez sur **Back to Centreon Customer identity and Access management Web**. Vous pouvez maintenant inviter d'autres utilisateurs dans votre organisation.
