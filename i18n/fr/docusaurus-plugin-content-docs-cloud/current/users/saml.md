...
description: Configuration pas à pas de l'authentification unique SAML entre un fournisseur d'identité et Centreon Hub, avec le mapping des rôles et des groupes
---
