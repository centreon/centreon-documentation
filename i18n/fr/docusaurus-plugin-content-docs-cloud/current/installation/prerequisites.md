...
S'il n'est pas possible pour vous de faire du filtrage sur les adresses IP, vous pouvez faire du filtrage par FQDN. Les FQDNs à autoriser sont les suivants :
