...
1. [Dans votre interface utilisateur](../getting-started/interface.md#accéder-à-linterface-utilisateurl), cliquez sur la flèche à côté de **Collecteurs** dans le bandeau en haut à gauche.
