...
Avec un jeton d'authentification, une application tierce peut faire des appels à l'API Centreon afin de réaliser des actions dans Centreon (webhooks).
...
## Qui peut créer des jetons d'authentication ?

[Les utilisateurs ayant un rôle **Administrator**](../users/users.md#rôles-des-utilisateurs) ont accès à la page **Administration > Jetons d'authentication** et peuvent :
* créer des jetons d'authentification pour leur propre usage.
...
* Désactiver un jeton d'authentification valide en utilisant le switch **Activé/Désactivé** à droite de la ligne. Le jeton pourra être réactivé si besoin.
