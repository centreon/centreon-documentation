...
* Les [jetons d'API](api_tokens.md) : utilisés pour authentifier les requêtes adressées à l'API Centreon, permettant ainsi à des outils ou scripts externes d'interagir avec la plateforme par programmation.
