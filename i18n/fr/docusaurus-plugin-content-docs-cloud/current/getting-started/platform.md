...
1. Créez votre organisation dans [Centreon Hub](../users/centreon-hub.md). Attention lorsque vous choisissez un nom : ce nom fera partie de l'URL de votre plateforme Centreon.
2. Envoyez le nom de votre organisation à votre interlocuteur commercial et nous préparerons votre [plateforme SaaS](architecture.md) pour vous.
