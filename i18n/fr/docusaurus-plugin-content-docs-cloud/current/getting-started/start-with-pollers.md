...
Une fois le collecteur installé, nous vous recommandons de le [sécuriser](../installation/poller-secure.md) et de [le garder à jour](../installation/poller-update-upgrade.md). Si vous utilisez plusieurs collecteurs, nous vous recommandons également de les faire se [superviser entre eux](../installation/poller-monitor.md) plutôt que chaque collecteur se supervise lui-même.

## Dépannage

Nous avons une section dédiée au [dépannage de collecteurs](../installation/poller-troubleshoot.md) à votre disposition. Vous pouvez également utiliser [notre plateforme communautaire The Watch](https://thewatch.centreon.com/).
