...
La formule d'essai de Centreon Cloud est une **licence gratuite de 7 jours**, qui comprend les fonctionnalités de notre [IT Edition](https://www.centreon.com/fr/centreon-editions/#editions-table) avec une capacité de supervision de jusqu'à 125 hôtes.
...
- La plateforme prête : l'administrateur invite d'autres utilisateurs à créer leurs propres comptes sur Centreon CIAM et rejoindre la plateforme d'essai.
...
> Un nombre limité de plateformes d'essai est disponible à un instant donné : il est possible qu'il n'y ait pas de plateforme disponible lorsque vous envoyez le formulaire. Dans ce cas, vous serez automatiquement placé en liste d'attente et notifié lorsqu'une plateforme sera préparée pour vous.
