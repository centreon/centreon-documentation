...
Centreon Engine détecte les hôtes et les services bagotants ("flapping"). Le bagotement se produit lorsqu'un service ou un hôte change de statut trop souvent. Cela empêche Centreon d'envoyer de nombreuses notifications d'alerte et de récupération : une seule notification de bagotement est envoyée (une en début et une en fin de bagotement). Le bagotement peut indiquer des services gênants ou de vrais problèmes de réseau.
...
## Seuils de bagotement

Dans Centreon Cloud, les seuils de bagotement sont les suivants :

| Seuil | Hôtes | Services |
| --- | --- | --- |
| Seuil bas de détection de bagotage | | |
| Seuil haut de détection de bagotage | | |
