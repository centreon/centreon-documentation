...
* [Tutoriels pour profiter de votre supervision](introduction-tutorials.md)
...
> Pour une installation plus personnalisée, les prérequis complets sont disponibles [ici](../installation/prerequisites.md).

### Téléchargement

Vous pouvez installer Centreon :

- [A partir de l'ISO](../installation/installation-of-a-central-server/using-centreon-iso.md)
...
> Rendez-vous dans le chapitre [How to translate menu](../developer/developer-translate-centreon.md) pour plus d'informations.
...
> [configuration du proxy](../administration/parameters/centreon-ui.md#configuration-du-proxy)
