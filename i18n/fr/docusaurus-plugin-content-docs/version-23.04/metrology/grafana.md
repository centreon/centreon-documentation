...
* Si vous entrez **${__field.labels}**, le libellé inclura toutes les personnalisations possibles (host, service, metric_name).
* Par exemple, si vous entrez **${__field.labels.host}: ${__field.labels.service}**, le libellé d'une courbe serait affiché de cette manière : **10.11.12.13: cpu**.
