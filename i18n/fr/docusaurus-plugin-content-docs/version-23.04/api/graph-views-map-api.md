...
> Suivez ce [lien](https://docs-api.centreon.com/api/centreon-map/23.04/) pour accéder à la documentation de l'API Centreon et avoir un aperçu des fonctionnalités de l'API.
