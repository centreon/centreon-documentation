...
Ce chapitre décrit comment mettre à niveau votre plate-forme Centreon HA de la version 22.04
...
Pour effectuer la mise à niveau, veuillez [suivre la documentation officielle](../../upgrade/upgrade-from-22-04.md) Uniquement sur le **nœud central actif** et **nœud de base de données actif si nécessaire**.
