...
1. Sur votre plateforme 21.04, remplacez `https://packages.centreon.com/rpm-standard` par `https://archives.centreon.com/standard/` dans votre configuration YUM (par défaut, `/etc/yum.repos.d/centreon.repo`).
