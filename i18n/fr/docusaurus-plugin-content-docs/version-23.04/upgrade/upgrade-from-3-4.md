...
Centreon depuis la version 3.4 (Centreon Web 2.8) vers la version 23.04.
...
2. Désinstallez la version actuelle :
  ...
  > Assurez-vous d'avoir [installé le dépôt officiel de MariaDB](./upgrade-from-3-4.md#installer-le-dépôt-mariadb) avant de poursuivre la procédure.
...
> La macro de ressource $USER1$ de Centreon 23.04 pointe à présent sur
