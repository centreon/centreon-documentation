...
- [Diagnostic] Fixed diagnostic when MAP is configured in HTTPS.
- [Editor] Fixed an issue causing link labels not to be displayed in editor.
...
- [Server] Fixed an issue in connection between Centreon Central and MAP server initialization causing issues in real time updates.
