...
- [Viewer] Added an option to the Pie Chart widget to hide resources label.
...
- [Editor] Fixed issue when hovering a disabled resource.
- [Editor] Deleted resources no longer displayed.
...
- [Viewer] Fixed issue with the fill-color parameter of the Output widget.
- [Viewer] Fixed an issue that converted breadcrumb elements to lowercase.
- [Viewer] Fixed wrong color for disabled resource.
- [Viewer] Fixed issue with the border parameters of the Output widget. 
...
- Fixed display of impact tree when deprecated pages are enabled for user.
