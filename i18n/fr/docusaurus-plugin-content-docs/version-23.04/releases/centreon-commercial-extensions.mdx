...
- [Homepage] Removed improper label in MAP homepage.
...
- [Viewer] Fixed the Business Activity name display in the tooltip.
...
- When the license is not valid, expired, renamed, or moved, users now get an error page instead of multiple error messages.
