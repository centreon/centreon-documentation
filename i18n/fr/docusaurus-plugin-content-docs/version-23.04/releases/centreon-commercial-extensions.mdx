...
- [Viewer] Fixed an issue causing label not to be aligned for resources in geometric mode.
- [Viewer] Fixed an issue that makes breadcrumb not right when selecting a Centreon resource.
- [Viewer] Fixed the position of links anchor points for geometric shapes.
