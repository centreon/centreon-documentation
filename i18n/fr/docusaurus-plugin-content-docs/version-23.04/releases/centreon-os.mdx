...
- [Anomaly Detection] Added a feature flag to hide exclusion of periods.
...
- [Anomaly Detection] Don't list Business Activities as service in configuration form.
...
- [Authentication] Fixed the access to Centreon UI when a default page is defined using SSO authentication (OIDC/SAML).	
