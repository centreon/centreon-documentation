...
- [Installation] Fixed installation when database user already exists.
...
- [Resource Status] Fixed default sorting order resources status: from worse to best.
- [Web] Fixed an issue of appearing herited contacts/contact groups in notification tab.
