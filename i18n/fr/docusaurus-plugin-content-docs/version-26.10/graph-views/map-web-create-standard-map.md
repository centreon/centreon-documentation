...
description: "Créer et personnaliser des cartes standard à l'aide de l'éditeur MAP"
---
...
- **Metric link :** utilisez ce lien entre deux éléments et configurez un service ou un meta-service et ses métriques à partir de celui-ci. Ensuite, ce lien affichera les métriques du service ou meta-service que vous avez spécifié. 
