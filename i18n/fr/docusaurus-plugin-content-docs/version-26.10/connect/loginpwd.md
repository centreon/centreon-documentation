...
- **Le mot de passe expire après** : Une fois le mot de passe expiré, l'utilisateur sera redirigé vers une
  [page dédiée](../monitoring/basic-objects/customization.md#réinitialiser-votre-mot-de-passe-après-expiration) pour mettre à jour son mot de passe. La durée de vie d'un mot de passe doit être d'au moins 7 jours.
