---
id: cma-setup-manual
title: Configurer CMA manuellement
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import PollerAgentConfiguration from './_poller-agent-configuration.mdx';

> Cette procédure est destinée aux utilisateurs avancés qui maîtrisent bien la gestion des certificats. En cas de doute, utilisez la [procédure d'installation automatique](cma-setup.md).
