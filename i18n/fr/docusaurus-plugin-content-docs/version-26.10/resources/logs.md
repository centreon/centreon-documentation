...
|                                    |                                  |/var/log/apache2/*.log                            |  Interface défaillante                                                                                                                                       |
|                                    |                                  |/var/log/httpd/*.log                              |Interface défaillante (erreurs HTTP 50x)                                                                                                 |
...
|Gestion des licences                |                                  |/var/log/centreon/license-manager.log             |Les licences ne sont pas présentes ou ne sont pas à jour <br/> Pas d'accès aux connecteurs de supervision                                |
|Jetons d'API                        |cron outdated-token-removal.php   |/var/log/centreon/centreon-tokens.log             |Problèmes avec des jetons |Jetons d'API                        |                                  |/var/log/centreon/prod.token.log                  |Problèmes de création, de modification ou de suppression de jetons d'API                                                                 |
