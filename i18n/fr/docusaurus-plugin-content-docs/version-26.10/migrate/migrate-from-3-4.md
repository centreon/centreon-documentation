...
4. Sur le serveur de base de données Centreon 26.10, supprimer les bases de
...
> tard en 26.10, attention au dossier des plugins Nagios. La macro de
> ressource $USER1$ de Centreon 26.10 pointe sur /usr/lib64/nagios/plugins
>
...
Vous pouvez générer les configurations depuis Centreon 26.10
indifféremment vers un collecteur en 26.10 ou 1.8.1.

### Montée de version de la solution Centreon

Forcez la montée de version du nouveau serveur en déplacant le contenu du répertoire
**/var/lib/centreon/installs/install-26.10.0-YYYYMMDD\_HHMMSS** dans le
...
compatibilité avec Centreon 26.10, et pour mettre à jour ces derniers.
