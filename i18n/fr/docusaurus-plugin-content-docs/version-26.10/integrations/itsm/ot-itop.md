...
Those information are not retrieved from iTop. They are configured in your open ticket rule as [custom lists](../../alerts-notifications/ticketing.md#définition-de-liste).
