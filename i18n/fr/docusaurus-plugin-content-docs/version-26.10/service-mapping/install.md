...
> ```
>
> puis créer les vues sur le slave [avec le fichier suivant](https://docs.centreon.com/fr/assets/files/view_creation-40750b8dad6e40d6e628d82828222318.sql), en lançant la commande:
>
> ``` shell
