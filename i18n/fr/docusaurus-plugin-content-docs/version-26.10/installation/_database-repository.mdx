...
# install_weak_deps=False : ici, la pile mariadb de la distribution n'est qu'une dépendance recommandée ;
# sans cette option, dnf installe mariadb à côté d'Oracle MySQL et les deux entrent en conflit sur /usr/bin/mysql.
