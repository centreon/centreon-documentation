...
> Vous devez utiliser le compte **admin** pour le paramètre **\<API_ACCOUNT\>**.
...
> La version Centreon du serveur distant est invalide. Elle doit être supérieure ou égale à 26.10.
