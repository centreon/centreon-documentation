...
description: Créer et gérer des tâches de découverte d'hôtes à l'aide d'assistants et de mappers
---
...
2. Installez le [connecteur de supervision](../pluginpacks.md) correspondant aux ressources que vous voulez découvrir.
    ...
    >
    > Si, à la page **Configuration > Connecteurs > Connecteurs de supervision**, vous avez réglé **Installation automatique des plugins** sur **ON**, le plugin de découverte sera installé automatiquement lorsque la tâche de découverte sera exécutée.
