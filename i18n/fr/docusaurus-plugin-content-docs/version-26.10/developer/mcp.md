...
## Fonctionnalités du serveur MCP Centreon
...
- Supervision de ressources : lister des ressources en appliquant des filtres tels que par nom ou par statut.
- Inventaire de l'infrastucture : lister les groupes ou les collecteurs en appliqaunt des filtres.
- Acquittements : lister et gérer les acquittements.
