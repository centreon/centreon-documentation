...
- [Server] Fixed issue preventing resources from being displayed when configuration contains a host without any service associated to it.
...
- [Viewer] Fixed issue preventing data from being displayed when hovering on a meta-service.
