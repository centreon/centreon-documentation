...
- If you are still using Map Legacy and want to know more about how to migrate to MAP, [(https://docs.centreon.com/docs/graph-views/map-legacy-eol/)this topic] will be helpful.
