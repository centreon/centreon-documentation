...
- [Configuration] Fixed an issue where the value initially set in host community is replaced by '*' characters when editing configuration.
- [Dashboards] Fixed issue preventing metric widgets from being displayed.
- [Resource Status] Fixed an issue causing an error when displaying a graph.
