...
- [Configuration] Fixed an error when duplicating a rrd broker config and outputs were missing.
...
- [Performance Graphs] Fixed issue preventing user from selecting multiple graphs when language selected isn't "en_US".
