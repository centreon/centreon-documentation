...
- [Poller/Agent configurations] A new feature is available to manage agents configuration, including Centreon Monitoring Agent and Telegraf to manage the configuration of agents.
