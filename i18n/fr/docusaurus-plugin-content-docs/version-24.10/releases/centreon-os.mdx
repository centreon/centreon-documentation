...
- [Custom Views] Fixed issue preventing non admin users from seeing hostgroups in the Hostgroup Monitoring widget.
- [Custom Views] Fixed issue preventing non admin users from seeing servicegroups in the Servicegroup Monitoring widget.
- [Dashboards] Fixed issue forcing edit mode on dashboards containing a Resource Table widget.
- [Dashboards][Metrics Graph] Optimized bar chart rendering when modifying opacity or bar radius.
...
- [Graphs] Fixed issue preventing non admin users from exporting graphs in ".png".
- [Resource Status] Fixed an issue on Host & Services columns that doesn't contain the rights infos in the view by host.
...
- [Web] Fixed issue preventing users of some password managers from accessing to legacy pages.
