...
- [Users] Fixed an issue that caused a blank page when trying to create a user with an autologin key.
...
- [Install] Fixed an issue with SQL schema missing when upgrading version.
