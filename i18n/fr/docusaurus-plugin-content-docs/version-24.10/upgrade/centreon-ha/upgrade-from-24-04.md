...
description: "Mettre à niveau un cluster Centreon HA depuis la version 24.04 vers la 24.10"
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

Ce chapitre décrit comment mettre à niveau votre plate-forme Centreon HA de la version 24.04 vers la version 24.10.
