...
<Tabs groupId="database-sync" queryString>
<TabItem value="MariaDB" label="MariaDB">
...
Veuillez noter que les configurations suivantes ne sont que des exemples des possibilités pour une infrastructure avec 8 Go de RAM. Il appartient à chaque utilisateur d'adapter la configuration de la base de données à ses besoins.
Nous vous invitons à vous rapprocher de votre administrateur de base de données pour avoir une configuration qui répond à vos besoins.
...
Veuillez noter que la configuration suivante n'est qu'un exemple pour une infrastructure avec 8 Go de RAM. Il appartient à chaque utilisateur d'adapter la configuration de la base de données à ses besoins.
Nous vous invitons à vous rapprocher de votre administrateur de base de données pour avoir une configuration qui répond à vos besoins.
