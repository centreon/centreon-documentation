...
Veuillez noter que la configuration suivante n'est qu'un exemple pour une infrastructure de 8go de RAM. Centreon ne saurait être tenu responsable des potentielles modifications à effectuer sur cette partie.
