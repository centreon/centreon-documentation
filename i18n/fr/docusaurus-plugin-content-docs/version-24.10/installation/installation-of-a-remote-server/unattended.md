...
4. Une fois le script exécuté, suivez les [étapes 5 à 8 de la procédure d'installation standard d'un serveur distant](using-packages.md#étape-5--enregistrer-le-remote-server).
