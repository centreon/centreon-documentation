...
- trier la vue de la page **Statut des ressources** par niveau de criticité. Les criticités sont affichées dans la colonne **S** de la page **Statut des ressources**.
...
Les criticités sont assignées depuis la page de configuration des catégories d'hôtes et celle des catégories de services.
...
3. Définissez un niveau de 1 à 127 pour cette criticité (un chiffre qui permettra de trier les hôtes ou les services dans la page **Statut des ressources**), aisni qu'une icône qui apparaîtra dans la colonne **S** de la page **Statut des ressources**.
...
2. Dans l'onglet **Informations détaillées de l'hôte** pour les hôtes ou bien **Informtions complémentaires** pour les services, dans la section **Moteur de supervision**, sélectionnez la criticité désirée dans la liste **Niveau de criticité**. Cette méthode permet uniquement d'assigner des niveaux de criticité existants.
