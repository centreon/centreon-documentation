...
|------------------------------------|----------------------------------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
|Centreon Engine                     |centengine                        |/var/log/centreon-engine/centengine.log           |Contrôles non effectués Objets supprimés encore supervisés                                                                               |
...
|Gorgone                             |gorgoned                          |/var/log/centreon-gorgone/gorgoned.log            |Actions ne se déclenchent pas : acquittements, plages de maintenance, force checks, autodisco Configuration non mise à jour sur le poller|
...
|Interface Centreon et API           |                                  |/var/log/centreon/centreon-web.log                |All APIs call or errors in forms Page blanche Interface défaillante Erreurs SQL State                                                    |
...
|Traps SNMP (DSM)                    |dsmd                              |/var/log/centreon/centreon-dsm.log                |Problèmes de gestion des trap SNMP avec DSM                                                                                              |
...
|Knowledge Base                      |cron centKnowledgeSynchronizer.php|/var/log/centreon/knowledgebase.log               |Erreurs dans le cron qui synchronise les pages Mediawiki avec le paramètre URL Notes sur les ressources                                  |
...
|Gestion des licences                |                                  |/var/log/centreon/license-manager.log             |Les licences ne sont pas présentes ou ne sont pas à jour Pas d'accès aux connecteurs de supervision                                      |
