...
- [Resource Status] Improved the update of filters by removing unnecessary dialog box.
...
- [Dashboards - Map widget] Fixed an issue where Map, Geoview and perspectives couldn't be saved.
