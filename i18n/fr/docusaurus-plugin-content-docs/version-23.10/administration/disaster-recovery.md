...
- [installer un collecteur de secours](backup-poller.md#cas-n2-collecteur-de-secours) synchronisé avec votre collecteur actif, afin que le collecteur de secours puisse prendre le relais en cas de panne.
