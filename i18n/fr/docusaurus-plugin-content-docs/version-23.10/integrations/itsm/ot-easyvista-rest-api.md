...
1. Téléchargez le dossier **EasyVistaRest** dans **/usr/share/centreon/www/modules/centreon-open-ckets/providers** sur votre serveur central.

2. Modifiez le fichier **/usr/share/centreon/www/modules/centreon-open-ckets/providers/register.php** en ajoutant une ligne pour EasyVistaRest en fin de liste, comme suit:
