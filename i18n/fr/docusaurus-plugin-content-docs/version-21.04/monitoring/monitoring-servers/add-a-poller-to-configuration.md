...
Depuis la liste des Pollers, cliquez sur l'icône d'action **Gorgone configuration** sur la ligne correspondant à votre Poller ![image](../../assets/monitoring/monitoring-servers/gorgone-configuration.png#thumbnail1)
