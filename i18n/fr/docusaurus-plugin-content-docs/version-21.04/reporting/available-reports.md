...
| sla 3         | Champ texte      | Temps maximum en minutes du troisième intervalle [sla2 min, **sla3**]   |
| sla 4         | Champ texte      | Temps maximum en minutes du quatrième intervalle [sla3 min, **sla4**]   |
| title         | Champ texte      | Permet de préciser un titre particulier pour le rapport                 |
| time period   | Liste déroulante | Sélectionner la période de reporting à appliquer\*                      |
