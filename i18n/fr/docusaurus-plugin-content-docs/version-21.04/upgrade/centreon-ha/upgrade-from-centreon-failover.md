...
* [Réaliser les étapes supplémentaires](../../upgrade/upgrade-from-19-04.md#actions-complementaires)
...
* Si vous étiez en version 20.04, suivez ce [chapitre](../../upgrade/upgrade-from-19-04.md#finalisation-de-la-mise-à-jour).
