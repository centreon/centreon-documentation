...
> Hello community! We're looking for a contributor to help us to translate the content into French. 
If it's you, let us know and ping us on [Slack](https://centreon.slack.com).

## Before starting

- You can send events from a central server, a remote server or a poller.
- By default, this stream connector sends **host_status**, **service_status** events. The event format is shown **[here](#event-format)**.
