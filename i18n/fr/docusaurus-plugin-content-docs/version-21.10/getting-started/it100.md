...
* Vérifiez si l'empreinte du serveur est correcte.
  ...
  Votre licence est liée à l'empeinte de votre serveur. Dans certains cas, cette empreinte peut changer (par exemple en cas de modification des interfaces réseau).
