...
- Vous aurez accès à la fonctionnalité de [découverte automatique des hôtes et services](../monitoring/discovery/introduction), et à la totalité de la bibliothèque de [plugin packs Centreon](/pp/integrations/plugin-packs/introduction).
