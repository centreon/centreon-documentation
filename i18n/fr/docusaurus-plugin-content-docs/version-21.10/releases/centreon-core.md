...
- Fixed an issue that prevented Gorgone from handling advanced [Service Discovery features](https://docs.centreon.com/fr/docs/monitoring/discovery/services-discovery#options-avanc%C3%A9es) correctly.
