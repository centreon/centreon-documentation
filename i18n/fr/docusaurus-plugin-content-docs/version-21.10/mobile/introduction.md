...
<video width="675" height="712" controls={true} allowFullScreen={true} poster={require('../assets/mobile/mobile-login.png').default}><source src={require('../../../../../assets/fr/mobile/mobile-demo.mp4').default} type="video/mp4"/></video>
