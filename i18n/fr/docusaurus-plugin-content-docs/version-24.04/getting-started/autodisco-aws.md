...
[Setup](/pp/integrations/plugin-packs/procedures/cloud-aws-ec2#privilèges-aws)) pour finir d'installer le connecteur de supervision. (Vous pouvez également accéder à la documentation d'un connecteur de supervision en cliquant sur le `i`.)
