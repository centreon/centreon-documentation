...
Veuillez noter que les configurations suivantes ne sont que des exemples des possibilités pour une infrastructure de 8go de RAM. Centreon ne saurait être tenu responsable des modifications nécessaires à effectuer sur cette partie.
