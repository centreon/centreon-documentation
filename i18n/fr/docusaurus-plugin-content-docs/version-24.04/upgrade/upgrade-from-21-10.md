...
> Nous avons des articles dédiés pour les procédures de montée de version pour [Centreon MBI](../reporting/update.md) et [Centreon MAP](../graph-views/map-web-upgrade.md).
