...
Si vous avez configuré le SSL (voir [Configuration HTTPS/TLS](secure-your-map-platform.md#configurer-httpstls-sur-le-serveur-map-ou-map-legacy), utilisez le port 8443.
