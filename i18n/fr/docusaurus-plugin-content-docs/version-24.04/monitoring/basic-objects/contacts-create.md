...
* Les trois champs qui suivent servent à autoriser les utilisteurs à faire appel à notre [API v1](../../api/rest-api-v1.md#api-calls) et notre [API v2](https://docs-api.centreon.com/api/centreon-web/24.04/) (à noter que notre documentation API n'est disponible qu'en anglais et est destinée à des développeurs familiers avec les requêtes HTTP et JSON).
- Le champ **API de configuration** ne s'applique qu'aux API V2 car seuls les administrateurs peuvent utiliser cette API en v1.
- L'[**API de temps réel**](../../api/rest-api-v1.md#realtime-information) peut être appelé par les non-administrateurs dans les deux versions lorsque ce champ est coché.
- Les administrateurs peuvent faire appel à l'**API de configuration** et l'[**API de temps réel**](../../api/rest-api-v1.md#realtime-information) indépendamment de si le champ correspondant à ces APIs est coché. Ceci est valable pour les v1 et les v2. Les administrateurs sont également les seuls à pouvoir utiliser [**CLAPI**](../../api/clapi.md), les autres utilisteurs n'ont accès qu'à l'API Rest.
