...
- [Viewer] Fixed an issue preventing data from being displayed when hovering on a meta-service.
- [Viewer] Fixed an issue that prevented pie chart widget from being displayed in percentage per status.
