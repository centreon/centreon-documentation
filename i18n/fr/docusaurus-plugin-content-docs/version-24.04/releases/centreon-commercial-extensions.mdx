...
- [Migration] Added multiple information logs when migrating from MAP Legacy.
- [Server] Fixed access right issue with the media directory, preventing images from being copied on a remote server.
...
- [Server] Fixed issue causing BA to disappear after a BAM reinstallation.
...
- Fixed issue preventing installation from being completed when database tables already existed.
