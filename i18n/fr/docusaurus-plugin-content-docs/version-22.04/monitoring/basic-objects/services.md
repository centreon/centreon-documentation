...
Pour réinitialiser la macro avec sa valeur par défaut (définie dans le templae) cliquez sur <img src={require('../../assets/configuration/common/undo.png').default} style={{width:'32px', marginBottom:'-6px'}} />

Pour afficher la description de la macro, cliquez sur <img src={require('../../assets/configuration/common/description.png').default} style={{width:'32px', marginBottom:'-6px'}} />

Pour supprimer la macro, cliquez sur <img src={require('../../assets/configuration/common/delete.png').default} style={{width:'32px', marginBottom:'-6px'}} />

Pour déplacer l’ordre des macros, cliquez sur <img src={require('../../assets/configuration/common/move.png').default} style={{width:'32px', marginBottom:'-6px'}} />
