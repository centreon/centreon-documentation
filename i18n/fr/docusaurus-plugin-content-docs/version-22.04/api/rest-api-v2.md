...
Cette page décrit comment utiliser [l'API v2](https://docs-api.centreon.com/api/centreon-web/22.04/) de Centreon Web avec Postman.
...
```text
https://raw.githubusercontent.com/centreon/centreon/22.04.x/centreon/doc/API/centreon-api-v22.04.yaml
```
