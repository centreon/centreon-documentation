...
En plus des flux réseaux nécessaires décrits dans le chapitre [prérequis](/docs/installation/architectures.md#Tableaux_des_flux_réseau)
...
Il ne reste maintenant plus qu'à [intégrer les collecteurs](/docs/installation/installation-of-centreon-ha/integrating-pollers.md) et commencer à superviser !
