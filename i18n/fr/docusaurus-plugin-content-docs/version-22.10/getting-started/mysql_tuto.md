...
La base de données sera supervisée à l'aide du [Plugin Pack **MySQL/MariaDB**](/monitoring-connectors/integrations/plugin-packs/procedures/applications-databases-mysql).
