...
Votre routeur Cisco sera supervisé à l'aide du Plugin Pack [Cisco standard](/monitoring-connectors/integrations/plugin-packs/procedures/network-cisco-standard-snmp). (Plus d'informations sur les Plugin Packs [ici](../monitoring/pluginpacks.md)).
...
Connectez-vous à votre collecteur en SSH et installez le plugin standard Cisco (voir la [procédure de surveillance pour le Plugin Pack **Cisco standard**](/monitoring-connectors/integrations/plugin-packs/procedures/network-cisco-standard-snmp) pour plus d'informations) :
