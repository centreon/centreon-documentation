...
### Utiliser MAP
  - [Gérer les cartes dans MAP](map-web-manage.md) vous donne des informations sur la manière de créer et de gérer des cartes à partir de l'interface Centreon MAP.
  - [Utiliser l'éditeur MAP](map-web-editor.md) explique comment concevoir des cartes à l'aide de l'outil d'édition.
