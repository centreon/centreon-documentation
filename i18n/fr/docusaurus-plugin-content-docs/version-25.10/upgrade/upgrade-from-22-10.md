...
Centreon depuis la version 22.10 vers la version 25.10.

> La version 22.10 n'est plus supportée. La montée de version à partir de cette version n'a pas été testée par l'équipe d'assurance qualité de Centreon.
