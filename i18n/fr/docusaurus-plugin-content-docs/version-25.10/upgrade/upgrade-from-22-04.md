...
description: "Passer une plateforme Centreon de la version 22.04 à la 25.10"
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

Ce chapitre décrit la procédure de montée de version de votre plateforme
Centreon depuis la version 22.04 vers la version 25.10.

> La version 22.04 n'est plus supportée. La montée de version à partir de cette version n'a pas été testée par l'équipe d'assurance qualité de Centreon.
...
> Debian 11 n'est plus supporté depuis la version 24.10. Si vous utilisiez Debian 11, vous devez d'abord migrer en Debian 12 avant d'upgrader Centreon. Voir [Migrer depuis Debian 11 vers Debian 12](../migrate/migrate-from-debian-to-debian.md). Si vous utilisez la HA sur votre plateforme, contactez votre représentant commercial Centreon pour discuter des scénarios de migration possibles.
...
Debian 11 n'est plus supporté depuis la version 24.10. Si vous utilisiez Debian 11, vous devez d'abord migrer en Debian 12 avant d'upgrader Centreon. Voir [Migrer depuis Debian 11 vers Debian 12](../migrate/migrate-from-debian-to-debian.md).
...
<Tabs groupId="sync">
<TabItem value="RHEL 8 / Alma / Oracle Linux 8" label="RHEL 8 / Alma / Oracle Linux 8">
