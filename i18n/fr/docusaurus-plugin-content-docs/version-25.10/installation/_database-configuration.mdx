...
Veuillez noter que les configurations suivantes ne sont que des exemples des possibilités pour une infrastructure avec 8 Go de RAM. Centreon ne saurait être tenu responsable des modifications nécessaires à effectuer sur cette partie.
...
Veuillez noter que la configuration suivante n'est qu'un exemple pour une infrastructure avec 8 Go de RAM. Centreon ne saurait être tenu responsable des potentielles modifications à effectuer sur cette partie.
Nous vous invitons à vous rapprocher de votre administrateur de base de données pour avoir une configuration qui répond à vos besoins.
