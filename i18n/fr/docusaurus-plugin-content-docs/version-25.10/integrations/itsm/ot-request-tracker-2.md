...
Those information are not retrieved from Request Tracker. They are configured in your open ticket rule as [custom lists](../../alerts-notifications/ticketing.md#définition-de-liste).
