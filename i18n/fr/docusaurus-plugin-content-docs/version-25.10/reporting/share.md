...
A much simpler option is to [send the generated report to this user by email or copy the report to a server they can access](https://docs.centreon.com/docs/reporting/reports_publication_rule.md), using a publication rule.
...
When [creating a job](generate-reports.md) (on the **Reporting > Monitoring Business Intelligence > Jobs** page), in the **Job Configuration** section of the **Configuration** tab, link a job group to your job so as to apply the ACLs you have defined.
