...
A much simpler option is to [send the generated report to this user by email or copy the report to a server they can access](./reports_publication_rule.md), using a publication rule.
