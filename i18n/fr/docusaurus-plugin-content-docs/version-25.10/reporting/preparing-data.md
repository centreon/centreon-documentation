...
- Chaque hôte que vous souhaitez voir apparaître dans les rapports doit appartenir à au moins un [groupe d'hôtes](../monitoring/groups.md#cr%C3%A9er-un-groupes-dh%C3%B4tes) et une [catégorie d'hôtes](../monitoring/categories.md#cat%C3%A9gories-dh%C3%B4tes).
