...
Pour les rapports sur la disponibilité et les performances des hôtes/services, les ressources que vous souhaitez voir apparaître dans les rapports doivent être organisées en [groupes d'hôtes](https://docs-next-int.centreon.com/fr/docs/monitoring/groups/#cr%C3%A9er-un-groupes-dh%C3%B4tes), [catégories d'hôtes](https://docs-next-int.centreon.com/fr/docs/monitoring/categories/#cat%C3%A9gories-dh%C3%B4tes) et [catégories de services](https://docs-next-int.centreon.com/fr/docs/monitoring/categories/#cat%C3%A9gories-de-services).

- Chaque hôte que vous souhaitez voir apparaître dans les rapports doit appartenir à au moins un [groupe d'hôtes](https://docs-next-int.centreon.com/fr/docs/monitoring/groups/#cr%C3%A9er-un-groupes-dh%C3%B4tes) et une [catégorie d'hôtes](https://docs-next-int.centreon.com/fr/docs/monitoring/categories/#cat%C3%A9gories-dh%C3%B4tes).
- Chaque service que vous souhaitez voir apparaître dans les rapports doit appartenir à au moins une [catégorie de services](https://docs-next-int.centreon.com/fr/docs/monitoring/categories/#cat%C3%A9gories-de-services).
...
Chaque [tâche](https://docs-next-int.centreon.com/fr/docs/reporting/concepts/#tâches) utilise une [période](https://docs-next-int.centreon.com/fr/docs/monitoring/basic-objects/timeperiods/) comme paramètre : **24x7**, **workhours**, **non-workhours**, etc. Seules les données contenues dans les périodes sélectionnées seront incluses dans le rapport.
...
Les rapports générés peuvent être [partagés localement (via l'interface Centreon)](https://docs-next-int.centreon.com/docs/reporting/share.md) ou [publiés par email ou sur un serveur](reports-publication-rule.md). Avant de [créer une tâche](generating-reports.md#étape-1--créer-une-nouvelle-tâche), assurez-vous d'avoir créé les groupes de tâches ou les règles de publication dont vous avez besoin.
