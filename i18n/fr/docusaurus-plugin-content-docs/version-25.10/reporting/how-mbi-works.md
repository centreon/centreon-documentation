...
Exemple : Centreon peut envoyer des rapports par email selon les paramètres définis dans une [une règle de publication](reports-publication-rule.md) SMTP ([postfix](https://docs.centreon.com/fr/docs/administration/postfix/) doit être configuré).
