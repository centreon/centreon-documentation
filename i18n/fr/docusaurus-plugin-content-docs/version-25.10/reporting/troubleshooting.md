...
Dans ce cas, vous devrez [reconstruire une partie de vos données](rebuilding-data.md#partial-rebuild-keep-your-data-history). Vous devrez par exemple reconstruire **data_bin** pour le 28 juillet.
...
Dans ce cas, vous devrez [reconstruire une partie de vos données](rebuilding-data.md#partial-rebuild-keep-your-data-history).
