...
- Les fichiers RPM sont disponibles sur les dépôts Centreon officiels des versions actuellement supportées. Le [dépôt Centreon officiel](../installation/installation-of-a-central-server/using-packages.md#dépôt-centreon).
