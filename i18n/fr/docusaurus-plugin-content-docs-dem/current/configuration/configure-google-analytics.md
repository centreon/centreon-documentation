...
title: Configurer Google Analytics avec CXM
--- 

## Questions fréquentes

### Pourquoi intégrer Google Analytics dans CXM ?
...
### Les sondes CXM sont-elles comptabilisées dans GA ?

**Non**, CXM est un ninja pour Google Analytics ! En effet nous n'appelons pas le tag Google Analytics présent sur les pages de votre site.

Ainsi vos statistiques ne seront pas affectées par nos sondes.

### Pourquoi je n'ai pas de données Analytics qui remonte dans CXM ?
...
### J’ai désactivé par erreur le module Google Analytics de CXM. Est-il possible de récupérer de l’historique ?
...
## Lier Google Analytics à CXM

Avec CXM, vous pouvez corréler le temps d’exécution de vos webscénarios avec le traffic mesuré par Google Analytics sur la même période et ainsi analyser les effets du traffic sur les temps de chargement du site.


>Pour pouvoir ajouter/supprimer une liaison vous avez besoin d’avoir les permissions « Administrateur » ou « Propriétaire » sur votre Organisation dans CXM.
...
Pour lier CXM avec votre compte Google Analytics, rendez-vous dans l’onglet « Configuration » (icône qui ressemble à un engrenage en haut à droite de votre écran) sélectionnez le site (en cliquant sur son nom) pour lequel vous voulez lier votre compte Google Analytics.
...
Une fois authentifié vous êtes de nouveau redirigé vers CXM, vos profils Analytics sont importés dans l’interface et il ne vous reste plus qu’à choisir celui que vous souhaitez utiliser.
