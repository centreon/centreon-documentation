...
Centreon CXM utilise un script chargé depuis ``https://appstatic.quanta.io``, et envoie ensuite ses mesures de performance vers ``https://rum-metrics.quanta.io``.
