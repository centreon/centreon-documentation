...
Réaliser un Test de Montée en Charge (ou “TMC” pour les intimes) consiste à lancer, directement depuis CXM, un grand nombre de navigateurs web en parallèle et les faire interagir avec un site Internet afin de “stresser” volontairement la plateforme et l’application web.
...
Proposés avec ou sans accompagnement d’experts, les TMC CXM font l’objet d’une facturation spécifique. Pour en savoir + n’hésitez pas à contacter votre commercial ou l’équipe commerciale CXM by Centreon sur [sales@quanta.io](mailto:sales@quanta.io).
