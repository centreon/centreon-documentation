...
Dans DEM, vous pouvez appartenir à plusieurs organisations, et chaque organisation peut contenir l'accès au monitoring de plusieurs applications web. Dans ce contexte, les tableaux de bord vous permettent d’afficher, sur un même écran, n’importe quelles cartes de DEM auxquelles vous avez accès.
