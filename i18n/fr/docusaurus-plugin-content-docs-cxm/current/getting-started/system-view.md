...
- avoir une licence CXM **OPS**, **Full** ou **Enterprise**.
...
- avoir installé les agents systèmes CXM. Ils sont disponibles sous forme de packages Linux et nécessitent quelques minutes d’opération par un administrateur système afin d’être installés.
