...
- **If the input was Markdown, plain text, or pasted directly in chat**: produce a Markdown file where each issue is called out inline using a blockquote or bracketed annotation immediately after the flagged sentence, in this form:
  ```
...
- store the markdown file at the root of the centreon-documentation folder.
