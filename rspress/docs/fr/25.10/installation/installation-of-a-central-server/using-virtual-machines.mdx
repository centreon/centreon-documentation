...
<Tabs groupId="sync">
<Tab value="Page de téléchargement (tous types de licence)" label="Page de téléchargement (tous types de licence)">
...
<Tab value="Page d'essai gratuit IT-100" label="Page d'essai gratuit IT-100">
...
<Tabs groupId="sync">
<Tab value="Alma 8 et 9" label="Alma 8 et 9">
