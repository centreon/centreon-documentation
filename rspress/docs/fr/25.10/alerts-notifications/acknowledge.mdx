...
<Tabs groupId="sync">
<Tab value="Page Statut des ressources" label="Page Statut des ressources">
...
<Tab value="Supervision temps réel" label="Supervision temps réel">
...
<Tab value="Page de détail d'un objet" label="Page de détail d'un objet">
...
<Tabs groupId="sync">
<Tab value="À partir de la page Statut des ressources" label="À partir de la page Statut des ressources">
...
<Tab value="À partir de la supervision temps réel" label="À partir de la supervision temps réel">
