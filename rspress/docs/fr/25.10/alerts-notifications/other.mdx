...
<Tabs groupId="sync">
<Tab value="Page de détails d'un objet" label="Page de détails d'un objet">
...
<Tab value="Depuis le menu commentaires" label="Depuis le menu commentaires">
...
<Tab value="Interface temps réel" label="Interface temps réel">
