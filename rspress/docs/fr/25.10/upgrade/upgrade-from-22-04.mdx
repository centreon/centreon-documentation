...
<Tabs groupId="sync">
<Tab value="RHEL 8 / Alma / Oracle Linux 8" label="RHEL 8 / Alma / Oracle Linux 8">
...
<Tab value="RHEL / Alma / Oracle Linux 9" label="RHEL / Alma / Oracle Linux 9">
...
Vous devez ensuite finaliser le processus de mise à jour :
  ...
  <Tabs groupId="sync">
  <Tab value="Avec l'assistant d'interface" label="Avec l'assistant d'interface">
...
<Tab value="Avec une API dédiée" label="Avec une API dédiée">
