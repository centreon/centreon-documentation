...
vers la version 25.10.

Vous ne pouvez pas simplement monter de version une plateforme avec HA (ou Centreon Failover) depuis une version antérieure à Centreon 20.10 et vers une version 25.10, car CentOS 7 n'est plus supporté: vous devez [migrer votre plateforme vers un OS supporté](../../migrate/introduction.md), puis installer Centreon HA sur la nouvelle platforme. Contactez votre représentant commercial Centreon pour discuter de toute migration avec la HA.
...
<Tabs groupId="sync">
<Tab value="RHEL 8 / Oracle Linux 8" label="RHEL 8 / Oracle Linux 8">
