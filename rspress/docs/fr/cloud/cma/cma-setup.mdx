...
5. Dans la section **Paramètres**, sélectionnez le ou les collecteurs qui recevront des données en provenance de l'agent. 
...
5. Dans la section **Paramètres**, sélectionnez le collecteur qui se connectera aux agents. 
...
<Tabs groupId="sync">
<Tab value="Mode interactif" label="Mode interactif">
...
<Tab value="Mode silencieux" label="Mode silencieux (console)">
