...
Les utilisateurs et groupes d'utilisateurs sont gérés dans [Centreon Hub](../users/centreon-hub.md). Seuls les administrateurs Centreon Hub peuvent créer et gérer des groupes d'utilisateurs.

Un utilisateur peut appartenir à plusieurs groupes.

## Créer un groupe d'utilisateurs

1. Dans Centreon Hub, allez à la page **Users > User groups**.
