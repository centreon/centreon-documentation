...
<Tabs groupId="sync">
<Tab value="Depuis la page Statut des ressources" label="Depuis la page Statut des ressources">
...
<Tab value="Depuis la page de supervision temps réel" label="Depuis la page de supervision temps réel">
