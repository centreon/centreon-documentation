...
<Tabs groupId="sync">
<Tab value="Gestion automatique utilisateurs" label="Gestion automatique">
...
<Tab value="Gestion manuelle utilisateurs" label="Gestion manuelle">
...
<Tabs groupId="sync">
<Tab value="Role automatic management" label="Gestion automatique">
...
<Tab value="Role manual management" label="Gestion manuelle">
...
<Tabs groupId="sync">
<Tab value="Groups automatic management" label="Gestion automatique">
...
<Tab value="Groups manual management" label="Gestion manuelle">
...
<Tabs groupId="sync">
<Tab value="Microsoft Azure AD" label="Microsoft Azure AD">
...
<Tab value="Keycloak" label="Keycloak">
...
<Tab value="LemonLDAP::NG" label="LemonLDAP::NG">
