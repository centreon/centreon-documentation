...
<Tabs groupId="sync">
<Tab value="Moderne (recommandé)" label="Moderne (recommandé)">
...
<Tab value="Legacy (ex-Centcore)" label="Legacy (ex-Centcore)">
...
<Tab value="Autre (non recommandé)" label="Autre (non recommandé)">
...
<Tabs groupId="sync">
<Tab value="Pour un Poller" label="Pour un Poller">
...
<Tab value="Pour un Remote Server" label="Pour un Remote Server">
