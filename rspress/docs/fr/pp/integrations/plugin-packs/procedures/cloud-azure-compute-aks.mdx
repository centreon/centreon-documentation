...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Compute-Aks-custom" label="Cloud-Azure-Compute-Aks-custom">
...
<Tabs groupId="sync">
<Tab value="Allocatable-resources" label="Allocatable-resources">
...
<Tab value="Node-State" label="Node-State">
...
<Tab value="Pod-State" label="Pod-State">
...
<Tab value="Unneeded-nodes" label="Unneeded-nodes">
...
<Tab value="Unschedulable-Pods" label="Unschedulable-Pods">
