...
<Tabs groupId="sync">
<Tab value="HW-Storage-Hitachi-Eseries-CMA-custom" label="HW-Storage-Hitachi-Eseries-CMA-custom">
...
<Tabs groupId="sync">
<Tab value="Efficiency" label="Efficiency">
...
<Tab value="Pair-Status" label="Pair-Status">
...
<Tab value="Path-Status" label="Path-Status">
