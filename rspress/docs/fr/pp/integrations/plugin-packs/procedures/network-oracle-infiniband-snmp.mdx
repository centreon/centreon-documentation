...
<Tabs groupId="sync">
<Tab value="Net-Oracle-Infiniband-SNMP-custom" label="Net-Oracle-Infiniband-SNMP-custom">
...
<Tab value="Infiniband-Usage-Global" label="Infiniband-Usage-Global">
...
<Tab value="Infiniband-Usage-Name" label="Infiniband-Usage-Name">
