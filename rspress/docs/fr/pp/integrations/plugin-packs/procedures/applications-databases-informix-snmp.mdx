...
<Tabs groupId="sync">
<Tab value="App-DB-Informix-SNMP-custom" label="App-DB-Informix-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Archivelevel0" label="Archivelevel0">
...
<Tab value="Chunk-Status" label="Chunk-Status">
...
<Tab value="Dbspace-Usage" label="Dbspace-Usage">
...
<Tab value="Global-Cache" label="Global-Cache">
...
<Tab value="Lock-Stats" label="Lock-Stats">
...
<Tab value="Logfile-Usage" label="Logfile-Usage">
