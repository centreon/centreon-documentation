...
<Tabs groupId="sync">
<Tab value="App-DB-Mongodb-custom" label="App-DB-Mongodb-custom">
...
<Tabs groupId="sync">
<Tab value="Collection-Statistics" label="Collection-Statistics">
...
<Tab value="Database-Statistics" label="Database-Statistics">
...
<Tab value="Replication-Status" label="Replication-Status">
