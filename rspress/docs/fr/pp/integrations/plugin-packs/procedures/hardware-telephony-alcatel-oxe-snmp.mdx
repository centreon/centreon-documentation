...
<Tabs groupId="sync">
<Tab value="HW-Telephony-Alcatel-OXE-SNMP-custom" label="HW-Telephony-Alcatel-OXE-SNMP-custom">
...
<Tab value="Domain-Usage" label="Domain-Usage">
...
<Tab value="PBX-Role" label="PBX-Role">
