...
<Tab value="Database-logs" label="Database-logs">
...
<Tab value="Database-usage" label="Database-usage">
...
<Tab value="Tablespaces" label="Tablespaces">
...
<Tabs groupId="sync">
<Tab value="Online License" label="Online License">
...
2. Sur l'interface Web de Centreon, installer le Pack *DB2 Database* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**

</Tab>
<Tab value="Offline License" label="Offline License">
...
3. Sur l'interface Web de Centreon, installer le Pack *DB2 Database* depuis la page **Configuration > Connecteurs > Connecteurs de supervision**
