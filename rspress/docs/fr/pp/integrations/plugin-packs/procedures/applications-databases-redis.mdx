...
<Tabs groupId="sync">
<Tab value="App-DB-Redis-custom" label="App-DB-Redis-custom">
...
<Tab value="Persistence" label="Persistence">
...
<Tab value="Replication" label="Replication">
...
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| REDISUSERNAME     | Redis username (available for perlmod and redis-cli \>= 6.x mandatory)                                                                             |                   |             |
| REDISPASSWORD     | Redis password (available for perlmod and redis-cli)                                                                                               |                   |             |
| REDISPORT         | Redis port                                                                                                                                         | 6379              |             |
| REDISSENTINELPORT | Sentinel port (default: 26379)                                                                                                                     |                   |             |
| REDISCACERT       | CA Certificate file to verify with (redis-cli \>= 6.x mandatory)                                                                                   |                   |             |
| REDISCERT         | Client certificate to authenticate with (redis-cli \>= 6.x mandatory)                                                                              |                   |             |
...
| REDISKEY          | Private key file to authenticate with (redis-cli \>= 6.x mandatory)                                                                                |                   |      X      |
| REDISSENTINEL     | Sentinel server. Alternative of server option. service option is required                                                                          |                   |             |
...
```bash
OK: system: 48751 % user: 42637 % system children: 43110 % user children: 77477 % | 'cpu.system.usage.percentage'=48751%;;;0;100 'cpu.user.usage.percentage'=42637%;;;0;100 'cpu.system.children.usage.percentage'=43110%;;;0;100 'cpu.user.children.usage.percentage'=77477%;;;0;100 
```
...
| --username                                 | Redis username (available for perlmod and redis-cli \>= 6.x mandatory).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
