...
<Tabs groupId="sync">
<Tab value="Net-Juniper-Mseries-SNMP-custom" label="Net-Juniper-Mseries-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Bgp-Peer-Prefix-Statistics" label="Bgp-Peer-Prefix-Statistics">
...
<Tab value="Bgp-Peer-State" label="Bgp-Peer-State">
...
<Tab value="Cpu-Routing" label="Cpu-Routing">
...
<Tab value="Ldp-Session-Status" label="Ldp-Session-Status">
...
<Tab value="Lsp-Status" label="Lsp-Status">
...
<Tab value="Memory-Routing" label="Memory-Routing">
...
<Tab value="Rsvp-Session-Status" label="Rsvp-Session-Status">
...
<Tab value="Disk-Generic-Id" label="Disk-Generic-Id">
...
<Tab value="Disk-Generic-Name" label="Disk-Generic-Name">
