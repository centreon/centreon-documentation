...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-Elb-Application-LoadBalancer-custom" label="Cloud-Aws-Elb-Application-LoadBalancer-custom">
...
<Tab value="Cloud-Aws-Elb-AvailabilityZone-custom" label="Cloud-Aws-Elb-AvailabilityZone-custom">
...
<Tab value="Cloud-Aws-Elb-LoadBalancer-custom" label="Cloud-Aws-Elb-LoadBalancer-custom">
...
<Tab value="Cloud-Aws-Elb-Network-LoadBalancer-custom" label="Cloud-Aws-Elb-Network-LoadBalancer-custom">
...
<Tabs groupId="sync">
<Tab value="Elb-Connections" label="Elb-Connections">
...
<Tab value="Elb-Http-Codes*" label="Elb-Http-Codes*">
...
<Tab value="Elb-Performances" label="Elb-Performances">
...
<Tab value="Elb-Queues" label="Elb-Queues">
...
<Tab value="Elb-Targets-Health*" label="Elb-Targets-Health*">
