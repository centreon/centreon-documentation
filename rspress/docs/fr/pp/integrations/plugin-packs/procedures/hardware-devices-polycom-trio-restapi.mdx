...
<Tabs groupId="sync">
<Tab value="HW-Device-Polycom-Trio-Restapi-custom" label="HW-Device-Polycom-Trio-Restapi-custom">
...
<Tab value="Paired-Devices" label="Paired-Devices">
...
<Tab value="Sip-Registration" label="Sip-Registration">
