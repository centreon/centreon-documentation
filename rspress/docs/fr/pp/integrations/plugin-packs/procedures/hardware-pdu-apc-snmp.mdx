...
Le connecteur de supervision **APC PDU SNMP** apporte un modèle d'hôte :

* **HW-Pdu-Apc-SNMP-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<Tab value="HW-Pdu-Apc-SNMP-custom" label="HW-Pdu-Apc-SNMP-custom">
...
| Alias  | Modèle de service             | Description                                               |
|:-------|:------------------------------|:----------------------------------------------------------|
| Ntp    | HW-Pdu-Apc-NTP-SNMP-custom    | Contrôle la synchronisation avec un serveur NTP           |
| Uptime | HW-Pdu-Apc-Uptime-SNMP-custom | Durée depuis laquelle le serveur tourne sans interruption |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Pdu-Apc-SNMP-custom**. |
...
| Nom                          | Unité |
|:-----------------------------|:------|
| *device*#device.power.watt   | W     |
| bank-status                  | N/A   |
| *bank*#bank.current.ampere   | A     |
| phase-status                 | N/A   |
| *phase*#phase.current.ampere | A     |
| *phase*#phase.power.watt     | W     |
...
<Tab value="Outlet" label="Outlet">

| Nom                             | Unité |
|:--------------------------------|:------|
| status                          | N/A   |
| status                          | N/A   |
| *outlet1*#outlet.current.ampere | A     |
| *outlet2*#outlet.current.ampere | A     |
...
```bash
dnf install centreon-pack-hardware-pdu-apc-snmp
```
...
```bash
apt install centreon-pack-hardware-pdu-apc-snmp
```
...
```bash
yum install centreon-pack-hardware-pdu-apc-snmp
```

</Tab>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **APC PDU SNMP**
...
```bash
dnf install centreon-plugin-Hardware-Pdu-Apc-Snmp
```
...
```bash
apt install centreon-plugin-hardware-pdu-apc-snmp
```
...
3. Appliquez le modèle d'hôte **HW-Pdu-Apc-SNMP-custom**.
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check (default: '.*'). Can be: 'psu', 'humidity', 'temperature'                                                               |                   |             |
...
```bash
/usr/lib/centreon/plugins/centreon_pdu_apc_snmp.pl  \
...
```bash
OK: All outlets are ok | 'outlet1#outlet.current.ampere'=60547A;;;0; 'outlet2#outlet.current.ampere'=35084A;;;0; 
```
...
|:------------------------------------------------------------------------------------------------------------------------|:--------------------------------|
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/apc/snmp/mode/hardware.pm)] | HW-Pdu-Apc-Hardware-SNMP-custom |
| load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/apc/snmp/mode/load.pm)]         | HW-Pdu-Apc-SNMP-Load-custom     |
| outlet [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/apc/snmp/mode/outlet.pm)]     | HW-Pdu-Apc-SNMP-Outlet-custom   |
| time [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/apc/snmp/mode/ntp.pm)]          | HW-Pdu-Apc-NTP-SNMP-custom      |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/uptime.pm)]             | HW-Pdu-Apc-Uptime-SNMP-custom   |
