...
<Tabs groupId="sync">
<Tab value="OS-AS400-Connector-custom" label="OS-AS400-Connector-custom">
...
<Tab value="Job-Queues" label="Job-Queues">
...
<Tab value="Message-Queue" label="Message-Queue">
...
<Tab value="Page-Faults" label="Page-Faults">
...
<Tab value="SubSystem" label="SubSystem">
...
```bash
OK: processing units used: 52 % storage pool space used: 31 % total: 76375 active: 40528 running: 81783 waiting for message: 27461 | 'system~system.processing.units.usage.percentage'=52%;;;0; 'system~system.storage.pool.space.usage.percentage'=31%;;;0;100 'system~system.jobs.total.count'=76375;;;0; 'system~system.jobs.active.count'=40528;;;0; 'system~system.batch_jobs.running.count'=81783;;;0; 'system~system.batch_jobs.waiting_message.count'=27461;;;0; 
```
