...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Kadiska-Restapi-Alerts-custom" label="App-Monitoring-Kadiska-Restapi-Alerts-custom">
...
<Tab value="App-Monitoring-Kadiska-Runner-Restapi-custom" label="App-Monitoring-Kadiska-Runner-Restapi-custom">
...
<Tab value="App-Monitoring-Kadiska-Watcher-Restapi-custom" label="App-Monitoring-Kadiska-Watcher-Restapi-custom">
...
<Tab value="Target-Statistics" label="Target-Statistics">
...
<Tab value="Watcher-Statistics-Per-Country" label="Watcher-Statistics-Per-Country">
...
<Tab value="Watcher-Statistics-Per-ISP" label="Watcher-Statistics-Per-ISP">
...
<Tab value="Watcher-Statistics-Per-Site-And-Gateway" label="Watcher-Statistics-Per-Site-And-Gateway">
