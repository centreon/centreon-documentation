...
<Tabs groupId="sync">
<Tab value="App-DB-Cassandra-JMX-custom" label="App-DB-Cassandra-JMX-custom">
...
<Tabs groupId="sync">
<Tab value="Caches-Usage" label="Caches-Usage">
...
<Tab value="Client-Requests-Usage" label="Client-Requests-Usage">
...
<Tab value="Thread-Pools-Usage" label="Thread-Pools-Usage">
