...
<Tabs groupId="sync">
<Tab value="App-Exchange-NSClient-Restapi-custom" label="App-Exchange-NSClient-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Activesync-Mailbox" label="Activesync-Mailbox">
...
<Tab value="Exchange-Services" label="Exchange-Services">

Pas de métriques pour ce service.

</Tab>
<Tab value="Imap-Mailbox" label="Imap-Mailbox">

Pas de métriques pour ce service.

</Tab>
<Tab value="Mailboxes" label="Mailboxes">
...
<Tab value="Mapi-Mailbox" label="Mapi-Mailbox">

Pas de métriques pour ce service.

</Tab>
<Tab value="Outlook-Webservices" label="Outlook-Webservices">

Pas de métriques pour ce service.

</Tab>
<Tab value="Owa-Mailbox" label="Owa-Mailbox">
...
<Tab value="Replication-Health" label="Replication-Health">
