...
Le connecteur de supervision **Fiberstore SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="Net-Fiberstore-SNMP-custom" label="Net-Fiberstore-SNMP-custom">

| Alias    | Modèle de service                   | Description                                    |
|:---------|:------------------------------------|:-----------------------------------------------|
| Cpu      | Net-Fiberstore-Cpu-SNMP-custom      | Contrôle du taux d'utilisation des processeurs |
| Hardware | Net-Fiberstore-Hardware-SNMP-custom | Contrôle le matériel                           |
| Memory   | Net-Fiberstore-Memory-SNMP-custom   | Contrôle du taux d'utilisation des mémoires     |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Fiberstore-SNMP-custom** est utilisé.
...
|:-----------|:--------------------------------------|:------------------------|:----------:|
| Interfaces | Net-Fiberstore-Interfaces-SNMP-custom | Contrôle les interfaces | X          |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Fiberstore-SNMP-custom** |
...
| Nom de la règle                    | Description                                                             |
|:-----------------------------------|:------------------------------------------------------------------------|
| Net-Fiberstore-SNMP-Interface-Name | Découvre les interfaces réseau et supervise le statut et l'utilisation |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Fiberstore SNMP**
...
3. Appliquez le modèle d'hôte **Net-Fiberstore-SNMP-custom**.
