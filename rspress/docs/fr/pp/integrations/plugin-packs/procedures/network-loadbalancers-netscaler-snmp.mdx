...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Citrix Netscaler SNMP** 
...
Le connecteur de supervision **Citrix Netscaler SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="Net-Citrix-Netscaler-SNMP-custom" label="Net-Citrix-Netscaler-SNMP-custom">
...
| Health         | Net-Citrix-Netscaler-Health-SNMP-custom         | Contrôle l'état du matériel (Ventilateurs, alimentations, températures, voltages)                                         |            |
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Citrix-Netscaler-SNMP-custom**. |
...
| Nom de la règle                        | Description                                                                                       |
|:---------------------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Citrix-Netscaler-SNMP-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
| Net-Citrix-Netscaler-SNMP-Vserver-Name | Découvre les serveurs virtuels et supervise leur status                                           |
...
<Tabs groupId="sync">
<Tab value="Certificates-Expire" label="Certificates-Expire">
...
<Tab value="Ha-State" label="Ha-State">
...
<Tab value="Vserver-Status" label="Vserver-Status">
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Citrix Netscaler SNMP**
...
| list-vservers [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/citrix/netscaler/snmp/mode/listvservers.pm)]             | Utilisé pour la découverte de services                                                                                                                              |
