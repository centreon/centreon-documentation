...
<Tabs groupId="sync">
<Tab value="App-Oracle-Ovm-Api-custom" label="App-Oracle-Ovm-Api-custom">
...
<Tabs groupId="sync">
<Tab value="File-Servers" label="File-Servers">
...
<Tab value="Server-Pools" label="Server-Pools">
