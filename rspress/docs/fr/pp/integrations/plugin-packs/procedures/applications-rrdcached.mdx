...
<Tabs groupId="sync">
<Tab value="App-Rrdcached-Tcp-custom" label="App-Rrdcached-Tcp-custom">
...
<Tab value="App-Rrdcached-Unix-custom" label="App-Rrdcached-Unix-custom">
...
<Tabs groupId="sync">
<Tab value="Ping-Socket*" label="Ping-Socket*">
...
<Tab value="UNIX socket" label="UNIX socket">
