...
<Tabs groupId="sync">
<Tab value="HW-Storage-Hp-P2000-Xmlapi-custom" label="HW-Storage-Hp-P2000-Xmlapi-custom">
...
<Tab value="Volume-Stats-Global" label="Volume-Stats-Global">
...
<Tab value="Volume-Stats-Name" label="Volume-Stats-Name">
