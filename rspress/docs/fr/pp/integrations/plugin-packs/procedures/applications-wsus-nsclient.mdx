...
<Tabs groupId="sync">
<Tab value="App-Wsus-NRPE-custom" label="App-Wsus-NRPE-custom">
...
<Tab value="App-Wsus-NSClient-05-Restapi-custom" label="App-Wsus-NSClient-05-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Computers-Status*" label="Computers-Status*">
...
<Tab value="Server-Statistics*" label="Server-Statistics*">
...
<Tab value="Synchronisation-Status*" label="Synchronisation-Status*">
...
<Tab value="Update-Status*" label="Update-Status*">
