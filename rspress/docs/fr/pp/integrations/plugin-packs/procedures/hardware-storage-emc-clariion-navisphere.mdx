...
<Tabs groupId="sync">
<Tab value="HW-Storage-EMC-Clariion-Navisphere-custom" label="HW-Storage-EMC-Clariion-Navisphere-custom">
...
<Tab value="Controller" label="Controller">
...
<Tab value="Hba-State" label="Hba-State">
...
<Tab value="Port-State" label="Port-State">
