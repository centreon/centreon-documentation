...
<Tabs groupId="sync">
<Tab value="HW-Server-Hp-Server-SNMP-custom" label="HW-Server-Hp-Server-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Hardware-Cpu" label="Hardware-Cpu">
...
<Tab value="Hardware-Network" label="Hardware-Network">
...
<Tab value="Hardware-Pc" label="Hardware-Pc">
...
<Tab value="Hardware-Storage" label="Hardware-Storage">
...
<Tab value="Hardware-Temperature" label="Hardware-Temperature">
