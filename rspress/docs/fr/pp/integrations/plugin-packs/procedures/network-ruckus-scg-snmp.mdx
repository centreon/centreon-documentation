...
Le connecteur de supervision **Ruckus SCG** apporte un modèle d'hôte :
...
|:-------------|:----------------------------------------|:----------------------------------------------------------|
| Ap-Status    | Net-Ruckus-Scg-Ap-Status-SNMP-custom    | Contrôle le statut des points d'accès                     |
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Ruckus-Scg-SNMP-custom** |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Ruckus SCG**
...
3. Appliquez le modèle d'hôte **Net-Ruckus-Scg-SNMP-custom**.
