...
<Tabs groupId="sync">
<Tab value="sshcli backend" label="sshcli backend">
...
<Tab value="plink backend" label="plink backend">
...
<Tab value="libssh backend (par défaut)" label="libssh backend (par défaut)">
