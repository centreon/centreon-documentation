...
<Tabs groupId="sync">
<Tab value="generic-active-host-custom" label="generic-active-host-custom">
...
<Tab value="generic-passive-host-custom" label="generic-passive-host-custom">
  
Ce modèle d'hôte n'est associé à aucun modèle de service.

</Tab>
<Tab value="generic-dummy-host-custom" label="generic-dummy-host-custom">

Ce modèle d'hôte n'est associé à aucun modèle de service.

</Tab>
<Tab value="Generic-Active-Cloud-Host-custom" label="Generic-Active-Cloud-Host-custom">
...
<Tabs groupId="sync">
<Tab value="Base-Ping-LAN" label="Base-Ping-LAN">
...
<Tabs groupId="sync">
<Tab value="generic-dummy-host" label="generic-dummy-host">
...
<Tab value="generic-passive-host" label="generic-passive-host">
...
<Tab value="generic-passive-service" label="generic-passive-service">
