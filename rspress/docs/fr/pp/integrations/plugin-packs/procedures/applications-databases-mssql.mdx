...
<Tabs groupId="sync">
<Tab value="App-DB-MSSQL-custom" label="App-DB-MSSQL-custom">
...
<Tabs groupId="sync">
<Tab value="Backup-Age" label="Backup-Age">
...
<Tab value="Databases-Size" label="Databases-Size">
...
<Tab value="Locks-Waits" label="Locks-Waits">
...
<Tab value="Page-Life-Expectancy" label="Page-Life-Expectancy">
...
<Tab value="Sql-Statement-String" label="Sql-Statement-String">
