...
<Tabs groupId="sync">
<Tab value="App-DB-Postgres-custom" label="App-DB-Postgres-custom">
...
<Tab value="Cache-Hitratio" label="Cache-Hitratio">
...
<Tab value="Query-Time" label="Query-Time">
...
<Tab value="Tablespace-Size" label="Tablespace-Size">
...
<Tab value="Time-Sync" label="Time-Sync">
