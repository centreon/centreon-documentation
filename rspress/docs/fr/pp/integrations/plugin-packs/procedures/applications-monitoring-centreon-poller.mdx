...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Centreon-Poller-custom" label="App-Monitoring-Centreon-Poller-custom">
...
<Tabs groupId="sync">
<Tab value="Broker-Stats" label="Broker-Stats">
...
<Tab value="proc-centengine" label="proc-centengine">
...
<Tab value="proc-gorgoned" label="proc-gorgoned">
...
<Tab value="proc-ntpd" label="proc-ntpd">
...
<Tab value="proc-sshd" label="proc-sshd">
