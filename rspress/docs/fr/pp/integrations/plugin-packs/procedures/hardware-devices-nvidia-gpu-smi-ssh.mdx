...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **NVIDIA GPU SMI SSH** 
...
Le connecteur de supervision **NVIDIA GPU SMI SSH** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="HW-Device-Nvidia-Gpu-Smi-SSH-custom" label="HW-Device-Nvidia-Gpu-Smi-SSH-custom">

| Alias     | Modèle de service                         | Description                   |
|:----------|:------------------------------------------|:------------------------------|
| Gpu-Stats | HW-Device-Nvidia-Gpu-Smi-Stats-Ssh-custom | Contrôle les statistiques GPU |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **HW-Device-Nvidia-Gpu-Smi-SSH-custom** est utilisé.
...
<Tabs groupId="sync">
<Tab value="Gpu-Stats" label="Gpu-Stats">
...
L'utilisateur distant doit avoir assez de privilèges pour executer la commande nvidia-smi.
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **NVIDIA GPU SMI SSH**
...
3. Appliquez le modèle d'hôte **HW-Device-Nvidia-Gpu-Smi-SSH-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
