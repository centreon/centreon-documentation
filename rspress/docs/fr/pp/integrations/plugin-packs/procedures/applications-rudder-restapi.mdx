...
<Tabs groupId="sync">
<Tab value="App-Rudder-Node-Compliance-Restapi-custom" label="App-Rudder-Node-Compliance-Restapi-custom">
...
<Tab value="App-Rudder-Restapi-custom" label="App-Rudder-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Global-Compliance" label="Global-Compliance">
...
<Tab value="Node-Compliance*" label="Node-Compliance*">
...
<Tab value="Nodes-Overall-Compliance" label="Nodes-Overall-Compliance">
...
<Tab value="Rule-Compliance" label="Rule-Compliance">
