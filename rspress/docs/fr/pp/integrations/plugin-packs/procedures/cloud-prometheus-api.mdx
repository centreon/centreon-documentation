...
<Tabs groupId="sync">
<Tab value="Cloud-Prometheus-Api-custom" label="Cloud-Prometheus-Api-custom">
...
<Tab value="Cloud-Prometheus-Target-Name-Api-custom" label="Cloud-Prometheus-Target-Name-Api-custom">
...
<Tabs groupId="sync">
<Tab value="Expression" label="Expression">
...
<Tab value="Target-Name-Status" label="Target-Name-Status">
...
<Tab value="Target-Status" label="Target-Status">
