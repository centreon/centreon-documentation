...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Microsoft Cluster Server NSClient++ NRPE**
...
Le connecteur de supervision **Microsoft Cluster Server NSClient++ NRPE** apporte un modèle d'hôte :

* **App-Mscs-NRPE-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<Tab value="App-Mscs-NRPE-custom" label="App-Mscs-NRPE-custom">

| Alias                       | Modèle de service                         | Description                                                                    |
|:----------------------------|:------------------------------------------|:-------------------------------------------------------------------------------|
| Cluster-Network-Status      | App-Mscs-Network-Status-NRPE-custom       | Contrôle permettant de vérifier le statut réseau du cluster                   |
| Cluster-Node-Status         | App-Mscs-Node-Status-NRPE-custom          | Contrôle permettant de vérifier le statut des noeuds du cluster                |
| Cluster-Resouce-Status      | App-Mscs-Resource-Status-NRPE-custom      | Contrôle permettant de vérifier le statut des ressources du cluster            |
| Cluster-Resoucegroup-Status | App-Mscs-Resourcegroup-Status-NRPE-custom | Contrôle permettant de vérifier le statut des groupes de ressources du cluster |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Mscs-NRPE-custom** est utilisé.
...
Veuillez suivre notre [documentation officielle](../getting-started/how-to-guides/centreon-nsclient-tutorial.md) et assurez-vous que la configuration du **NRPE** est correcte.
...
```bash
dnf install centreon-pack-applications-mscs-nrpe
```
...
```bash
apt install centreon-pack-applications-mscs-nrpe
```
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Microsoft Cluster Server NSClient++ NRPE**
...
3. Appliquez le modèle d'hôte **App-Mscs-NRPE-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
| network-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/microsoft/mscs/local/mode/networkstatus.pm)]             | App-Mscs-Network-Status-NRPE-custom       |
| node-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/microsoft/mscs/local/mode/nodestatus.pm)]                   | App-Mscs-Node-Status-NRPE-custom          |
| resource-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/microsoft/mscs/local/mode/resourcestatus.pm)]           | App-Mscs-Resource-Status-NRPE-custom      |
| resourcegroup-status [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/microsoft/mscs/local/mode/resourcegroupstatus.pm)] | App-Mscs-Resourcegroup-Status-NRPE-custom |
