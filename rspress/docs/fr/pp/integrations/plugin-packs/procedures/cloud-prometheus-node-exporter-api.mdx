...
<Tabs groupId="sync">
<Tab value="Cloud-Prometheus-Node-Exporter-Api-custom" label="Cloud-Prometheus-Node-Exporter-Api-custom">
...
<Tab value="Node-Cpu-Detailed" label="Node-Cpu-Detailed">
...
<Tab value="Node-Load" label="Node-Load">
