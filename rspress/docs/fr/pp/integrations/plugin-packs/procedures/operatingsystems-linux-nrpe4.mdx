...
<Tabs groupId="sync">
<Tab value="OS-Linux-NRPE4-custom" label="OS-Linux-NRPE4-custom">
...
<Tab value="Protocol-NRPE4" label="Protocol-NRPE4">
...
<Tabs groupId="sync">
<Tab value="Alma / RHEL / Oracle Linux 8, 9 & 10" label="Alma / RHEL / Oracle Linux 8, 9 & 10">
