...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-Rds-Cluster-custom" label="Cloud-Aws-Rds-Cluster-custom">
...
<Tab value="Cloud-Aws-Rds-Instance-Aurora-custom" label="Cloud-Aws-Rds-Instance-Aurora-custom">
...
<Tab value="Cloud-Aws-Rds-Instance-MSSQL-custom" label="Cloud-Aws-Rds-Instance-MSSQL-custom">
...
<Tab value="Cloud-Aws-Rds-Instance-MariaDB-custom" label="Cloud-Aws-Rds-Instance-MariaDB-custom">
...
<Tab value="Cloud-Aws-Rds-Instance-MySQL-custom" label="Cloud-Aws-Rds-Instance-MySQL-custom">
...
<Tab value="Cloud-Aws-Rds-Instance-Oracle-custom" label="Cloud-Aws-Rds-Instance-Oracle-custom">
...
<Tab value="Cloud-Aws-Rds-Instance-PostgreSQL-custom" label="Cloud-Aws-Rds-Instance-PostgreSQL-custom">
...
<Tabs groupId="sync">
<Tab value="Rds-Connections" label="Rds-Connections">
...
<Tab value="Rds-Cpu-Credit" label="Rds-Cpu-Credit">
...
<Tab value="Rds-Cpu-Usage" label="Rds-Cpu-Usage">
...
<Tab value="Rds-Diskio" label="Rds-Diskio">
...
<Tab value="Rds-Instance-Status" label="Rds-Instance-Status">
...
<Tab value="Rds-Network" label="Rds-Network">
...
<Tab value="Rds-Queries" label="Rds-Queries">
...
<Tab value="Rds-Storage" label="Rds-Storage">
...
<Tab value="Rds-Transactions" label="Rds-Transactions">
...
<Tab value="Rds-Volume-Iops" label="Rds-Volume-Iops">
...
<Tab value="Rds-Volume-Usage" label="Rds-Volume-Usage">
