...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **JVM Actuator**
...
Le connecteur de supervision **JVM Actuator** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="App-Jvm-Actuator-custom" label="App-Jvm-Actuator-custom">
...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Jvm-Actuator-custom** est utilisé.
...
<Tabs groupId="sync">
<Tab value="Class-Count" label="Class-Count">
...
<Tab value="Fd-Usage" label="Fd-Usage">
...
<Tab value="Load-Average" label="Load-Average">
...
<Tab value="Memory-Detailed" label="Memory-Detailed">
...
```bash
dnf install centreon-pack-applications-jvm-actuator
```
...
```bash
apt install centreon-pack-applications-jvm-actuator
```
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **JVM Actuator**
...
3. Appliquez le modèle d'hôte **App-Jvm-Actuator-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
| ACTUATORAPIPORT         | API port (default: 8080)                                                                                                   | 8080              |             |
| ACTUATORAPIURLPATH      | API url path (default: '/centreon-studio/api/beta')                                                                        | /actuator         |             |
| ACTUATORCUSTOMMODE      | When a plugin offers several ways (CLI, library, etc.) to get information the desired one must be defined with this option | standard          |             |
...
|:--------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------|
| class-count [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/classcount.pm)]         | App-Jvm-Class-Count-Actuator-custom     |
| cpu-load [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/cpuload.pm)]               | App-Jvm-Cpu-Load-Actuator-custom        |
| fd-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/fdusage.pm)]               | App-Jvm-Fd-Usage-Actuator-custom        |
| load-average [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/loadaverage.pm)]       | App-Jvm-Load-Average-Actuator-custom    |
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/memory.pm)]                  | App-Jvm-Memory-Actuator-custom          |
| memory-detailed [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/memorydetailed.pm)] | App-Jvm-Memory-Detailed-Actuator-custom |
| threads [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/java/jvm/actuator/mode/threads.pm)]                | App-Jvm-Threads-Actuator-custom         |
