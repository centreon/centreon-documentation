...
<Tabs groupId="sync">
<Tab value="Virt-Hyperv-2012-Node-CMA-custom" label="Virt-Hyperv-2012-Node-CMA-custom">
...
<Tab value="Virt-Hyperv-2012-Scvmm-CMA-custom" label="Virt-Hyperv-2012-Scvmm-CMA-custom">
...
<Tabs groupId="sync">
<Tab value="Node-Integration-Service" label="Node-Integration-Service">
...
<Tab value="Node-Replication" label="Node-Replication">
...
<Tab value="Node-Snapshot" label="Node-Snapshot">
...
<Tab value="Node-Vm-Status" label="Node-Vm-Status">
...
<Tab value="Scvmm-Integration-Service" label="Scvmm-Integration-Service">
...
<Tab value="Scvmm-Snapshot" label="Scvmm-Snapshot">
...
<Tab value="Scvmm-Vm-Status" label="Scvmm-Vm-Status">
