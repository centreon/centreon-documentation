...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **RedBack Router SNMP** 
...
<Tabs groupId="sync">
<Tab value="Net-Redback-SNMP-custom" label="Net-Redback-SNMP-custom">

| Alias             | Modèle de service                         | Description                                                                              |
|:------------------|:------------------------------------------|:-----------------------------------------------------------------------------------------|
| Cpu               | Net-Redback-Cpu-SNMP-custom               | Contrôle du taux d'utilisation du CPU de la machine                                      |
| Disk-Usage-Global | Net-Redback-Disk-Usage-Global-SNMP-custom | Contrôle du taux d'espace libre disponible des disques                                   |
| Hardware-Global   | Net-Redback-Hardware-Global-SNMP-custom   | Contrôle le matériel ('ventilateur', 'alimentation', 'température', 'voltage', 'disque') |
| Memory            | Net-Redback-Memory-SNMP-custom            | Contrôle du taux d'utilisation des mémoires                                              |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Redback-SNMP-custom** est utilisé.
...
|:----------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Redback-SNMP-custom**. |
...
| Nom de la règle                     | Description                                                                                       |
|:------------------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Redback-SNMP-Packet-Errors-Name | Découvre les interfaces réseau en utilisant leur nom et supervise les paquets erronés et rejetés  |
| Net-Redback-SNMP-Traffic-Name       | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
```bash
dnf install centreon-pack-network-routers-redback-snmp
```
...
```bash
apt install centreon-pack-network-routers-redback-snmp
```
...
```bash
yum install centreon-pack-network-routers-redback-snmp
```
...
```bash
dnf install centreon-plugin-Network-Routers-Redback-Snmp
```
...
```bash
apt install centreon-plugin-network-routers-redback-snmp
```
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| CRITICAL     | Critical threshold in percent (5s,1min,5min)                                                                                                     | ,,95              |             |
| WARNING      | Warning threshold in percent (5s,1min,5min)                                                                                                      | ,,90              |             |
...
| Macro         | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:--------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| FILTER        | Filter disk name (can be a regexp)                                                                                                               | .*                |             |
...
| Macro        | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check. Can be: 'fan', 'psu', 'temperature', 'voltage', 'disk'                                                                 | .*                |             |
| EXTRAOPTIONS | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
| Macro         | Description                                                                                                                                      | Valeur par défaut | Obligatoire |
|:--------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| FILTER        | Filter memory name (can be a regexp)                                                                                                             | .*                |             |
| CRITICALUSAGE | Critical threshold (in percent)                                                                                                                  | 90                |             |
| WARNINGUSAGE  | Warning threshold (in percent)                                                                                                                   | 80                |             |
| EXTRAOPTIONS  | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). | --verbose         |             |
...
```bash
/usr/lib/centreon/plugins/centreon_redback.pl \
	--plugin=network::redback::snmp::plugin \
	--mode=interfaces \
	--hostname=10.0.0.1 \
	--snmp-version='2c' \
...
|:-----------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cpu [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/redback/snmp/mode/cpu.pm)]                 | Net-Redback-Cpu-SNMP-custom                                                                                                                                                                                                                                                                              |
| disk-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/redback/snmp/mode/disk.pm)]         | Net-Redback-Disk-Usage-Global-SNMP-custom                                                                                                                                                                                                                                                                |
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/redback/snmp/mode/hardware.pm)]       | Net-Redback-Hardware-Global-SNMP-custom                                                                                                                                                                                                                                                                  |
| interfaces [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/interfaces.pm)]          | Net-Redback-Packet-Errors-Generic-Id-SNMP-custom<br />Net-Redback-Packet-Errors-Generic-Name-SNMP-custom<br />Net-Redback-Packet-Errors-Global-SNMP-custom<br />Net-Redback-Traffic-Generic-Id-SNMP-custom<br />Net-Redback-Traffic-Generic-Name-SNMP-custom<br />Net-Redback-Traffic-Global-SNMP-custom |
...
| memory [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/redback/snmp/mode/memory.pm)]           | Net-Redback-Memory-SNMP-custom                                                                                                                                                                                                                                                                           |
...
| Option               | Description                                                                                                                                                                                                                |
|:---------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --component          | Which component to check (default: '.*'). Can be: 'fan', 'psu', 'temperature', 'voltage', 'disk'.                                                                                                                          |
...
| --warning-usage   | Warning threshold (in percent).                                                                                           |
| --critical-usage  | Critical threshold (in percent).                                                                                          |
| --filter-name     | Filter memory name (can be a regexp).                                                                                     |
