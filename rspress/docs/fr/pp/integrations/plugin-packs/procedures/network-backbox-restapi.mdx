...
<Tabs groupId="sync">
<Tab value="Net-Backbox-RESTAPI-custom" label="Net-Backbox-RESTAPI-custom">
...
<Tab value="Configstatus" label="Configstatus">
...
<Tab value="Device-Backup" label="Device-Backup">
...
<Tab value="Intellicheck" label="Intellicheck">
