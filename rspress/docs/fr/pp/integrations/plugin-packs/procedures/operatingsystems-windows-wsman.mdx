...
<Tabs groupId="sync">
<Tab value="OS-Windows-WSMAN-custom" label="OS-Windows-WSMAN-custom">
...
<Tab value="Files-Date-Generic" label="Files-Date-Generic">
...
<Tab value="Files-Size-Generic" label="Files-Size-Generic">
...
<Tab value="Process-Global" label="Process-Global">
