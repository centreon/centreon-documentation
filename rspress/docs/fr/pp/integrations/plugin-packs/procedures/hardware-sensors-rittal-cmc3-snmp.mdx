...
<Tabs groupId="sync">
<Tab value="HW-Sensor-Rittal-Cmc3-SNMP-custom" label="HW-Sensor-Rittal-Cmc3-SNMP-custom">
...
<Tab value="Unit-Status" label="Unit-Status">
...
| --snmp-errors-exit                         | Expected status in case of SNMP error or timeout. Possible values are ok, warning, critical and unknown (default).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | SNMP   |
