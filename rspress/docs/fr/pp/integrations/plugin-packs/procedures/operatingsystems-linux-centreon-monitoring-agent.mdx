...
<Tabs groupId="sync">
<Tab value="OS-Linux-Centreon-Monitoring-Agent-custom" label="OS-Linux-Centreon-Monitoring-Agent-custom">
...
<Tabs groupId="sync">
<Tab value="Cmd-Generic" label="Cmd-Generic">
...
<Tab value="Connections-Generic" label="Connections-Generic">
...
<Tab value="File-Date-Generic" label="File-Date-Generic">
...
<Tab value="File-Size-Generic" label="File-Size-Generic">
...
<Tab value="Is-File-Generic" label="Is-File-Generic">
...
<Tab value="Is-Not-File-Generic" label="Is-Not-File-Generic">
...
<Tab value="Open-Files" label="Open-Files">
...
<Tab value="Pending-Updates" label="Pending-Updates">
...
<Tab value="Protocol-Centreon-Monitoring-Agent" label="Protocol-Centreon-Monitoring-Agent">
...
<Tab value="Systemd-Journal" label="Systemd-Journal">
...
<Tab value="Systemd-Sc-Status" label="Systemd-Sc-Status">
...
<Tabs groupId="sync">
<Tab value="Version OnPrem 24.10.6 ou plus récente" label="Version OnPrem 24.10.6 ou plus récente">

Pour cette version, aucune configuration n'est nécessaire. Passez à [l'étape suivante](#plugin).

</Tab>
<Tab value="Version OnPrem antérieure à la 24.10.6" label="Version OnPrem antérieure à la 24.10.6">
