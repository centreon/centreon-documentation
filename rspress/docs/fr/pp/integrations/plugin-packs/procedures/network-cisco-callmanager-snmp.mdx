...
<Tabs groupId="sync">
<Tab value="Net-Cisco-Callmanager-SNMP-custom" label="Net-Cisco-Callmanager-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Ccm-Usage" label="Ccm-Usage">
...
<Tab value="Gateway-Usage" label="Gateway-Usage">
...
<Tab value="Mediadevice-Usage" label="Mediadevice-Usage">
...
<Tab value="Phone-Usage" label="Phone-Usage">
