...
<Tabs groupId="sync">
<Tab value="Net-Sonus-Sbc-SNMP-custom" label="Net-Sonus-Sbc-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Call-Statistics" label="Call-Statistics">
...
<Tab value="Dsp-Statistics" label="Dsp-Statistics">
