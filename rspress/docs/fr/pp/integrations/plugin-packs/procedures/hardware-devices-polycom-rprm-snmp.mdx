...
<Tabs groupId="sync">
<Tab value="HW-Device-Polycom-Rprm-SNMP-custom" label="HW-Device-Polycom-Rprm-SNMP-custom">
...
<Tab value="Provisioning" label="Provisioning">
...
<Tab value="SiteLinks" label="SiteLinks">
