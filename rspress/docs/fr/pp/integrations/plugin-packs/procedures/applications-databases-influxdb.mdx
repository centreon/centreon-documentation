...
<Tabs groupId="sync">
<Tab value="App-DB-Influxdb-custom" label="App-DB-Influxdb-custom">
...
<Tab value="Http-Server-Statistics" label="Http-Server-Statistics">
...
<Tab value="Write-Statistics" label="Write-Statistics">
