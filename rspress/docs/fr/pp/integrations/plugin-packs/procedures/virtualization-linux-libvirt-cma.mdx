...
<Tabs groupId="sync">
<Tab value="Virt-Linux-Libvirt-Hypervisor-CMA-custom" label="Virt-Linux-Libvirt-Hypervisor-CMA-custom">
...
<Tab value="Virt-Linux-Libvirt-VM-CMA-custom" label="Virt-Linux-Libvirt-VM-CMA-custom">
