...
<Tabs groupId="sync">
<Tab value="HW-Device-Camera-Avigilon-SNMP-custom" label="HW-Device-Camera-Avigilon-SNMP-custom">
...
<Tab value="Storage state" label="Storage state">
...
<Tab value="Temperature sensor" label="Temperature sensor">
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Camera Avigilon SNMP**
