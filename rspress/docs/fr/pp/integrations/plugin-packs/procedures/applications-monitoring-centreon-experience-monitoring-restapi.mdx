...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Centreon-DEM-Restapi-custom" label="App-Monitoring-Centreon-DEM-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="RUM Overview" label="RUM Overview">
...
<Tab value="Site Performances Overview" label="Site Performances Overview">
...
<Tab value="User Journey Incidents" label="User Journey Incidents">
...
<Tab value="User Journey Statistics" label="User Journey Statistics">
