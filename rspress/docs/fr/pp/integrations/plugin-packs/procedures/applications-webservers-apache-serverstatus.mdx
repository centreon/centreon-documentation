...
<Tabs groupId="sync">
<Tab value="App-Webserver-Apache-ServerStatus-custom" label="App-Webserver-Apache-ServerStatus-custom">
...
<Tabs groupId="sync">
<Tab value="Apache-Cpuload" label="Apache-Cpuload">
...
<Tab value="Apache-Requests" label="Apache-Requests">
...
<Tab value="Apache-ResponseTime" label="Apache-ResponseTime">
...
<Tab value="Apache-SlotStates" label="Apache-SlotStates">
...
<Tab value="Apache-Workers" label="Apache-Workers">
