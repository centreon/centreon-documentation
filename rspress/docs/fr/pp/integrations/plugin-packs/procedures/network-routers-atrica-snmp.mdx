...
<Tabs groupId="sync">
<Tab value="Net-Atrica-SNMP-custom" label="Net-Atrica-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Connections-Generic-Id" label="Connections-Generic-Id">
...
<Tab value="Connections-Generic-Name" label="Connections-Generic-Name">
...
<Tab value="Connections-Global" label="Connections-Global">
