...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Ruckus Zonedirector SNMP** 
...
Le connecteur de supervision **Ruckus Zonedirector SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="Net-Ruckus-Zonedirector-SNMP-custom" label="Net-Ruckus-Zonedirector-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Access-Point" label="Access-Point">
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Ruckus Zonedirector SNMP**
...
| WARNINGCONNECTIONROGUEDEVICES             | Threshold                                                                                                                                        |                   |             |
| CRITICALCONNECTIONROGUEDEVICES            | Threshold                                                                                                                                        |                   |             |
...
```bash
OK: cpu usage: 35%   ram used: 30 % access points connections: 79 client devices authorized connections: 36 rogue devices connections: 57 traffic in: 6037/s traffic in: 2551/s | 'system~system.cpu.utilization.percentage'=35%;;;0;100 'system~system.memory.usage.bytes'=396B;;;0;total 'system~system.memory.free.bytes'=830B;;;0;total 'system~system.memory.usage.percentage'=30%;;;0;100 'system~system.connection.accesspoints.count'=79;;;0; 'system~system.connection.client.devices.authorized.count'=36;;;0; 'system~system.connection.rogue.devices.count'=57;;;0; 'system~system.traffic.in.bitspersecond'=767b/s;;;0; 'system~system.traffic.out.bitspersecond'=251b/s;;;0; 
```
...
| list-access-points [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/network/ruckus/zonedirector/snmp/mode/listaccesspoints.pm)] | Utilisé pour la découverte de services           |
