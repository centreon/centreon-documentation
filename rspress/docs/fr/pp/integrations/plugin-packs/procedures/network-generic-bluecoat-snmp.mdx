...
<Tabs groupId="sync">
<Tab value="Net-Bluecoat-SNMP-custom" label="Net-Bluecoat-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Client-Connections" label="Client-Connections">
...
<Tab value="Client-Requests" label="Client-Requests">
...
<Tab value="Client-Traffic" label="Client-Traffic">
...
<Tab value="Server-Connections" label="Server-Connections">
