...
<Tabs groupId="sync">
<Tab value="Cloud-Microsoft-Office365-Onedrive-Api-custom" label="Cloud-Microsoft-Office365-Onedrive-Api-custom">
...
<Tabs groupId="sync">
<Tab value="Site-Usage-OneDrive" label="Site-Usage-OneDrive">
...
<Tab value="Users-Activity-OneDrive" label="Users-Activity-OneDrive">
