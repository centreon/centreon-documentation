...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Mac SNMP** 
...
Le connecteur de supervision **Mac SNMP** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="OS-Mac-SNMP-custom" label="OS-Mac-SNMP-custom">
...
| Disk-IO | OS-Mac-Disk-IO-SNMP-custom | Contrôle les accès disques du disque. Pour chaque contrôle, le nom du disque apparaîtra                                                                                      |
| Load    | OS-Mac-Load-SNMP-custom    | Contrôle de la charge serveur                                                                                                                                                |
| Memory  | OS-Mac-Memory-SNMP-custom  | Contrôle du taux d'utilisation de la mémoire vive (RAM)                                                                                                                      |
| Swap    | OS-Mac-Swap-SNMP-custom    | Contrôle du taux d'utilisation de la mémoire virtuelle (SWAP)                                                                                                                |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **OS-Mac-SNMP-custom** est utilisé.
...
|:---------------------|:----------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|:----------:|
| Disk-Generic-Id      | OS-Mac-Disk-Generic-Id-SNMP-custom      | Contrôle du taux d'espace libre disponible du disque. Pour chaque contrôle apparaîtra le nom du disque («                |            |
| Disk-Generic-Name    | OS-Mac-Disk-Generic-Name-SNMP-custom    | Contrôle du taux d'espace libre disponible du disque. Pour chaque contrôle apparaîtra le point de montage du disque («   |            |
| Disk-Global          | OS-Mac-Disk-Global-SNMP-custom          | Contrôle du taux d'espace libre disponible des disques. Pour chaque contrôle, le point de montage des disques apparaîtra | X          |
| Inodes-Global        | OS-Mac-Inodes-Global-SNMP-custom        | Contrôle l'utilisation des inodes                                                                                        |            |
| Process-Generic      | OS-Mac-Process-Generic-SNMP-custom      | Contrôle permettant de vérifier le fonctionnement d'un processus/service Unix                                            |            |
| Traffic-Generic-Id   | OS-Mac-Traffic-Generic-Id-SNMP-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface («                   |            |
| Traffic-Generic-Name | OS-Mac-Traffic-Generic-Name-SNMP-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface («                   |            |
| Traffic-Global       | OS-Mac-Traffic-Global-SNMP-custom       | Contrôle de la bande passante des interfaces. Pour chaque contrôle apparaîtra le nom de l'interface («                   | X          |
| Uptime               | OS-Mac-Uptime-SNMP-custom               | Durée depuis laquelle le serveur tourne sans interruption                                                                |            |
...
| Nom de la règle          | Description                                                                                            |
|:-------------------------|:-------------------------------------------------------------------------------------------------------|
| OS-Mac-SNMP-Disk-Name    | Utilise le nom du disque pour découvrir les partitions du disque et supervise l'occupation de l'espace |
| OS-Mac-SNMP-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation      |
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Mac SNMP**
...
| list-diskspath [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/listdiskspath.pm)]   | Non utilisé dans ce connecteur de supervision                                                                             |
