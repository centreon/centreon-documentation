...
<Tabs groupId="sync">
<Tab value="HW-Storage-EMC-DataDomain-SNMP-custom" label="HW-Storage-EMC-DataDomain-SNMP-custom">
...
<Tab value="Hardware-Battery" label="Hardware-Battery">
...
<Tab value="Hardware-Disk" label="Hardware-Disk">
...
<Tab value="Replications" label="Replications">
