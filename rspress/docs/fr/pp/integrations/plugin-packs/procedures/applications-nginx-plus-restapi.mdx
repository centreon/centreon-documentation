...
<Tabs groupId="sync">
<Tab value="App-Nginx-Plus-Restapi-custom" label="App-Nginx-Plus-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Nginx-Http-Zones-Restapi" label="Nginx-Http-Zones-Restapi">
...
<Tab value="Nginx-Plus-Connections-Restapi" label="Nginx-Plus-Connections-Restapi">
...
<Tab value="Nginx-Plus-Ssl=Restapi" label="Nginx-Plus-Ssl=Restapi">
