...
<Tabs groupId="sync">
<Tab value="HW-Storage-NetApp-Ontap-SNMP-custom" label="HW-Storage-NetApp-Ontap-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Aggregates" label="Aggregates">

| Nom   | Unité |
|:------|:------|
| state | N/A   |
</Tab>
<Tab value="Cache-Age" label="Cache-Age">
...
<Tab value="Cluster-Nodes" label="Cluster-Nodes">
...
<Tab value="Cp-Statistics" label="Cp-Statistics">
...
<Tab value="Cpu-Load" label="Cpu-Load">
...
<Tab value="Fan" label="Fan">

Pas de métrique pour ce service.

</Tab>
<Tab value="File-System-Global" label="File-System-Global">
...
<Tab value="Global-status" label="Global-status">
...
<Tab value="Ndmpsessions" label="Ndmpsessions">
...
<Tab value="Nvram" label="Nvram">

Pas de métrique pour ce service.

</Tab>
<Tab value="Partner-Status" label="Partner-Status">

Pas de métrique pour ce service.

</Tab>
<Tab value="Plexes" label="Plexes">
...
<Tab value="Share-Calls" label="Share-Calls">
...
<Tab value="Snapmirrorlag" label="Snapmirrorlag">
...
<Tab value="Snapshot-Age-Global" label="Snapshot-Age-Global">
...
<Tab value="Snapshot-Age-Name" label="Snapshot-Age-Name">
...
<Tab value="Volume-Options-Generic" label="Volume-Options-Generic">
