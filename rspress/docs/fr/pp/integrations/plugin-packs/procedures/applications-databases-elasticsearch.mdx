...
<Tabs groupId="sync">
<Tab value="App-DB-Elasticsearch-custom" label="App-DB-Elasticsearch-custom">
...
<Tabs groupId="sync">
<Tab value="Cluster-Statistics" label="Cluster-Statistics">
...
<Tab value="Indice-Statistics" label="Indice-Statistics">
...
<Tab value="Node-Statistics" label="Node-Statistics">
