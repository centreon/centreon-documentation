...
<Tabs groupId="sync">
<Tab value="Net-Aruba-Standard-Ap-SNMP-custom" label="Net-Aruba-Standard-Ap-SNMP-custom">
...
<Tab value="Net-Aruba-Standard-Controller-SNMP-custom" label="Net-Aruba-Standard-Controller-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Ap-Ssid-Statistics" label="Ap-Ssid-Statistics">
...
<Tab value="Hardware-Fan" label="Hardware-Fan">
...
<Tab value="Hardware-Module" label="Hardware-Module">
...
<Tab value="Hardware-Psu" label="Hardware-Psu">
