...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Dell S-series SNMP** 
...
<Tabs groupId="sync">
<Tab value="Net-Dell-Sseries-SNMP-custom" label="Net-Dell-Sseries-SNMP-custom">

| Alias           | Modèle de service                            | Description                                         |
|:----------------|:---------------------------------------------|:----------------------------------------------------|
| Cpu             | Net-Dell-Sseries-Cpu-SNMP-custom             | Contrôle du taux d'utilisation du CPU de la machine |
| Hardware-Global | Net-Dell-Sseries-Hardware-Global-SNMP-custom | Contrôle le matériel                                |
| Memory          | Net-Dell-Sseries-Memory-SNMP-custom          | Contrôle du taux d'utilisation des mémoires         |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Dell-Sseries-SNMP-custom** est utilisé.
...
|:---------------------|:--------------------------------------------------|:----------------------------------------------------------|:----------:|
| Traffic-Generic-Id   | Net-Dell-Sseries-Traffic-Generic-Id-SNMP-custom   | Contrôle le trafic réseau d'une interface réseau         |            |
| Traffic-Generic-Name | Net-Dell-Sseries-Traffic-Generic-Name-SNMP-custom | Contrôle le trafic réseau d'une interface réseau         |            |
| Traffic-Global       | Net-Dell-Sseries-Traffic-Global-SNMP-custom       | Contrôle le trafic réseau de plusieurs interfaces réseau |     X      |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Dell-Sseries-SNMP-custom**. |
...
| Nom de la règle                    | Description                                                                                       |
|:-----------------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Dell-Sseries-SNMP-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
3. Appliquez le modèle d'hôte **Net-Dell-Sseries-SNMP-custom**.
