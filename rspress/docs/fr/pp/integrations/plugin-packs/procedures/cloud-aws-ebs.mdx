...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-Ebs-custom" label="Cloud-Aws-Ebs-custom">
...
<Tabs groupId="sync">
<Tab value="Ebs-Iops" label="Ebs-Iops">
...
<Tab value="Ebs-Time" label="Ebs-Time">
...
<Tab value="Ebs-Volume-IO" label="Ebs-Volume-IO">
