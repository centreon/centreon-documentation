...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Node-Exporter-Windows-custom" label="App-Monitoring-Node-Exporter-Windows-custom">
...
<Tabs groupId="sync">
<Tab value="Node-Cpu" label="Node-Cpu">
...
<Tab value="Node-Memory" label="Node-Memory">
...
<Tab value="Node-Service-Name" label="Node-Service-Name">
...
<Tab value="Node-Storage" label="Node-Storage">
...
<Tab value="Node-Traffic" label="Node-Traffic">
