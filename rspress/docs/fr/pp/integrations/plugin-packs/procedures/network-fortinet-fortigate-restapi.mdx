...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Fortinet Fortigate Rest API** 
...
<Tabs groupId="sync">
<Tab value="Net-Fortinet-Fortigate-Restapi-custom" label="Net-Fortinet-Fortigate-Restapi-custom">
