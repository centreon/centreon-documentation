...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Centreon-SQL-Metrics-custom" label="App-Monitoring-Centreon-SQL-Metrics-custom">
...
<Tabs groupId="sync">
<Tab value="DSMQueue-Count" label="DSMQueue-Count">
...
<Tab value="Execution-Time" label="Execution-Time">
...
<Tab value="Notifications-Count" label="Notifications-Count">
...
<Tab value="Poller-Delay" label="Poller-Delay">
...
<Tab value="Problems-Count" label="Problems-Count">
...
<Tab value="Resources-Count" label="Resources-Count">
...
<Tab value="Storage-Partitioning" label="Storage-Partitioning">

Pas de métriques pour ce service.

</Tab>
<Tab value="Virtual-Service" label="Virtual-Service">
