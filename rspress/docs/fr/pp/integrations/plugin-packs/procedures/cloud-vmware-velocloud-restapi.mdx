...
<Tabs groupId="sync">
<Tab value="Cloud-Vmware-Velocloud-Edge-Restapi-custom" label="Cloud-Vmware-Velocloud-Edge-Restapi-custom">
...
<Tab value="Category-Usage" label="Category-Usage">
...
<Tab value="Edge-Qoe" label="Edge-Qoe">
...
<Tab value="Edge-Status" label="Edge-Status">
...
<Tab value="Link-Status" label="Link-Status">
...
<Tab value="Link-Usage" label="Link-Usage">
