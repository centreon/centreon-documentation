...
<Tabs groupId="sync">
<Tab value="Net-Barracuda-Cloudgen-SNMP-custom" label="Net-Barracuda-Cloudgen-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Box-Service" label="Box-Service">
...
<Tab value="Server-Service" label="Server-Service">
