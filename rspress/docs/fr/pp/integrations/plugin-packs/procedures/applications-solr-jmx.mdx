...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Solr**
...
Le connecteur de supervision **Solr** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="App-Solr-JMX-custom" label="App-Solr-JMX-custom">

| Alias                 | Modèle de service                         | Description                                                         |
|:----------------------|:------------------------------------------|:--------------------------------------------------------------------|
| Cache-Usage           | App-Solr-Cache-Usage-JMX-custom           | Contrôle permettant de vérifier l'utilisation des caches            |
| Request-Handler-Usage | App-Solr-Request-Handler-Usage-JMX-custom | Contrôle permettant de vérifier l'utilisation des 'request handler' |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **App-Solr-JMX-custom** est utilisé.
...
<Tabs groupId="sync">
<Tab value="Cache-Usage" label="Cache-Usage">
...
<Tab value="Request-Handler-Usage" label="Request-Handler-Usage">
...
[Installez l'agent Jolokia sur votre JVM](https://jolokia.org/download.html).
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Solr**
...
3. Appliquez le modèle d'hôte **App-Solr-JMX-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
