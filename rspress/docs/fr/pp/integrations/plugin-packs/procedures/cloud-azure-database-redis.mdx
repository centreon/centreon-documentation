...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Database-Redis-custom" label="Cloud-Azure-Database-Redis-custom">
...
<Tabs groupId="sync">
<Tab value="Cache-Latency" label="Cache-Latency">
...
<Tab value="Cache-Throughput" label="Cache-Throughput">
