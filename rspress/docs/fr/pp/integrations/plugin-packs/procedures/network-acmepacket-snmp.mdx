...
<Tabs groupId="sync">
<Tab value="Net-Acmepacket-SNMP-custom" label="Net-Acmepacket-SNMP-custom">
...
<Tab value="Policy-Servers" label="Policy-Servers">
...
<Tab value="Realm-Usage" label="Realm-Usage">
...
<Tab value="Sip-Usage" label="Sip-Usage">
