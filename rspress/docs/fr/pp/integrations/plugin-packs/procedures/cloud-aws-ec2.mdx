...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-Ec2-Asg-custom" label="Cloud-Aws-Ec2-Asg-custom">
...
<Tab value="Cloud-Aws-Ec2-Instance-custom" label="Cloud-Aws-Ec2-Instance-custom">
...
<Tab value="Cloud-Aws-Ec2-Spot-Fleet-Request-custom" label="Cloud-Aws-Ec2-Spot-Fleet-Request-custom">
...
<Tabs groupId="sync">
<Tab value="EC2Spot-Active-Instances" label="EC2Spot-Active-Instances">
...
<Tab value="Ec2-Asg-Status-Global" label="Ec2-Asg-Status-Global">
...
<Tab value="Ec2-Cpu-Credit" label="Ec2-Cpu-Credit">
...
<Tab value="Ec2-Cpu-Usage" label="Ec2-Cpu-Usage">
...
<Tab value="Ec2-Diskio" label="Ec2-Diskio">
...
<Tab value="Ec2-Instances-Status-Global" label="Ec2-Instances-Status-Global">
...
<Tab value="Ec2-Instances-Types-Global" label="Ec2-Instances-Types-Global">

Aucune métrique pour ce modèle.

</Tab>
<Tab value="Ec2-Network" label="Ec2-Network">
...
<Tab value="Ec2-Status" label="Ec2-Status">
