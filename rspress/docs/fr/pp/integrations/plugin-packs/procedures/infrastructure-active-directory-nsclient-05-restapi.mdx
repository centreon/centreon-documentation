...
<Tabs groupId="sync">
<Tab value="Infra-ActiveDirectory-NSClient-05-Restapi-custom" label="Infra-ActiveDirectory-NSClient-05-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Ad-Domain-Controller" label="Ad-Domain-Controller">
...
<Tab value="Dfsr-Backlog" label="Dfsr-Backlog">
