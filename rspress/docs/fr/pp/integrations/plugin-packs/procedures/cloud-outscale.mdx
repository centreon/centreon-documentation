...
<Tabs groupId="sync">
<Tab value="Cloud-Outscale-Osscli-custom" label="Cloud-Outscale-Osscli-custom">
...
<Tabs groupId="sync">
<Tab value="Account-Consumptions" label="Account-Consumptions">
...
<Tab value="Client-Gateways" label="Client-Gateways">
...
<Tab value="Internet-Services" label="Internet-Services">
...
<Tab value="Load-Balancers" label="Load-Balancers">
...
<Tab value="Nat-Services" label="Nat-Services">
...
<Tab value="Route-Tables" label="Route-Tables">
...
<Tab value="Subnets" label="Subnets">
...
<Tab value="Virtual-Gateways" label="Virtual-Gateways">
...
<Tab value="Vpn-Connections" label="Vpn-Connections">
