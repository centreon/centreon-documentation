...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Juniper Mag SNMP** 
...
<Tabs groupId="sync">
<Tab value="Net-Juniper-MAG-custom" label="Net-Juniper-MAG-custom">

| Alias             | Modèle de service                             | Description                                                                                                               |
|:------------------|:----------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
| Blade-Temperature | Net-Juniper-MAG-Blade-Temperature-SNMP-custom | Contrôle la température du blade                                                                                          |
| CPU               | Net-Juniper-MAG-Cpu-SNMP-custom               | Contrôle du taux d'utilisation du CPU de la machine. Ce contrôle pourra remonter la moyenne du taux d'utilisation des CPU |
| Logfile           | Net-Juniper-MAG-Logfile-SNMP-custom           | Contrôle l'utilisation du journal                                                                                         |
| Memory            | Net-Juniper-MAG-Memory-SNMP-custom            | Contrôle l'utilisation mémoire du matériel                                                                                |
| Swap              | Net-Juniper-MAG-Swap-SNMP-custom              | Contrôle l'utilisation de la swap du matériel                                                                             |

> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Juniper-MAG-custom** est utilisé.
...
|:---------------------|:-------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------:|
| Disk                 | Net-Juniper-MAG-Disk-SNMP-custom                 | Controle l'utilisation de l'espace disque                                                                                                                   |            |
| Traffic-Generic-ID   | Net-Juniper-MAG-Traffic-Generic-ID-SNMP-custom   | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Generic-Name | Net-Juniper-MAG-Traffic-Generic-Name-SNMP-custom | Contrôle de la bande passante de l'interface. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface)             |            |
| Traffic-Global       | Net-Juniper-MAG-Traffic-Global-SNMP-custom       | Contrôle de la bande passante d'un ensemble d'interfaces. Pour chaque contrôle apparaîtra le nom de l'interface (« label » raccourci décrivant l'interface) | X          |
| Users                | Net-Juniper-MAG-Users-SNMP-custom                | Contrôle les utilisateurs connectés                                                                                                                         |            |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **Net-Juniper-MAG-custom**. |
...
| Nom de la règle              | Description                                                                                       |
|:-----------------------------|:--------------------------------------------------------------------------------------------------|
| Net-Juniper-MAG-Traffic-Name | Découvre les interfaces réseau en utilisant leur nom et supervise leur statut et leur utilisation |
...
<Tabs groupId="sync">
<Tab value="Blade-Temperature" label="Blade-Temperature">
...
<Tab value="Logfile" label="Logfile">
...
3. Appliquez le modèle d'hôte **Net-Juniper-MAG-custom**.
