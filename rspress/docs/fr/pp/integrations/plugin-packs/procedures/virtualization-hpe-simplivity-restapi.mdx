...
<Tabs groupId="sync">
<Tab value="Virt-Hpe-Simplivity-Restapi-custom" label="Virt-Hpe-Simplivity-Restapi-custom">
...
<Tab value="Omnistack-Clusters" label="Omnistack-Clusters">
...
<Tab value="Virtual-Machines" label="Virtual-Machines">
