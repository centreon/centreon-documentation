...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **PHP APC**
...
Le connecteur de supervision **PHP APC** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="App-Php-Apc-Web-custom" label="App-Php-Apc-Web-custom">
...
<Tabs groupId="sync">
<Tab value="Php-Apc-File-Cache" label="Php-Apc-File-Cache">
...
<Tab value="Php-Apc-Memory" label="Php-Apc-Memory">
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **PHP APC**
...
3. Appliquez le modèle d'hôte **App-Php-Apc-Web-custom**. Une liste de macros apparaît. Les macros vous permettent de définir comment le connecteur se connectera à la ressource, ainsi que de personnaliser le comportement du connecteur.
...
| PHPAPCWEBEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles). |                   |             |
