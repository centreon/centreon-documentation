...
<Tabs groupId="sync">
<Tab value="Net-Versa-SNMP-custom" label="Net-Versa-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Bgp-Peers" label="Bgp-Peers">
...
<Tab value="Qos-Policy" label="Qos-Policy">
