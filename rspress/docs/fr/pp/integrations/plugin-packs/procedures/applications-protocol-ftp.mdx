...
<Tabs groupId="sync">
<Tab value="App-Protocol-FTP-custom" label="App-Protocol-FTP-custom">
...
<Tab value="FTP-FilesCount" label="FTP-FilesCount">
...
<Tab value="FTP-Login" label="FTP-Login">
