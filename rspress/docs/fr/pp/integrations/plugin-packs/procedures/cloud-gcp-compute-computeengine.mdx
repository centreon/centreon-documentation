...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Google Compute Engine**
...
<Tabs groupId="sync">
<Tab value="Cloud-Gcp-Compute-ComputeEngine-custom" label="Cloud-Gcp-Compute-ComputeEngine-custom">

| Alias   | Modèle de service                                  | Description                                  |
|:--------|:---------------------------------------------------|:---------------------------------------------|
| Cpu     | Cloud-Gcp-Compute-ComputeEngine-Cpu-Api-custom     | Contrôle l'utilisation CPU             |
| Diskio  | Cloud-Gcp-Compute-ComputeEngine-Diskio-Api-custom  | Contrôle les entrées/sorties sur les disques |
...
| WARNINGREADOPS               | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| CRITICALREADOPS              | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| WARNINGREADVOLUME            | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| CRITICALREADVOLUME           | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| WARNINGTHROTTLEDREADVOLUME   | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| CRITICALTHROTTLEDREADVOLUME  | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| WARNINGTHROTTLEDWRITEVOLUME  | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| CRITICALTHROTTLEDWRITEVOLUME | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| WARNINGWRITEOPS              | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| CRITICALWRITEOPS             | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| WARNINGWRITEVOLUME           | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| CRITICALWRITEVOLUME          | Threshold                                                                                                                                                                                                                                                                              |                   |             |
| EXTRAOPTIONS                 | Any extra option you may want to add to the command (a --verbose flag for example). Toutes les options sont listées [ici](#options-disponibles).                                                                                                                                                                                     | --verbose         |             |
...
| WARNINGRECEIVEDPACKETS  | Threshold                                                                                                                                                                                                         |                   |             |
| CRITICALRECEIVEDPACKETS | Threshold                                                                                                                                                                                                         |                   |             |
| WARNINGRECEIVEDVOLUME   | Threshold                                                                                                                                                                                                         |                   |             |
| CRITICALRECEIVEDVOLUME  | Threshold                                                                                                                                                                                                         |                   |             |
| WARNINGSENTPACKETS      | Threshold                                                                                                                                                                                                         |                   |             |
| CRITICALSENTPACKETS     | Threshold                                                                                                                                                                                                         |                   |             |
...
```bash
OK: received: 91564 sent: 6419 received packets: 57005 sent packets: 63293 | 'computeengine.network.received.volume.bytes'=91564B;;;; 'computeengine.network.sent.volume.bytes'=6419B;;;; 'computeengine.network.received.packets.count'=57005packets;;;; 'computeengine.network.sent.packets.count'=63293packets;;;;
```
