...
<Tabs groupId="sync">
<Tab value="Net-Cisco-Meraki-Cloudcontroller-Restapi-custom" label="Net-Cisco-Meraki-Cloudcontroller-Restapi-custom">
...
<Tab value="Net-Cisco-Meraki-Device-Restapi-custom" label="Net-Cisco-Meraki-Device-Restapi-custom">
...
<Tab value="Net-Cisco-Meraki-Network-Restapi-custom" label="Net-Cisco-Meraki-Network-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Api-Requests" label="Api-Requests">
...
<Tab value="Vpn-Tunnels" label="Vpn-Tunnels">
