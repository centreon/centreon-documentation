...
<Tabs groupId="sync">
<Tab value="HW-Storage-Dell-Me4-Restapi-custom" label="HW-Storage-Dell-Me4-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Controller-Statistics" label="Controller-Statistics">
...
<Tab value="Volume-Statistics" label="Volume-Statistics">
