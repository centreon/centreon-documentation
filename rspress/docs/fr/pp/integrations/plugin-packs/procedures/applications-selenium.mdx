...
<Tabs groupId="sync">
<Tab value="App-Selenium-Katalon-custom" label="App-Selenium-Katalon-custom">
...
<Tab value="App-Selenium-WAA-custom" label="App-Selenium-WAA-custom">
...
<Tabs groupId="sync">
<Tab value="Scenario-Selenium-Katalon" label="Scenario-Selenium-Katalon">
...
<Tab value="Scenario-Selenium-WAA" label="Scenario-Selenium-WAA">
...
<Tabs groupId="sync">
<Tab value="Scenario-Selenium-Karalon" label="Scenario-Selenium-Katalon">
...
<Tabs groupId="sync">
<Tab value="Scenario-Selenium" label="Scenario-Selenium">
