...
<Tabs groupId="sync">
<Tab value="App-Weblogic-JMX-custom" label="App-Weblogic-JMX-custom">
...
<Tabs groupId="sync">
<Tab value="Weblogic-Class-Count" label="Weblogic-Class-Count">
...
<Tab value="Weblogic-Memory" label="Weblogic-Memory">
...
<Tab value="Weblogic-Memory-Detailed" label="Weblogic-Memory-Detailed">
...
<Tab value="Weblogic-Threads" label="Weblogic-Threads">
...
<Tab value="Weblogic-Work-Manager-Global" label="Weblogic-Work-Manager-Global">
