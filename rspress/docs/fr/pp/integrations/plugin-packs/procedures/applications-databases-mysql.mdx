...
<Tabs groupId="sync">
<Tab value="App-DB-MySQL-custom" label="App-DB-MySQL-custom">
...
<Tab value="Connections-Number" label="Connections-Number">
...
<Tab value="Innodb-Bufferpool" label="Innodb-Bufferpool">
...
<Tab value="MariaDB-Replication" label="MariaDB-Replication">
...
<Tab value="Myisam-Keycache" label="Myisam-Keycache">
...
<Tab value="Password-Expiration" label="Password-Expiration">
...
<Tab value="Qcache-Hitrate" label="Qcache-Hitrate">
...
<Tab value="Slowqueries" label="Slowqueries">
