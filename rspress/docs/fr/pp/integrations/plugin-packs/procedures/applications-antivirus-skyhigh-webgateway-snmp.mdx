...
<Tabs groupId="sync">
<Tab value="App-Antivirus-Skyhigh-Webgateway-SNMP-custom" label="App-Antivirus-Skyhigh-Webgateway-SNMP-custom">
...
<Tab value="Ftp-Statistics" label="Ftp-Statistics">
...
<Tab value="Http-Statistics" label="Http-Statistics">
...
<Tab value="Https-Statistics" label="Https-Statistics">
