...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Veeam NSClient API** 
...
Le connecteur de supervision **Veeam NSClient API** apporte un modèle d'hôte :
...
<Tabs groupId="sync">
<Tab value="App-Veeam-NSClient-05-Restapi-custom" label="App-Veeam-NSClient-05-Restapi-custom">
...
<Tab value="Tape-Jobs" label="Tape-Jobs">
...
<Tab value="Vsb-Jobs" label="Vsb-Jobs">
...
2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Veeam NSClient API**
...
```bash
OK: detected jobs: 27324 success: 34158 failed: 99808 warning: 73451 All SureBackup jobs are ok | 'sure_backup.jobs.detected.count'=27324;;;0; 'sure_backup.jobs.success.count'=34158;;;0; 'sure_backup.jobs.failed.count'=99808;;;0; 'sure_backup.jobs.warning.count'=73451;;;0; 
```
