...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Web-AppService-custom" label="Cloud-Azure-Web-AppService-custom">
...
<Tabs groupId="sync">
<Tab value="App-Usage" label="App-Usage">
...
<Tab value="Cpu-Time" label="Cpu-Time">
...
<Tab value="File-System" label="File-System">
...
<Tab value="Gc-Usage" label="Gc-Usage">
...
<Tab value="Http-Requests" label="Http-Requests">
