...
<Tabs groupId="sync">
<Tab value="App-Skype-2015-Mssql-custom" label="App-Skype-2015-Mssql-custom">
...
<Tabs groupId="sync">
<Tab value="App-Sharing-Qoe" label="App-Sharing-Qoe">
...
<Tab value="Audio-Qoe" label="Audio-Qoe">
...
<Tab value="Poor-Calls" label="Poor-Calls">
...
<Tab value="Session-Types" label="Session-Types">
...
<Tab value="Video-Qoe" label="Video-Qoe">
