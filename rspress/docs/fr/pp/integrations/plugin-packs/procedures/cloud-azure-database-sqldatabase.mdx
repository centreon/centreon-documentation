...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Database-SqlDatabase-custom" label="Cloud-Azure-Database-SqlDatabase-custom">
...
<Tabs groupId="sync">
<Tab value="App-Resources" label="App-Resources">
...
<Tab value="Deadlocks" label="Deadlocks">
