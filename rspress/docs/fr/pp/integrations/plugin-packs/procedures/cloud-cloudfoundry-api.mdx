...
<Tabs groupId="sync">
<Tab value="Cloud-Cloudfoundry-Api-custom" label="Cloud-Cloudfoundry-Api-custom">
...
<Tabs groupId="sync">
<Tab value="Apps-State" label="Apps-State">
...
<Tab value="Instances-State" label="Instances-State">
