...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Database-Elasticpool-custom" label="Cloud-Azure-Database-Elasticpool-custom">
...
<Tab value="Log-Usage" label="Log-Usage">
