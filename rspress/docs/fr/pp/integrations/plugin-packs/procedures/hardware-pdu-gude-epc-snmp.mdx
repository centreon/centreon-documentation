...
Les connecteurs de supervision suivants sont automatiquement installés lors de l'installation du connecteur **Gude EPC SNMP** 
...
<Tabs groupId="sync">
<Tab value="HW-Pdu-Gude-Epc-SNMP-custom" label="HW-Pdu-Gude-Epc-SNMP-custom">
...
|:----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Pdu-Gude-Epc-SNMP-custom**. |
...
| Nom de la règle                            | Description                                                  |
|:-------------------------------------------|:-------------------------------------------------------------|
| HW-Pdu-Gude-Epc-SNMP-Sp-Power-Channel-Name | Découvre les ports unitaires power channels et les supervise |
...
<Tabs groupId="sync">
<Tab value="Power-Channels" label="Power-Channels">
...
<Tab value="Sp-Power-Channels" label="Sp-Power-Channels">
...
L'agent SNMP doit être activé et configuré sur l'équipement. Référez vous à la documentation officielle. 
