...
Le connecteur de supervision **Dell CMC** apporte un modèle d'hôte :

* **HW-Server-Dell-CMC-SNMP-custom**

Le connecteur apporte les modèles de service suivants
(classés selon le modèle d'hôte auquel ils sont rattachés) :

<Tabs groupId="sync">
<Tab value="HW-Server-Dell-CMC-SNMP-custom" label="HW-Server-Dell-CMC-SNMP-custom">
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Découvre les ressources via un scan réseau SNMP. Installez le connecteur [Generic SNMP](./applications-protocol-snmp.md) pour obtenir la règle de découverte et créez un modificateur pour le modèle d'hôte **HW-Server-Dell-CMC-SNMP-custom**. |
...
```bash
dnf install centreon-pack-hardware-servers-dell-cmc-snmp
```
...
```bash
apt install centreon-pack-hardware-servers-dell-cmc-snmp
```
...
```bash
yum install centreon-pack-hardware-servers-dell-cmc-snmp
```

</Tab>
</Tabs>

2. Quel que soit le type de la licence (*online* ou *offline*), installez le connecteur **Dell CMC**
...
```bash
dnf install centreon-plugin-Hardware-Servers-Dell-Cmc-Snmp
```
...
```bash
apt install centreon-plugin-hardware-servers-dell-cmc-snmp
```
...
3. Appliquez le modèle d'hôte **HW-Server-Dell-CMC-SNMP-custom**.
...
| Macro        | Description                                                                                                  | Valeur par défaut | Obligatoire |
|:-------------|:-------------------------------------------------------------------------------------------------------------|:------------------|:-----------:|
| COMPONENT    | Which component to check (default: '.*'). Can be: 'chassis', 'disk', 'health', 'psu', 'temperature', 'vdisk' | .*                |             |
...
```bash
/usr/lib/centreon/plugins/centreon_dell_cmc.pl \
...
```bash
OK: System uptime is: 1400m 46s | 'system.uptime.seconds'=84046s;;;;
```
...
|:--------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------|
| hardware [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/server/dell/cmc/snmp/mode/hardware.pm)] | HW-Dell-CMC-Hardware-Global-SNMP-custom |
| uptime [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/snmp_standard/mode/uptime.pm)]                     | HW-Dell-CMC-Uptime-SNMP-custom          |
