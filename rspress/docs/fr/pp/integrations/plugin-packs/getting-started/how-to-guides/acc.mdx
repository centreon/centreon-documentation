...
## Créer une configuration additionnelle pour un connecteur

1. À la page **Configuration > Connecteurs > Configurations additionnelles**, cliquez sur **Ajouter**.
2. Dans la fenêtre qui apparaît, remplissez les champs suivants :
   * **Nom** et **Description** (la description apparaîtra dans la liste des configurations).
