...
<Tabs groupId="sync">
<Tab value="New connectors" label="New connectors">
...
<Tab value="Enhancements" label="Enhancements">
...
<Tab value="Breaking changes" label="Breaking changes">
...
<Tab value="Bug fixes" label="Bug fixes">
