...
The following monitoring connectors will be installed when you install the **Cisco Voice Gateway SNMP** connector through the
...
The Monitoring Connector **Cisco Voice Gateway SNMP** brings a host template:
...
<Tabs groupId="sync">
<Tab value="Net-Cisco-Voice-Gateway-SNMP-custom" label="Net-Cisco-Voice-Gateway-SNMP-custom">
...
| Rule name                                 | Description                                                   |
|:------------------------------------------|:--------------------------------------------------------------|
| Net-Cisco-Voice-Gateway-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
<Tabs groupId="sync">
<Tab value="Isdn-Usage-Global" label="Isdn-Usage-Global">
...
2. Whatever the license type (*online* or *offline*), install the **Cisco Voice Gateway SNMP** connector through
...
3. Apply the **Net-Cisco-Voice-Gateway-SNMP-custom** template to the host.
...
| WARNINGCURRENTCALLS  | Threshold                                                                                                                                        |               |           |
| CRITICALCURRENTCALLS | Threshold                                                                                                                                        |               |           |
| WARNINGINCALLS       | Threshold                                                                                                                                        |               |           |
| CRITICALINCALLS      | Threshold                                                                                                                                        |               |           |
| WARNINGOUTCALLS      | Threshold                                                                                                                                        |               |           |
| CRITICALOUTCALLS     | Threshold                                                                                                                                        |               |           |
