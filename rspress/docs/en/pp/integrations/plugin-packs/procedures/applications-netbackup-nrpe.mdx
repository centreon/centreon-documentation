...
<Tabs groupId="sync">
<Tab value="App-Netbackup-NRPE-custom" label="App-Netbackup-NRPE-custom">
...
<Tabs groupId="sync">
<Tab value="Dedup-Status" label="Dedup-Status">
...
<Tab value="Drive-Cleaning" label="Drive-Cleaning">
...
<Tab value="Drive-Status" label="Drive-Status">
...
<Tab value="Job-Status" label="Job-Status">
...
<Tab value="Tape-Usage" label="Tape-Usage">
