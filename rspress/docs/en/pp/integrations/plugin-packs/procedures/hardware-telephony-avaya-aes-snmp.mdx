...
The following monitoring connectors will be installed when you install the **Avaya AES SNMP** connector through the
...
The Monitoring Connector **Avaya AES SNMP** brings a host template:
...
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Telephony-Avaya-Aes-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Avaya AES SNMP** connector through
...
3. Apply the **HW-Telephony-Avaya-Aes-SNMP-custom** template to the host. 
