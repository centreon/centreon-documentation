...
The following monitoring connectors will be installed when you install the **Microsoft SCCM CMA** connector through the
...
The Monitoring Connector **Microsoft SCCM CMA** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Sccm-CMA-custom" label="App-Sccm-CMA-custom">

| Service Alias               | Service Template                                | Service Description                |
|:----------------------------|:------------------------------------------------|:-----------------------------------|
| Database-Replication-Status | App-Sccm-Database-Replication-Status-CMA-custom | Check databases replication status |
| Site-Status                 | App-Sccm-Site-Status-CMA-custom                 | Check sites status                 |

> The services listed above are created automatically when the **App-Sccm-CMA-custom** host template is used.
...
<Tabs groupId="sync">
<Tab value="Database-Replication-Status" label="Database-Replication-Status">
...
<Tab value="Site-Status" label="Site-Status">
...
2. Whatever the license type (*online* or *offline*), install the **Microsoft SCCM CMA** connector through
...
3. Apply the **App-Sccm-CMA-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
