...
The following monitoring connectors will be installed when you install the **ZIXI** connector through the
...
The Monitoring Connector **ZIXI** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Video-Zixi-Broadcaster-Restapi-custom" label="App-Video-Zixi-Broadcaster-Restapi-custom">

| Service Alias | Service Template                                        | Service Description |
|:--------------|:--------------------------------------------------------|:--------------------|
| Input-Usage   | App-Video-Zixi-Broadcaster-Input-Usage-RESTAPI-custom   | Check input usage   |
| License-Usage | App-Video-Zixi-Broadcaster-License-Usage-RESTAPI-custom | Check license usage |
| Output-Usage  | App-Video-Zixi-Broadcaster-Output-Usage-RESTAPI-custom  | Check output usage  |
| System-Usage  | App-Video-Zixi-Broadcaster-System-Usage-RESTAPI-custom  | Check system usage  |

> The services listed above are created automatically when the **App-Video-Zixi-Broadcaster-Restapi-custom** host template is used.
...
<Tabs groupId="sync">
<Tab value="Input-Usage" label="Input-Usage">
...
<Tab value="License-Usage" label="License-Usage">
...
<Tab value="Output-Usage" label="Output-Usage">
...
2. Whatever the license type (*online* or *offline*), install the **ZIXI** connector through
...
3. Apply the **App-Video-Zixi-Broadcaster-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| ZIXIEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
