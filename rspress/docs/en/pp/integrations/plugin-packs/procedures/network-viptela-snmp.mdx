...
<Tabs groupId="sync">
<Tab value="Net-Viptela-SNMP-custom" label="Net-Viptela-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Control-Connections" label="Control-Connections">
...
<Tab value="Gre-Tunnels" label="Gre-Tunnels">
