...
The following monitoring connectors will be installed when you install the **RabbitMQ RestAPI** connector through the
...
The Monitoring Connector **RabbitMQ RestAPI** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Rabbitmq-Restapi-custom" label="App-Rabbitmq-Restapi-custom">

| Service Alias | Service Template                         | Service Description |
|:--------------|:-----------------------------------------|:--------------------|
| Node-Usage    | App-Rabbitmq-Node-Usage-Restapi-custom   | Check node usage    |
| Queue-Usage   | App-Rabbitmq-Queue-Usage-Restapi-custom  | Check queue usage   |
| System-Usage  | App-Rabbitmq-System-Usage-Restapi-custom | Check system usage  |
| Vhost-Usage   | App-Rabbitmq-Vhost-Usage-Restapi-custom  | Check vhost usage   |

> The services listed above are created automatically when the **App-Rabbitmq-Restapi-custom** host template is used.
...
<Tab value="Queue-Usage" label="Queue-Usage">
...
<Tab value="Vhost-Usage" label="Vhost-Usage">
...
For monitoring, a user with read permissions on the RabbitMQ Management REST API is required.
...
2. Whatever the license type (*online* or *offline*), install the **RabbitMQ RestAPI** connector through
...
3. Apply the **App-Rabbitmq-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
