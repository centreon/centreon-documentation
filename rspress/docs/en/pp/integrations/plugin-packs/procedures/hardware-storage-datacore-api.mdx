...
<Tabs groupId="sync">
<Tab value="HW-Storage-Datacore-Sansymphony-RESTAPI-custom" label="HW-Storage-Datacore-Sansymphony-RESTAPI-custom">
...
<Tab value="Monitors-Status" label="Monitors-Status">
