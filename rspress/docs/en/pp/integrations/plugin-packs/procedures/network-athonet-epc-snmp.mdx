...
<Tabs groupId="sync">
<Tab value="Net-Athonet-Epc-SNMP-custom" label="Net-Athonet-Epc-SNMP-custom">
...
<Tab value="Interfaces-Diameter" label="Interfaces-Diameter">
...
<Tab value="Interfaces-Ga" label="Interfaces-Ga">
...
<Tab value="Interfaces-Gtpc" label="Interfaces-Gtpc">
...
<Tab value="Interfaces-Lte" label="Interfaces-Lte">
