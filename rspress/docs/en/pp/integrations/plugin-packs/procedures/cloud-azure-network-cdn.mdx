...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Network-CDN-custom" label="Cloud-Azure-Network-CDN-custom">
...
<Tabs groupId="sync">
<Tab value="Hit-Ratio" label="Hit-Ratio">
...
<Tab value="Response-Size" label="Response-Size">
