...
2. On the Centreon Web interface, install the **Hikvision NVR SNMP** Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page.
...
3. On the Centreon Web interface, install the **Hikvision NVR SNMP** Centreon Pack on the **Configuration > Connectors > Monitoring Connectors** page.
