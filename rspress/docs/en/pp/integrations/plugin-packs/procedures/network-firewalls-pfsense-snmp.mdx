...
The following monitoring connectors will be installed when you install the **pfSense SNMP** connector through the
...
The Monitoring Connector **pfSense SNMP** brings a host template:
...
<Tabs groupId="sync">
<Tab value="Net-FW-Pfsense-SNMP-custom" label="Net-FW-Pfsense-SNMP-custom">
...
| Cpu                           | Net-FW-Pfsense-Cpu-SNMP-custom                           | Check the rate of CPU utilization for the machine. This check can give the average CPU utilization rate and the rate per CPU for multi-core CPU |           |
| Fragment-Packets              | Net-FW-Pfsense-Fragment-Packets-SNMP-custom              | Check number of fragmented packets                                                                                                              |           |
| Load                          | Net-FW-Pfsense-Load-SNMP-custom                          | Check the server load average                                                                                                                   |           |
| Match-Packets                 | Net-FW-Pfsense-Match-Packets-SNMP-custom                 | Check number of packets that match a filter rule                                                                                                |           |
| Memory                        | Net-FW-Pfsense-Memory-SNMP-custom                        | Check memory usage (RAM)                                                                                                                        |           |
...
| Swap                          | Net-FW-Pfsense-Swap-SNMP-custom                          | Check virtual memory usage                                                                                                                      |           |
| Uptime                        | Net-FW-Pfsense-Uptime-SNMP-custom                        | Check the time since the server has been working and available                                                                                  |           |

> The services listed above are created automatically when the **Net-FW-Pfsense-SNMP-custom** host template is used.
...
|:--------------|:----------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cpu-Detailed  | Net-FW-Pfsense-Cpu-Detailed-SNMP-custom | Check the detailed rate of utilization of CPU for the machine. This check can give the average CPU utilization rate and the rate per CPU for multi-core CPU |
...
<Tabs groupId="sync">
<Tab value="Bad-Offset-Packets" label="Bad-Offset-Packets">
...
<Tab value="Blocked-Packets-Per-Interface" label="Blocked-Packets-Per-Interface">
...
<Tab value="Fragment-Packets" label="Fragment-Packets">
...
<Tab value="Match-Packets" label="Match-Packets">
...
<Tab value="Memory-Dropped-Packets" label="Memory-Dropped-Packets">
...
<Tab value="Normalize-Packets" label="Normalize-Packets">
...
<Tab value="Short-Packets" label="Short-Packets">
...
2. Whatever the license type (*online* or *offline*), install the **pfSense SNMP** connector through
...
3. Apply the **Net-FW-Pfsense-SNMP-custom** template to the host. 
