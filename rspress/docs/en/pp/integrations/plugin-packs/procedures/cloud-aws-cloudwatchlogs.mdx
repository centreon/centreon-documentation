...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-CloudWatchLogs-custom" label="Cloud-Aws-CloudWatchLogs-custom">
...
<Tabs groupId="sync">
<Tab value="Cloudwatchlogs-Get-Logs" label="Cloudwatchlogs-Get-Logs">
