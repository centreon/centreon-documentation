...
<Tabs groupId="sync">
<Tab value="App-Veeam-Vone-Restapi-custom" label="App-Veeam-Vone-Restapi-custom">

| Service Alias | Service Template                           | Service Description | Discovery |
|:--------------|:-------------------------------------------|:--------------------|:---------:|
| Repositories  | App-Veeam-Vone-Repositories-Restapi-custom | Check repositories  | X         |
...
| Service Alias | Service Template                      | Service Description | Discovery |
|:--------------|:--------------------------------------|:--------------------|:---------:|
| Jobs          | App-Veeam-Vone-Jobs-Restapi-custom    | Check jobs          | X         |
| License       | App-Veeam-Vone-License-Restapi-custom | Monitor licenses    |           |
| Proxies       | App-Veeam-Vone-Proxies-Restapi-custom | Check proxies       | X         |
...
<Tab value="Proxies" label="Proxies">
...
To monitor the infrastructure and backup jobs with Veeam ONE, the REST API must be configured as described in the [official documentation](https://helpcenter.veeam.com/docs/one/userguide/access.html?zoom_highlight=api&ver=13#veeam-one-rest-api).
...
2. Whatever the license type (*online* or *offline*), install the **Veeam ONE Rest API** connector through
...
| VONE_EXTRA_OPTIONS  | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options).           |               |           |
...
|:-----------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------|
| cache [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/apps/backup/veeam/vone/restapi/mode/cache.pm)]               | Not used in this Monitoring Connector      |
