...
The following monitoring connectors will be installed when you install the **Active Directory WSMAN** connector through the
...
The Monitoring Connector **Active Directory WSMAN** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-ActiveDirectory-WSMAN-custom" label="App-ActiveDirectory-WSMAN-custom">
...
2. Whatever the license type (*online* or *offline*), install the **Active Directory WSMAN** connector through
...
3. Apply the **App-ActiveDirectory-WSMAN-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
