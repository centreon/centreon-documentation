...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Integration-ServiceBus-custom" label="Cloud-Azure-Integration-ServiceBus-custom">
...
<Tabs groupId="sync">
<Tab value="Azure AZ CLI" label="Azure AZ CLI">
...
<Tab value="Azure Monitor API" label="Azure Monitor API">
