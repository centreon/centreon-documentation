...
The following monitoring connectors will be installed when you install the **IBM MQ Rest API** connector through the
...
The Monitoring Connector **IBM MQ Rest API** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Ibmmq-Restapi-custom" label="App-Ibmmq-Restapi-custom">

| Service Alias  | Service Template                        | Service Description  | Discovery  |
|:---------------|:----------------------------------------|:---------------------|:----------:|
| Queue-Managers | App-Ibmmq-Queue-Managers-Restapi-custom | Check queue managers | X          |
| Queues         | App-Ibmmq-Queues-Restapi-custom         | Check queues         | X          |

> The services listed above are created automatically when the **App-Ibmmq-Restapi-custom** host template is used.
...
<Tabs groupId="sync">
<Tab value="Queue-Managers" label="Queue-Managers">
...
2. Whatever the license type (*online* or *offline*), install the **IBM MQ Rest API** connector through
...
3. Apply the **App-Ibmmq-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| IBMMQAPIEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                      |             |
