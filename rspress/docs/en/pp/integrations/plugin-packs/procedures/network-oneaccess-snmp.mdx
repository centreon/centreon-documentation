...
<Tabs groupId="sync">
<Tab value="Net-Oneaccess-SNMP-custom" label="Net-Oneaccess-SNMP-custom">

| Service Alias | Service Template                 | Service Description                                  |
|:--------------|:---------------------------------|:-----------------------------------------------------|
| Cpu           | Net-Oneaccess-Cpu-SNMP-custom    | Check the rate of utilization of CPU for the machine |
| Memory        | Net-Oneaccess-Memory-SNMP-custom | Check the rate of the utilization of memory          |
...
|:--------------|:--------------------------------------|:-----------------------------|:----------:|
| Cells-Radio   | Net-Oneaccess-Cells-Radio-SNMP-custom | Check cellular radio modules |            |
| Interfaces    | Net-Oneaccess-Interfaces-SNMP-custom  | Check interfaces             | X          |
| Rtt-Probes    | Net-Oneaccess-Rtt-Probes-SNMP-custom  | Check round-trip time probes | X          |
...
<Tabs groupId="sync">
<Tab value="Cells-Radio" label="Cells-Radio">
...
<Tab value="Rtt-Probes" label="Rtt-Probes">
