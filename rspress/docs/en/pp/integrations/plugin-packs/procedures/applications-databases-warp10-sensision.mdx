...
<Tabs groupId="sync">
<Tab value="App-DB-Warp10-Sensision-Web-custom" label="App-DB-Warp10-Sensision-Web-custom">
...
<Tabs groupId="sync">
<Tab value="Fetch-Statistics" label="Fetch-Statistics">
...
<Tab value="Script-Statistics" label="Script-Statistics">
