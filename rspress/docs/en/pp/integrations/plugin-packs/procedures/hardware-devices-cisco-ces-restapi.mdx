...
<Tabs groupId="sync">
<Tab value="HW-Device-Cisco-Ces-Restapi-custom" label="HW-Device-Cisco-Ces-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Calls-Rt" label="Calls-Rt">
...
<Tab value="Calls-Summary" label="Calls-Summary">
...
<Tab value="Components-Audio-Device" label="Components-Audio-Device">
...
<Tab value="Components-Audio-Input-Connector" label="Components-Audio-Input-Connector">
...
<Tab value="Components-Audio-Output-Connector" label="Components-Audio-Output-Connector">
...
<Tab value="Components-Camera" label="Components-Camera">
...
<Tab value="Components-Global" label="Components-Global">
...
<Tab value="Components-Software" label="Components-Software">
...
<Tab value="Components-Speakertrack" label="Components-Speakertrack">
...
<Tab value="Components-Temperature" label="Components-Temperature">
...
<Tab value="Components-Video-Input-Connector" label="Components-Video-Input-Connector">
...
<Tab value="Components-Video-Input-Source" label="Components-Video-Input-Source">
...
<Tab value="Components-Video-Output-Connector" label="Components-Video-Output-Connector">
...
<Tab value="Components-Webex" label="Components-Webex">
...
<Tab value="Peripherals" label="Peripherals">
