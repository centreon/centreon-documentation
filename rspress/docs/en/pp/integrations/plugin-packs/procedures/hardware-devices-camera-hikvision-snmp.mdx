...
The Monitoring Connector **Hikvision camera SNMP** brings a host template:
...
> The services listed above are created automatically when the **HW-Device-Camera-Hikvision-SNMP-custom** host template is used.
...
| Service Alias | Service Template                            | Service Description |
|:--------------|:--------------------------------------------|:--------------------|
| Time          | HW-Device-Camera-Hikvision-Time-SNMP-custom | Check time offset   |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Device-Camera-Hikvision-SNMP-custom** host template. |
...
3. Apply the **HW-Device-Camera-Hikvision-SNMP-custom** template to the host. 
