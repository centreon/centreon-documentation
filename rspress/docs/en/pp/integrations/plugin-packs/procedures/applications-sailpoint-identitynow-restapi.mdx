...
<Tabs groupId="sync">
<Tab value="App-Sailpoint-Identitynow-Restapi-custom" label="App-Sailpoint-Identitynow-Restapi-custom">
...
<Tabs groupId="sync">
<Tab value="Search-Count" label="Search-Count">
...
<Tab value="Source-Health" label="Source-Health">
