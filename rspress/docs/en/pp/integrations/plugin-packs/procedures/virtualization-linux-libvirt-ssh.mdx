...
<Tabs groupId="sync">
<Tab value="Virt-Linux-Libvirt-Hypervisor-SSH-custom" label="Virt-Linux-Libvirt-Hypervisor-SSH-custom">
...
<Tab value="Virt-Linux-Libvirt-VM-SSH-custom" label="Virt-Linux-Libvirt-VM-SSH-custom">
...
<Tab value="Pool-Status" label="Pool-Status">
