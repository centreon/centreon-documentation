...
<Tabs groupId="sync">
<Tab value="Cloud-cAdvisor-Api-custom" label="Cloud-cAdvisor-Api-custom">
...
<Tabs groupId="sync">
<Tab value="Container-Disk-IO" label="Container-Disk-IO">
...
<Tab value="Container-Traffic" label="Container-Traffic">
