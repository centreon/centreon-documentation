...
The following monitoring connectors will be installed when you install the **NtopNG RestAPI** connector through the
...
The Monitoring Connector **NtopNG RestAPI** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Ntopng-Restapi-custom" label="App-Monitoring-Ntopng-Restapi-custom">

| Service Alias  | Service Template                                    | Service Description  |
|:---------------|:----------------------------------------------------|:---------------------|
| Alerts         | App-Monitoring-Ntopng-Restapi-Alerts-custom         | Check alerts         |
| Netflow-Health | App-Monitoring-Ntopng-Restapi-Netflow-Health-custom | Check netflow health |
| Probe-Health   | App-Monitoring-Ntopng-Restapi-Probe-Health-custom   | Check probe health   |

> The services listed above are created automatically when the **App-Monitoring-Ntopng-Restapi-custom** host template is used.
...
| Service Alias | Service Template                                | Service Description |
|:--------------|:------------------------------------------------|:--------------------|
| Host-Flows    | App-Monitoring-Ntopng-Restapi-Host-Flows-custom | Check host flows    |
...
<Tab value="Host-Flows" label="Host-Flows">
...
<Tab value="Netflow-Health" label="Netflow-Health">
...
<Tab value="Probe-Health" label="Probe-Health">
...
2. Whatever the license type (*online* or *offline*), install the **NtopNG RestAPI** connector through
...
3. Apply the **App-Monitoring-Ntopng-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| NTOPNGAPIEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
