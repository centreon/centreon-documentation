...
<Tabs groupId="sync">
<Tab value="Cloud-Prometheus-cAdvisor-Api-custom" label="Cloud-Prometheus-cAdvisor-Api-custom">
...
<Tabs groupId="sync">
<Tab value="Container-Cpu" label="Container-Cpu">
...
<Tab value="Container-Load" label="Container-Load">
...
<Tab value="Container-Memory" label="Container-Memory">
...
<Tab value="Container-Storage" label="Container-Storage">
...
<Tab value="Container-Task-State" label="Container-Task-State">
