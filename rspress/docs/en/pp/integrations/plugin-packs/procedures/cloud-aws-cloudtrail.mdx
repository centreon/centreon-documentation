...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-CloudTrail" label="Cloud-Aws-CloudTrail">
...
<Tabs groupId="sync">
<Tab value="Cloudtrail-Check-Trail-Status" label="Cloudtrail-Check-Trail-Status">
...
<Tab value="Cloudtrail-Count-Events" label="Cloudtrail-Count-Events">
