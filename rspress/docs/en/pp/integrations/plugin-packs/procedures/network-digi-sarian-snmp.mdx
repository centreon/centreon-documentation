...
<Tabs groupId="sync">
<Tab value="Net-Digi-Sarian-SNMP-custom" label="Net-Digi-Sarian-SNMP-custom">
...
|:---------------|:-------------------------------------------|:---------------------------------------------|:----------:|
| Traffic-Global | Net-Digi-Sarian-Traffic-Global-SNMP-custom | Check traffic of multiple network interfaces | X          |
...
| Rule name                         | Description                                                   |
|:----------------------------------|:--------------------------------------------------------------|
| Net-Digi-Sarian-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
3. Apply the **Net-Digi-Sarian-SNMP-custom** template to the host. 
