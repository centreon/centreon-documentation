...
The following monitoring connectors will be installed when you install the **Mulesoft Anypoint** connector through the
...
The Monitoring Connector **Mulesoft Anypoint** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Mulesoft-Restapi-custom" label="App-Mulesoft-Restapi-custom">

| Service Alias       | Service Template                                | Service Description                | Discovery  |
|:--------------------|:------------------------------------------------|:-----------------------------------|:----------:|
| Applications-Global | App-Mulesoft-Restapi-Applications-Global-custom | Check Anypoint applications status | X          |
| Servers-Global      | App-Mulesoft-Restapi-Servers-Global-custom      | Check Anypoint servers status      | X          |

> The services listed above are created automatically when the **App-Mulesoft-Restapi-custom** host template is used.
...
| Service Alias         | Service Template                                  | Service Description            | Discovery  |
|:----------------------|:--------------------------------------------------|:-------------------------------|:----------:|
| Clusters-Global       | App-Mulesoft-Restapi-Clusters-Global-custom       | Check Anypoint clusters status |            |
| Queue-Messages-Global | App-Mulesoft-Restapi-Queue-Messages-Global-custom | Check Anypoint MQ messages     | X          |
...
<Tabs groupId="sync">
<Tab value="Applications-Global" label="Applications-Global">
...
<Tab value="Clusters-Global" label="Clusters-Global">
...
<Tab value="Queue-Messages-Global" label="Queue-Messages-Global">
...
<Tab value="Servers-Global" label="Servers-Global">
...
2. Whatever the license type (*online* or *offline*), install the **Mulesoft Anypoint** connector through
...
3. Apply the **App-Mulesoft-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
