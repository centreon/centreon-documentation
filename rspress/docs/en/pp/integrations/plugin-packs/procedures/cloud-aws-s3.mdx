...
<Tabs groupId="sync">
<Tab value="Cloud-Aws-S3-custom" label="Cloud-Aws-S3-custom">
...
<Tabs groupId="sync">
<Tab value="S3-Bucket-Size" label="S3-Bucket-Size">
...
<Tab value="S3-Objects" label="S3-Objects">
...
<Tab value="S3-Requests" label="S3-Requests">
