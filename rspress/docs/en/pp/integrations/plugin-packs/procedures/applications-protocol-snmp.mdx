...
<Tabs groupId="sync">
<Tab value="App-Protocol-SNMP-custom" label="App-Protocol-SNMP-custom">

This host template does not bring any service template.

</Tab>
<Tab value="App-Protocol-SNMP-Only-custom" label="App-Protocol-SNMP-Only-custom">
...
<Tab value="No host template" label="No host template">
