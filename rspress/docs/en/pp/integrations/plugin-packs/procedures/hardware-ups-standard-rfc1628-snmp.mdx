...
The following monitoring connectors will be installed when you install the **UPS Standard** connector through the
...
<Tabs groupId="sync">
<Tab value="HW-UPS-Standard-Rfc1628-SNMP-custom" label="HW-UPS-Standard-Rfc1628-SNMP-custom">

| Service Alias  | Service Template                                   | Service Description                               |
|:---------------|:---------------------------------------------------|:--------------------------------------------------|
| Alarms         | HW-UPS-Standard-Rfc1628-Alarms-SNMP-custom         | Check if alarms are present                       |
| Battery-Status | HW-UPS-Standard-Rfc1628-Battery-Status-SNMP-custom | Check battery status and remaining battery charge |
...
|:------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-UPS-Standard-Rfc1628-SNMP-custom** host template. |
