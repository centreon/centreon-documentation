...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Centreon-HA-Cluster-Node-custom" label="App-Monitoring-Centreon-HA-Cluster-Node-custom">
...
<Tabs groupId="sync">
<Tab value="PCS-Constraint-cbd_rrd" label="PCS-Constraint-cbd_rrd">
...
<Tab value="PCS-Constraint-centreon" label="PCS-Constraint-centreon">
...
<Tab value="PCS-Constraint-ms_mysql-master" label="PCS-Constraint-ms_mysql-master">
...
<Tab value="PCS-Constraint-php7" label="PCS-Constraint-php7">
...
<Tab value="PCS-Status" label="PCS-Status">
...
<Tab value="proc-corosync" label="proc-corosync">
...
<Tab value="proc-corosync-qnetd" label="proc-corosync-qnetd">
...
<Tab value="proc-pacemakerd" label="proc-pacemakerd">
...
<Tab value="proc-pcsd" label="proc-pcsd">
