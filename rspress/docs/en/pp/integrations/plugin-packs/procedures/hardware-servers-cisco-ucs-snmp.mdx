...
<Tabs groupId="sync">
<Tab value="HW-Server-Cisco-Ucs-SNMP-custom" label="HW-Server-Cisco-Ucs-SNMP-custom">
...
<Tab value="Mgmt-Entities" label="Mgmt-Entities">
...
<Tab value="Service-Profile" label="Service-Profile">
