...
<Tabs groupId="sync">
<Tab value="HW-Sensor-Sensormetrix-Em01-Web-custom" label="HW-Sensor-Sensormetrix-Em01-Web-custom">
...
<Tab value="Illumination" label="Illumination">
...
<Tab value="Thermistor-Temperature" label="Thermistor-Temperature">
...
<Tab value="Voltage" label="Voltage">
