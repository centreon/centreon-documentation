...
<Tabs groupId="sync">
<Tab value="Cloud-Microsoft-Office365-Management-Api-custom" label="Cloud-Microsoft-Office365-Management-Api-custom">
...
<Tabs groupId="sync">
<Tab value="App-Credentials" label="App-Credentials">
...
<Tab value="Service-Status" label="Service-Status">
