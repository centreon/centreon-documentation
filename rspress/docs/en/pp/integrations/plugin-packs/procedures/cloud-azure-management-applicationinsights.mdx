...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Management-ApplicationInsights-custom" label="Cloud-Azure-Management-ApplicationInsights-custom">
...
<Tab value="Browser-Timings" label="Browser-Timings">
...
<Tab value="External-Calls" label="External-Calls">
...
<Tab value="IO-Operations" label="IO-Operations">
...
<Tab value="Page-Views" label="Page-Views">
