...
<Tabs groupId="sync">
<Tab value="App-Monitoring-Centreon-MBI-custom" label="App-Monitoring-MBI-custom">
...
<Tabs groupId="sync">
<Tab value="DWH-db-content" label="DWH-db-content">

No metrics for this service.

</Tab>
<Tab value="DWH-partitions" label="DWH-partitions">

No metrics for this service.

</Tab>
<Tab value="failed-jobs" label="failed-jobs">
...
<Tab value="proc-cbis" label="proc-cbis">
...
<Tab value="proc-mysql" label="proc-mysql">
