...
<Tabs groupId="sync">
<Tab value="App-Github-Repository-Restapi-custom" label="App-Github-Repository-Restapi-custom">
...
<Tab value="App-Github-Restapi-custom" label="App-Github-Restapi-custom">
...
<Tab value="Github-Status" label="Github-Status">
...
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|:---------------|:---------:|
| GITHUBAPIHOSTNAME | IP Addr/FQDN of the GitHub's status website                                                                                              | api.github.com |           |
| GITHUBAPIPROTO    | Specify https if needed                                                                                                                  | https          |           |
| GITHUBAPIPORT     | Port used by GitHub's status website                                                                                                     | 443            |           |
| GITHUBOWNER       | Specify GitHub's owner                                                                                                                   |                |           |
| GITHUBREPOSITORY  | Specify GitHub's repository                                                                                                              |                |           |
...
| Macro                | Description                                                                                                                              | Default value          | Mandatory |
|:---------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|:-----------------------|:---------:|
| GITHUBSTATUSHOSTNAME | IP Addr/FQDN of the GitHub's status website                                                                                              | status.github.com      |           |
| GITHUBSTATUSPROTO    | Specify https if needed                                                                                                                  | https                  |           |
| GITHUBSTATUSPORT     | Port used by GitHub's status website                                                                                                     | 443                    |           |
...
| --hostname             |   IP Addr/FQDN of the GitHub's API (default: api.github.com)                                                                                                                                                                                    |
...
| --port               |   Port used by GitHub's status website (default: '443')                                                                                                                                              |
| --proto              |   Specify https if needed (default: 'https')                                                                                                                                                         |
| --urlpath            |   Set path to get GitHub's status information (default: '/api/last-message.json')                                                                                                                    |
| --timeout            |   Threshold for HTTP timeout (default: 5)                                                                                                                                                            |
...
| Option       | Description                                                   |
|:-------------|:--------------------------------------------------------------|
| --hostname   |   IP Addr/FQDN of the GitHub's API (default: api.gitub.com)   |
| --port       |   Port used by GitHub's API (default: '443')                  |
| --proto      |   Specify https if needed (default: 'https')                  |
| --timeout    |   Threshold for HTTP timeout (default: 5)                     |
| --warning    |   Warning threshold.                                          |
