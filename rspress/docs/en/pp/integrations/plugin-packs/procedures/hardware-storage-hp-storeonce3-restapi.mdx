...
The following monitoring connectors will be installed when you install the **HP StoreOnce 3 Rest API** connector through the
...
The Monitoring Connector **HP StoreOnce 3 Rest API** brings a host template:
...
<Tabs groupId="sync">
<Tab value="HW-Storage-Hp-Storeonce3-Restapi-custom" label="HW-Storage-Hp-Storeonce3-Restapi-custom">

| Service Alias    | Service Template                                         | Service Description     |
|:-----------------|:---------------------------------------------------------|:------------------------|
| Cluster-Usage    | HW-Storage-Hp-Storeonce3-Cluster-Usage-Restapi-custom    | Check cluster status    |
| Serviceset-Usage | HW-Storage-Hp-Storeonce3-Serviceset-Usage-Restapi-custom | Check service set usage |

> The services listed above are created automatically when the **HW-Storage-Hp-Storeonce3-Restapi-custom** host template is used.
...
| Service Alias | Service Template                                  | Service Description                  |
|:--------------|:--------------------------------------------------|:-------------------------------------|
| Fcs-Usage     | HW-Storage-Hp-Storeonce3-Fcs-Usage-Restapi-custom | Check federated catalyst store usage |
| Nas-Usage     | HW-Storage-Hp-Storeonce3-Nas-Usage-Restapi-custom | Check NAS usage                      |
...
<Tab value="Fcs-Usage" label="Fcs-Usage">
...
<Tab value="Nas-Usage" label="Nas-Usage">
...
<Tab value="Serviceset-Usage" label="Serviceset-Usage">
...
2. Whatever the license type (*online* or *offline*), install the **HP StoreOnce 3 Rest API** connector through
...
3. Apply the **HW-Storage-Hp-Storeonce3-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
| STOREONCEEXTRAOPTIONS | Any extra option you may want to add to every command (a --verbose flag for example). All options are listed [here](#available-options). |                   |             |
