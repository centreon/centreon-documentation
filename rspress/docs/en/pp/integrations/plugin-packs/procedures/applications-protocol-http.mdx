...
<Tabs groupId="sync">
<Tab value="App-Protocol-HTTP-custom" label="App-Protocol-HTTP-custom">
...
<Tab value="HTTP-Expected-Content" label="HTTP-Expected-Content">
...
<Tab value="HTTP-Json-Content" label="HTTP-Json-Content">
...
<Tab value="HTTP-Response-Time" label="HTTP-Response-Time">
...
<Tab value="HTTP-Soap-Content" label="HTTP-Soap-Content">
