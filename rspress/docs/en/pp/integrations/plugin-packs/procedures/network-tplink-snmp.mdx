...
The Monitoring Connector **TP-Link SNMP** brings a host template:
...
<Tabs groupId="sync">
<Tab value="Net-Tplink-SNMP-custom" label="Net-Tplink-SNMP-custom">
...
|:--------------|:----------------------------------|:--------------------|:----------:|
| Interfaces    | Net-Tplink-Interfaces-SNMP-custom | Check interfaces    | X          |
...
| Rule name                      | Description                                                   |
|:-------------------------------|:--------------------------------------------------------------|
| Net-Tplink-SNMP-Interface-Name | Discover network interfaces and monitor bandwidth utilization |
...
2. Whatever the license type (*online* or *offline*), install the **TP-Link SNMP** connector through
...
3. Apply the **Net-Tplink-SNMP-custom** template to the host. 
