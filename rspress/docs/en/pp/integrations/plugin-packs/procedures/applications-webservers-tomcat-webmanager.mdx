...
<Tabs groupId="sync">
<Tab value="App-Webserver-Tomcat6-Webmanager-custom" label="App-Webserver-Tomcat6-Webmanager-custom">
...
<Tab value="App-Webserver-Tomcat7-Webmanager-custom" label="App-Webserver-Tomcat7-Webmanager-custom">
...
<Tabs groupId="sync">
<Tab value="Tomcat-Applications-Global" label="Tomcat-Applications-Global">
...
<Tab value="Tomcat-Connectors-Global" label="Tomcat-Connectors-Global">
