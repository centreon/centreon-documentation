...
The Monitoring Connector **CyberPower Systems UPS SNMP** brings a host template:
...
<Tabs groupId="sync">
<Tab value="HW-UPS-Cyberpower-SNMP-custom" label="HW-UPS-Cyberpower-SNMP-custom">

| Service Alias  | Service Template                             | Service Description        |
|:---------------|:---------------------------------------------|:---------------------------|
| Battery-Status | HW-UPS-Cyberpower-Battery-Status-SNMP-custom | Check battery status       |
| Input-Lines    | HW-UPS-Cyberpower-Input-Lines-SNMP-custom    | Check input lines metrics  |
| Output-Lines   | HW-UPS-Cyberpower-Output-Lines-SNMP-custom   | Check output lines metrics |

> The services listed above are created automatically when the **HW-UPS-Cyberpower-SNMP-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **CyberPower Systems UPS SNMP** connector through
...
3. Apply the **HW-UPS-Cyberpower-SNMP-custom** template to the host. 
