...
<Tabs groupId="sync">
<Tab value="Net-F5-Bigip-SNMP-custom" label="Net-F5-Bigip-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="APM-Sessions" label="APM-Sessions">
...
<Tab value="Cpu-Usage" label="Cpu-Usage">
...
<Tab value="Failover" label="Failover">
...
<Tab value="Node-Status-Global" label="Node-Status-Global">
...
<Tab value="Pool-Status-Global" label="Pool-Status-Global">
...
<Tab value="Tmm-Usage" label="Tmm-Usage">
...
<Tab value="Trunk-Usage" label="Trunk-Usage">
...
<Tab value="Virtualserver-Status-Global" label="Virtualserver-Status-Global">
