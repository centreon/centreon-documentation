...
<Tabs groupId="sync">
<Tab value="HW-Pdu-Emerson-SNMP-custom" label="HW-Pdu-Emerson-SNMP-custom">
...
<Tab value="Power-Source-Usage" label="Power-Source-Usage">
...
<Tab value="Receptacles" label="Receptacles">
