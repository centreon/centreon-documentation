...
<Tabs groupId="sync">
<Tab value="Net-Cisco-Ironport-SNMP-custom" label="Net-Cisco-Ironport-SNMP-custom">
...
<Tab value="Mail-Usage" label="Mail-Usage">
...
<Tab value="Proxy-Usage" label="Proxy-Usage">
