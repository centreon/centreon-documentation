...
The following monitoring connectors will be installed when you install the **EMC Symmetrix API** connector through the
...
The Monitoring Connector **EMC Symmetrix API** brings 2 host templates:
...
<Tabs groupId="sync">
<Tab value="HW-Storage-EMC-Symmetrix-Dmx34-NSClient-05-Restapi-custom" label="HW-Storage-EMC-Symmetrix-Dmx34-NSClient-05-Restapi-custom">

| Service Alias   | Service Template                                                         | Service Description             |
|:----------------|:-------------------------------------------------------------------------|:--------------------------------|
| Hardware-Global | HW-Storage-EMC-Symmetrix-Dmx34-Hardware-Global-NSClient05-Restapi-custom | Check hardware components state |

> The services listed above are created automatically when the **HW-Storage-EMC-Symmetrix-Dmx34-NSClient-05-Restapi-custom** host template is used.

</Tab>
<Tab value="HW-Storage-EMC-Symmetrix-Vmax-NSClient-05-Restapi-custom" label="HW-Storage-EMC-Symmetrix-Vmax-NSClient-05-Restapi-custom">

| Service Alias   | Service Template                                                         | Service Description             |
|:----------------|:-------------------------------------------------------------------------|:--------------------------------|
| Hardware-Global | HW-Storage-EMC-Symmetrix-Vmax-Hardware-Global-NSClient05-Restapi-custom  | Check hardware components state |

> The services listed above are created automatically when the **HW-Storage-EMC-Symmetrix-Vmax-NSClient-05-Restapi-custom** host template is used.
...
2. Whatever the license type (*online* or *offline*), install the **EMC Symmetrix API** connector through
...
3. Apply the **HW-Storage-EMC-Symmetrix-Dmx34-NSClient-05-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **HW-Storage-EMC-Symmetrix-Vmax-NSClient-05-Restapi-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
4. Fill in the macros you want. Some macros are mandatory.
