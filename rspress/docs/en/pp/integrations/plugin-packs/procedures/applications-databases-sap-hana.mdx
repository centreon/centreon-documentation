...
<Tabs groupId="sync">
<Tab value="App-DB-Sap-Hana-custom" label="App-DB-Sap-Hana-custom">
...
<Tabs groupId="sync">
<Tab value="Blocked-Transactions" label="Blocked-Transactions">
...
<Tab value="Host-Cpu" label="Host-Cpu">
...
<Tab value="Host-Memory" label="Host-Memory">
