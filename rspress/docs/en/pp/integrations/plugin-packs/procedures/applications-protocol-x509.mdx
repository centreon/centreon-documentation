...
<Tabs groupId="sync">
<Tab value="App-Protocol-X509-custom" label="App-Protocol-X509-custom">
...
<Tabs groupId="sync">
<Tab value="X509-Certificate" label="X509-Certificate">
...
<Tab value="opensslcli" label="opensslcli">
