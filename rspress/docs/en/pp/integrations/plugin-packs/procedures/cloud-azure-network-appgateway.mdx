...
<Tabs groupId="sync">
<Tab value="Cloud-Azure-Network-AppGateway-V1-custom" label="Cloud-Azure-Network-AppGateway-V1-custom">
...
<Tab value="Cloud-Azure-Network-AppGateway-V2-custom" label="Cloud-Azure-Network-AppGateway-V2-custom">
...
<Tab value="Backend-Status" label="Backend-Status">
...
<Tab value="Backend-Time" label="Backend-Time">
...
<Tab value="Clients-Traffic" label="Clients-Traffic">
...
<Tab value="Gateway-Time" label="Gateway-Time">
