...
<Tabs groupId="sync">
<Tab value="HW-Device-Abb-Cms700-SNMP-custom" label="HW-Device-Abb-Cms700-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Mains-Measurements" label="Mains-Measurements">
...
<Tab value="Sensors-Measurements" label="Sensors-Measurements">
