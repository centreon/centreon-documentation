...
<Tabs groupId="sync">
<Tab value="Net-Riverbed-Steelhead-SNMP-custom" label="Net-Riverbed-Steelhead-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Bandwidth-Optimization" label="Bandwidth-Optimization">
...
<Tab value="Bandwidth-Passthrough" label="Bandwidth-Passthrough">
...
<Tab value="Disk-Utilization" label="Disk-Utilization">
