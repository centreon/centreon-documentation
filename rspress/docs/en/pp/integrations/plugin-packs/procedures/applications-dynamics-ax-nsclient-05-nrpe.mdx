...
<Tabs groupId="sync">
<Tab value="App-Dynamics-AX-NRPE-custom" label="App-Dynamics-AX-NRPE-custom">
...
<Tabs groupId="sync">
<Tab value="RIS-Import-Input" label="RIS-Import-Input">
...
<Tab value="RIS-Import-ProcessingErrors" label="RIS-Import-ProcessingErrors">
...
<Tab value="Service-RIS" label="Service-RIS">
