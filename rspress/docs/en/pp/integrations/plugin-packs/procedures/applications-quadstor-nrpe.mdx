...
<Tabs groupId="sync">
<Tab value="App-Quadstor-Vtl-NRPE-custom" label="App-Quadstor-Vtl-NRPE-custom">
...
<Tabs groupId="sync">
<Tab value="Vtl-Disk-Usage" label="Vtl-Disk-Usage">
...
<Tab value="Vtl-Job-Status" label="Vtl-Job-Status">
...
<Tab value="Vtl-Tape-Usage" label="Vtl-Tape-Usage">
