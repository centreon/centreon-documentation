...
<Tabs groupId="sync">
<Tab value="Virt-VMware8-VM-Restapi-custom" label="Virt-VMware8-VM-Restapi-custom">
...
<Tab value="Vm-Disk-IO" label="Vm-Disk-IO">
...
<Tab value="Vm-Network-Throughput" label="Vm-Network-Throughput">
...
<Tab value="Vm-Power" label="Vm-Power">
