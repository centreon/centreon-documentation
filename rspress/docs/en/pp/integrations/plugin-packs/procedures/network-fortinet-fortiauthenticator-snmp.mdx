...
<Tabs groupId="sync">
<Tab value="Net-Fortinet-Fortiauthenticator-SNMP-custom" label="Net-Fortinet-Fortiauthenticator-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Authenticator" label="Authenticator">
...
<Tab value="Disk-Log" label="Disk-Log">
