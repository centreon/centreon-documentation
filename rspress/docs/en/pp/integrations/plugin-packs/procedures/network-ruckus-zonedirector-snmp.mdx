...
The following monitoring connectors will be installed when you install the **Ruckus Zonedirector SNMP** connector through the
...
The Monitoring Connector **Ruckus Zonedirector SNMP** brings a host template:
...
2. Whatever the license type (*online* or *offline*), install the **Ruckus Zonedirector SNMP** connector through
