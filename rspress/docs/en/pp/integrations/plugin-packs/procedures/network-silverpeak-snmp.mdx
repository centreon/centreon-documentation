...
The following monitoring connectors will be installed when you install the **Silverpeak SNMP** connector through the
...
<Tabs groupId="sync">
<Tab value="Net-Silverpeak-SNMP-custom" label="Net-Silverpeak-SNMP-custom">

| Service Alias | Service Template                      | Service Description                                     |
|:--------------|:--------------------------------------|:--------------------------------------------------------|
| Alarms        | Net-Silverpeak-Alarms-SNMP-custom     | Check alarms on Silverpeak appliances                   |
| OperStatus    | Net-Silverpeak-OperStatus-SNMP-custom | Check Operational status of a Silverpeak appliance      |
| Uptime        | Net-Silverpeak-Uptime-SNMP-custom     | Time since the server has been working and initializing |

> The services listed above are created automatically when the **Net-Silverpeak-SNMP-custom** host template is used.
...
|:------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **Net-Silverpeak-SNMP-custom** host template. |
...
| Rule name                        | Description                                                   |
|:---------------------------------|:--------------------------------------------------------------|
| Net-Silverpeak-SNMP-Traffic-Name | Discover network interfaces and monitor bandwidth utilization |
...
<Tab value="OperStatus" label="OperStatus">
