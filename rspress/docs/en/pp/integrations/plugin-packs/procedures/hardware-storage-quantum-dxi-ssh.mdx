...
<Tabs groupId="sync">
<Tab value="HW-Storage-Quantum-Dxi-SSH-custom" label="HW-Storage-Quantum-Dxi-SSH-custom">
...
<Tab value="Dedupnas" label="Dedupnas">
...
<Tab value="Hostbus-Adapter-Status" label="Hostbus-Adapter-Status">
...
<Tab value="Reclamation" label="Reclamation">
...
<Tab value="Reduction" label="Reduction">
...
<Tab value="Storage-Array-Status" label="Storage-Array-Status">
