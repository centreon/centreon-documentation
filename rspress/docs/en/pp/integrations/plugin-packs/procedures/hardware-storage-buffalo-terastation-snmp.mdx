...
The following monitoring connectors will be installed when you install the **Buffalo TeraStation SNMP** connector through the
...
The Monitoring Connector **Buffalo TeraStation SNMP** brings a host template:
...
| Service Alias | Service Template                                      | Service Description |
|:--------------|:------------------------------------------------------|:--------------------|
| Interfaces    | HW-Storage-Buffalo-Terastation-Interfaces-SNMP-custom | Check interfaces    |
...
|:----------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Storage-Buffalo-Terastation-SNMP-custom** host template. |
...
2. Whatever the license type (*online* or *offline*), install the **Buffalo TeraStation SNMP** connector through
...
3. Apply the **HW-Storage-Buffalo-Terastation-SNMP-custom** template to the host.
