...
<Tabs groupId="sync">
<Tab value="Net-Cisco-Wlc-SNMP-custom" label="Net-Cisco-Wlc-SNMP-custom">
...
<Tab value="Net-Cisco-Wlc-SNMP-Access-Point-custom" label="Net-Cisco-Wlc-SNMP-Access-Point-custom">
...
<Tabs groupId="sync">
<Tab value="Ap-Channel-Interference-Global" label="Ap-Channel-Interference-Global">
...
<Tab value="Ap-Channel-Noise-Global" label="Ap-Channel-Noise-Global">
...
<Tab value="Ap-Status-Global" label="Ap-Status-Global">
