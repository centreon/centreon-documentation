...
The Monitoring Connector **Eaton PDU SNMP** brings a host template:

* **HW-Pdu-Eaton-SNMP-custom**

The connector brings the following service templates (sorted by the host template they are attached to):

<Tabs groupId="sync">
<Tab value="HW-Pdu-Eaton-SNMP-custom" label="HW-Pdu-Eaton-SNMP-custom">

| Service Alias | Service Template                     | Service Description         |
|:--------------|:-------------------------------------|:----------------------------|
| Environment   | HW-Pdu-Eaton-Environment-SNMP-custom | Check environmental sensors |
| Group         | HW-Pdu-Eaton-Group-SNMP-custom       | Check groups                |
| Outlet        | HW-Pdu-Eaton-Outlet-SNMP-custom      | Check outlets               |

> The services listed above are created automatically when the **HW-Pdu-Eaton-SNMP-custom** host template is used.
...
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resources through an SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) connector to get the discovery rule and create a template mapper for the **HW-Pdu-Eaton-SNMP-custom** host template |
...
| Metric name                                    | Unit  |
|:-----------------------------------------------|:------|
| *pdu*~*temperature*#temperature-status         | N/A   |
| *pdu*~*temperature*#sensor.temperature.celsius | C     |
| *pdu*~*humidity*#humidity-status               | N/A   |
| *pdu*~*humidity*#sensor.humidity.percentage    | %     |
...
| Metric name                  | Unit  |
|:-----------------------------|:------|
| *group*#group.current.ampere | A     |
| *group*#group.voltage.volt   | V     |
| *group*#group.power.watt     | W     |
...
| Metric name                    | Unit  |
|:-------------------------------|:------|
| *outlet*#outlet.current.ampere | A     |
| *outlet*#outlet.voltage.volt   | V     |
| *outlet*#outlet.power.watt     | W     |
...
```bash
dnf install centreon-pack-hardware-pdu-eaton-snmp
```
...
```bash
apt install centreon-pack-hardware-pdu-eaton-snmp
```
...
```bash
yum install centreon-pack-hardware-pdu-eaton-snmp
```

</Tab>
</Tabs>

2. Whatever the license type (*online* or *offline*), install the **Eaton PDU SNMP** connector through
...
```bash
dnf install centreon-plugin-Hardware-Pdu-Eaton-Snmp
```
...
```bash
apt install centreon-plugin-hardware-pdu-eaton-snmp
```
...
3. Apply the **HW-Pdu-Eaton-SNMP-custom** template to the host. 
...
| Macro                     | Description                                                                                                                                              | Default value      | Mandatory   |
|:--------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------|:-----------:|
| UNKNOWNHUMIDITYSTATUS     | Define the conditions to match for the status to be UNKNOWN (default: ''). You can use the following variables: %\{status\}, %\{display\}                    |                    |             |
...
```bash
/usr/lib/centreon/plugins/centreon_pdu_eaton_snmp.pl  \
	--plugin=hardware::pdu::eaton::snmp::plugin \
	--mode=outlet \
	--hostname='10.0.0.1' \
	--snmp-version='2c' \
...
|:--------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------|
| environment [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/eaton/snmp/mode/environment.pm)] | HW-Pdu-Eaton-Environment-SNMP-custom |
| group [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/eaton/snmp/mode/group.pm)]             | HW-Pdu-Eaton-Group-SNMP-custom       |
| outlet [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/hardware/pdu/eaton/snmp/mode/outlet.pm)]           | HW-Pdu-Eaton-Outlet-SNMP-custom      |
...
| Option        | Description                                                   |
|:--------------|:--------------------------------------------------------------|
| --filter-name | Filter group name (can be a regexp).                          |
...
| Option        | Description                                                   |
|:--------------|:--------------------------------------------------------------|
| --filter-name | Filter outlet name (can be a regexp).                         |
| --warning-*   | Warning threshold. Can be: 'voltage', 'current', 'power'.     |
| --critical-*  | Critical threshold. Can be: 'voltage', 'current', 'power'.    |
