...
<Tabs groupId="sync">
<Tab value="Cloud-Microsoft-Office365-Teams-Api-custom" label="Cloud-Microsoft-Office365-Teams-Api-custom">
...
<Tabs groupId="sync">
<Tab value="Devices-Usage-Teams" label="Devices-Usage-Teams">
...
<Tab value="Users-Activity-Teams" label="Users-Activity-Teams">
