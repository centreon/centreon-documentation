...
<Tabs groupId="sync">
<Tab value="Virt-VMWare2-VM-custom" label="Virt-VMWare2-VM-custom">
...
<Tab value="Vm-Datastores-Iops" label="Vm-Datastores-Iops">
...
<Tab value="Vm-Device" label="Vm-Device">
...
<Tab value="Vm-Limit" label="Vm-Limit">
...
<Tab value="Vm-Memory" label="Vm-Memory">
...
<Tab value="Vm-Snapshot" label="Vm-Snapshot">
...
<Tab value="Vm-Status" label="Vm-Status">
...
<Tab value="Vm-Swap" label="Vm-Swap">
...
<Tab value="Vm-Thinprovisioning" label="Vm-Thinprovisioning">
...
<Tab value="Vm-Tools" label="Vm-Tools">
...
<Tabs groupId="sync">
<Tab value="Centreon Cloud and OnPrem from version 24.10" label="Centreon Cloud and OnPrem from version 24.10">
...
<Tab value="Versions of Centreon OnPrem older than 24.10" label="Versions of Centreon OnPrem older than 24.10">
