...
<Tabs groupId="sync">
<Tab value="HW-Storage-Panzura-SNMP-custom" label="HW-Storage-Panzura-SNMP-custom">
...
<Tabs groupId="sync">
<Tab value="Cpu-Cloud" label="Cpu-Cloud">
...
<Tab value="Disk-Usage-Cloud-*" label="Disk-Usage-Cloud-*">
...
<Tab value="Disk-Usage-Local" label="Disk-Usage-Local">
...
<Tab value="Disk-Io-Generic-Name" label="Disk-Io-Generic-Name">
...
<Tab value="Disk-Io-Global" label="Disk-Io-Global">
...
<Tab value="Disk-Usage-Cloud-Generic-Name" label="Disk-Usage-Cloud-Generic-Name">
...
<Tab value="Disk-Usage-Cloud-Global" label="Disk-Usage-Cloud-Global">
