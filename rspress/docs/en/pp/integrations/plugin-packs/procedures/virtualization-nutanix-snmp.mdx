...
The following monitoring connectors will be installed when you install the **Nutanix SNMP** connector through the
...
The Monitoring Connector **Nutanix SNMP** brings 4 host templates:
...
<Tabs groupId="sync">
<Tab value="Virt-Nutanix-Container-SNMP-custom" label="Virt-Nutanix-Container-SNMP-custom">

| Service Alias | Service Template                            | Service Description                   |
|:--------------|:--------------------------------------------|:--------------------------------------|
| Iops          | Virt-Nutanix-Container-Iops-SNMP-custom     | Check Nutanix containers IOPS         |
| Latency       | Virt-Nutanix-Container-Latency-SNMP-custom  | Check Nutanix containers latency      |
| Storage       | Virt-Nutanix-Container-Storage-SNMP-custom  | Check Nutanix container storage usage |

> The services listed above are created automatically when the **Virt-Nutanix-Container-SNMP-custom** host template is used.

</Tab>
<Tab value="Virt-Nutanix-Hypervisor-SNMP-custom" label="Virt-Nutanix-Hypervisor-SNMP-custom">

| Service Alias | Service Template                             | Service Description                     |
|:--------------|:---------------------------------------------|:----------------------------------------|
| Cpu           | Virt-Nutanix-Hypervisor-Cpu-SNMP-custom      | Check Nutanix hypervisor CPU usage      |
| Iops          | Virt-Nutanix-Hypervisor-Iops-SNMP-custom     | Check Nutanix hypervisors IOPS          |
| Latency       | Virt-Nutanix-Hypervisor-Latency-SNMP-custom  | Check Nutanix hypervisor latency        |
| Memory        | Virt-Nutanix-Hypervisor-Memory-SNMP-custom   | Check Nutanix hypervisor memory usage   |
| Vm-count      | Virt-Nutanix-Hypervisor-Vm-Count-SNMP-custom | Check hypervisor virtual machines count |

> The services listed above are created automatically when the **Virt-Nutanix-Hypervisor-SNMP-custom** host template is used.

</Tab>
<Tab value="Virt-Nutanix-SNMP-custom" label="Virt-Nutanix-SNMP-custom">

| Service Alias      | Service Template                            | Service Description         | Discovery |
|:-------------------|:--------------------------------------------|:----------------------------|:---------:|
| Cluster-Usage      | Virt-Nutanix-Cluster-Usage-SNMP-custom      | Check cluster usage         |           |
| Container-Usage    | Virt-Nutanix-Container-Usage-SNMP-custom    | Check container usage       |           |
| Disk-Usage         | Virt-Nutanix-Disk-Usage-SNMP-custom         | Check disk usage            |     X     |
| Hypervisor-Usage   | Virt-Nutanix-Hypervisor-Usage-SNMP-custom   | Check hypervisor usage      |           |
| Storage-Pool-Usage | Virt-Nutanix-Storage-Pool-Usage-SNMP-custom | Check storage pool usage    |     X     |
| Vm-Usage           | Virt-Nutanix-Vm-Usage-SNMP-custom           | Check virtual machine usage |           |

> The services listed above are created automatically when the **Virt-Nutanix-SNMP-custom** host template is used.

> If **Discovery** is checked, it means a service discovery rule exists for this service template.

</Tab>
<Tab value="Virt-Nutanix-VM-SNMP-custom" label="Virt-Nutanix-VM-SNMP-custom">

| Service Alias | Service Template                            | Service Description                       |
|:--------------|:--------------------------------------------|:------------------------------------------|
| Cpu           | Virt-Nutanix-VM-Cpu-SNMP-custom             | Check Nutanix virtual machine CPU usage   |
| Iops          | Virt-Nutanix-VM-Iops-SNMP-custom            | Check Nutanix virtual machine IOPS        |
| Latency       | Virt-Nutanix-VM-Latency-SNMP-custom         | Check Nutanix virtual machine latency     |
| Power-State   | Virt-Nutanix-VM-Power-State-SNMP-custom     | Check Nutanix virtual machine power state |
| Traffic       | Virt-Nutanix-VM-Traffic-SNMP-custom         | Check Nutanix virtual machine traffic     |

> The services listed above are created automatically when the **Virt-Nutanix-VM-SNMP-custom** host template is used.
...
<Tabs groupId="sync">
<Tab value="Cluster-Usage" label="Cluster-Usage">
...
<Tab value="Hypervisor-Usage" label="Hypervisor-Usage">
...
<Tab value="Power-State" label="Power-State">
...
<Tab value="Storage-Pool-Usage" label="Storage-Pool-Usage">
...
<Tab value="Vm-Usage" label="Vm-Usage">
...
<Tab value="Vm-count" label="Vm-count">
...
Please refer to the [official documentation](https://portal.nutanix.com/page/documents/kbs/details?targetId=kA0600000008bAECAY) from the manufacturer/publisher. 
...
2. Whatever the license type (*online* or *offline*), install the **Nutanix SNMP** connector through
...
3. Apply the **Virt-Nutanix-Container-SNMP-custom** template to the host. 
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **Virt-Nutanix-Hypervisor-SNMP-custom** template to the host. 
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **Virt-Nutanix-SNMP-custom** template to the host. 
...
1. Log into Centreon and add a new host through **Configuration > Hosts**.
2. Fill in the **Name**, **Alias** & **IP Address/DNS** fields according to your resource's settings.
3. Apply the **Virt-Nutanix-VM-SNMP-custom** template to the host. 
