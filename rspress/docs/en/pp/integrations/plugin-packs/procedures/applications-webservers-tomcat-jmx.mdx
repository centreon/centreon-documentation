...
The following monitoring connectors will be installed when you install the **Tomcat JMX** connector through the
...
The Monitoring Connector **Tomcat JMX** brings a host template:
...
<Tabs groupId="sync">
<Tab value="App-Webserver-Tomcat-JMX-custom" label="App-Webserver-Tomcat-JMX-custom">

| Service Alias          | Service Template                                 | Service Description                         |
|:-----------------------|:-------------------------------------------------|:--------------------------------------------|
| Tomcat-Class-Count     | App-Webserver-Tomcat-Class-Count-JMX-custom      | Check Java Class usage                      |
| Tomcat-Cpu-Load        | App-Webserver-Tomcat-Cpu-Load-JMX-custom         | Check JVM SystemCpuLoad and ProcessCpuLoad  |
| Tomcat-Fd-Usage        | App-Webserver-Tomcat-Fd-Usage-JMX-custom         | Check number/percentage of file descriptors |
| Tomcat-Load-Average    | App-Webserver-Tomcat-Load-Average-JMX-custom     | Check system load average                   |
| Tomcat-Memory          | App-Webserver-Tomcat-Memory-JMX-custom           | Check Java Heap and NonHeap Memory usage    |
| Tomcat-Memory-Detailed | App-Webserver-Tomcat-Memory-Detailed-JMX-custom  | Check Java Memory Pools                     |
| Tomcat-Threads         | App-Webserver-Tomcat-Threads-JMX-custom          | Check threads                               |
| Webapps-Sessions       | App-Webserver-Tomcat-Webapps-Sessions-JMX-custom | Check webapps usage                         |

> The services listed above are created automatically when the **App-Webserver-Tomcat-JMX-custom** host template is used.
...
| Service Alias    | Service Template                                 | Service Description     |
|:-----------------|:-------------------------------------------------|:------------------------|
| Connector-Usage  | App-Webserver-Tomcat-Connector-Usage-JMX-custom  | Check connector usage   |
| Datasource-Usage | App-Webserver-Tomcat-Datasource-Usage-JMX-custom | Check datasources usage |
...
<Tabs groupId="sync">
<Tab value="Connector-Usage" label="Connector-Usage">
...
<Tab value="Tomcat-Class-Count" label="Tomcat-Class-Count">
...
<Tab value="Tomcat-Cpu-Load" label="Tomcat-Cpu-Load">
...
<Tab value="Tomcat-Fd-Usage" label="Tomcat-Fd-Usage">
...
<Tab value="Tomcat-Load-Average" label="Tomcat-Load-Average">
...
<Tab value="Tomcat-Memory" label="Tomcat-Memory">
...
<Tab value="Tomcat-Memory-Detailed" label="Tomcat-Memory-Detailed">
...
<Tab value="Tomcat-Threads" label="Tomcat-Threads">
...
<Tab value="Webapps-Sessions" label="Webapps-Sessions">
...
To monitor Tomcat, you need to enable JMX access or install Jolokia, and ensure that the Centreon poller can connect with the correct credentials.
...
2. Whatever the license type (*online* or *offline*), install the **Tomcat JMX** connector through
...
3. Apply the **App-Webserver-Tomcat-JMX-custom** template to the host. A list of macros appears. Macros allow you to define how the connector will connect to the resource, and to customize the connector's behavior.
