...
2.  Install the "OpenMetrics" Centreon Monitoring Connector from the **Configuration > Connectors > Monitoring Connectors** page.
...
3.  Install the "OpenMetrics" Centreon Monitoring Connector from the **Configuration > Connectors > Monitoring Connectors** page.
