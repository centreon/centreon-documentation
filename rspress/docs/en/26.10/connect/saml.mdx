...
<Tabs groupId="sync">
<Tab value="Users automatic management" label="Automatic management">
...
<Tab value="Users manual management" label="Manual management">
...
<Tabs groupId="sync">
<Tab value="Role automatic management" label="Automatic management">
...
<Tab value="Role manual management" label="Manual management">
...
<Tabs groupId="sync">
<Tab value="Groups automatic management" label="Automatic management">
...
<Tab value="Groups manual management" label="Manual management">
