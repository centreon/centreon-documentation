...
<Tabs groupId="sync">
<Tab value="Download page (all types of license)" label="Download page (all types of license)">
...
<Tab value="IT-100 free trial page" label="IT-100 free trial page">
...
<Tab value="Oracle VirtualBox" label="Oracle VirtualBox">
...
<Tabs groupId="sync">
<Tab value="Alma 8 and 9" label="Alma 8 and 9">
