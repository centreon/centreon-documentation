...
<Tab value="RHEL / Oracle Linux 9" label="RHEL / Oracle Linux 9">
...
<Tabs groupId="sync">
<Tab value="With authentication/TLS" label="With authentication/TLS">
...
<Tab value="Without authentication/TLS" label="Without authentication/TLS">
