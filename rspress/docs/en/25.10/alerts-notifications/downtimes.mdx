...
<Tabs groupId="sync">
<Tab value="Resources Status page" label="Resources Status page">
...
<Tab value="Detailed sheet of an object" label="Detailed sheet of an object">
...
<Tab value="Real time monitoring" label="Real time monitoring">
...
<Tab value="Downtime menu" label="Downtime menu">
