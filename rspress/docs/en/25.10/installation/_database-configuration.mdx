...
Please note that the following configuration is only an example for an 8 GB of RAM infrastructure. It is up to each user to adapt the database configuration to fit their needs.
We recommend you consult your database administrator for a configuration that fits your needs.
