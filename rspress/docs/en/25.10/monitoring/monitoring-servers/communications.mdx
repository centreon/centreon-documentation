...
<Tabs groupId="sync">
<Tab value="Modern (recommended)" label="Modern (recommended)">
...
<Tab value="Other (not recommended)" label="Other (not recommended)">
...
<Tabs groupId="sync">
<Tab value="For a Poller" label="For a Poller">
...
<Tab value="For a Remote Server" label="For a Remote Server">
