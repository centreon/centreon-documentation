...
<Tabs groupId="sync">
<Tab value="Central / Remote Server" label="Central / Remote Server">
...
<Tab value="Map server" label="Map server">
...
<Tab value="MBI server" label="MBI server">
