...
Before you do this, you must check the cluster.
...
The cluster logs are located in `/var/log/cluster/corosync.log` (or in `/var/log/corosync/corosync.log` for Debian). To display them, use the following command:
