...
title: Upgrade Centreon HA from Centreon 24.10
---
import { Tabs } from 'rspress/theme';
import { Tab } from 'rspress/theme';

This chapter describes how to upgrade your Centreon HA platform from version 24.10 to version 25.10.
...
> For the **active central node** and **active database node if needed** please [follow the official documentation](../../upgrade/upgrade-from-24-10.md) **until the "Upgrade MariaDB" step included**.
