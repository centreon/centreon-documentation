...
Once the poller is installed, we recommend [securing](../installation/poller-secure.md) it and keeping it [up-to-date](../installation/poller-update-upgrade.md). If you have more than one poller, we also recommend having them [monitor each other](../installation/poller-monitor.md) rather than having each poller monitor itself.

## Troubleshooting

We have a section dedicated to [troubleshooting pollers](../installation/poller-troubleshoot.md) to help you out. You can also use [our community platform The Watch](https://thewatch.centreon.com/).
