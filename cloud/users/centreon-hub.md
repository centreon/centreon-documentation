...
4. Click **Back to Centreon Hub**. You can now create an organization.

### Creating an organization

1. Log in to Centreon Hub:
   - When you first log in to Centreon Hub using the URL provided by the Centreon support team, the default screen will have a **Create your organization** button.
...
2. Fill in the fields:
   ...
   - **Display name**. This is the name your organization will have in the Centreon Hub interface.
