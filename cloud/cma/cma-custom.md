...
3. If you haven't already done so, [create a host](../monitoring/basic-objects/hosts) for the resource to be monitored.
...
5. [Deploy the configuration](../monitoring/monitoring-servers/deploying-a-configuration).
