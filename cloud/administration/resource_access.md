...
4. In the **Contacts/contact groups** section, define which users will be able to see these resources. If you select **All contacts/All contact groups**, the rule will apply to all existing contacts/contact groups, and also to any contacts/contact groups created in the future. Bear in mind that users and user groups are managed using [Centreon Hub](../users/centreon-hub.md).
