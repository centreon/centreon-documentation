...
The aformentioned account must be able to at least be able to open a ticket using through the **API operation core/create** using the **UserRequest class**.
...
This open ticket connector can retrieve the following informations from your Itop server
