...
- les chain rules : qui permet d'activer une autre règle open ticket après avoir ouvert un ticket
- les commandes : permet d'exécuter une commande lors de l'ouverture d'un ticket
...
> Attention, même pour des tests le répertoire /tmp n'est pas utilisable. /var/log/php-fpm lui l'est
...
avec un script bash test_opt.sh suivant :
