...
Lorsque vous créez une [règle Open Ticket (à la page **Configuration > Notifications > Règles**)](../ticketing.md), vous pouvez définir des champs à afficher dans la popup de création de ticket. Les informations saisies par l'utilisateur seront insérées dans le corps du ticket lors de sa création.
