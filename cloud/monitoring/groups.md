...
* Use the **Name** field to define a clear, relevant name for the host group. The name can be used in the **Resource status** search bar to display the group's hosts.
