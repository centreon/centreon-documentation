...
Pollers can then be updated by following the [step 6 of the procedure indicated here](../monitoring/monitoring-servers/add-a-remote-server-to-configuration.md#step-1-configure-a-new-remote-server).
