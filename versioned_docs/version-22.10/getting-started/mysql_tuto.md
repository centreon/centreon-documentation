...
The database will be monitored using the [**MySQL/MariaDB** Plugin Pack](/monitoring-connectors/integrations/plugin-packs/procedures/applications-databases-mysql).
