...
> If not, please follow before the [MariaDB update chapter](./upgrade-from-19-10.md#upgrade-the-mariadb-server)
...
2. Uninstall the current version:
  ...
  > Make sure you have [installed the official MariaDB repository](upgrade-from-20-04.md#install-the-mariadb-repository) before you continue the procedure.
