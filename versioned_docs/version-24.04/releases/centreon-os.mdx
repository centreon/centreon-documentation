...
- [Cron] Fixed an issue on data purge cron with partitioned tables.
...
- [Graph] Fixed an issue preventing "fill" and "invert" options from being considered in the graphs from Resource Status and Dashboards.
