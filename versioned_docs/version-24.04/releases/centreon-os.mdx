...
- [Configuration] Fixed an issue on getting metrics on MetaService form.
- [Configuration] The correct value for the notification activation option is now written to the Engine configuration file.
- [Dataset] Fixed filtering when searching a resource.
- [Dataset] Handled special characters in metrics.
- [Dashboards] Fixed host search for resource status widgets.
...
- [Resource Status] Fixed an issue that occured when a non-admin user was searching for resources by host categories.
...
- [Status Chart widget] Fixed issue with the list of resources displayed when hovering the charts.
- [Status Chart widget] Filter on selected resources is now handled correctly.
- [Status Grid widget] Filter on selected resources is now handled correctly in the condensed view.
