...
- [Broker] Fixed a segfault on Broker that was occuring when Engine stopped or was restarted, when Engine's version was older than 24.04.
...
- [Gorgone] Raise an error if ETL configuration file don't exist.
- [MBI] Fixed a bug in MBI where hostname with semicolon will break database insertion.	
