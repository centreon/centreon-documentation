...
- [Installation] Fixed an issue with the mariadb password setup when using the unattended installation.
...
- [Custom Views] Fixed an issue that caused an SQL error when renaming a widget.
...
- [Configuration] Fixed an issue where the broker cache would not be updated.
