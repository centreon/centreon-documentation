...
- [API] Fixed an issue on service template listing endpoint.
- [Administration] Fixed an issue on user groups and templates when importing LDAP with a non admin user.
...
- [Compatibility] Fixed issue preventing Business Activities from being displayed on remote servers.
