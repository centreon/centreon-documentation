...
3. Install the 24.04 Business repository: Visitt the [support portal](https://support.centreon.com/hc/en-us/categories/10341239833105-Repositories) to get its address.
...
page:
  ...
  > If the Centreon BAM module is installed, refer to the [upgrade it](../service-mapping/update.md) before connecting to the interface.
