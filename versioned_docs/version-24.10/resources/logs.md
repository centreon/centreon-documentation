...
|Interface, API and database |                            | /var/log/centreon/prod.web.log <br/> *Replacse centreon-web.log, sql-error.log and /var/log/php-fpm/centreon-error.log* | API call issues, form errors, SQL errors, blank page, uncaught exceptions |
