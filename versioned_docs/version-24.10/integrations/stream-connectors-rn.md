...
- [**InfluxDB 2 Metrics**](data-analytics/sc-influxdb2-metrics.md) - Properly escape host name in tags.
- [**Centreon library: sc_params**](https://github.com/centreon/centreon-stream-connector-scripts/blob/develop/modules/centreon-stream-connectors-lib/sc_params.lua) - Fixed correct usage of broker apiv2.
- [**Canopsis Events**](data-analytics/sc-canopsis-events.md) - Fixed for downtime names/id that weren't unique enough and library that wasn't properly detecting the status of a host/service in a downtime event.
