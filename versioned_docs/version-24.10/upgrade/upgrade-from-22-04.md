...
description: "Upgrade a Centreon platform from version 22.04 to 24.10"
---
...
> Version 24.10 means the end of support for Debian 11. If you were using Debian 11, you must first migrate to Debian 12 before you can upgrade Centreon. If your Centreon platform has HA, please contact your Centreon sales representative to discuss any migration scenario.
...
2. If you have installed Business extensions, delete the configuration of the 22.04 repository: 
