...
- [Configuration] Changes made in a host's Relations tab are now recorded in the logs like other configuration changes.
...
- [Configuration] Fixed an undefined array key from ACL users which were spamming the PHP logs when listing hosts.
...
### Centreon Open Tickets 24.10.16
...
### Centreon DSM 24.10.8

No functional changes for this module in this version.

### Centreon Collect 24.10.24

<details open>
  <summary>Enhancements</summary>

- Vcpkg have been upgraded.
...
### Centreon Monitoring Agent 24.10.19
