...
- [Status Grid widget] Optimized the way the health of the Business Activities is calculated.
...
- [Agent/Poller configuration] Fixed an issue on search.
...
- [Reports/Availability] Fixed an issue when downloading CSV if a day is UNDETERMINED on selected period.
...
- [Resource Status] Fixed issue preventing user from using compact mode.
