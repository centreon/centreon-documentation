...
- [Dashboards] Added meta-services to metric widgets.
...
- [ACC] Fixed an issue on ACC where .json file was not deployed in case of a central Poller.
...
- [Downtimeas] Fixed an issue on actions details column in Action Log.
