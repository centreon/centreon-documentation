...
- [Gorgone] Fix centreontrapd configuration file permissions when exporting poller configuration.
- [Gorgone] Fixed a bug in MBI where hostname with semicolon will break database insertion.
