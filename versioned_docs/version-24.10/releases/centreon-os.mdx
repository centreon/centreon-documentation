...
- Non-admin users can now see freshly-created host groups in the list of host groups immediately.
- Non-admin users can now see freshly-created service groups immediately in the list of service groups.
...
- **Metrics Graph widget**:
   - Added curve type format setting.
