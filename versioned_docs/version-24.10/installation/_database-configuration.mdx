...
Please note that the following configuration is only an example for an 8 GB of RAM infrastructure. Centreon is not responsible for the potential modifications needed in this part. 
