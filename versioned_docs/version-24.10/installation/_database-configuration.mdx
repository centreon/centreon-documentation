...
Please note that the following configuration is only an example for an 8gb of RAM infrastructure. Centreon is not responsible for the potential modifications needed in this part. We recommend you consult your database administrator for a configuration that fits your needs.
...
Please note that the following configuration is only an example for an 8gb of RAM infrastructure. Centreon is not responsible for the potential modifications needed in this part.
