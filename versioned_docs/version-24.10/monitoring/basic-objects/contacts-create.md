...
* The next 3 fields are for authorizing users to perform [API calls](../../api/rest-api-v1.md#api-calls) (note: our API documentation is written for developers familiar with HTTP requests and JSON).
...
- Administrators are able to call both the **Configuration API** and the [**Realtime API**](../../api/rest-api-v1.md#realtime-information) regardless of the corresponding field being checked in both. This is true for both v1 and v2.
