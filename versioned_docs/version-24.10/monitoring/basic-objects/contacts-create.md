...
- Administrators are able to call both the **Configuration API** and the [**Realtime API**](../../api/rest-api-v1.md#realtime-information) regardless of the corresponding field being checked in both. This is true for both v1 and v2. They are also the only ones allowed to use [**CLAPI**](clapi.md) while others can only use Rest API.
