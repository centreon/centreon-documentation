...
- You will be able to use the [autodiscovery feature] for hosts and services, and  the entire [Centreon Plugin Pack library].
...
4. Add the Centreon IT Edition token you have received by email.
    > If necessary, [configure the proxy]
...
5. Your plateform is now ready. You can [monitor your first host].
