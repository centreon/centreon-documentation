...
> postpone the upgrade to 21.10, be aware that Centreon Web 21.10 resource
...
You can now push poller configuration from Centreon 21.10 whether the distant
Poller is Centreon Engine 21.10 or 1.8.1.
