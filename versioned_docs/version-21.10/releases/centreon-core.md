...
- Fixed an issue that prevented Gorgone from handling advanced [Service Discovery features](http://localhost:3000/docs/monitoring/discovery/services-discovery#advanced-options) correctly.
