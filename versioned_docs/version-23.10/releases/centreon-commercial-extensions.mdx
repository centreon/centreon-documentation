...
- [Editor] Fixed critical issue when hovering a disabled resource
...
- [Server] handle the generation of API routes during the upgrade process.
...
- Fixed the display of impact tree when deprecated pages are enabled for the user.
