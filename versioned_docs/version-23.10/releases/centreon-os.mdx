...
- [Broker] Fixed an issue with acknowledgements that did not appear in the logs table.
- [Configuration] Fixed issue with the output password parameter of the Broker stream connector.
