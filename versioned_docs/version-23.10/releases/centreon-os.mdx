...
- Solved a conflict between centreon-collect 23.04 and centreon-collect 23.10 that was occurring because of a change in the way we provide the mariadb caching sha2 password plugin.
