...
- [Resource Status] Improved update of filters by removing useless dialog
...
- [Authentication] Fixed issue in SSO authentication.
- [API] Fixed a visibility issue on UserFilter endpoint.
- [API] Fixes an issue where 500 error was returned when a host didn't have alias.
- [CLAPI] Fixed a decoding issue on HTML entities export.
- [CLAPI] While exporting services and hosts, duplicates were generated.
- [Dashboards - Map widget] Fixed Map, Geoview and perspective save.
