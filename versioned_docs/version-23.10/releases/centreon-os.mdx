...
- [API] Fixed an issue on Service Template Service group update.
- [API] POST /administration/tokens endpoint documentation now includes 201 response details.
- [API] Fixed an visibility issue on configuration/users endpoint.
- [Metrics Graph widget] Fixed cropping issue on ordinate.
- [Server] URL patterns have been modified.
- [Single Metric widget] Simplified metric selection.
- [UI] Fixed cursor issue when editing a widget
- [Widget edition] Fixed issue when removing resource/metric.
...
- [Security] Prevented the command injection in SENDTRAPCFG gorgone event.
...
- [Gorgone] Fixed a stability issue causing the kernel to kill the gorgone process.
