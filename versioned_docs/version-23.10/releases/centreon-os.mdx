...
- [API] Fixed an issue with is_password when using Service and Servite Template POST endpoint.
- [API] Fixed access control for some v2 API endpoints.
- [Auto Discovery] Fixed rights of temporary files created during configuration generation.
...
- [Resource Status] Fixed access to view report from resource details panel.
- [Resource Status] Fixed the selection of disabled poller in filters.
- [UX] Fixed the possibility to close the top counter pop-up when user clicks away.
