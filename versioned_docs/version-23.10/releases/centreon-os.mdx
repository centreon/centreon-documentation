...
- [Broker] During BA initializations, kpi could be set with incoherent status. This was breaking BAs.
...
- [Collect] Use perl-interpretor instead of perl for centreon-connector-perl packaging (rpm).
- [Collect] Use perl-base instead of perl for centreon-connector-perl packaging (deb).
