...
- [Dashboards] Handled the new shares system on Dashboards.
- [Dashboards] Correctly retrieved contact and contactgroup shares for non admin users.
...
- [Dashboards] Fixed an issue that was retrieving all contactgroups despite Dashboard ACLs.
- [MySQL] Fixed an issue preventing to search a host in a widget.
- [Status Grid widget] Fixed tiles ordering by status.
- [Status Grid widget] Fixed an issue preventing the user from deleting the value for the number of tiles to display.
- [Status Grid widget] Fixed the "Metric not found" message that was not supposed to appear.
