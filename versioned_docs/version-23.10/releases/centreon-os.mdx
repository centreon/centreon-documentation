...
- [Performance] Fixed a query performance issue with some specific datas in resource status.
- [Resource Status] Fixed an issue with "Force Active Checks" option which was ignored in some cases.
