...
- [Engine] Fixed Engine crash when deleting a host during downtime notification.
...
- [Gorgone] Added option to make discovery commands less permissive
- [Gorgone] Fixed centreontrapd configuration file permissions when exporting poller configuration.
- [MBI] Fixed an issue where ETL would never finish if some service templates were referencing themselfes.
