...
- [Dashboard]Handled the new shares system on Dashboard.
...
- [Dashboard]: Retrieve only contactgroups with Dashboard ACLs.
- [MySQL] Fixed an issue preventing to search a host in a widget.
- [Status Grid widget] Fixed tiles ordering by status.
- [Status Grid widget] Fixed an issue preventing user to delete value of the number of tiles to be displayed.
- [Status Grid widget] No more "Metric not found" on Status Grid.
- [UI] Fixed the display of inappropriate 404 error page when loading map home page.
