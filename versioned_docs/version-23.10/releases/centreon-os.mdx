...
- [Unattended] Backported recent bug fixes on unattended (http services not restarting, it-edition-extensions installation, unattended issue on Oracle Linux distributions).
