...
- [Broker] Fixed a bug concerning the update of a Business Activity, after status change of a KPI with type BA.
- [Install] Fixed rights on SSH directory for Debian.
- [Packaging] Fixed an error that was returned during centreon-broker-cbmod installation.
