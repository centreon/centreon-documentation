...
- Before going any further, make sure that you have correctly set up [Centreon Open Tickets](../../alerts-notifications/ticketing-install.md) on your Centreon instance.
