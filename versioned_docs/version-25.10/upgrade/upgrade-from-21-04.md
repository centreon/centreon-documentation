...
description: "Upgrade a Centreon platform from version 21.04 to 25.10"
---
...
Then, Ensure the `memory_limit` parameter in `/etc/php.d/50-centreon.ini` is set to at least 256mb. If it isn't, insert it manually. 
