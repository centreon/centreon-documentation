...
title: Upgrade Centreon HA from Centreon 24.04
description: "Upgrade a Centreon HA cluster from version 24.04 to 25.10"
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This chapter describes how to upgrade your Centreon HA platform from version 24.04 to version 25.10.
...
> For the **active central node** and **active database node if needed** please [follow the official documentation](../../upgrade/upgrade-from-24-04.md) **until the "Upgrade MariaDB" step included**.

> For the **passive central node** and **passive database node if needed**, please [follow the official documentation](../../upgrade/upgrade-from-24-04.md) **until the "Update your customized Apache configuration" step included**. Then, skip to the "Upgrade MariaDB" step and follow its instructions. **Do not follow "Finalizing the upgrade" and "Post-upgrade actions"**.
