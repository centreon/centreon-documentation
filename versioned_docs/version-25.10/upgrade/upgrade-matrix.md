...
Pour rappel, les [OS supportés en version 25.10](../installation/compatibility.md#operating-systems) sont les suivants :
...
<table>
  <thead>
    <tr>
      ...
      <th>OS toujours supporté en 25.10 ?</th>
      <th>Procédure à suivre</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td rowspan="3"><strong>24.10</strong></td>
      <td>RHEL/Oracle Linux/Alma Linux 8</td>
      <td style={{color: 'green', fontWeight: 'bold'}}>OUI</td>
      <td><a href="upgrade-from-24-10.md">Procédure de montée de version</a></td>
    </tr>
    <tr>
      <td>RHEL/Oracle Linux/Alma Linux 9</td>
      <td style={{color: 'green', fontWeight: 'bold'}}>OUI</td>
      <td><a href="upgrade-from-24-10.md">Procédure de montée de version</a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>RHEL/OracleLinux/Alma Linux 9</td>
      <td style={{color: 'green', fontWeight: 'bold'}}>OUI</td>
      <td><a href="upgrade-from-24-04.md">Procédure de montée de version</a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>RHEL/OracleLinux/AlmaLinux 9</td>
      <td style={{color: 'green', fontWeight: 'bold'}}>OUI</td>
      <td><a href="upgrade-from-23-10.md">Procédure de montée de version</a></td>
    </tr>
    <tr>
