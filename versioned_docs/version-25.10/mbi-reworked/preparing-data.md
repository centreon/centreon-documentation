...
For business activities and business views availability reports template, the resources you want to see appear in reports need to be organized in [businessa ctivities](https://docs.centreon.com/cloud/service-mapping/ba-management/#business-activities-ba) and [business views](https://docs.centreon.com/cloud/service-mapping/ba-management/#business-view-bv)
...
If you need to use a specific timeperiod, go to  **Configuration > User > Time Periods** and create new one following [this procedure](https://docs.centreon.com/cloud/monitoring/basic-objects/timeperiods/)
