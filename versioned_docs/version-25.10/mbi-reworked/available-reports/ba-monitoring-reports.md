...
> In the **Time period** field, do not use time periods that include [exceptions](https://docs.centreon.com/cloud/monitoring/basic-objects/timeperiods/#time-range-exceptions-tab), as the exceptions will not not be taken into account.
