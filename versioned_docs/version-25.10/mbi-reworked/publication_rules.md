...
By default, reports are available to download from the central server. If you want to distribute your reports directly to your users, create a publication rule and select it in the job you want.
