...
Rules marked as global, such as the default rule, do not appear here because it is not necessary to select them, they are automatically applied to all jobs.
