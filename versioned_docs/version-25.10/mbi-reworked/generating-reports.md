...
Enabling the admnistrator notification will cause the administrator to be notified each time a report is generated by this specific job. Note that admnistrator notification needs to be first enabled in **Reporting > Monitoring Business Intelligence > [General Options](configuring-mbi.md#notification-options)** for this field to work.
