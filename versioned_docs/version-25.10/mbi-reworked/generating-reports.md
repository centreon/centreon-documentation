...
The Output formats determine in what formats you will be able to download the generated report. Note that a report design may not be available in all formats. Consult our [available reports catalog](available-reports/available-reports.md) 
