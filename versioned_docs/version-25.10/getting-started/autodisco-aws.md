...
7. Follow [this procedure](/pp/integrations/plugin-packs/procedures/cloud-aws-ec2.md) (sections [Plugin dependencies](/pp/integrations/plugin-packs/procedures/cloud-aws-ec2.md#plugin-dependencies) and [Setup](/pp/integrations/plugin-packs/procedures/cloud-aws-ec2.md#installing-the-monitoring-connector)) to finish installing the Monitoring Connector. (You can also access the documentation for a Monitoring Connector by clicking the `i`.)
