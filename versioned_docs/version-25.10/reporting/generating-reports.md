...
> MBI is a Centreon extension that has some terms you may not have heard elsewhere in our documentation. We strongly suggest you read the [**Concepts** page](../reporting/concepts.md) before following MBI-related procedures.
