...
A much simpler option is to [send the generated report to this user by email or copy the report to a server they can access](https://docs.centreon.com/docs/reporting/reports-publication-rule), using a publication rule.
