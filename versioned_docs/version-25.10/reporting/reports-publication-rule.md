...
| Centreon main server web protocol   | http                                 | Protocol used to access the Centreon interface (HTTP or [HTTPS](https://docs.centreon.com/docs/reporting/administration/secure-platform.md)).                       |
