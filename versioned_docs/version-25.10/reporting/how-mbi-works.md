...
2. On the central server, a script (**eventReportBuilder**) is launched by a cronjob every day at 3 AM: it converts check results into [events](https://docs.centreon.com/docs/reporting/concepts/#event) that will be used to calculate availability. The time this script is launched is defined in **/etc/cron.d/centreon**.
