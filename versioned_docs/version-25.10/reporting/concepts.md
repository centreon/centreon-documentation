...
Service user created automatically when the extension is installed. This user will generate reports. The CBIS user must be granted access to all resources using [the regular Centreon ACLs](https://docs.centreon.com/docs/administration/access-control-lists/) to function properly.
