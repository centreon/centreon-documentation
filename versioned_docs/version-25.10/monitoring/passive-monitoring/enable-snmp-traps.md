...
MariaDB/MySQL database. The traps can subsequently be linked to passive services via the **Relations** tab of the definition
of a service.
...
keeping the information of the traps contained in the MariaDB/MySQL database cached. This SQLite database is automatically
