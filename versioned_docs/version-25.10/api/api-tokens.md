...
* [Users or administrators](../administration/access-control-lists.md#granting-rights-to-a-user) accessing the **Administration > Authentication Tokens** page can create tokens for themselves.
...
3. Fill in the required fields (inclding type:**API**) and then click **Generate new token**. A **Token** field appears in the window. You can click the eye icon to display the token if you want.
...
Users [with the correct rights](#who-can-create-api-tokens) can also:
