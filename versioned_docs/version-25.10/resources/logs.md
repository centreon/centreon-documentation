...
|Interface, API and database        |                                  |/var/log/centreon/prod.web.log <br/> *Replaces centreon-web.log, sql-error.log and /var/log/php-fpm/centreon-error.log*|API call problems, errors in forms, SQL errors, blank pages, uncaught exceptions                                                  |
|                                   |                                  |/var/log/apache2/*.log                            |Malfunctioning interface                                                                                                          |
|                                   |                                  |/var/log/httpd/*.log                              |Malfunctioning interface (HTTP 50x errors)                                                                                        |
