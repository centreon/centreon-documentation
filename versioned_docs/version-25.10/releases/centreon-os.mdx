...
- [Authentication] Fixed an issue where a users could lose their DN during an LDAP connection.
- [Authentication] Fixed issue with LDAP authentication crashing right after a success message.
...
- [Configuration] Fixed an issue of page content getting mixed-up when navigating between Host Groups and Additional configuration pages.
...
- [Performance Graphs] Fixed issue when exporting data in CSV that resulted in an empty file..
