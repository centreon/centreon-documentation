...
- structured logging of every command/query bus dispatch and uncaught exception on the new kernel (backport).
- [administration] centreon web is now able to connect to db using tls 1.3.
...
- [upgrade] upgrades are now fully traced in a dedicated upgrade.log file, making migrations easier to troubleshoot.
- [web] new logging system for centreon-web.
...
- [web] fixed an issue causing sso logout to fail due to invalid format in sso logout request.
