...
- [Dashboards] Added Notes and Action columns to the Resource table widget.
...
- Fixed section header in SNMP traps configuration form.
...
- [Configuration] Fixes saving configuration when the database name contains a hyphen or dollar sign.
...
- [Export] Fixed encrypted passwords in exported configuration files, which could prevent Broker from starting.
