...
- [Packaging] Fixed missing file libcentreon_pb_bbdo.so.debug on Collect.
...
- [CMA] Timeperiods are now handled for checks cheduling and freshness calculation.
- [Packaging] Fixed missing file libcentreon_pb_bbdo.so.debug on CMA.
