...
- Fixed an issue where services associated with multiple hosts are deleted for all hosts when a host is deleted.

</details>

<summary>Security fixes</summary>

- [Security] Fixed an issue on CLAPI Import.
...
- [Security]Fixed an issue in AWIE Export Module.
- [Security] Fixed an issue on CLAPI Import.
