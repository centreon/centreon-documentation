...
| **Centreon Collect** | [25.10.4 (March 30, 2026)](#centreon-collect-25104)<br/>[25.10.3 (February 25, 2026)](#centreon-collect-25103)<br/>[25.10.2 (January 29, 2026)](#centreon-collect-25102)<br/>[25.10.1 (December 17, 2025)](#centreon-collect-25101) |
| **Centreon Gorgone** |  [25.10.5 (March 30, 2026)](#centreon-gorgone-25105)<br/>[25.10.4 (February 25, 2026)](#centreon-gorgone-25104)<br/>[25.10.3 (January 29, 2026)](#centreon-gorgone-25103)<br/>[25.10.2 (December 17, 2025)](#centreon-gorgone-25102)<br/>[25.10.1 (November 17, 2025)](#centreon-gorgone-25101)<br/>[25.10.0 (November 4, 2025)](#centreon-gorgone-25100) |
| **Centreon Monitoring Agent** | [25.10.4 (March 30, 2026)](#centreon-monitoring-agent-25104)<br/>[25.10.3 (February 25, 2026)](#centreon-monitoring-agent-25103)<br/>[25.10.2 (January 29, 2026)](#centreon-monitoring-agent-25102)<br/>[25.10.1 (December 17, 2025)](#centreon-monitoring-agent-25101)<br/>[25.10.0 (November 4, 2025)](#centreon-monitoring-agent-25100)  |
...
- Dedicated token & agent configuration are created when deploying/upgrading a platform.
...
- [Authentication] Improved special characters list.
- [Configuration] Enhanced hosts selection in hostgroups creation.
...
- [API] Fixed Acknowledgements API Documentation.
- [API] Fixed an issue where adding a host or service doesn't trigger ACL recalculation.
...
- [CEIP] Fixed an issue where database name was hardcoded.
- [Configuration] Fixed an issue where exporting the configuration was slower on 25.10.
- [Configuration] Fixed an issue where unlinking a host template from a host does not unlink it from the service by host page.
...
- [Login] Fixed an issue on login autofill when using Safari.
