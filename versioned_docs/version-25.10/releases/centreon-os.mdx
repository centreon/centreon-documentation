...
| **Centreon Open Tickets** | [25.10.8 (June 29, 2026)](#centreon-open-tickets-25108)<br/>[25.10.7 (May 26, 2026)](#centreon-open-tickets-25107)<br/>[25.10.6 (April 28, 2026)](#centreon-open-tickets-25106)<br/>[25.10.5 (March 30, 2026)](#centreon-open-tickets-25105)<br/>[25.10.4 (February 25, 2026)](#centreon-open-tickets-25104)<br/>[25.10.3 (February 23, 2026)](#centreon-open-tickets-25103)<br/>[25.10.2 (January 29, 2026)](#centreon-open-tickets-25102)<br/>[25.10.1 (December 17, 2025)](#centreon-open-tickets-25101)<br/>[25.10.0 (November 4, 2025)](#centreon-open-tickets-25100) |
...
- [Configuration] Users can now change the log level of the event_script broker output from the broker configuration page.
- [Report] Corrected page break issues in the "Hostgroup-graphs-v2" report when displaying a large number of services.
- [Upgrade] Made APIv2 update endpoint fully compatible with upgrade endpoint.
- [VMware Connector] Do not restart VMware connector if associated configuration doesn't change on a poller.
...
- Fixed an issue on host edition/creation API internal calls.
- Fixed an issue where configuration for centreon trapd could not be pushed on pollers.
- Fixed an issue where upgrade to version 25.10.10 failed when the central broker configuration was not linked to the broker daemon, as commonly configured on HA platforms.
...
- [Configuration] Fixed an issue on export via top counter button.
...
- [Monitoring] Removed unnecessary PHP warnings on service details page.
...
- [Packaging] Fixed cache rebuild missing commands.
...
- Fixed an issue when moving a host or a service, it might be removed from cache.
- [Centengine] Fixed an issue where time period was only active on time range exception day.
...
- Fixed a bug where invalid data could crash the Autodiscovery module.
- Fixed an issue where configuration for centreon trapd could not be pushed on pollers.
- [ETL] Fixed a critical ETL failure path and corrected calculation logic to ensure data accuracy and processing stability.
...
- [CMA] Installer now handles upgrade of existing instance.
...
- Fixed the collection of the used swap value on Windows Server 2025.
