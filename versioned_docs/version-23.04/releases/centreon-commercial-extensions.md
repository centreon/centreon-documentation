...
- [Editor] Fixed a bug where empty metric min or max prevented to save a map.
...
- [UI] Fixed empty "Current usage" column in the mbi-storage-list-near-saturation widget.
