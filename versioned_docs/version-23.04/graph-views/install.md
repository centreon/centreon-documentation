...
If you [customized the URI](../administration/secure-platform.md#custom-uri) for your Centreon platform, you need to edit the **studio-config.properties** file by adding:
