...
1. On your central server, go to **Configuration > Connectors > Monitoring Connectors**.
2. [Install](../monitoring/pluginpacks.md#installing-a-monitoring-connector.md) the [**Windows Centreon Monitoring Agent**](/pp/integrations/plugin-packs/procedures/operatingsystems-windows-centreon-monitoring-agent) monitoring connector.
