...
Pour rappel, les [OS supportés en version 26.10](../installation/compatibility.md#operating-systems) sont les suivants :
...
<table>
  <thead>
    <tr>
      ...
      <th>OS toujours supporté en 26.10 ?</th>
      <th>Procédure à suivre</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td rowspan="3"><strong>25.10</strong></td>
    ...
    <tr>
      ...
      <td><a href="upgrade-from-25-10.md">Procédure de montée de version</a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>22.10 et antérieures</td>
      <td>Voir documentations correspondantes</td>
      <td style={{color: 'red'}}>NON</td>
      <td><a href="../migrate/introduction.md">Procédure de migration depuis EL ou Debian</a></td>
    </tr>
<!--     <tr>
