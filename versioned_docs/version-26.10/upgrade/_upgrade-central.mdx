...
1. Update your Centreon {props.centreonVersion} to the latest minor version.

2. Remove the repository files:

   <CodeBlock language="shell">
   {`rm /etc/yum.repos.d/centreon-${props.centreonVersion}.repo\nrm /etc/yum.repos.d/centreon.repo`}
   </CodeBlock>
...
2. If you have installed Business extensions, delete the configuration of the {props.centreonVersion} repository:

<Tabs groupId="sync">
<TabItem value="Alma / RHEL / Oracle Linux 9" label="Alma / RHEL / Oracle Linux 9">

<CodeBlock language="shell">{`rm /etc/yum.repos.d/centreon-business-${props.centreonVersion}.repo`}</CodeBlock>
...
You need to change the PHP stream from version {props.phpVersion} to 8.4 by executing the following commands and answering **y**
to confirm:
