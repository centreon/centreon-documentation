---
id: install
title: Installing Centreon MAP (Legacy) extension
---
...
```shell
dnf install -y https://yum.centreon.com/standard/22.04/el8/stable/noarch/RPMS/centreon-release-22.04-1.el8.noarch.rpm
```
