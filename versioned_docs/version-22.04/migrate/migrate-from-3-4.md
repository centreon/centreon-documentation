...
3. Export the dumps to the new Centreon 22.04 database server (make sure you
...
4. On the Centreon 22.04 database server, drop the original databases and
create them again:
...
> postpone the upgrade to 22.04, be aware that Centreon Web 22.04 resource
...
You can now push poller configuration from Centreon 22.04 whether the distant
Poller is Centreon Engine 22.04 or 1.8.1.
...
Centreon 22.04 and perform the upgrade.
